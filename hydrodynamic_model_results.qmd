...
# !! Moesa: M1
## M1_16_00 Single Attribute Rasters
```{r}
...
test <- raster("raster_files/M1_v_16_00.tif")
crs(test) <- "EPSG: 2056"
plot(test)
...
test <- raster("raster_files/M1_v_18_84.tif")
crs(test) <- "EPSG: 2056"
plot(test)
...
test <- raster("raster_files/M1_v_22_84.tif")
crs(test) <- "EPSG: 2056"
plot(test)
```
...
L_2 <- raster("raster_files/S2_wd_2_00.tif")
crs(L_2) <- "EPSG: 2056"
plot(L_2)

L_3 <- raster("raster_files/S2_wd_20_00.tif")
crs(L_3) <- "EPSG: 2056"
plot(L_3)
