...
# Test
```{r}
r <- raster("raster_files/GL2_wd_6_00.tif")
crs(r) <- "EPSG: 2056"
plot(r)
r[r == 0] <- NA
plot(r)
...
# Glenner: GL2
## ab GL2_11 - Single Attribute Rasters
...
#Error in `[[.H5File`(h5, "RESULTS") :
#An object with name RESULTS does not exist in this group
...
## Stacked Rasters
2_00, 3_70, 6_50, 8_50, 10_68, 13_00, 15_00, 18_00, 20_00
```{r}
