...
```{r}
# with k_index as response ----------------------------------------------------
p_brt_k_add <- ggplot(brt_add, aes(obs_k_index, m2_k_index_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wrap_k_add <- ggplot(brt_add, aes(obs_k_index, m2_k_index_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_k_add.png", plot = p_brt_k_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_k_add.png", plot = p_brt_wrap_k_add, width = 8, height = 8)

# with shannon index as response ----------------------------------------------
p_brt_s_add <- ggplot(brt_add, aes(obs_shannon, m2_shannon_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wrap_s_add <- ggplot(brt_add, aes(obs_shannon, m2_shannon_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_s_add.png", plot = p_brt_s_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_s_add.png", plot = p_brt_wrap_s_add, width = 8, height = 8)

# with abundance as response --------------------------------------------------
p_brt_a_add <- ggplot(brt_add, aes(obs_abundance, m2_abundance_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wrap_a_add <- ggplot(brt_add, aes(obs_abundance, m2_abundance_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_a_add.png", plot = p_brt_a_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_a_add.png", plot = p_brt_wrap_a_add, width = 8, height = 8)

# with relative abundance as response -----------------------------------------
p_brt_ra_add <- ggplot(brt_add, aes(obs_rel_abundance, m2_rel_abundance_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wrap_ra_add <- ggplot(brt_add, aes(obs_rel_abundance, m2_rel_abundance_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_ra_add.png", plot = p_brt_ra_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_ra_add.png", plot = p_brt_wrap_ra_add, width = 8, height = 8)
```

### Predictor: V + WD + add
```{r}
# with k_index as response-----------------------------------------------------
p_brt_wd_k_add <- ggplot(brt_add, aes(obs_k_index, m2_k_index_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wd_wrap_k_add <- ggplot(brt_add, aes(obs_k_index, m2_k_index_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_wd_k_add.png", plot = p_brt_wd_k_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wd_wrap_k_add.png", plot = p_brt_wd_wrap_k_add, width = 8, height = 8)

# with shannon index as response ---------------------------------------------
p_brt_wd_s_add <- ggplot(brt_add, aes(obs_shannon, m2_shannon_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wd_wrap_s_add <- ggplot(brt_add, aes(obs_shannon, m2_shannon_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_wd_s_add.png", plot = p_brt_wd_s_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wd_wrap_s_add.png", plot = p_brt_wd_wrap_s_add, width = 8, height = 8)

# with abundance as response --------------------------------------------------
p_brt_wd_a_add <- ggplot(brt_add, aes(obs_abundance, m2_abundance_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wd_wrap_a_add <- ggplot(brt_add, aes(obs_abundance, m2_abundance_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_wd_a_add.png", plot = p_brt_wd_a_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wd_wrap_a_add.png", plot = p_brt_wd_wrap_a_add, width = 8, height = 8)

# with relative abundance as response ----------------------------------------
p_brt_wd_ra_add <- ggplot(brt_add, aes(obs_rel_abundance, m2_rel_abundance_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wd_wrap_ra_add <- ggplot(brt_add, aes(obs_rel_abundance, m2_rel_abundance_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_wd_ra_add.png", plot = p_brt_wd_ra_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wd_wrap_ra_add.png", plot = p_brt_wd_wrap_ra_add, width = 8, height = 8)
```
...
```{r}
# with k_index as response ----------------------------------------------------
p_rf_k_add <- ggplot(rf_add, aes(obs_k_index, m2_k_index_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_wrap_k_add <- ggplot(rf_add, aes(obs_k_index, m2_k_index_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_k_add.png", plot = p_rf_k_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_k_add.png", plot = p_rf_wrap_k_add, width = 8, height = 8)

# with shannon index as response ----------------------------------------------
p_rf_s_add <- ggplot(rf_add, aes(obs_shannon, m2_shannon_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_wrap_s_add <- ggplot(rf_add, aes(obs_shannon, m2_shannon_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_s_add.png", plot = p_rf_s_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_s_add.png", plot = p_rf_wrap_s_add, width = 8, height = 8)

# with abundance as response --------------------------------------------------
p_rf_a_add <- ggplot(rf_add, aes(obs_abundance, m2_abundance_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_wrap_a_add <- ggplot(rf_add, aes(obs_abundance, m2_abundance_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_a_add.png", plot = p_rf_a_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_a_add.png", plot = p_rf_wrap_a_add, width = 8, height = 8)

# with relative abundance as response -----------------------------------------
p_rf_ra_add <- ggplot(rf_add, aes(obs_rel_abundance, m2_rel_abundance_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_wrap_ra_add <- ggplot(rf_add, aes(obs_rel_abundance, m2_rel_abundance_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_ra_add.png", plot = p_rf_ra_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_ra_add.png", plot = p_rf_wrap_ra_add, width = 8, height = 8)
```

### Predictor: V + WD + add
```{r}
# with k_index as response-----------------------------------------------------
p_rf_wd_k_add <- ggplot(rf_add, aes(obs_k_index, m2_k_index_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_wd_wrap_k_add <- ggplot(rf_add, aes(obs_k_index, m2_k_index_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_wd_k_add.png", plot = p_rf_wd_k_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wd_wrap_k_add.png", plot = p_rf_wd_wrap_k_add, width = 8, height = 8)

# with shannon index as response ---------------------------------------------
p_rf_wd_s_add <- ggplot(rf_add, aes(obs_shannon, m2_shannon_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_wd_wrap_s_add <- ggplot(rf_add, aes(obs_shannon, m2_shannon_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_wd_s_add.png", plot = p_rf_wd_s_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wd_wrap_s_add.png", plot = p_rf_wd_wrap_s_add, width = 8, height = 8)

# with abundance as response --------------------------------------------------
p_rf_wd_a_add <- ggplot(rf_add, aes(obs_abundance, m2_abundance_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_wd_wrap_a_add <- ggplot(rf_add, aes(obs_abundance, m2_abundance_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_wd_a_add.png", plot = p_rf_wd_a_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wd_wrap_a_add.png", plot = p_rf_wd_wrap_a_add, width = 8, height = 8)

# with relative abundance as response ----------------------------------------
p_rf_wd_ra_add <- ggplot(rf_add, aes(obs_rel_abundance, m2_rel_abundance_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_wd_wrap_ra_add <- ggplot(rf_add, aes(obs_rel_abundance, m2_rel_abundance_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_wd_ra_add.png", plot = p_rf_wd_ra_add, width = 6, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wd_wrap_ra_add.png", plot = p_rf_wd_wrap_ra_add, width = 8, height = 8)
```
