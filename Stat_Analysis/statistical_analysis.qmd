...
### PREDICTOR: VELOCITY ### --------------------------------------------------
# with k_index as response
regr_v_rf_k_train <- lm(pred_train_v_k ~ k_index, data = brt_train)
...
# with shannon index as response
regr_v_rf_s_train <- lm(pred_train_v_s ~ shannon, data = brt_train)
...
# with abundance as response
regr_v_rf_a_train <- lm(pred_train_v_a ~ abundance, data = brt_train)
...
# with rel_abundance as response
regr_v_rf_ra_train <- lm(pred_train_v_ra ~ rel_abundance, data = brt_train)
...
### PREDICTOR: V + WD ### --------------------------------------------------
# with k_index as response
regr_wd_rf_k_train <- lm(pred_train_wd_k ~ k_index, data = brt_train)
...
# with shannon index as response
regr_wd_rf_s_train <- lm(pred_train_wd_s ~ shannon, data = brt_train)
...
# with abundance as response
regr_wd_rf_a_train <- lm(pred_train_wd_a ~ abundance, data = brt_train)
...
# with rel_abundance as response
regr_wd_rf_ra_train <- lm(pred_train_wd_ra ~ rel_abundance, data = brt_train)
...
### PREDICTOR: SAMPLING LOCATIONS ### ----------------------------------------
# with k_index as response
regr_samp_rf_k_train <- lm(pred_train_samp_k ~ k_index, data = brt_train)
...
# with shannon index as response
regr_samp_rf_s_train <- lm(pred_train_samp_s ~ shannon, data = brt_train)
...
# with abundance as response
regr_samp_rf_a_train <- lm(pred_train_samp_a ~ abundance, data = brt_train)
...
# with rel_abundance as response
regr_samp_rf_ra_train <- lm(pred_train_samp_ra ~ rel_abundance, data = brt_train)
...
### PREDICTOR: ALL PREDICTORS ### ----------------------------------------
# with k_index as response
regr_sec_rf_k_train <- lm(pred_train_sec_k ~ k_index, data = brt_train)
...
# with shannon index as response
regr_sec_rf_s_train <- lm(pred_train_sec_s ~ shannon, data = brt_train)
...
# with abundance as response
regr_sec_rf_a_train <- lm(pred_train_sec_a ~ abundance, data = brt_train)
...
# with rel_abundance as response
regr_sec_rf_ra_train <- lm(pred_train_sec_ra ~ rel_abundance, data = brt_train)
...
### PREDICTOR: SELECTED VARIABLES ### ----------------------------------------
# with k_index as response
regr_var_rf_k_train <- lm(pred_train_var_k ~ k_index, data = brt_train)
...
# with shannon index as response
regr_var_rf_s_train <- lm(pred_train_var_s ~ shannon, data = brt_train)
...
# with abundance as response
regr_var_rf_a_train <- lm(pred_train_var_a ~ abundance, data = brt_train)
...
# with rel_abundance as response
regr_var_rf_ra_train <- lm(pred_train_var_ra ~ rel_abundance, data = brt_train)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_k_rast.png", plot = p_brt_k_rast, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_k_rast.png", plot = p_brt_wrap_k_rast, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_s_rast.png", plot = p_brt_s_rast, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_s_rast.png", plot = p_brt_wrap_s_rast, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_a_rast.png", plot = p_brt_a_rast, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_a_rast.png", plot = p_brt_wrap_a_rast, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_ra_rast.png", plot = p_brt_ra_rast, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_ra_rast.png", plot = p_brt_wrap_ra_rast, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_k_meas.png", plot = p_brt_k_meas, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_k_meas.png", plot = p_brt_wrap_k_meas, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_s_meas.png", plot = p_brt_s_meas, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_s_meas.png", plot = p_brt_wrap_s_meas, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_a_meas.png", plot = p_brt_a_meas, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_a_meas.png", plot = p_brt_wrap_a_meas, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_ra_meas.png", plot = p_brt_ra_meas, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_ra_meas.png", plot = p_brt_wrap_ra_meas, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_k_train.png", plot = p_brt_k_train, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_k_train.png", plot = p_brt_wrap_k_train, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_s_train.png", plot = p_brt_s_train, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_s_train.png", plot = p_brt_wrap_s_train, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_a_train.png", plot = p_brt_a_train, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_a_train.png", plot = p_brt_wrap_a_train, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_brt_ra_train.png", plot = p_brt_ra_train, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_brt_wrap_ra_train.png", plot = p_brt_wrap_ra_train, width = 8, height = 8)
...
### PREDICTOR: ALL PREDICTORS ### ------------------------------------------
# with k_index as response-----------------------------------------------------
p_brt_sec_k_train <- ggplot(brt_train, aes(k_index, pred_train_sec_k, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_sec_wrap_k_train <- ggplot(brt_train, aes(k_index, pred_train_sec_k, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with shannon index as response ---------------------------------------------
p_brt_sec_s_train <- ggplot(brt_train, aes(shannon, pred_train_sec_s, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_sec_wrap_s_train <- ggplot(brt_train, aes(shannon, pred_train_sec_s, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with abundance as response --------------------------------------------------
p_brt_sec_a_train <- ggplot(brt_train, aes(abundance, pred_train_sec_a, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_sec_wrap_a_train <- ggplot(brt_train, aes(abundance, pred_train_sec_a, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with relative abundance as response ----------------------------------------
p_brt_sec_ra_train <- ggplot(brt_train, aes(rel_abundance, pred_train_sec_ra, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_sec_wrap_ra_train <- ggplot(brt_train, aes(rel_abundance, pred_train_sec_ra, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
### PREDICTOR: SELCTED VARIABLES ### ------------------------------------------
# with k_index as response-----------------------------------------------------
p_brt_var_k_train <- ggplot(brt_train, aes(k_index, pred_train_var_k, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_var_wrap_k_train <- ggplot(brt_train, aes(k_index, pred_train_var_k, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with shannon index as response ---------------------------------------------
p_brt_var_s_train <- ggplot(brt_train, aes(shannon, pred_train_var_s, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_var_wrap_s_train <- ggplot(brt_train, aes(shannon, pred_train_var_s, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with abundance as response --------------------------------------------------
p_brt_var_a_train <- ggplot(brt_train, aes(abundance, pred_train_var_a, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_var_wrap_a_train <- ggplot(brt_train, aes(abundance, pred_train_var_a, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with relative abundance as response ----------------------------------------
p_brt_var_ra_train <- ggplot(brt_train, aes(rel_abundance, pred_train_var_ra, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_var_wrap_ra_train <- ggplot(brt_train, aes(rel_abundance, pred_train_var_ra, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_k_rast.png", plot = p_rf_k_rast, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_k_rast.png", plot = p_rf_wrap_k_rast, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_s_rast.png", plot = p_rf_s_rast, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_s_rast.png", plot = p_rf_wrap_s_rast, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_a_rast.png", plot = p_rf_a_rast, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_a_rast.png", plot = p_rf_wrap_a_rast, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_ra_rast.png", plot = p_rf_ra_rast, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_ra_rast.png", plot = p_rf_wrap_ra_rast, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_k_meas.png", plot = p_rf_k_meas, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_k_meas.png", plot = p_rf_wrap_k_meas, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_s_meas.png", plot = p_rf_s_meas, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_s_meas.png", plot = p_rf_wrap_s_meas, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_a_meas.png", plot = p_rf_a_meas, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_a_meas.png", plot = p_rf_wrap_a_meas, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_ra_meas.png", plot = p_rf_ra_meas, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_ra_meas.png", plot = p_rf_wrap_ra_meas, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_k_train.png", plot = p_rf_k_train, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_k_train.png", plot = p_rf_wrap_k_train, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_s_train.png", plot = p_rf_s_train, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_s_train.png", plot = p_rf_wrap_s_train, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_a_train.png", plot = p_rf_a_train, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_a_train.png", plot = p_rf_wrap_a_train, width = 8, height = 8)
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_rf_ra_train.png", plot = p_rf_ra_train, width = 8, height = 5)
ggsave("Stat_Analysis/regr_plots/regr_rf_wrap_ra_train.png", plot = p_rf_wrap_ra_train, width = 8, height = 8)
...
### PREDICTOR: ALL PREDICTORS ### ------------------------------------------
# with k_index as response-----------------------------------------------------
p_rf_sec_k_train <- ggplot(rf_train, aes(k_index, pred_train_sec_k, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_sec_wrap_k_train <- ggplot(rf_train, aes(k_index, pred_train_sec_k, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with shannon index as response ---------------------------------------------
p_rf_sec_s_train <- ggplot(rf_train, aes(shannon, pred_train_sec_s, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_sec_wrap_s_train <- ggplot(rf_train, aes(shannon, pred_train_sec_s, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with abundance as response --------------------------------------------------
p_rf_sec_a_train <- ggplot(rf_train, aes(abundance, pred_train_sec_a, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_sec_wrap_a_train <- ggplot(rf_train, aes(abundance, pred_train_sec_a, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with relative abundance as response ----------------------------------------
p_rf_sec_ra_train <- ggplot(rf_train, aes(rel_abundance, pred_train_sec_ra, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_sec_wrap_ra_train <- ggplot(rf_train, aes(rel_abundance, pred_train_sec_ra, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
### PREDICTOR: SELCTED VARIABLES ### ------------------------------------------
# with k_index as response-----------------------------------------------------
p_rf_var_k_train <- ggplot(rf_train, aes(k_index, pred_train_var_k, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_var_wrap_k_train <- ggplot(rf_train, aes(k_index, pred_train_var_k, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with shannon index as response ---------------------------------------------
p_rf_var_s_train <- ggplot(rf_train, aes(shannon, pred_train_var_s, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_var_wrap_s_train <- ggplot(rf_train, aes(shannon, pred_train_var_s, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with abundance as response --------------------------------------------------
p_rf_var_a_train <- ggplot(rf_train, aes(abundance, pred_train_var_a, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_var_wrap_a_train <- ggplot(rf_train, aes(abundance, pred_train_var_a, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with relative abundance as response ----------------------------------------
p_rf_var_ra_train <- ggplot(rf_train, aes(rel_abundance, pred_train_var_ra, col = reach_type)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_rf_var_wrap_ra_train <- ggplot(rf_train, aes(rel_abundance, pred_train_var_ra, col = reach_type)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
