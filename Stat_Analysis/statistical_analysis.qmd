...
brt_train_2 <- read_delim("Stat_Analysis/stat_analysis_data/regr_pred_train_brt.csv")|>
  mutate(reach_type = ifelse(Reach_Untersuchungsstelle %in% names(training_sections), 
                                   training_sections[Reach_Untersuchungsstelle], NA))
...
rf_train_2 <- read_delim("Stat_Analysis/stat_analysis_data/regr_pred_train_rf.csv")|>
  mutate(reach_type = ifelse(Reach_Untersuchungsstelle %in% names(training_sections), 
                                   training_sections[Reach_Untersuchungsstelle], NA))
```
