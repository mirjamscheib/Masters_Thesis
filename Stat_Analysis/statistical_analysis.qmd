...
regr_v_brt_k <- lm(k_index_v ~ obs_k_index, data = brt)
...
r_v_brt_k <- summary(lm(k_index_v ~ obs_k_index, data = brt))$adj.r.squared

# with shannon index as response
regr_v_brt_s <- lm(shannon_v ~ obs_shannon, data = brt)
...
r_v_brt_s <- summary(lm(shannon_v ~ obs_shannon, data = brt))$adj.r.squared

# with abundance as response
regr_v_brt_a <- lm(abundance_v ~ obs_abundance, data = brt)
...
r_v_brt_a <- summary(lm(abundance_v ~ obs_abundance, data = brt))$adj.r.squared

# with rel_abundance as response
regr_v_brt_ra <- lm(rel_abundance_v ~ obs_rel_abundance, data = brt)
...
r_v_brt_ra <- summary(lm(rel_abundance_v ~ obs_rel_abundance, data = brt))$adj.r.squared
...
### BRT models ----------------------------------------------------------------
# with k_index as response
regr_wd_brt_k <- lm(k_index_wd ~ obs_k_index, data = brt)
...
r_wd_brt_k <- summary(lm(k_index_wd ~ obs_k_index, data = brt))$adj.r.squared

# with shannon index as response
regr_wd_brt_s <- lm(shannon_wd ~ obs_shannon, data = brt)
...
r_wd_brt_s <- summary(lm(shannon_wd ~ obs_shannon, data = brt))$adj.r.squared

# with abundance as response
regr_wd_brt_a <- lm(abundance_wd ~ obs_abundance, data = brt)
...
r_wd_brt_a <- summary(lm(abundance_wd ~ obs_abundance, data = brt))$adj.r.squared

# with rel_abundance as response
regr_wd_brt_ra <- lm(rel_abundance_wd ~ obs_rel_abundance, data = brt)
...
r_wd_brt_ra <- summary(lm(rel_abundance_wd ~ obs_rel_abundance, data = brt))$adj.r.squared
```
...
### BRT models ----------------------------------------------------------------
# with k_index as response
regr_var_brt_k <- lm(k_index_var ~ obs_k_index, data = brt)
sum_var_brt_k <- summary(regr_var_brt_k)
p_var_brt_k <- sum_var_brt_k$coefficients["obs_k_index", "Pr(>|t|)"]
s_var_brt_k <- sum_var_brt_k$coefficients["obs_k_index", "Estimate"]
r_var_brt_k <- summary(lm(k_index_var ~ obs_k_index, data = brt))$adj.r.squared

# with shannon index as response
regr_var_brt_s <- lm(shannon_var ~ obs_shannon, data = brt)
sum_var_brt_s <- summary(regr_wd_brt_s)
p_var_brt_s <- sum_var_brt_s$coefficients["obs_shannon", "Pr(>|t|)"]
s_var_brt_s <- sum_var_brt_s$coefficients["obs_shannon", "Estimate"]
r_var_brt_s <- summary(lm(shannon_var ~ obs_shannon, data = brt))$adj.r.squared

# with abundance as response
regr_var_brt_a <- lm(abundance_var ~ obs_abundance, data = brt)
sum_var_brt_a <- summary(regr_var_brt_a)
p_var_brt_a <- sum_var_brt_a$coefficients["obs_abundance", "Pr(>|t|)"]
s_var_brt_a <- sum_var_brt_a$coefficients["obs_abundance", "Estimate"]
r_var_brt_a <- summary(lm(abundance_var ~ obs_abundance, data = brt))$adj.r.squared

# with rel_abundance as response
regr_var_brt_ra <- lm(rel_abundance_var ~ obs_rel_abundance, data = brt)
sum_var_brt_ra <- summary(regr_var_brt_ra)
p_var_brt_ra <- sum_var_brt_ra$coefficients["obs_rel_abundance", "Pr(>|t|)"]
s_var_brt_ra <- sum_var_brt_ra$coefficients["obs_rel_abundance", "Estimate"]
r_var_brt_ra <- summary(lm(rel_abundance_var ~ obs_rel_abundance, data = brt))$adj.r.squared
```
...
### BRT models ----------------------------------------------------------------
# with k_index as response
regr_v_rf_k <- lm(k_index_v ~ obs_k_index, data = rf)
...
r_v_rf_k <- summary(lm(k_index_v ~ obs_k_index, data = rf))$adj.r.squared

# with shannon index as response
regr_v_rf_s <- lm(shannon_v ~ obs_shannon, data = rf)
...
r_v_rf_s <- summary(lm(shannon_v ~ obs_shannon, data = rf))$adj.r.squared

# with abundance as response
regr_v_rf_a <- lm(abundance_v ~ obs_abundance, data = rf)
...
r_v_rf_a <- summary(lm(abundance_v ~ obs_abundance, data = rf))$adj.r.squared

# with rel_abundance as response
regr_v_rf_ra <- lm(rel_abundance_v ~ obs_rel_abundance, data = rf)
...
r_v_rf_ra <- summary(lm(rel_abundance_v ~ obs_rel_abundance, data = rf))$adj.r.squared
```
...
### BRT models ----------------------------------------------------------------
# with k_index as response
regr_wd_rf_k <- lm(k_index_wd ~ obs_k_index, data = rf)
...
# with shannon index as response
regr_wd_rf_s <- lm(shannon_wd ~ obs_shannon, data = rf)
...
# with abundance as response
regr_wd_rf_a <- lm(abundance_wd ~ obs_abundance, data = rf)
...
# with rel_abundance as response
regr_wd_rf_ra <- lm(rel_abundance_wd ~ obs_rel_abundance, data = rf)
...
### BRT models ----------------------------------------------------------------
# with k_index as response
regr_var_rf_k <- lm(k_index_var ~ obs_k_index, data = rf)
sum_var_rf_k <- summary(regr_var_rf_k)
p_var_rf_k <- sum_var_rf_k$coefficients["obs_k_index", "Pr(>|t|)"]
s_var_rf_k <- sum_var_rf_k$coefficients["obs_k_index", "Estimate"]

# with shannon index as response
regr_var_rf_s <- lm(shannon_var ~ obs_shannon, data = rf)
sum_var_rf_s <- summary(regr_var_rf_s)
p_var_rf_s <- sum_var_rf_s$coefficients["obs_shannon", "Pr(>|t|)"]
s_var_rf_s <- sum_var_rf_s$coefficients["obs_shannon", "Estimate"]

# with abundance as response
regr_var_rf_a <- lm(abundance_var ~ obs_abundance, data = rf)
sum_var_rf_a <- summary(regr_var_rf_a)
p_var_rf_a <- sum_var_rf_a$coefficients["obs_abundance", "Pr(>|t|)"]
s_var_rf_a <- sum_var_rf_a$coefficients["obs_abundance", "Estimate"]

# with rel_abundance as response
regr_var_rf_ra <- lm(rel_abundance_var ~ obs_rel_abundance, data = rf)
sum_var_rf_ra <- summary(regr_var_rf_ra)
p_var_rf_ra <- sum_var_rf_ra$coefficients["obs_rel_abundance", "Pr(>|t|)"]
s_var_rf_ra <- sum_var_rf_ra$coefficients["obs_rel_abundance", "Estimate"]
```
...
```{r}
# with k_index as response ----------------------------------------------------
p_brt_k <- ggplot(brt, aes(obs_k_index, k_index_v)) +
  geom_point() +
...
p_brt_wrap_k <- ggplot(brt, aes(obs_k_index, k_index_v)) +
...
# with shannon index as response ----------------------------------------------
p_brt_s <- ggplot(brt, aes(obs_shannon, shannon_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wrap_s <- ggplot(brt, aes(obs_shannon, shannon_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with abundance as response --------------------------------------------------
p_brt_a <- ggplot(brt, aes(obs_abundance, abundance_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wrap_a <- ggplot(brt, aes(obs_abundance, abundance_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
p_brt_ra <- ggplot(brt, aes(obs_rel_abundance, rel_abundance_v)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wrap_ra <- ggplot(brt, aes(obs_rel_abundance, rel_abundance_v)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
```{r}
# with k_index as response-----------------------------------------------------
p_brt_wd_k <- ggplot(brt, aes(obs_k_index, k_index_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wd_wrap_k <- ggplot(brt, aes(obs_k_index, k_index_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with shannon index as response ---------------------------------------------
p_brt_wd_s <- ggplot(brt, aes(obs_shannon, shannon_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wd_wrap_s <- ggplot(brt, aes(obs_shannon, shannon_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with abundance as response --------------------------------------------------
p_brt_wd_a <- ggplot(brt, aes(obs_abundance, abundance_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wd_wrap_a <- ggplot(brt, aes(obs_abundance, abundance_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with relative abundance as response ----------------------------------------
p_brt_wd_ra <- ggplot(brt, aes(obs_rel_abundance, rel_abundance_wd)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_wd_wrap_ra <- ggplot(brt, aes(obs_rel_abundance, rel_abundance_wd)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
```{r}
# with k_index as response-----------------------------------------------------
p_brt_var_k <- ggplot(brt, aes(obs_k_index, k_index_var)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_var_wrap_k <- ggplot(brt, aes(obs_k_index, k_index_var)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with shannon index as response ---------------------------------------------
p_brt_var_s <- ggplot(brt, aes(obs_shannon, shannon_var)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_var_wrap_s <- ggplot(brt, aes(obs_shannon, shannon_var)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with abundance as response --------------------------------------------------
p_brt_var_a <- ggplot(brt, aes(obs_abundance, abundance_var)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_var_wrap_a <- ggplot(brt, aes(obs_abundance, abundance_var)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# with relative abundance as response ----------------------------------------
p_brt_var_ra <- ggplot(brt, aes(obs_rel_abundance, rel_abundance_var)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
p_brt_var_wrap_ra <- ggplot(brt, aes(obs_rel_abundance, rel_abundance_var)) +
  facet_wrap(~Reach_Untersuchungsstelle) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
...
# Create dataframe
```{r}
results_hdm <- data.frame(lm_p_value = c(p_v_brt_k, p_v_brt_s, p_v_brt_a, p_v_brt_ra, p_v_rf_k, p_v_rf_s, p_v_rf_a, p_v_rf_ra,  
                                           p_wd_brt_k, p_wd_brt_s, p_wd_brt_a, p_wd_brt_ra, p_wd_rf_k, p_wd_rf_s, p_wd_rf_a, p_wd_rf_ra, 
                                         p_var_brt_k, p_var_brt_s, p_var_brt_a, p_var_brt_ra,
                                         p_var_rf_k, p_var_rf_s, p_var_rf_a, p_var_rf_ra,
                                           p_foen_class_k, p_foen_class_s, p_foen_class_a, p_foen_class_ra,
                                           p_foen_hsi_k, p_foen_hsi_s, p_foen_hsi_a, p_foen_hsi_ra),
                          
                          lm_slope = c(s_v_brt_k, s_v_brt_s, s_v_brt_a, s_v_brt_ra, s_v_rf_k, s_v_rf_s, s_v_rf_a, s_v_rf_ra, 
                                       s_wd_brt_k, s_wd_brt_s, s_wd_brt_a, s_wd_brt_ra,  s_wd_rf_k, s_wd_rf_s, s_wd_rf_a, s_wd_rf_ra,
                                       s_var_brt_k, s_var_brt_s, s_var_brt_a, s_var_brt_ra, s_var_rf_k, s_var_rf_s, s_var_rf_a, s_var_rf_ra, 
                                       s_foen_class_k, s_foen_class_s, s_foen_class_a, s_foen_class_ra,
                                       s_foen_hsi_k, s_foen_hsi_s, s_foen_hsi_a, s_foen_hsi_ra),
                          
                          index = c("k_index", "shannon", "abundance", "rel_abundance", "k_index", "shannon", "abundance", "rel_abundance", "k_index", "shannon", "abundance", "rel_abundance", 
                                  "k_index", "shannon", "abundance", "rel_abundance", "k_index", "shannon", "abundance", "rel_abundance", "k_index", "shannon", "abundance", "rel_abundance", "k_index", "shannon", "abundance", "rel_abundance",
                                  "k_index", "shannon", "abundance", "rel_abundance", "k_index", "shannon", "abundance", "rel_abundance"),
                          
  
           variable = c("velocity", "velocity", "velocity", "velocity",
