...
t_base <- t.test(all_base$`Natural/near-natural`, all_base$Hydropeaking)
# p-value < 2.2e-16
...
# Einseitig "Test auf a > b" -------------
t.test(all_peak$`Natural/near-natural`, all_peak$Hydropeaking)
# p-value < 2.2e-16
...
# Einseitig "Test auf a > b" -------------
t.test(all_pers$`Natural/near-natural`, all_pers$Hydropeaking)
# p-value < 2.2e-16
```
...
# Posthoc-Test
HSD.test(aov.GL1, "scenario", group = FALSE, console = TRUE)
