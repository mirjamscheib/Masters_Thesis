...
# EDA
boxplot(k_index~study_area + scenario, data = natural)
boxplot(k_index~study_area + scenario, data = hydropeak)

# ANOVA OHNE Interaktion 
summary(aov(k_index~study_area + scenario, data = natural))
summary(aov(k_index~study_area + scenario, data = hydropeak))
...
summary(aov(k_index~scenario * study_area, data = natural)) 
summary(aov(k_index~scenario * study_area, data = hydropeak)) 
# wenn Interaktion nicht sign. - Interaktionsterm ausschliessen 


#Visualisierung 2-fach-Interaktion etwas elaborierter mit ggplot
theme_set(theme_classic())
aov <- aov(k_index~scenario * study_area, data = natural)
plot_model(aov, type = "pred", terms = c("scenario", "study_area"))

aov_hydro <- aov(k_index~scenario * study_area, data = hydropeak)
plot_model(aov_hydro, type = "pred", terms = c("scenario", "study_area"))
```
