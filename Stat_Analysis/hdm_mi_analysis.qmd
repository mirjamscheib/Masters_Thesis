...
```{r}
# velocity --------------------------------------------------------------------
vel <- ggplot(data_hdm, aes(velocity, v_raster)) +
  geom_point() +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_velocity.png", plot = vel, width = 6, height = 5)

# water depth ----------------------------------------------------------------
wd <- ggplot(data_hdm, aes(wd_m, wd_m_raster)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_wd.png", plot = wd, width = 6, height = 5)

# froude ----------------------------------------------------------------
froude <- ggplot(data_hdm, aes(froude, froude_raster)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_froude.png", plot = froude, width = 6, height = 5)

# shear stress ---------------------------------------------------------------
shear <- ggplot(data_hdm, aes(shear_stress, shear_raster)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
  ...
  xlim(0, 1.0) + 
  labs(
    x = "Shear Stress Measured (kg m-1 s-2)",
    y = "Shear Stress Extracted (kg m-1 s-2)"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
        axis.title = element_text(size=14))
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_shear_stress.png", plot = shear, width = 6, height = 5)

# stream power ---------------------------------------------------------------
stream <- ggplot(data_hdm, aes(stream_power, stream_raster)) +
  geom_point() +
  geom_abline(slope = 1, intercept = 0, lty = 2, lwd = 0.8) +
  stat_smooth(method = "lm", se = FALSE, fullrange = TRUE, lwd = 0.8, col = "black") +
  theme_minimal() +
  ...
  xlim(0, 1.0) + 
  labs(
    x = "Stream Power Measured (W m-2)",
    y = "Stream Power Extracted (W m-2)"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
        axis.title = element_text(size=14))
...
# save the plots 
ggsave("Stat_Analysis/regr_plots/regr_stream_power.png", plot = stream, width = 6, height = 5)
```
