...
bar <- read_delim("ML_model/var_imp/var_imp_samp.csv") |> 
  dplyr::select(variable, k_index_rf, k_index_brt) |>
  mutate(var_new = c("Velocity [m/s]", "Z Coordinate [m.a.s.l.]", "Dist. Waterline [m]", "Cat. Velocity [1-5]", "Algae Cover [1-5]", "Moos Cover [0-3]", "CPOM Cover [1-3]", "Water Deph [m]", "Clogging Class [0-2]", "Clogging Class [0-6]", "Substrate Type [0-3]")) |>
...
# save the plots 
ggsave("Stat_Analysis/var_imp.png", plot = p, width = 9, height = 6)
```
