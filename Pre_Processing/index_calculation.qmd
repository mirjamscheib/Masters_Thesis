...
lab_turb$Turbidity_FNU_after <- as.numeric(lab_turb$Turbidity_FNU_after)
...
lab_ml_model_section <- lab_new |>
  ...
  mutate(gaug_station = rowMeans(lab_gauging),
         discharge = rowMeans(lab_q),
         temp = rowMeans(lab_temp),
         turbidity = rowMeans(lab_turb),
         ox_sat = rowMeans(lab_ox_sat),
         ox_cont = rowMeans(lab_ox_cont),
         conductivity = rowMeans(lab_cond),
         ph = rowMeans(lab_ph)) |>
