...
abiotic_corr <- read.delim("Pre_Processing/abiotic_mi_sampling/Abiotic_MI_Field_corr.txt", header = FALSE) |>
  dplyr::rename(join_key = V1,
                x = V2,
                y = V3,
                z = V4)
...
# Glenner 
gl1 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/GL1.csv", col_names = FALSE)
gl2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/GL2.csv", col_names = FALSE)
gl3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/GL3.csv", col_names = FALSE)
gl4 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/GL4.csv", col_names = FALSE)
gl5 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/GL5.csv", col_names = FALSE)
gl6 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/GL6.csv", col_names = FALSE)

# Landquart
l1 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/L1.csv", col_names = FALSE)
l2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/L2.csv", col_names = FALSE)
l3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/L3.csv", col_names = FALSE)
l4 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/L4.csv", col_names = FALSE)
lr <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/LR.csv", col_names = FALSE)

# Moesa 
m1 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/M1.csv", col_names = FALSE)
m2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/M2.csv", col_names = FALSE)
m3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/M3.csv", col_names = FALSE)
m4 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/M4.csv", col_names = FALSE)
m5 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/M5.csv", col_names = FALSE)
m6 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/M6.csv", col_names = FALSE)
m7 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/M7.csv", col_names = FALSE)
mr <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/MR.csv", col_names = FALSE)

# Plessur
p1 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/P1.csv", col_names = FALSE)
p2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/P2.csv", col_names = FALSE)
p3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/P3.csv", col_names = FALSE)
pr <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/PR.csv", col_names = FALSE)

# Sitter
s1 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/S1.csv", col_names = FALSE)
s2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/S2.csv", col_names = FALSE)
s3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/S3.csv", col_names = FALSE)
s4 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/S4.csv", col_names = FALSE)
s5 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/S5.csv", col_names = FALSE)
s6 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/S6.csv", col_names = FALSE)

# Saane 
sa1 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SA1.csv", col_names = FALSE)
sa2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SA2.csv", col_names = FALSE)
sa3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SA3.csv", col_names = FALSE)
sa4 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SA4.csv", col_names = FALSE)
sa5 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SA5.csv", col_names = FALSE)
sa6 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SA6.csv", col_names = FALSE)
sa7 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SA7.csv", col_names = FALSE)
sar <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SAR.csv", col_names = FALSE)

# Sense/Singine 
se1 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SE1.csv", col_names = FALSE)
se2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SE2-new.csv", col_names = FALSE)
se3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SE3-NEW.csv", col_names = FALSE)
se4 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SE4.csv", col_names = FALSE)
sr <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/SR.csv", col_names = FALSE)

# Ticino 
t1 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/T1.csv", col_names = FALSE)
t2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/T2.csv", col_names = FALSE)
t3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/T3.csv", col_names = FALSE)

# Thur 
th1 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/th1.csv", col_names = FALSE)
th2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/th2.csv", col_names = FALSE)
th3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/TH3-NEW.csv", col_names = FALSE)
th4 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/TH4-NEW.csv", col_names = FALSE)
th5 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/th5.csv", col_names = FALSE)

# Verzasca
ve2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/VE2.csv", col_names = FALSE)
ve3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/VE3.csv", col_names = FALSE)
ve4 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/VE4b.csv", col_names = FALSE)

# Vorderrhein 
vr1 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/VR1.csv", col_names = FALSE)
vr2 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/VR2.csv", col_names = FALSE)
vr3 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/VR3.csv", col_names = FALSE)
vr4 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/VR4.csv", col_names = FALSE)
vr5 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/VR5.csv", col_names = FALSE)
vr6 <- readr::read_delim("Pre_Processing/abiotic_mi_sampling/GPS_Points/VR6.csv", col_names = FALSE)
```
...
# label header into R friendly characters 
colnames(abiotic2) <- c("River", "reach", "Abiotic_measured_by", "Date_of_survey", "Time_of_survey", "pH", "Conductivity_ys_s", "Oxygen_content_mg_l", "Oxygen_saturation_%", "Turbidity_FNU", "Temperature_C", "Discharge_m3_s", "Water_gauge_MueM", "Gauging_station", "Varia")
...
#abiotic2$time_new <- abiotic2 |>
#  dplyr::select(Time_of_survey, Reach_Untersuchungsstelle)
...
colnames(oxy_sat) <- c("Oxygen_saturation_%_before", "Oxygen_saturation_%_during", "Oxygen_saturation_%_after", "reach")
...
coordinates <- rbind(gl1, gl2, gl3, gl4, gl5, gl6, l1, l2, l3, l4, lr, m1, m2, m3, m4, m5, m6, m7, mr, p1, p2, p3, pr, s1, s2, s3, s4, s5, s6, sa1, sa2, sa3, sa4, sa5, sa6, sa7, sar, se1, se2, se3, se4, sr, t1, t2, t3, th1, th2, th3, th4, th5, ve2, ve3, ve4, vr1, vr2, vr3, vr4, vr5, vr6)

# discard columns which are not needed & rename columns 
coordinates <- coordinates |>
  dplyr::select(-X1, -X2, -river, -transect, -sampling_point) |>
  dplyr::rename(x = X3, y = X4, z = X5)
```
...
write_xlsx(abiotic_lab,"Pre_Processing\\abiotic_mi_sampling\\Abiotic_MI_Lab.xlsx")  
```
