...
write_xlsx(abiotic_field,"abiotic_mi_sampling\\Abiotic_MI_Field2.xlsx")
```
...
write_xlsx(abiotic_lab,"abiotic_mi_sampling\\Abiotic_MI_Lab2.xlsx")  
```
...
# write excel with Lab results 
write_xlsx(abiotic_lab_model,"abiotic_mi_sampling\\Abiotic_MI_Lab_Model2.xlsx")  
```
