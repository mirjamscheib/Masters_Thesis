...
### turb_before
tb_sec_s_brt_add <- read.delim("ML_Model/pdp_data/pdp_tb_sec_s_brt_add.csv", sep = ",")
tb_sec_s_c_brt_add <- read.delim("ML_Model/pdp_data/pdp_tb_sec_s_c_brt_add.csv", sep = ",")
...
### turb_before
p_tb_sec_k_rf <- ggplot(tb_sec_k_rf, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_tb_sec_k_c_rf <- ggplot(tb_sec_k_rf, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_k_rf.png", plot = p_tb_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_k_c_rf.png", plot = p_tb_sec_k_c_rf, width = 6, height = 5)

### turb_during
p_td_sec_k_rf <- ggplot(td_sec_k_rf, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_td_sec_k_c_rf <- ggplot(td_sec_k_rf, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_k_rf.png", plot = p_td_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_k_c_rf.png", plot = p_td_sec_k_c_rf, width = 6, height = 5)

### turb_after
p_ta_sec_k_rf <- ggplot(ta_sec_k_rf, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_ta_sec_k_c_rf <- ggplot(ta_sec_k_rf, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_k_rf.png", plot = p_ta_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_k_c_rf.png", plot = p_ta_sec_k_c_rf, width = 6, height = 5)

### temp_before
p_teb_sec_k_rf <- ggplot(teb_sec_k_rf, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_teb_sec_k_c_rf <- ggplot(teb_sec_k_rf, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_k_rf.png", plot = p_teb_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_k_c_rf.png", plot = p_teb_sec_k_c_rf, width = 6, height = 5)

### temp_during
p_ted_sec_k_rf <- ggplot(ted_sec_k_rf, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_ted_sec_k_c_rf <- ggplot(ted_sec_k_rf, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_k_rf.png", plot = p_ted_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_k_c_rf.png", plot = p_ted_sec_k_c_rf, width = 6, height = 5)

### temp_after
p_tea_sec_k_rf <- ggplot(tea_sec_k_rf, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_tea_sec_k_c_rf <- ggplot(tea_sec_k_rf, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_k_rf.png", plot = p_tea_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_k_c_rf.png", plot = p_tea_sec_k_c_rf, width = 6, height = 5)

### q_before
p_qb_sec_k_rf <- ggplot(qb_sec_k_rf, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_qb_sec_k_c_rf <- ggplot(qb_sec_k_rf, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_k_rf.png", plot = p_qb_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_k_c_rf.png", plot = p_qb_sec_k_c_rf, width = 6, height = 5)

### q_during
p_qd_sec_k_rf <- ggplot(qd_sec_k_rf, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_qd_sec_k_c_rf <- ggplot(qd_sec_k_rf, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_k_rf.png", plot = p_qd_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_k_c_rf.png", plot = p_qd_sec_k_c_rf, width = 6, height = 5)

### q_after
p_qa_sec_k_rf <- ggplot(qa_sec_k_rf, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_qa_sec_k_c_rf <- ggplot(qa_sec_k_rf, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_k_rf.png", plot = p_qa_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_k_c_rf.png", plot = p_qa_sec_k_c_rf, width = 6, height = 5)

### gaug_before
p_gb_sec_k_rf <- ggplot(gb_sec_k_rf, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_gb_sec_k_c_rf <- ggplot(gb_sec_k_rf, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_k_rf.png", plot = p_gb_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_k_c_rf.png", plot = p_gb_sec_k_c_rf, width = 6, height = 5)

### gaug_during
p_gd_sec_k_rf <- ggplot(gd_sec_k_rf, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_gd_sec_k_c_rf <- ggplot(gd_sec_k_rf, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_k_rf.png", plot = p_gd_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_k_c_rf.png", plot = p_gd_sec_k_c_rf, width = 6, height = 5)

### gaug_after
p_ga_sec_k_rf <- ggplot(ga_sec_k_rf, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
    y = "K-Index"
  ) +
  theme_minimal() +
  theme(axis.text = element_text(size=12),
...
p_ga_sec_k_c_rf <- ggplot(ga_sec_k_rf, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_k_rf.png", plot = p_ga_sec_k_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_k_c_rf.png", plot = p_ga_sec_k_c_rf, width = 6, height = 5)
...
### pH_before
p_phb_sec_s_rf <- ggplot(phb_sec_s_rf, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_s_c_rf <- ggplot(phb_sec_s_rf, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_s_rf.png", plot = p_phb_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_s_c_rf.png", plot = p_phb_sec_s_c_rf, width = 6, height = 5)

### pH_during
p_phd_sec_s_rf <- ggplot(phd_sec_s_rf, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_s_c_rf <- ggplot(phd_sec_s_rf, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_s_rf.png", plot = p_phd_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_s_c_rf.png", plot = p_phd_sec_s_c_rf, width = 6, height = 5)

### pH_after
p_pha_sec_s_rf <- ggplot(pha_sec_s_rf, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_s_c_rf <- ggplot(pha_sec_s_rf, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_s_rf.png", plot = p_pha_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_s_c_rf.png", plot = p_pha_sec_s_c_rf, width = 6, height = 5)

### conduct_before
p_cb_sec_s_rf <- ggplot(cb_sec_s_rf, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_s_c_rf <- ggplot(cb_sec_s_rf, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_s_rf.png", plot = p_cb_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_s_c_rf.png", plot = p_cb_sec_s_c_rf, width = 6, height = 5)

### conduct_during
p_cd_sec_s_rf <- ggplot(cd_sec_s_rf, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_s_c_rf <- ggplot(cd_sec_s_rf, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_s_rf.png", plot = p_cd_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_s_c_rf.png", plot = p_cd_sec_s_c_rf, width = 6, height = 5)

### conduct_after
p_ca_sec_s_rf <- ggplot(ca_sec_s_rf, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_s_c_rf <- ggplot(ca_sec_s_rf, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_s_rf.png", plot = p_ca_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_s_c_rf.png", plot = p_ca_sec_s_c_rf, width = 6, height = 5)

### ox_before
p_ob_sec_s_rf <- ggplot(ob_sec_s_rf, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_s_c_rf <- ggplot(ob_sec_s_rf, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_s_rf.png", plot = p_ob_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_s_c_rf.png", plot = p_ob_sec_s_c_rf, width = 6, height = 5)

### ox_during
p_od_sec_s_rf <- ggplot(od_sec_s_rf, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_s_c_rf <- ggplot(od_sec_s_rf, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_s_rf.png", plot = p_od_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_s_c_rf.png", plot = p_od_sec_s_c_rf, width = 6, height = 5)

### ox_after
p_oa_sec_s_rf <- ggplot(oa_sec_s_rf, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_s_c_rf <- ggplot(oa_sec_s_rf, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_s_rf.png", plot = p_oa_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_s_c_rf.png", plot = p_oa_sec_s_c_rf, width = 6, height = 5)

### turb_before
p_tb_sec_s_rf <- ggplot(tb_sec_s_rf, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_s_c_rf <- ggplot(tb_sec_s_rf, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_s_rf.png", plot = p_tb_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_s_c_rf.png", plot = p_tb_sec_s_c_rf, width = 6, height = 5)

### turb_during
p_td_sec_s_rf <- ggplot(td_sec_s_rf, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_s_c_rf <- ggplot(td_sec_s_rf, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_s_rf.png", plot = p_td_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_s_c_rf.png", plot = p_td_sec_s_c_rf, width = 6, height = 5)

### turb_after
p_ta_sec_s_rf <- ggplot(ta_sec_s_rf, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_s_c_rf <- ggplot(ta_sec_s_rf, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_s_rf.png", plot = p_ta_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_s_c_rf.png", plot = p_ta_sec_s_c_rf, width = 6, height = 5)

### temp_before
p_teb_sec_s_rf <- ggplot(teb_sec_s_rf, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_s_c_rf <- ggplot(teb_sec_s_rf, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_s_rf.png", plot = p_teb_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_s_c_rf.png", plot = p_teb_sec_s_c_rf, width = 6, height = 5)

### temp_during
p_ted_sec_s_rf <- ggplot(ted_sec_s_rf, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_s_c_rf <- ggplot(ted_sec_s_rf, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_s_rf.png", plot = p_ted_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_s_c_rf.png", plot = p_ted_sec_s_c_rf, width = 6, height = 5)

### temp_after
p_tea_sec_s_rf <- ggplot(tea_sec_s_rf, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_s_c_rf <- ggplot(tea_sec_s_rf, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_s_rf.png", plot = p_tea_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_s_c_rf.png", plot = p_tea_sec_s_c_rf, width = 6, height = 5)

### q_before
p_qb_sec_s_rf <- ggplot(qb_sec_s_rf, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_s_c_rf <- ggplot(qb_sec_s_rf, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_s_rf.png", plot = p_qb_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_s_c_rf.png", plot = p_qb_sec_s_c_rf, width = 6, height = 5)

### q_during
p_qd_sec_s_rf <- ggplot(qd_sec_s_rf, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_s_c_rf <- ggplot(qd_sec_s_rf, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_s_rf.png", plot = p_qd_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_s_c_rf.png", plot = p_qd_sec_s_c_rf, width = 6, height = 5)

### q_after
p_qa_sec_s_rf <- ggplot(qa_sec_s_rf, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_s_c_rf <- ggplot(qa_sec_s_rf, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_s_rf.png", plot = p_qa_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_s_c_rf.png", plot = p_qa_sec_s_c_rf, width = 6, height = 5)

### gaug_before
p_gb_sec_s_rf <- ggplot(gb_sec_s_rf, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_s_c_rf <- ggplot(gb_sec_s_rf, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_s_rf.png", plot = p_gb_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_s_c_rf.png", plot = p_gb_sec_s_c_rf, width = 6, height = 5)

### gaug_during
p_gd_sec_s_rf <- ggplot(gd_sec_s_rf, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_s_c_rf <- ggplot(gd_sec_s_rf, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_s_rf.png", plot = p_gd_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_s_c_rf.png", plot = p_gd_sec_s_c_rf, width = 6, height = 5)

### gaug_after
p_ga_sec_s_rf <- ggplot(ga_sec_s_rf, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_s_c_rf <- ggplot(ga_sec_s_rf, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_s_rf.png", plot = p_ga_sec_s_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_s_c_rf.png", plot = p_ga_sec_s_c_rf, width = 6, height = 5)
...
### pH_before
p_phb_sec_a_rf <- ggplot(phb_sec_a_rf, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_a_c_rf <- ggplot(phb_sec_a_rf, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_a_rf.png", plot = p_phb_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_a_c_rf.png", plot = p_phb_sec_a_c_rf, width = 6, height = 5)

### pH_during
p_phd_sec_a_rf <- ggplot(phd_sec_a_rf, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_a_c_rf <- ggplot(phd_sec_a_rf, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_a_rf.png", plot = p_phd_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_a_c_rf.png", plot = p_phd_sec_a_c_rf, width = 6, height = 5)

### pH_after
p_pha_sec_a_rf <- ggplot(pha_sec_a_rf, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_a_c_rf <- ggplot(pha_sec_a_rf, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_a_rf.png", plot = p_pha_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_a_c_rf.png", plot = p_pha_sec_a_c_rf, width = 6, height = 5)

### conduct_before
p_cb_sec_a_rf <- ggplot(cb_sec_a_rf, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_a_c_rf <- ggplot(cb_sec_a_rf, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_a_rf.png", plot = p_cb_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_a_c_rf.png", plot = p_cb_sec_a_c_rf, width = 6, height = 5)

### conduct_during
p_cd_sec_a_rf <- ggplot(cd_sec_a_rf, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_a_c_rf <- ggplot(cd_sec_a_rf, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_a_rf.png", plot = p_cd_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_a_c_rf.png", plot = p_cd_sec_a_c_rf, width = 6, height = 5)

### conduct_after
p_ca_sec_a_rf <- ggplot(ca_sec_a_rf, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_a_c_rf <- ggplot(ca_sec_a_rf, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_a_rf.png", plot = p_ca_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_a_c_rf.png", plot = p_ca_sec_a_c_rf, width = 6, height = 5)

### ox_before
p_ob_sec_a_rf <- ggplot(ob_sec_a_rf, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_a_c_rf <- ggplot(ob_sec_a_rf, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_a_rf.png", plot = p_ob_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_a_c_rf.png", plot = p_ob_sec_a_c_rf, width = 6, height = 5)

### ox_during
p_od_sec_a_rf <- ggplot(od_sec_a_rf, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_a_c_rf <- ggplot(od_sec_a_rf, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_a_rf.png", plot = p_od_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_a_c_rf.png", plot = p_od_sec_a_c_rf, width = 6, height = 5)

### ox_after
p_oa_sec_a_rf <- ggplot(oa_sec_a_rf, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_a_c_rf <- ggplot(oa_sec_a_rf, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_a_rf.png", plot = p_oa_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_a_c_rf.png", plot = p_oa_sec_a_c_rf, width = 6, height = 5)

### turb_before
p_tb_sec_a_rf <- ggplot(tb_sec_a_rf, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_a_c_rf <- ggplot(tb_sec_a_rf, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_a_rf.png", plot = p_tb_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_a_c_rf.png", plot = p_tb_sec_a_c_rf, width = 6, height = 5)

### turb_during
p_td_sec_a_rf <- ggplot(td_sec_a_rf, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_a_c_rf <- ggplot(td_sec_a_rf, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_a_rf.png", plot = p_td_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_a_c_rf.png", plot = p_td_sec_a_c_rf, width = 6, height = 5)

### turb_after
p_ta_sec_a_rf <- ggplot(ta_sec_a_rf, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_a_c_rf <- ggplot(ta_sec_a_rf, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_a_rf.png", plot = p_ta_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_a_c_rf.png", plot = p_ta_sec_a_c_rf, width = 6, height = 5)

### temp_before
p_teb_sec_a_rf <- ggplot(teb_sec_a_rf, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_a_c_rf <- ggplot(teb_sec_a_rf, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_a_rf.png", plot = p_teb_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_a_c_rf.png", plot = p_teb_sec_a_c_rf, width = 6, height = 5)

### temp_during
p_ted_sec_a_rf <- ggplot(ted_sec_a_rf, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_a_c_rf <- ggplot(ted_sec_a_rf, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_a_rf.png", plot = p_ted_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_a_c_rf.png", plot = p_ted_sec_a_c_rf, width = 6, height = 5)

### temp_after
p_tea_sec_a_rf <- ggplot(tea_sec_a_rf, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_a_c_rf <- ggplot(tea_sec_a_rf, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_a_rf.png", plot = p_tea_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_a_c_rf.png", plot = p_tea_sec_a_c_rf, width = 6, height = 5)

### q_before
p_qb_sec_a_rf <- ggplot(qb_sec_a_rf, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_a_c_rf <- ggplot(qb_sec_a_rf, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_a_rf.png", plot = p_qb_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_a_c_rf.png", plot = p_qb_sec_a_c_rf, width = 6, height = 5)

### q_during
p_qd_sec_a_rf <- ggplot(qd_sec_a_rf, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_a_c_rf <- ggplot(qd_sec_a_rf, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_a_rf.png", plot = p_qd_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_a_c_rf.png", plot = p_qd_sec_a_c_rf, width = 6, height = 5)

### q_after
p_qa_sec_a_rf <- ggplot(qa_sec_a_rf, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_a_c_rf <- ggplot(qa_sec_a_rf, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_a_rf.png", plot = p_qa_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_a_c_rf.png", plot = p_qa_sec_a_c_rf, width = 6, height = 5)

### gaug_before
p_gb_sec_a_rf <- ggplot(gb_sec_a_rf, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_a_c_rf <- ggplot(gb_sec_a_rf, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_a_rf.png", plot = p_gb_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_a_c_rf.png", plot = p_gb_sec_a_c_rf, width = 6, height = 5)

### gaug_during
p_gd_sec_a_rf <- ggplot(gd_sec_a_rf, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_a_c_rf <- ggplot(gd_sec_a_rf, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_a_rf.png", plot = p_gd_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_a_c_rf.png", plot = p_gd_sec_a_c_rf, width = 6, height = 5)

### gaug_after
p_ga_sec_a_rf <- ggplot(ga_sec_a_rf, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_a_c_rf <- ggplot(ga_sec_a_rf, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_a_rf.png", plot = p_ga_sec_a_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_a_c_rf.png", plot = p_ga_sec_a_c_rf, width = 6, height = 5)
...
### pH_before
p_phb_sec_ra_rf <- ggplot(phb_sec_ra_rf, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_ra_c_rf <- ggplot(phb_sec_ra_rf, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_ra_rf.png", plot = p_phb_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_ra_c_rf.png", plot = p_phb_sec_ra_c_rf, width = 6, height = 5)

### pH_during
p_phd_sec_ra_rf <- ggplot(phd_sec_ra_rf, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_ra_c_rf <- ggplot(phd_sec_ra_rf, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_ra_rf.png", plot = p_phd_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_ra_c_rf.png", plot = p_phd_sec_ra_c_rf, width = 6, height = 5)

### pH_after
p_pha_sec_ra_rf <- ggplot(pha_sec_ra_rf, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_ra_c_rf <- ggplot(pha_sec_ra_rf, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_ra_rf.png", plot = p_pha_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_ra_c_rf.png", plot = p_pha_sec_ra_c_rf, width = 6, height = 5)

### conduct_before
p_cb_sec_ra_rf <- ggplot(cb_sec_ra_rf, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_ra_c_rf <- ggplot(cb_sec_ra_rf, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_ra_rf.png", plot = p_cb_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_ra_c_rf.png", plot = p_cb_sec_ra_c_rf, width = 6, height = 5)

### conduct_during
p_cd_sec_ra_rf <- ggplot(cd_sec_ra_rf, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_ra_c_rf <- ggplot(cd_sec_ra_rf, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_ra_rf.png", plot = p_cd_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_ra_c_rf.png", plot = p_cd_sec_ra_c_rf, width = 6, height = 5)

### conduct_after
p_ca_sec_ra_rf <- ggplot(ca_sec_ra_rf, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_ra_c_rf <- ggplot(ca_sec_ra_rf, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_ra_rf.png", plot = p_ca_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_ra_c_rf.png", plot = p_ca_sec_ra_c_rf, width = 6, height = 5)

### ox_before
p_ob_sec_ra_rf <- ggplot(ob_sec_ra_rf, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_ra_c_rf <- ggplot(ob_sec_ra_rf, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_ra_rf.png", plot = p_ob_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_ra_c_rf.png", plot = p_ob_sec_ra_c_rf, width = 6, height = 5)

### ox_during
p_od_sec_ra_rf <- ggplot(od_sec_ra_rf, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_ra_c_rf <- ggplot(od_sec_ra_rf, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_ra_rf.png", plot = p_od_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_ra_c_rf.png", plot = p_od_sec_ra_c_rf, width = 6, height = 5)

### ox_after
p_oa_sec_ra_rf <- ggplot(oa_sec_ra_rf, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_ra_c_rf <- ggplot(oa_sec_ra_rf, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_ra_rf.png", plot = p_oa_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_ra_c_rf.png", plot = p_oa_sec_ra_c_rf, width = 6, height = 5)

### turb_before
p_tb_sec_ra_rf <- ggplot(tb_sec_ra_rf, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_ra_c_rf <- ggplot(tb_sec_ra_rf, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_ra_rf.png", plot = p_tb_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_ra_c_rf.png", plot = p_tb_sec_ra_c_rf, width = 6, height = 5)

### turb_during
p_td_sec_ra_rf <- ggplot(td_sec_ra_rf, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_ra_c_rf <- ggplot(td_sec_ra_rf, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_ra_rf.png", plot = p_td_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_ra_c_rf.png", plot = p_td_sec_ra_c_rf, width = 6, height = 5)

### turb_after
p_ta_sec_ra_rf <- ggplot(ta_sec_ra_rf, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_ra_c_rf <- ggplot(ta_sec_ra_rf, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_ra_rf.png", plot = p_ta_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_ra_c_rf.png", plot = p_ta_sec_ra_c_rf, width = 6, height = 5)

### temp_before
p_teb_sec_ra_rf <- ggplot(teb_sec_ra_rf, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_ra_c_rf <- ggplot(teb_sec_ra_rf, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_ra_rf.png", plot = p_teb_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_ra_c_rf.png", plot = p_teb_sec_ra_c_rf, width = 6, height = 5)

### temp_during
p_ted_sec_ra_rf <- ggplot(ted_sec_ra_rf, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_ra_c_rf <- ggplot(ted_sec_ra_rf, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_ra_rf.png", plot = p_ted_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_ra_c_rf.png", plot = p_ted_sec_ra_c_rf, width = 6, height = 5)

### temp_after
p_tea_sec_ra_rf <- ggplot(tea_sec_ra_rf, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_ra_c_rf <- ggplot(tea_sec_ra_rf, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_ra_rf.png", plot = p_tea_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_ra_c_rf.png", plot = p_tea_sec_ra_c_rf, width = 6, height = 5)

### q_before
p_qb_sec_ra_rf <- ggplot(qb_sec_ra_rf, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_ra_c_rf <- ggplot(qb_sec_ra_rf, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_ra_rf.png", plot = p_qb_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_ra_c_rf.png", plot = p_qb_sec_ra_c_rf, width = 6, height = 5)

### q_during
p_qd_sec_ra_rf <- ggplot(qd_sec_ra_rf, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_ra_c_rf <- ggplot(qd_sec_ra_rf, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_ra_rf.png", plot = p_qd_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_ra_c_rf.png", plot = p_qd_sec_ra_c_rf, width = 6, height = 5)

### q_after
p_qa_sec_ra_rf <- ggplot(qa_sec_ra_rf, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_ra_c_rf <- ggplot(qa_sec_ra_rf, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_ra_rf.png", plot = p_qa_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_ra_c_rf.png", plot = p_qa_sec_ra_c_rf, width = 6, height = 5)

### gaug_before
p_gb_sec_ra_rf <- ggplot(gb_sec_ra_rf, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_ra_c_rf <- ggplot(gb_sec_ra_rf, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_ra_rf.png", plot = p_gb_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_ra_c_rf.png", plot = p_gb_sec_ra_c_rf, width = 6, height = 5)

### gaug_during
p_gd_sec_ra_rf <- ggplot(gd_sec_ra_rf, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_ra_c_rf <- ggplot(gd_sec_ra_rf, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_ra_rf.png", plot = p_gd_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_ra_c_rf.png", plot = p_gd_sec_ra_c_rf, width = 6, height = 5)

### gaug_after
p_ga_sec_ra_rf <- ggplot(ga_sec_ra_rf, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_ra_c_rf <- ggplot(ga_sec_ra_rf, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_ra_rf.png", plot = p_ga_sec_ra_rf, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_ra_c_rf.png", plot = p_ga_sec_ra_c_rf, width = 6, height = 5)
```
...
# With k_index as response ----------------------------------------------------
### froude 
p_f_sec_k_rf_add <- ggplot(f_sec_k_rf_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
p_f_sec_k_c_rf_add <- ggplot(f_sec_k_c_rf_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_sec_k_rf_add.png", plot = p_f_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_sec_k_c_rf_add.png", plot = p_f_sec_k_c_rf_add, width = 6, height = 5)

### shear_stress 
p_s_sec_k_rf_add <- ggplot(s_sec_k_rf_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
p_s_sec_k_c_rf_add <- ggplot(s_sec_k_c_rf_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_sec_k_rf_add.png", plot = p_s_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_sec_k_c_rf_add.png", plot = p_s_sec_k_c_rf_add, width = 6, height = 5)

### stream_power 
p_sp_sec_k_rf_add <- ggplot(sp_sec_k_rf_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
p_sp_sec_k_c_rf_add <- ggplot(sp_sec_k_c_rf_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_sec_k_rf_add.png", plot = p_sp_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sp_sec_k_c_rf_add.png", plot = p_sp_sec_k_c_rf_add, width = 6, height = 5)

### velocity 
p_v_sec_k_rf_add <- ggplot(v_sec_k_rf_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_k_c_rf_add <- ggplot(v_sec_k_c_rf_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_k_rf_add.png", plot = p_v_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_k_c_rf_add.png", plot = p_v_sec_k_c_rf_add, width = 6, height = 5)

### wd_m 
p_wd_sec_k_rf_add <- ggplot(wd_sec_k_rf_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_k_c_rf_add <- ggplot(wd_sec_k_c_rf_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_k_rf_add.png", plot = p_wd_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_k_c_rf_add.png", plot = p_wd_sec_k_c_rf_add, width = 6, height = 5)

### x/y
p_x_sec_k_rf_add <- ggplot(x_sec_k_rf_add, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_k_rf_add <- ggplot(y_sec_k_rf_add, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_k_rf_add.png", plot = p_x_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_k_rf_add.png", plot = p_y_sec_k_rf_add, width = 6, height = 5)

### z 
p_z_sec_k_rf_add <- ggplot(z_sec_k_rf_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_k_c_rf_add <- ggplot(z_sec_k_c_rf_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_k_rf_add.png", plot = p_z_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_k_c_rf_add.png", plot = p_z_sec_k_c_rf_add, width = 6, height = 5)

### dist_w 
p_dist_sec_k_rf_add <- ggplot(dist_sec_k_rf_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_k_c_rf_add <- ggplot(dist_sec_k_rf_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_k_rf_add.png", plot = p_dist_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_k_c_rf_add.png", plot = p_dist_sec_k_c_rf_add, width = 6, height = 5)

### cat_v
p_cv_sec_k_rf_add <- ggplot(cv_sec_k_rf_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_k_c_rf_add <- ggplot(cv_sec_k_rf_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_k_rf_add.png", plot = p_cv_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_k_c_rf_add.png", plot = p_cv_sec_k_c_rf_add, width = 6, height = 5)

### alg_cover 
p_ac_sec_k_rf_add <- ggplot(ac_sec_k_rf_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_k_c_rf_add <- ggplot(ac_sec_k_rf_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_k_rf_add.png", plot = p_ac_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_k_c_rf_add.png", plot = p_ac_sec_k_c_rf_add, width = 6, height = 5)

### moos_cover
p_mc_sec_k_rf_add <- ggplot(mc_sec_k_rf_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_k_c_rf_add <- ggplot(mc_sec_k_rf_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_k_rf_add.png", plot = p_mc_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_k_c_rf_add.png", plot = p_mc_sec_k_c_rf_add, width = 6, height = 5)

### cpom_cover 
p_cc_sec_k_rf_add <- ggplot(cc_sec_k_rf_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_k_c_rf_add <- ggplot(cc_sec_k_rf_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_k_rf_add.png", plot = p_cc_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_k_c_rf_add.png", plot = p_cc_sec_k_c_rf_add, width = 6, height = 5)

### clog_3 
p_clog_3_sec_k_rf_add <- ggplot(clog_3_sec_k_rf_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_k_c_rf_add <- ggplot(clog_3_sec_k_rf_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_k_rf_add.png", plot = p_clog_3_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_k_c_rf_add.png", plot = p_clog_3_sec_k_c_rf_add, width = 6, height = 5)

### clog_6 
p_clog_6_sec_k_rf_add <- ggplot(clog_6_sec_k_rf_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_k_c_rf_add <- ggplot(clog_6_sec_k_rf_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_k_rf_add.png", plot = p_clog_6_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_k_c_rf_add.png", plot = p_clog_6_sec_k_c_rf_add, width = 6, height = 5)

### sub_type
p_sub_sec_k_rf_add <- ggplot(sub_sec_k_rf_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_k_c_rf_add <- ggplot(sub_sec_k_rf_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_k_rf_add.png", plot = p_sub_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_k_c_rf_add.png", plot = p_sub_sec_k_c_rf_add, width = 6, height = 5)

### pH_before
p_phb_sec_k_rf_add <- ggplot(phb_sec_k_rf_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_k_c_rf_add <- ggplot(phb_sec_k_rf_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_k_rf_add.png", plot = p_phb_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_k_c_rf_add.png", plot = p_phb_sec_k_c_rf_add, width = 6, height = 5)

### pH_during
p_phd_sec_k_rf_add <- ggplot(phd_sec_k_rf_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_k_c_rf_add <- ggplot(phd_sec_k_rf_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_k_rf_add.png", plot = p_phd_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_k_c_rf_add.png", plot = p_phd_sec_k_c_rf_add, width = 6, height = 5)

### pH_after
p_pha_sec_k_rf_add <- ggplot(pha_sec_k_rf_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_k_c_rf_add <- ggplot(pha_sec_k_rf_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_k_rf_add.png", plot = p_pha_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_k_c_rf_add.png", plot = p_pha_sec_k_c_rf_add, width = 6, height = 5)

### conduct_before
p_cb_sec_k_rf_add <- ggplot(cb_sec_k_rf_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_k_c_rf_add <- ggplot(cb_sec_k_rf_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_k_rf_add.png", plot = p_cb_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_k_c_rf_add.png", plot = p_cb_sec_k_c_rf_add, width = 6, height = 5)

### conduct_during
p_cd_sec_k_rf_add <- ggplot(cd_sec_k_rf_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_k_c_rf_add <- ggplot(cd_sec_k_rf_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_k_rf_add.png", plot = p_cd_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_k_c_rf_add.png", plot = p_cd_sec_k_c_rf_add, width = 6, height = 5)

### conduct_after
p_ca_sec_k_rf_add <- ggplot(ca_sec_k_rf_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_k_c_rf_add <- ggplot(ca_sec_k_rf_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_k_rf_add.png", plot = p_ca_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_k_c_rf_add.png", plot = p_ca_sec_k_c_rf_add, width = 6, height = 5)

### ox_before
p_ob_sec_k_rf_add <- ggplot(ob_sec_k_rf_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_k_c_rf_add <- ggplot(ob_sec_k_rf_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_k_rf_add.png", plot = p_ob_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_k_c_rf_add.png", plot = p_ob_sec_k_c_rf_add, width = 6, height = 5)

### ox_during
p_od_sec_k_rf_add <- ggplot(od_sec_k_rf_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_k_c_rf_add <- ggplot(od_sec_k_rf_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_k_rf_add.png", plot = p_od_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_k_c_rf_add.png", plot = p_od_sec_k_c_rf_add, width = 6, height = 5)

### ox_after
p_oa_sec_k_rf_add <- ggplot(oa_sec_k_rf_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_k_c_rf_add <- ggplot(oa_sec_k_rf_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_k_rf_add.png", plot = p_oa_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_k_c_rf_add.png", plot = p_oa_sec_k_c_rf_add, width = 6, height = 5)

### turb_before
p_tb_sec_k_rf_add <- ggplot(tb_sec_k_rf_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_k_c_rf_add <- ggplot(tb_sec_k_rf_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_k_rf_add.png", plot = p_tb_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_k_c_rf_add.png", plot = p_tb_sec_k_c_rf_add, width = 6, height = 5)

### turb_during
p_td_sec_k_rf_add <- ggplot(td_sec_k_rf_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_k_c_rf_add <- ggplot(td_sec_k_rf_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_k_rf_add.png", plot = p_td_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_k_c_rf_add.png", plot = p_td_sec_k_c_rf_add, width = 6, height = 5)

### turb_after
p_ta_sec_k_rf_add <- ggplot(ta_sec_k_rf_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_k_c_rf_add <- ggplot(ta_sec_k_rf_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_k_rf_add.png", plot = p_ta_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_k_c_rf_add.png", plot = p_ta_sec_k_c_rf_add, width = 6, height = 5)

### temp_before
p_teb_sec_k_rf_add <- ggplot(teb_sec_k_rf_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_k_c_rf_add <- ggplot(teb_sec_k_rf_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_k_rf_add.png", plot = p_teb_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_k_c_rf_add.png", plot = p_teb_sec_k_c_rf_add, width = 6, height = 5)

### temp_during
p_ted_sec_k_rf_add <- ggplot(ted_sec_k_rf_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_k_c_rf_add <- ggplot(ted_sec_k_rf_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_k_rf_add.png", plot = p_ted_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_k_c_rf_add.png", plot = p_ted_sec_k_c_rf_add, width = 6, height = 5)

### temp_after
p_tea_sec_k_rf_add <- ggplot(tea_sec_k_rf_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_k_c_rf_add <- ggplot(tea_sec_k_rf_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_k_rf_add.png", plot = p_tea_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_k_c_rf_add.png", plot = p_tea_sec_k_c_rf_add, width = 6, height = 5)

### q_before
p_qb_sec_k_rf_add <- ggplot(qb_sec_k_rf_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_k_c_rf_add <- ggplot(qb_sec_k_rf_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_k_rf_add.png", plot = p_qb_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_k_c_rf_add.png", plot = p_qb_sec_k_c_rf_add, width = 6, height = 5)

### q_during
p_qd_sec_k_rf_add <- ggplot(qd_sec_k_rf_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_k_c_rf_add <- ggplot(qd_sec_k_rf_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_k_rf_add.png", plot = p_qd_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_k_c_rf_add.png", plot = p_qd_sec_k_c_rf_add, width = 6, height = 5)

### q_after
p_qa_sec_k_rf_add <- ggplot(qa_sec_k_rf_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_k_c_rf_add <- ggplot(qa_sec_k_rf_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_k_rf_add.png", plot = p_qa_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_k_c_rf_add.png", plot = p_qa_sec_k_c_rf_add, width = 6, height = 5)

### gaug_before
p_gb_sec_k_rf_add <- ggplot(gb_sec_k_rf_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_k_c_rf_add <- ggplot(gb_sec_k_rf_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_k_rf_add.png", plot = p_gb_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_k_c_rf_add.png", plot = p_gb_sec_k_c_rf_add, width = 6, height = 5)

### gaug_during
p_gd_sec_k_rf_add <- ggplot(gd_sec_k_rf_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_k_c_rf_add <- ggplot(gd_sec_k_rf_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_k_rf_add.png", plot = p_gd_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_k_c_rf_add.png", plot = p_gd_sec_k_c_rf_add, width = 6, height = 5)

### gaug_after
p_ga_sec_k_rf_add <- ggplot(ga_sec_k_rf_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_k_c_rf_add <- ggplot(ga_sec_k_rf_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_k_rf_add.png", plot = p_ga_sec_k_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_k_c_rf_add.png", plot = p_ga_sec_k_c_rf_add, width = 6, height = 5)

# With shannon index as response ----------------------------------------------
### froude 
p_f_sec_s_rf_add <- ggplot(f_sec_s_rf_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
p_f_sec_s_c_rf_add <- ggplot(f_sec_s_c_rf_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_sec_s_rf_add.png", plot = p_f_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_sec_s_c_rf_add.png", plot = p_f_sec_s_c_rf_add, width = 6, height = 5)

### shear_stress 
p_s_sec_s_rf_add <- ggplot(s_sec_s_rf_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
p_s_sec_s_c_rf_add <- ggplot(s_sec_s_c_rf_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_sec_s_rf_add.png", plot = p_s_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_sec_s_c_rf_add.png", plot = p_s_sec_s_c_rf_add, width = 6, height = 5)

### stream_power 
p_sp_sec_s_rf_add <- ggplot(sp_sec_s_rf_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
p_sp_sec_s_c_rf_add <- ggplot(sp_sec_s_c_rf_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_sec_s_rf_add.png", plot = p_sp_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sp_sec_s_c_rf_add.png", plot = p_sp_sec_s_c_rf_add, width = 6, height = 5)

### velocity
p_v_sec_s_rf_add <- ggplot(v_sec_s_rf_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_s_c_rf_add <- ggplot(v_sec_s_c_rf_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_s_rf_add.png", plot = p_v_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_s_c_rf_add.png", plot = p_v_sec_s_c_rf_add, width = 6, height = 5)

### wd_m 
p_wd_sec_s_rf_add <- ggplot(wd_sec_s_rf_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_s_c_rf_add <- ggplot(wd_sec_s_c_rf_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_s_rf_add.png", plot = p_wd_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_s_c_rf_add.png", plot = p_wd_sec_s_c_rf_add, width = 6, height = 5)


### x/y
p_x_sec_s_rf_add <- ggplot(x_sec_s_rf_add, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_s_rf_add <- ggplot(y_sec_s_rf_add, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_s_rf_add.png", plot = p_x_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_s_rf_add.png", plot = p_y_sec_s_rf_add, width = 6, height = 5)

### z 
p_z_sec_s_rf_add <- ggplot(z_sec_s_rf_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_s_c_rf_add <- ggplot(z_sec_s_c_rf_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_s_rf_add.png", plot = p_z_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_s_c_rf_add.png", plot = p_z_sec_s_c_rf_add, width = 6, height = 5)

### dist_w 
p_dist_sec_s_rf_add <- ggplot(dist_sec_s_rf_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_s_c_rf_add <- ggplot(dist_sec_s_rf_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_s_rf_add.png", plot = p_dist_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_s_c_rf_add.png", plot = p_dist_sec_s_c_rf_add, width = 6, height = 5)

### cat_v
p_cv_sec_s_rf_add <- ggplot(cv_sec_s_rf_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_s_c_rf_add <- ggplot(cv_sec_s_rf_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_s_rf_add.png", plot = p_cv_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_s_c_rf_add.png", plot = p_cv_sec_s_c_rf_add, width = 6, height = 5)

### alg_cover 
p_ac_sec_s_rf_add <- ggplot(ac_sec_s_rf_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_s_c_rf_add <- ggplot(ac_sec_s_rf_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_s_rf_add.png", plot = p_ac_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_s_c_rf_add.png", plot = p_ac_sec_s_c_rf_add, width = 6, height = 5)

### moos_cover
p_mc_sec_s_rf_add <- ggplot(mc_sec_s_rf_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_s_c_rf_add <- ggplot(mc_sec_s_rf_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_s_rf_add.png", plot = p_mc_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_s_c_rf_add.png", plot = p_mc_sec_s_c_rf_add, width = 6, height = 5)

### cpom_cover 
p_cc_sec_s_rf_add <- ggplot(cc_sec_s_rf_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_s_c_rf_add <- ggplot(cc_sec_s_rf_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_s_rf_add.png", plot = p_cc_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_s_c_rf_add.png", plot = p_cc_sec_s_c_rf_add, width = 6, height = 5)

### clog_3 
p_clog_3_sec_s_rf_add <- ggplot(clog_3_sec_s_rf_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_s_c_rf_add <- ggplot(clog_3_sec_s_rf_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_s_rf_add.png", plot = p_clog_3_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_s_c_rf_add.png", plot = p_clog_3_sec_s_c_rf_add, width = 6, height = 5)

### clog_6 
p_clog_6_sec_s_rf_add <- ggplot(clog_6_sec_s_rf_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_s_c_rf_add <- ggplot(clog_6_sec_s_rf_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_s_rf_add.png", plot = p_clog_6_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_s_c_rf_add.png", plot = p_clog_6_sec_s_c_rf_add, width = 6, height = 5)

### sub_type
p_sub_sec_s_rf_add <- ggplot(sub_sec_s_rf_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_s_c_rf_add <- ggplot(sub_sec_s_rf_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_s_rf_add.png", plot = p_sub_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_s_c_rf_add.png", plot = p_sub_sec_s_c_rf_add, width = 6, height = 5)

### pH_before
p_phb_sec_s_rf_add <- ggplot(phb_sec_s_rf_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_s_c_rf_add <- ggplot(phb_sec_s_rf_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_s_rf_add.png", plot = p_phb_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_s_c_rf_add.png", plot = p_phb_sec_s_c_rf_add, width = 6, height = 5)

### pH_during
p_phd_sec_s_rf_add <- ggplot(phd_sec_s_rf_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_s_c_rf_add <- ggplot(phd_sec_s_rf_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_s_rf_add.png", plot = p_phd_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_s_c_rf_add.png", plot = p_phd_sec_s_c_rf_add, width = 6, height = 5)

### pH_after
p_pha_sec_s_rf_add <- ggplot(pha_sec_s_rf_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_s_c_rf_add <- ggplot(pha_sec_s_rf_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_s_rf_add.png", plot = p_pha_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_s_c_rf_add.png", plot = p_pha_sec_s_c_rf_add, width = 6, height = 5)

### conduct_before
p_cb_sec_s_rf_add <- ggplot(cb_sec_s_rf_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_s_c_rf_add <- ggplot(cb_sec_s_rf_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_s_rf_add.png", plot = p_cb_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_s_c_rf_add.png", plot = p_cb_sec_s_c_rf_add, width = 6, height = 5)

### conduct_during
p_cd_sec_s_rf_add <- ggplot(cd_sec_s_rf_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_s_c_rf_add <- ggplot(cd_sec_s_rf_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_s_rf_add.png", plot = p_cd_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_s_c_rf_add.png", plot = p_cd_sec_s_c_rf_add, width = 6, height = 5)

### conduct_after
p_ca_sec_s_rf_add <- ggplot(ca_sec_s_rf_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_s_c_rf_add <- ggplot(ca_sec_s_rf_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_s_rf_add.png", plot = p_ca_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_s_c_rf_add.png", plot = p_ca_sec_s_c_rf_add, width = 6, height = 5)

### ox_before
p_ob_sec_s_rf_add <- ggplot(ob_sec_s_rf_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_s_c_rf_add <- ggplot(ob_sec_s_rf_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_s_rf_add.png", plot = p_ob_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_s_c_rf_add.png", plot = p_ob_sec_s_c_rf_add, width = 6, height = 5)

### ox_during
p_od_sec_s_rf_add <- ggplot(od_sec_s_rf_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_s_c_rf_add <- ggplot(od_sec_s_rf_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_s_rf_add.png", plot = p_od_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_s_c_rf_add.png", plot = p_od_sec_s_c_rf_add, width = 6, height = 5)

### ox_after
p_oa_sec_s_rf_add <- ggplot(oa_sec_s_rf_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_s_c_rf_add <- ggplot(oa_sec_s_rf_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_s_rf_add.png", plot = p_oa_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_s_c_rf_add.png", plot = p_oa_sec_s_c_rf_add, width = 6, height = 5)

### turb_before
p_tb_sec_s_rf_add <- ggplot(tb_sec_s_rf_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_s_c_rf_add <- ggplot(tb_sec_s_rf_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_s_rf_add.png", plot = p_tb_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_s_c_rf_add.png", plot = p_tb_sec_s_c_rf_add, width = 6, height = 5)

### turb_during
p_td_sec_s_rf_add <- ggplot(td_sec_s_rf_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_s_c_rf_add <- ggplot(td_sec_s_rf_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_s_rf_add.png", plot = p_td_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_s_c_rf_add.png", plot = p_td_sec_s_c_rf_add, width = 6, height = 5)

### turb_after
p_ta_sec_s_rf_add <- ggplot(ta_sec_s_rf_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_s_c_rf_add <- ggplot(ta_sec_s_rf_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_s_rf_add.png", plot = p_ta_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_s_c_rf_add.png", plot = p_ta_sec_s_c_rf_add, width = 6, height = 5)

### temp_before
p_teb_sec_s_rf_add <- ggplot(teb_sec_s_rf_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_s_c_rf_add <- ggplot(teb_sec_s_rf_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_s_rf_add.png", plot = p_teb_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_s_c_rf_add.png", plot = p_teb_sec_s_c_rf_add, width = 6, height = 5)

### temp_during
p_ted_sec_s_rf_add <- ggplot(ted_sec_s_rf_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_s_c_rf_add <- ggplot(ted_sec_s_rf_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_s_rf_add.png", plot = p_ted_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_s_c_rf_add.png", plot = p_ted_sec_s_c_rf_add, width = 6, height = 5)

### temp_after
p_tea_sec_s_rf_add <- ggplot(tea_sec_s_rf_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_s_c_rf_add <- ggplot(tea_sec_s_rf_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_s_rf_add.png", plot = p_tea_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_s_c_rf_add.png", plot = p_tea_sec_s_c_rf_add, width = 6, height = 5)

### q_before
p_qb_sec_s_rf_add <- ggplot(qb_sec_s_rf_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_s_c_rf_add <- ggplot(qb_sec_s_rf_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_s_rf_add.png", plot = p_qb_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_s_c_rf_add.png", plot = p_qb_sec_s_c_rf_add, width = 6, height = 5)

### q_during
p_qd_sec_s_rf_add <- ggplot(qd_sec_s_rf_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_s_c_rf_add <- ggplot(qd_sec_s_rf_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_s_rf_add.png", plot = p_qd_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_s_c_rf_add.png", plot = p_qd_sec_s_c_rf_add, width = 6, height = 5)

### q_after
p_qa_sec_s_rf_add <- ggplot(qa_sec_s_rf_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_s_c_rf_add <- ggplot(qa_sec_s_rf_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_s_rf_add.png", plot = p_qa_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_s_c_rf_add.png", plot = p_qa_sec_s_c_rf_add, width = 6, height = 5)

### gaug_before
p_gb_sec_s_rf_add <- ggplot(gb_sec_s_rf_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_s_c_rf_add <- ggplot(gb_sec_s_rf_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_s_rf_add.png", plot = p_gb_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_s_c_rf_add.png", plot = p_gb_sec_s_c_rf_add, width = 6, height = 5)

### gaug_during
p_gd_sec_s_rf_add <- ggplot(gd_sec_s_rf_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_s_c_rf_add <- ggplot(gd_sec_s_rf_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_s_rf_add.png", plot = p_gd_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_s_c_rf_add.png", plot = p_gd_sec_s_c_rf_add, width = 6, height = 5)

### gaug_after
p_ga_sec_s_rf_add <- ggplot(ga_sec_s_rf_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_s_c_rf_add <- ggplot(ga_sec_s_rf_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_s_rf_add.png", plot = p_ga_sec_s_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_s_c_rf_add.png", plot = p_ga_sec_s_c_rf_add, width = 6, height = 5)

# With abundance as response --------------------------------------------------
### froude 
p_f_sec_a_rf_add <- ggplot(f_sec_a_rf_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
p_f_sec_a_c_rf_add <- ggplot(f_sec_a_c_rf_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_sec_a_rf_add.png", plot = p_f_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_sec_a_c_rf_add.png", plot = p_f_sec_a_c_rf_add, width = 6, height = 5)

### shear_stress 
p_s_sec_a_rf_add <- ggplot(s_sec_a_rf_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
p_s_sec_a_c_rf_add <- ggplot(s_sec_a_c_rf_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_sec_a_rf_add.png", plot = p_s_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_sec_a_c_rf_add.png", plot = p_s_sec_a_c_rf_add, width = 6, height = 5)

### stream_power 
p_sp_sec_a_rf_add <- ggplot(sp_sec_a_rf_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
p_sp_sec_a_c_rf_add <- ggplot(sp_sec_a_c_rf_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_sec_a_rf_add.png", plot = p_sp_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sp_sec_a_c_rf_add.png", plot = p_sp_sec_a_c_rf_add, width = 6, height = 5)

### velocity
p_v_sec_a_rf_add <- ggplot(v_sec_a_rf_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_a_c_rf_add <- ggplot(v_sec_a_c_rf_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_a_rf_add.png", plot = p_v_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_a_c_rf_add.png", plot = p_v_sec_a_c_rf_add, width = 6, height = 5)

### wd_m 
p_wd_sec_a_rf_add <- ggplot(wd_sec_a_rf_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_a_c_rf_add <- ggplot(wd_sec_a_c_rf_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_a_rf_add.png", plot = p_wd_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_a_c_rf_add.png", plot = p_wd_sec_a_c_rf_add, width = 6, height = 5)


### x/y
p_x_sec_a_rf_add <- ggplot(x_sec_a_rf_add, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_a_rf_add <- ggplot(y_sec_a_rf_add, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_a_rf_add.png", plot = p_x_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_a_rf_add.png", plot = p_y_sec_a_rf_add, width = 6, height = 5)

### z 
p_z_sec_a_rf_add <- ggplot(z_sec_a_rf_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_a_c_rf_add <- ggplot(z_sec_a_c_rf_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_a_rf_add.png", plot = p_z_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_a_c_rf_add.png", plot = p_z_sec_a_c_rf_add, width = 6, height = 5)

### dist_w 
p_dist_sec_a_rf_add <- ggplot(dist_sec_a_rf_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_a_c_rf_add <- ggplot(dist_sec_a_rf_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_a_rf_add.png", plot = p_dist_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_a_c_rf_add.png", plot = p_dist_sec_a_c_rf_add, width = 6, height = 5)

### cat_v
p_cv_sec_a_rf_add <- ggplot(cv_sec_a_rf_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_a_c_rf_add <- ggplot(cv_sec_a_rf_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_a_rf_add.png", plot = p_cv_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_a_c_rf_add.png", plot = p_cv_sec_a_c_rf_add, width = 6, height = 5)

### alg_cover 
p_ac_sec_a_rf_add <- ggplot(ac_sec_a_rf_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_a_c_rf_add <- ggplot(ac_sec_a_rf_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_a_rf_add.png", plot = p_ac_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_a_c_rf_add.png", plot = p_ac_sec_a_c_rf_add, width = 6, height = 5)

### moos_cover
p_mc_sec_a_rf_add <- ggplot(mc_sec_a_rf_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_a_c_rf_add <- ggplot(mc_sec_a_rf_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_a_rf_add.png", plot = p_mc_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_a_c_rf_add.png", plot = p_mc_sec_a_c_rf_add, width = 6, height = 5)

### cpom_cover 
p_cc_sec_a_rf_add <- ggplot(cc_sec_a_rf_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_a_c_rf_add <- ggplot(cc_sec_a_rf_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_a_rf_add.png", plot = p_cc_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_a_c_rf_add.png", plot = p_cc_sec_a_c_rf_add, width = 6, height = 5)

### clog_3 
p_clog_3_sec_a_rf_add <- ggplot(clog_3_sec_a_rf_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_a_c_rf_add <- ggplot(clog_3_sec_a_rf_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_a_rf_add.png", plot = p_clog_3_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_a_c_rf_add.png", plot = p_clog_3_sec_a_c_rf_add, width = 6, height = 5)

### clog_6 
p_clog_6_sec_a_rf_add <- ggplot(clog_6_sec_a_rf_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_a_c_rf_add <- ggplot(clog_6_sec_a_rf_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_a_rf_add.png", plot = p_clog_6_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_a_c_rf_add.png", plot = p_clog_6_sec_a_c_rf_add, width = 6, height = 5)

### sub_type
p_sub_sec_a_rf_add <- ggplot(sub_sec_a_rf_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_a_c_rf_add <- ggplot(sub_sec_a_rf_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_a_rf_add.png", plot = p_sub_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_a_c_rf_add.png", plot = p_sub_sec_a_c_rf_add, width = 6, height = 5)

### pH_before
p_phb_sec_a_rf_add <- ggplot(phb_sec_a_rf_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_a_c_rf_add <- ggplot(phb_sec_a_rf_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_a_rf_add.png", plot = p_phb_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_a_c_rf_add.png", plot = p_phb_sec_a_c_rf_add, width = 6, height = 5)

### pH_during
p_phd_sec_a_rf_add <- ggplot(phd_sec_a_rf_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_a_c_rf_add <- ggplot(phd_sec_a_rf_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_a_rf_add.png", plot = p_phd_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_a_c_rf_add.png", plot = p_phd_sec_a_c_rf_add, width = 6, height = 5)

### pH_after
p_pha_sec_a_rf_add <- ggplot(pha_sec_a_rf_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_a_c_rf_add <- ggplot(pha_sec_a_rf_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_a_rf_add.png", plot = p_pha_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_a_c_rf_add.png", plot = p_pha_sec_a_c_rf_add, width = 6, height = 5)

### conduct_before
p_cb_sec_a_rf_add <- ggplot(cb_sec_a_rf_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_a_c_rf_add <- ggplot(cb_sec_a_rf_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_a_rf_add.png", plot = p_cb_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_a_c_rf_add.png", plot = p_cb_sec_a_c_rf_add, width = 6, height = 5)

### conduct_during
p_cd_sec_a_rf_add <- ggplot(cd_sec_a_rf_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_a_c_rf_add <- ggplot(cd_sec_a_rf_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_a_rf_add.png", plot = p_cd_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_a_c_rf_add.png", plot = p_cd_sec_a_c_rf_add, width = 6, height = 5)

### conduct_after
p_ca_sec_a_rf_add <- ggplot(ca_sec_a_rf_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_a_c_rf_add <- ggplot(ca_sec_a_rf_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_a_rf_add.png", plot = p_ca_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_a_c_rf_add.png", plot = p_ca_sec_a_c_rf_add, width = 6, height = 5)

### ox_before
p_ob_sec_a_rf_add <- ggplot(ob_sec_a_rf_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_a_c_rf_add <- ggplot(ob_sec_a_rf_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_a_rf_add.png", plot = p_ob_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_a_c_rf_add.png", plot = p_ob_sec_a_c_rf_add, width = 6, height = 5)

### ox_during
p_od_sec_a_rf_add <- ggplot(od_sec_a_rf_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_a_c_rf_add <- ggplot(od_sec_a_rf_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_a_rf_add.png", plot = p_od_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_a_c_rf_add.png", plot = p_od_sec_a_c_rf_add, width = 6, height = 5)

### ox_after
p_oa_sec_a_rf_add <- ggplot(oa_sec_a_rf_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_a_c_rf_add <- ggplot(oa_sec_a_rf_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_a_rf_add.png", plot = p_oa_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_a_c_rf_add.png", plot = p_oa_sec_a_c_rf_add, width = 6, height = 5)

### turb_before
p_tb_sec_a_rf_add <- ggplot(tb_sec_a_rf_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_a_c_rf_add <- ggplot(tb_sec_a_rf_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_a_rf_add.png", plot = p_tb_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_a_c_rf_add.png", plot = p_tb_sec_a_c_rf_add, width = 6, height = 5)

### turb_during
p_td_sec_a_rf_add <- ggplot(td_sec_a_rf_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_a_c_rf_add <- ggplot(td_sec_a_rf_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_a_rf_add.png", plot = p_td_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_a_c_rf_add.png", plot = p_td_sec_a_c_rf_add, width = 6, height = 5)

### turb_after
p_ta_sec_a_rf_add <- ggplot(ta_sec_a_rf_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_a_c_rf_add <- ggplot(ta_sec_a_rf_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_a_rf_add.png", plot = p_ta_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_a_c_rf_add.png", plot = p_ta_sec_a_c_rf_add, width = 6, height = 5)

### temp_before
p_teb_sec_a_rf_add <- ggplot(teb_sec_a_rf_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_a_c_rf_add <- ggplot(teb_sec_a_rf_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_a_rf_add.png", plot = p_teb_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_a_c_rf_add.png", plot = p_teb_sec_a_c_rf_add, width = 6, height = 5)

### temp_during
p_ted_sec_a_rf_add <- ggplot(ted_sec_a_rf_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_a_c_rf_add <- ggplot(ted_sec_a_rf_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_a_rf_add.png", plot = p_ted_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_a_c_rf_add.png", plot = p_ted_sec_a_c_rf_add, width = 6, height = 5)

### temp_after
p_tea_sec_a_rf_add <- ggplot(tea_sec_a_rf_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_a_c_rf_add <- ggplot(tea_sec_a_rf_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_a_rf_add.png", plot = p_tea_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_a_c_rf_add.png", plot = p_tea_sec_a_c_rf_add, width = 6, height = 5)

### q_before
p_qb_sec_a_rf_add <- ggplot(qb_sec_a_rf_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_a_c_rf_add <- ggplot(qb_sec_a_rf_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_a_rf_add.png", plot = p_qb_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_a_c_rf_add.png", plot = p_qb_sec_a_c_rf_add, width = 6, height = 5)

### q_during
p_qd_sec_a_rf_add <- ggplot(qd_sec_a_rf_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_a_c_rf_add <- ggplot(qd_sec_a_rf_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_a_rf_add.png", plot = p_qd_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_a_c_rf_add.png", plot = p_qd_sec_a_c_rf_add, width = 6, height = 5)

### q_after
p_qa_sec_a_rf_add <- ggplot(qa_sec_a_rf_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_a_c_rf_add <- ggplot(qa_sec_a_rf_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_a_rf_add.png", plot = p_qa_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_a_c_rf_add.png", plot = p_qa_sec_a_c_rf_add, width = 6, height = 5)

### gaug_before
p_gb_sec_a_rf_add <- ggplot(gb_sec_a_rf_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_a_c_rf_add <- ggplot(gb_sec_a_rf_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_a_rf_add.png", plot = p_gb_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_a_c_rf_add.png", plot = p_gb_sec_a_c_rf_add, width = 6, height = 5)

### gaug_during
p_gd_sec_a_rf_add <- ggplot(gd_sec_a_rf_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_a_c_rf_add <- ggplot(gd_sec_a_rf_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_a_rf_add.png", plot = p_gd_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_a_c_rf_add.png", plot = p_gd_sec_a_c_rf_add, width = 6, height = 5)

### gaug_after
p_ga_sec_a_rf_add <- ggplot(ga_sec_a_rf_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_a_c_rf_add <- ggplot(ga_sec_a_rf_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_a_rf_add.png", plot = p_ga_sec_a_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_a_c_rf_add.png", plot = p_ga_sec_a_c_rf_add, width = 6, height = 5)

# With rel_abundance as response --------------------------------------------------
### froude 
p_f_sec_ra_rf_add <- ggplot(f_sec_ra_rf_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
p_f_sec_ra_c_rf_add <- ggplot(f_sec_ra_c_rf_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_sec_ra_rf_add.png", plot = p_f_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_sec_ra_c_rf_add.png", plot = p_f_sec_ra_c_rf_add, width = 6, height = 5)

### shear_stress 
p_s_sec_ra_rf_add <- ggplot(s_sec_ra_rf_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
p_s_sec_ra_c_rf_add <- ggplot(s_sec_ra_c_rf_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_sec_ra_rf_add.png", plot = p_s_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_sec_ra_c_rf_add.png", plot = p_s_sec_ra_c_rf_add, width = 6, height = 5)

### stream_power 
p_sp_sec_ra_rf_add <- ggplot(sp_sec_ra_rf_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
p_sp_sec_ra_c_rf_add <- ggplot(sp_sec_ra_c_rf_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_sec_ra_rf_add.png", plot = p_sp_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sp_sec_ra_c_rf_add.png", plot = p_sp_sec_ra_c_rf_add, width = 6, height = 5)


### velocity
p_v_sec_ra_rf_add <- ggplot(v_sec_ra_rf_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_ra_c_rf_add <- ggplot(v_sec_ra_c_rf_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_ra_rf_add.png", plot = p_v_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_ra_c_rf_add.png", plot = p_v_sec_ra_c_rf_add, width = 6, height = 5)

### wd_m 
p_wd_sec_ra_rf_add <- ggplot(wd_sec_ra_rf_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_ra_c_rf_add <- ggplot(wd_sec_ra_c_rf_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_ra_rf_add.png", plot = p_wd_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_ra_c_rf_add.png", plot = p_wd_sec_ra_c_rf_add, width = 6, height = 5)


### x/y
p_x_sec_ra_rf_add <- ggplot(x_sec_ra_rf_add, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_ra_rf_add <- ggplot(y_sec_ra_rf_add, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_ra_rf_add.png", plot = p_x_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_ra_rf_add.png", plot = p_y_sec_ra_rf_add, width = 6, height = 5)

### z 
p_z_sec_ra_rf_add <- ggplot(z_sec_ra_rf_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_ra_c_rf_add <- ggplot(z_sec_ra_c_rf_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_ra_rf_add.png", plot = p_z_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_ra_c_rf_add.png", plot = p_z_sec_ra_c_rf_add, width = 6, height = 5)

### dist_w 
p_dist_sec_ra_rf_add <- ggplot(dist_sec_ra_rf_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_ra_c_rf_add <- ggplot(dist_sec_ra_rf_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_ra_rf_add.png", plot = p_dist_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_ra_c_rf_add.png", plot = p_dist_sec_ra_c_rf_add, width = 6, height = 5)

### cat_v
p_cv_sec_ra_rf_add <- ggplot(cv_sec_ra_rf_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_ra_c_rf_add <- ggplot(cv_sec_ra_rf_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_ra_rf_add.png", plot = p_cv_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_ra_c_rf_add.png", plot = p_cv_sec_ra_c_rf_add, width = 6, height = 5)

### alg_cover 
p_ac_sec_ra_rf_add <- ggplot(ac_sec_ra_rf_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_ra_c_rf_add <- ggplot(ac_sec_ra_rf_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_ra_rf_add.png", plot = p_ac_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_ra_c_rf_add.png", plot = p_ac_sec_ra_c_rf_add, width = 6, height = 5)

### moos_cover
p_mc_sec_ra_rf_add <- ggplot(mc_sec_ra_rf_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_ra_c_rf_add <- ggplot(mc_sec_ra_rf_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_ra_rf_add.png", plot = p_mc_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_ra_c_rf_add.png", plot = p_mc_sec_ra_c_rf_add, width = 6, height = 5)

### cpom_cover 
p_cc_sec_ra_rf_add <- ggplot(cc_sec_ra_rf_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_ra_c_rf_add <- ggplot(cc_sec_ra_rf_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_ra_rf_add.png", plot = p_cc_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_ra_c_rf_add.png", plot = p_cc_sec_ra_c_rf_add, width = 6, height = 5)

### clog_3 
p_clog_3_sec_ra_rf_add <- ggplot(clog_3_sec_ra_rf_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_ra_c_rf_add <- ggplot(clog_3_sec_ra_rf_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_ra_rf_add.png", plot = p_clog_3_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_ra_c_rf_add.png", plot = p_clog_3_sec_ra_c_rf_add, width = 6, height = 5)

### clog_6 
p_clog_6_sec_ra_rf_add <- ggplot(clog_6_sec_ra_rf_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_ra_c_rf_add <- ggplot(clog_6_sec_ra_rf_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_ra_rf_add.png", plot = p_clog_6_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_ra_c_rf_add.png", plot = p_clog_6_sec_ra_c_rf_add, width = 6, height = 5)

### sub_type
p_sub_sec_ra_rf_add <- ggplot(sub_sec_ra_rf_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_ra_c_rf_add <- ggplot(sub_sec_ra_rf_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_ra_rf_add.png", plot = p_sub_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_ra_c_rf_add.png", plot = p_sub_sec_ra_c_rf_add, width = 6, height = 5)

### pH_before
p_phb_sec_ra_rf_add <- ggplot(phb_sec_ra_rf_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_ra_c_rf_add <- ggplot(phb_sec_ra_rf_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_ra_rf_add.png", plot = p_phb_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_ra_c_rf_add.png", plot = p_phb_sec_ra_c_rf_add, width = 6, height = 5)

### pH_during
p_phd_sec_ra_rf_add <- ggplot(phd_sec_ra_rf_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_ra_c_rf_add <- ggplot(phd_sec_ra_rf_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_ra_rf_add.png", plot = p_phd_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_ra_c_rf_add.png", plot = p_phd_sec_ra_c_rf_add, width = 6, height = 5)

### pH_after
p_pha_sec_ra_rf_add <- ggplot(pha_sec_ra_rf_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_ra_c_rf_add <- ggplot(pha_sec_ra_rf_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_ra_rf_add.png", plot = p_pha_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_ra_c_rf_add.png", plot = p_pha_sec_ra_c_rf_add, width = 6, height = 5)

### conduct_before
p_cb_sec_ra_rf_add <- ggplot(cb_sec_ra_rf_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_ra_c_rf_add <- ggplot(cb_sec_ra_rf_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_ra_rf_add.png", plot = p_cb_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_ra_c_rf_add.png", plot = p_cb_sec_ra_c_rf_add, width = 6, height = 5)

### conduct_during
p_cd_sec_ra_rf_add <- ggplot(cd_sec_ra_rf_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_ra_c_rf_add <- ggplot(cd_sec_ra_rf_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_ra_rf_add.png", plot = p_cd_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_ra_c_rf_add.png", plot = p_cd_sec_ra_c_rf_add, width = 6, height = 5)

### conduct_after
p_ca_sec_ra_rf_add <- ggplot(ca_sec_ra_rf_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_ra_c_rf_add <- ggplot(ca_sec_ra_rf_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_ra_rf_add.png", plot = p_ca_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_ra_c_rf_add.png", plot = p_ca_sec_ra_c_rf_add, width = 6, height = 5)

### ox_before
p_ob_sec_ra_rf_add <- ggplot(ob_sec_ra_rf_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_ra_c_rf_add <- ggplot(ob_sec_ra_rf_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_ra_rf_add.png", plot = p_ob_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_ra_c_rf_add.png", plot = p_ob_sec_ra_c_rf_add, width = 6, height = 5)

### ox_during
p_od_sec_ra_rf_add <- ggplot(od_sec_ra_rf_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_ra_c_rf_add <- ggplot(od_sec_ra_rf_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_ra_rf_add.png", plot = p_od_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_ra_c_rf_add.png", plot = p_od_sec_ra_c_rf_add, width = 6, height = 5)

### ox_after
p_oa_sec_ra_rf_add <- ggplot(oa_sec_ra_rf_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_ra_c_rf_add <- ggplot(oa_sec_ra_rf_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_ra_rf_add.png", plot = p_oa_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_ra_c_rf_add.png", plot = p_oa_sec_ra_c_rf_add, width = 6, height = 5)

### turb_before
p_tb_sec_ra_rf_add <- ggplot(tb_sec_ra_rf_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_ra_c_rf_add <- ggplot(tb_sec_ra_rf_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_ra_rf_add.png", plot = p_tb_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_ra_c_rf_add.png", plot = p_tb_sec_ra_c_rf_add, width = 6, height = 5)

### turb_during
p_td_sec_ra_rf_add <- ggplot(td_sec_ra_rf_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_ra_c_rf_add <- ggplot(td_sec_ra_rf_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_ra_rf_add.png", plot = p_td_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_ra_c_rf_add.png", plot = p_td_sec_ra_c_rf_add, width = 6, height = 5)

### turb_after
p_ta_sec_ra_rf_add <- ggplot(ta_sec_ra_rf_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_ra_c_rf_add <- ggplot(ta_sec_ra_rf_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_ra_rf_add.png", plot = p_ta_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_ra_c_rf_add.png", plot = p_ta_sec_ra_c_rf_add, width = 6, height = 5)

### temp_before
p_teb_sec_ra_rf_add <- ggplot(teb_sec_ra_rf_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_ra_c_rf_add <- ggplot(teb_sec_ra_rf_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_ra_rf_add.png", plot = p_teb_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_ra_c_rf_add.png", plot = p_teb_sec_ra_c_rf_add, width = 6, height = 5)

### temp_during
p_ted_sec_ra_rf_add <- ggplot(ted_sec_ra_rf_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_ra_c_rf_add <- ggplot(ted_sec_ra_rf_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_ra_rf_add.png", plot = p_ted_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_ra_c_rf_add.png", plot = p_ted_sec_ra_c_rf_add, width = 6, height = 5)

### temp_after
p_tea_sec_ra_rf_add <- ggplot(tea_sec_ra_rf_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_ra_c_rf_add <- ggplot(tea_sec_ra_rf_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_ra_rf_add.png", plot = p_tea_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_ra_c_rf_add.png", plot = p_tea_sec_ra_c_rf_add, width = 6, height = 5)

### q_before
p_qb_sec_ra_rf_add <- ggplot(qb_sec_ra_rf_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_ra_c_rf_add <- ggplot(qb_sec_ra_rf_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_ra_rf_add.png", plot = p_qb_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_ra_c_rf_add.png", plot = p_qb_sec_ra_c_rf_add, width = 6, height = 5)

### q_during
p_qd_sec_ra_rf_add <- ggplot(qd_sec_ra_rf_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_ra_c_rf_add <- ggplot(qd_sec_ra_rf_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_ra_rf_add.png", plot = p_qd_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_ra_c_rf_add.png", plot = p_qd_sec_ra_c_rf_add, width = 6, height = 5)

### q_after
p_qa_sec_ra_rf_add <- ggplot(qa_sec_ra_rf_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_ra_c_rf_add <- ggplot(qa_sec_ra_rf_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_ra_rf_add.png", plot = p_qa_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_ra_c_rf_add.png", plot = p_qa_sec_ra_c_rf_add, width = 6, height = 5)

### gaug_before
p_gb_sec_ra_rf_add <- ggplot(gb_sec_ra_rf_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_ra_c_rf_add <- ggplot(gb_sec_ra_rf_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_ra_rf_add.png", plot = p_gb_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_ra_c_rf_add.png", plot = p_gb_sec_ra_c_rf_add, width = 6, height = 5)

### gaug_during
p_gd_sec_ra_rf_add <- ggplot(gd_sec_ra_rf_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_ra_c_rf_add <- ggplot(gd_sec_ra_rf_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_ra_rf_add.png", plot = p_gd_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_ra_c_rf_add.png", plot = p_gd_sec_ra_c_rf_add, width = 6, height = 5)

### gaug_after
p_ga_sec_ra_rf_add <- ggplot(ga_sec_ra_rf_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_ra_c_rf_add <- ggplot(ga_sec_ra_rf_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_ra_rf_add.png", plot = p_ga_sec_ra_rf_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_ra_c_rf_add.png", plot = p_ga_sec_ra_c_rf_add, width = 6, height = 5)
```
...
# With k_index as response ----------------------------------------------------
### velocity 
p_v_sec_k_brt <- ggplot(v_sec_k_brt, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_k_c_brt <- ggplot(v_sec_k_c_brt, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_k_brt.png", plot = p_v_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_k_c_brt.png", plot = p_v_sec_k_c_brt, width = 6, height = 5)

### wd_m 
p_wd_sec_k_brt <- ggplot(wd_sec_k_brt, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_k_c_brt <- ggplot(wd_sec_k_c_brt, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_k_brt.png", plot = p_wd_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_k_c_brt.png", plot = p_wd_sec_k_c_brt, width = 6, height = 5)

### x/y
p_x_sec_k_brt <- ggplot(x_sec_k_brt, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_k_brt <- ggplot(y_sec_k_brt, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_k_brt.png", plot = p_x_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_k_brt.png", plot = p_y_sec_k_brt, width = 6, height = 5)

### z 
p_z_sec_k_brt <- ggplot(z_sec_k_brt, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_k_c_brt <- ggplot(z_sec_k_c_brt, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_k_brt.png", plot = p_z_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_k_c_brt.png", plot = p_z_sec_k_c_brt, width = 6, height = 5)

### dist_w 
p_dist_sec_k_brt <- ggplot(dist_sec_k_brt, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_k_c_brt <- ggplot(dist_sec_k_brt, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_k_brt.png", plot = p_dist_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_k_c_brt.png", plot = p_dist_sec_k_c_brt, width = 6, height = 5)

### cat_v
p_cv_sec_k_brt <- ggplot(cv_sec_k_brt, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_k_c_brt <- ggplot(cv_sec_k_brt, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_k_brt.png", plot = p_cv_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_k_c_brt.png", plot = p_cv_sec_k_c_brt, width = 6, height = 5)

### alg_cover 
p_ac_sec_k_brt <- ggplot(ac_sec_k_brt, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_k_c_brt <- ggplot(ac_sec_k_brt, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_k_brt.png", plot = p_ac_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_k_c_brt.png", plot = p_ac_sec_k_c_brt, width = 6, height = 5)

### moos_cover
p_mc_sec_k_brt <- ggplot(mc_sec_k_brt, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_k_c_brt <- ggplot(mc_sec_k_brt, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_k_brt.png", plot = p_mc_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_k_c_brt.png", plot = p_mc_sec_k_c_brt, width = 6, height = 5)

### cpom_cover 
p_cc_sec_k_brt <- ggplot(cc_sec_k_brt, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_k_c_brt <- ggplot(cc_sec_k_brt, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_k_brt.png", plot = p_cc_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_k_c_brt.png", plot = p_cc_sec_k_c_brt, width = 6, height = 5)

### clog_3 
p_clog_3_sec_k_brt <- ggplot(clog_3_sec_k_brt, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_k_c_brt <- ggplot(clog_3_sec_k_brt, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_k_brt.png", plot = p_clog_3_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_k_c_brt.png", plot = p_clog_3_sec_k_c_brt, width = 6, height = 5)

### clog_6 
p_clog_6_sec_k_brt <- ggplot(clog_6_sec_k_brt, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_k_c_brt <- ggplot(clog_6_sec_k_brt, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_k_brt.png", plot = p_clog_6_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_k_c_brt.png", plot = p_clog_6_sec_k_c_brt, width = 6, height = 5)

### sub_type
p_sub_sec_k_brt <- ggplot(sub_sec_k_brt, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_k_c_brt <- ggplot(sub_sec_k_brt, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_k_brt.png", plot = p_sub_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_k_c_brt.png", plot = p_sub_sec_k_c_brt, width = 6, height = 5)

### pH_before
p_phb_sec_k_brt <- ggplot(phb_sec_k_brt, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_k_c_brt <- ggplot(phb_sec_k_brt, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_k_brt.png", plot = p_phb_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_k_c_brt.png", plot = p_phb_sec_k_c_brt, width = 6, height = 5)

### pH_during
p_phd_sec_k_brt <- ggplot(phd_sec_k_brt, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_k_c_brt <- ggplot(phd_sec_k_brt, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_k_brt.png", plot = p_phd_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_k_c_brt.png", plot = p_phd_sec_k_c_brt, width = 6, height = 5)

### pH_after
p_pha_sec_k_brt <- ggplot(pha_sec_k_brt, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_k_c_brt <- ggplot(pha_sec_k_brt, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_k_brt.png", plot = p_pha_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_k_c_brt.png", plot = p_pha_sec_k_c_brt, width = 6, height = 5)

### conduct_before
p_cb_sec_k_brt <- ggplot(cb_sec_k_brt, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_k_c_brt <- ggplot(cb_sec_k_brt, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_k_brt.png", plot = p_cb_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_k_c_brt.png", plot = p_cb_sec_k_c_brt, width = 6, height = 5)

### conduct_during
p_cd_sec_k_brt <- ggplot(cd_sec_k_brt, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_k_c_brt <- ggplot(cd_sec_k_brt, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_k_brt.png", plot = p_cd_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_k_c_brt.png", plot = p_cd_sec_k_c_brt, width = 6, height = 5)

### conduct_after
p_ca_sec_k_brt <- ggplot(ca_sec_k_brt, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_k_c_brt <- ggplot(ca_sec_k_brt, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_k_brt.png", plot = p_ca_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_k_c_brt.png", plot = p_ca_sec_k_c_brt, width = 6, height = 5)

### ox_before
p_ob_sec_k_brt <- ggplot(ob_sec_k_brt, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_k_c_brt <- ggplot(ob_sec_k_brt, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_k_brt.png", plot = p_ob_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_k_c_brt.png", plot = p_ob_sec_k_c_brt, width = 6, height = 5)

### ox_during
p_od_sec_k_brt <- ggplot(od_sec_k_brt, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_k_c_brt <- ggplot(od_sec_k_brt, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_k_brt.png", plot = p_od_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_k_c_brt.png", plot = p_od_sec_k_c_brt, width = 6, height = 5)

### ox_after
p_oa_sec_k_brt <- ggplot(oa_sec_k_brt, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_k_c_brt <- ggplot(oa_sec_k_brt, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_k_brt.png", plot = p_oa_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_k_c_brt.png", plot = p_oa_sec_k_c_brt, width = 6, height = 5)

### turb_before
p_tb_sec_k_brt <- ggplot(tb_sec_k_brt, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_k_c_brt <- ggplot(tb_sec_k_brt, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_k_brt.png", plot = p_tb_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_k_c_brt.png", plot = p_tb_sec_k_c_brt, width = 6, height = 5)

### turb_during
p_td_sec_k_brt <- ggplot(td_sec_k_brt, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_k_c_brt <- ggplot(td_sec_k_brt, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_k_brt.png", plot = p_td_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_k_c_brt.png", plot = p_td_sec_k_c_brt, width = 6, height = 5)

### turb_after
p_ta_sec_k_brt <- ggplot(ta_sec_k_brt, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_k_c_brt <- ggplot(ta_sec_k_brt, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_k_brt.png", plot = p_ta_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_k_c_brt.png", plot = p_ta_sec_k_c_brt, width = 6, height = 5)

### temp_before
p_teb_sec_k_brt <- ggplot(teb_sec_k_brt, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_k_c_brt <- ggplot(teb_sec_k_brt, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_k_brt.png", plot = p_teb_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_k_c_brt.png", plot = p_teb_sec_k_c_brt, width = 6, height = 5)

### temp_during
p_ted_sec_k_brt <- ggplot(ted_sec_k_brt, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_k_c_brt <- ggplot(ted_sec_k_brt, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_k_brt.png", plot = p_ted_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_k_c_brt.png", plot = p_ted_sec_k_c_brt, width = 6, height = 5)

### temp_after
p_tea_sec_k_brt <- ggplot(tea_sec_k_brt, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_k_c_brt <- ggplot(tea_sec_k_brt, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_k_brt.png", plot = p_tea_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_k_c_brt.png", plot = p_tea_sec_k_c_brt, width = 6, height = 5)

### q_before
p_qb_sec_k_brt <- ggplot(qb_sec_k_brt, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_k_c_brt <- ggplot(qb_sec_k_brt, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_k_brt.png", plot = p_qb_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_k_c_brt.png", plot = p_qb_sec_k_c_brt, width = 6, height = 5)

### q_during
p_qd_sec_k_brt <- ggplot(qd_sec_k_brt, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_k_c_brt <- ggplot(qd_sec_k_brt, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_k_brt.png", plot = p_qd_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_k_c_brt.png", plot = p_qd_sec_k_c_brt, width = 6, height = 5)

### q_after
p_qa_sec_k_brt <- ggplot(qa_sec_k_brt, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_k_c_brt <- ggplot(qa_sec_k_brt, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_k_brt.png", plot = p_qa_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_k_c_brt.png", plot = p_qa_sec_k_c_brt, width = 6, height = 5)

### gaug_before
p_gb_sec_k_brt <- ggplot(gb_sec_k_brt, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_k_c_brt <- ggplot(gb_sec_k_brt, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_k_brt.png", plot = p_gb_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_k_c_brt.png", plot = p_gb_sec_k_c_brt, width = 6, height = 5)

### gaug_during
p_gd_sec_k_brt <- ggplot(gd_sec_k_brt, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_k_c_brt <- ggplot(gd_sec_k_brt, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_k_brt.png", plot = p_gd_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_k_c_brt.png", plot = p_gd_sec_k_c_brt, width = 6, height = 5)

### gaug_after
p_ga_sec_k_brt <- ggplot(ga_sec_k_brt, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_k_c_brt <- ggplot(ga_sec_k_brt, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_k_brt.png", plot = p_ga_sec_k_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_k_c_brt.png", plot = p_ga_sec_k_c_brt, width = 6, height = 5)

# With shannon index as response ----------------------------------------------
### velocity
p_v_sec_s_brt <- ggplot(v_sec_s_brt, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_s_c_brt <- ggplot(v_sec_s_c_brt, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_s_brt.png", plot = p_v_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_s_c_brt.png", plot = p_v_sec_s_c_brt, width = 6, height = 5)

### wd_m 
p_wd_sec_s_brt <- ggplot(wd_sec_s_brt, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_s_c_brt <- ggplot(wd_sec_s_c_brt, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_s_brt.png", plot = p_wd_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_s_c_brt.png", plot = p_wd_sec_s_c_brt, width = 6, height = 5)


### x/y
p_x_sec_s_brt <- ggplot(x_sec_s_brt, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_s_brt <- ggplot(y_sec_s_brt, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_s_brt.png", plot = p_x_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_s_brt.png", plot = p_y_sec_s_brt, width = 6, height = 5)

### z 
p_z_sec_s_brt <- ggplot(z_sec_s_brt, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_s_c_brt <- ggplot(z_sec_s_c_brt, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_s_brt.png", plot = p_z_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_s_c_brt.png", plot = p_z_sec_s_c_brt, width = 6, height = 5)

### dist_w 
p_dist_sec_s_brt <- ggplot(dist_sec_s_brt, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_s_c_brt <- ggplot(dist_sec_s_brt, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_s_brt.png", plot = p_dist_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_s_c_brt.png", plot = p_dist_sec_s_c_brt, width = 6, height = 5)

### cat_v
p_cv_sec_s_brt <- ggplot(cv_sec_s_brt, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_s_c_brt <- ggplot(cv_sec_s_brt, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_s_brt.png", plot = p_cv_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_s_c_brt.png", plot = p_cv_sec_s_c_brt, width = 6, height = 5)

### alg_cover 
p_ac_sec_s_brt <- ggplot(ac_sec_s_brt, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_s_c_brt <- ggplot(ac_sec_s_brt, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_s_brt.png", plot = p_ac_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_s_c_brt.png", plot = p_ac_sec_s_c_brt, width = 6, height = 5)

### moos_cover
p_mc_sec_s_brt <- ggplot(mc_sec_s_brt, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_s_c_brt <- ggplot(mc_sec_s_brt, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_s_brt.png", plot = p_mc_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_s_c_brt.png", plot = p_mc_sec_s_c_brt, width = 6, height = 5)

### cpom_cover 
p_cc_sec_s_brt <- ggplot(cc_sec_s_brt, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_s_c_brt <- ggplot(cc_sec_s_brt, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_s_brt.png", plot = p_cc_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_s_c_brt.png", plot = p_cc_sec_s_c_brt, width = 6, height = 5)

### clog_3 
p_clog_3_sec_s_brt <- ggplot(clog_3_sec_s_brt, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_s_c_brt <- ggplot(clog_3_sec_s_brt, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_s_brt.png", plot = p_clog_3_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_s_c_brt.png", plot = p_clog_3_sec_s_c_brt, width = 6, height = 5)

### clog_6 
p_clog_6_sec_s_brt <- ggplot(clog_6_sec_s_brt, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_s_c_brt <- ggplot(clog_6_sec_s_brt, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_s_brt.png", plot = p_clog_6_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_s_c_brt.png", plot = p_clog_6_sec_s_c_brt, width = 6, height = 5)

### sub_type
p_sub_sec_s_brt <- ggplot(sub_sec_s_brt, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_s_c_brt <- ggplot(sub_sec_s_brt, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_s_brt.png", plot = p_sub_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_s_c_brt.png", plot = p_sub_sec_s_c_brt, width = 6, height = 5)

### pH_before
p_phb_sec_s_brt <- ggplot(phb_sec_s_brt, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_s_c_brt <- ggplot(phb_sec_s_brt, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_s_brt.png", plot = p_phb_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_s_c_brt.png", plot = p_phb_sec_s_c_brt, width = 6, height = 5)

### pH_during
p_phd_sec_s_brt <- ggplot(phd_sec_s_brt, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_s_c_brt <- ggplot(phd_sec_s_brt, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_s_brt.png", plot = p_phd_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_s_c_brt.png", plot = p_phd_sec_s_c_brt, width = 6, height = 5)

### pH_after
p_pha_sec_s_brt <- ggplot(pha_sec_s_brt, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_s_c_brt <- ggplot(pha_sec_s_brt, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_s_brt.png", plot = p_pha_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_s_c_brt.png", plot = p_pha_sec_s_c_brt, width = 6, height = 5)

### conduct_before
p_cb_sec_s_brt <- ggplot(cb_sec_s_brt, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_s_c_brt <- ggplot(cb_sec_s_brt, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_s_brt.png", plot = p_cb_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_s_c_brt.png", plot = p_cb_sec_s_c_brt, width = 6, height = 5)

### conduct_during
p_cd_sec_s_brt <- ggplot(cd_sec_s_brt, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_s_c_brt <- ggplot(cd_sec_s_brt, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_s_brt.png", plot = p_cd_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_s_c_brt.png", plot = p_cd_sec_s_c_brt, width = 6, height = 5)

### conduct_after
p_ca_sec_s_brt <- ggplot(ca_sec_s_brt, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_s_c_brt <- ggplot(ca_sec_s_brt, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_s_brt.png", plot = p_ca_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_s_c_brt.png", plot = p_ca_sec_s_c_brt, width = 6, height = 5)

### ox_before
p_ob_sec_s_brt <- ggplot(ob_sec_s_brt, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_s_c_brt <- ggplot(ob_sec_s_brt, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_s_brt.png", plot = p_ob_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_s_c_brt.png", plot = p_ob_sec_s_c_brt, width = 6, height = 5)

### ox_during
p_od_sec_s_brt <- ggplot(od_sec_s_brt, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_s_c_brt <- ggplot(od_sec_s_brt, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_s_brt.png", plot = p_od_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_s_c_brt.png", plot = p_od_sec_s_c_brt, width = 6, height = 5)

### ox_after
p_oa_sec_s_brt <- ggplot(oa_sec_s_brt, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_s_c_brt <- ggplot(oa_sec_s_brt, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_s_brt.png", plot = p_oa_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_s_c_brt.png", plot = p_oa_sec_s_c_brt, width = 6, height = 5)

### turb_before
p_tb_sec_s_brt <- ggplot(tb_sec_s_brt, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_s_c_brt <- ggplot(tb_sec_s_brt, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_s_brt.png", plot = p_tb_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_s_c_brt.png", plot = p_tb_sec_s_c_brt, width = 6, height = 5)

### turb_during
p_td_sec_s_brt <- ggplot(td_sec_s_brt, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_s_c_brt <- ggplot(td_sec_s_brt, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_s_brt.png", plot = p_td_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_s_c_brt.png", plot = p_td_sec_s_c_brt, width = 6, height = 5)

### turb_after
p_ta_sec_s_brt <- ggplot(ta_sec_s_brt, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_s_c_brt <- ggplot(ta_sec_s_brt, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_s_brt.png", plot = p_ta_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_s_c_brt.png", plot = p_ta_sec_s_c_brt, width = 6, height = 5)

### temp_before
p_teb_sec_s_brt <- ggplot(teb_sec_s_brt, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_s_c_brt <- ggplot(teb_sec_s_brt, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_s_brt.png", plot = p_teb_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_s_c_brt.png", plot = p_teb_sec_s_c_brt, width = 6, height = 5)

### temp_during
p_ted_sec_s_brt <- ggplot(ted_sec_s_brt, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_s_c_brt <- ggplot(ted_sec_s_brt, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_s_brt.png", plot = p_ted_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_s_c_brt.png", plot = p_ted_sec_s_c_brt, width = 6, height = 5)

### temp_after
p_tea_sec_s_brt <- ggplot(tea_sec_s_brt, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_s_c_brt <- ggplot(tea_sec_s_brt, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_s_brt.png", plot = p_tea_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_s_c_brt.png", plot = p_tea_sec_s_c_brt, width = 6, height = 5)

### q_before
p_qb_sec_s_brt <- ggplot(qb_sec_s_brt, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_s_c_brt <- ggplot(qb_sec_s_brt, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_s_brt.png", plot = p_qb_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_s_c_brt.png", plot = p_qb_sec_s_c_brt, width = 6, height = 5)

### q_during
p_qd_sec_s_brt <- ggplot(qd_sec_s_brt, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_s_c_brt <- ggplot(qd_sec_s_brt, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_s_brt.png", plot = p_qd_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_s_c_brt.png", plot = p_qd_sec_s_c_brt, width = 6, height = 5)

### q_after
p_qa_sec_s_brt <- ggplot(qa_sec_s_brt, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_s_c_brt <- ggplot(qa_sec_s_brt, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_s_brt.png", plot = p_qa_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_s_c_brt.png", plot = p_qa_sec_s_c_brt, width = 6, height = 5)

### gaug_before
p_gb_sec_s_brt <- ggplot(gb_sec_s_brt, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_s_c_brt <- ggplot(gb_sec_s_brt, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_s_brt.png", plot = p_gb_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_s_c_brt.png", plot = p_gb_sec_s_c_brt, width = 6, height = 5)

### gaug_during
p_gd_sec_s_brt <- ggplot(gd_sec_s_brt, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_s_c_brt <- ggplot(gd_sec_s_brt, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_s_brt.png", plot = p_gd_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_s_c_brt.png", plot = p_gd_sec_s_c_brt, width = 6, height = 5)

### gaug_after
p_ga_sec_s_brt <- ggplot(ga_sec_s_brt, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_s_c_brt <- ggplot(ga_sec_s_brt, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_s_brt.png", plot = p_ga_sec_s_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_s_c_brt.png", plot = p_ga_sec_s_c_brt, width = 6, height = 5)

# With abundance as response --------------------------------------------------
### velocity
p_v_sec_a_brt <- ggplot(v_sec_a_brt, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_a_c_brt <- ggplot(v_sec_a_c_brt, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_a_brt.png", plot = p_v_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_a_c_brt.png", plot = p_v_sec_a_c_brt, width = 6, height = 5)

### wd_m 
p_wd_sec_a_brt <- ggplot(wd_sec_a_brt, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_a_c_brt <- ggplot(wd_sec_a_c_brt, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_a_brt.png", plot = p_wd_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_a_c_brt.png", plot = p_wd_sec_a_c_brt, width = 6, height = 5)

### x/y
p_x_sec_a_brt <- ggplot(x_sec_a_brt, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_a_brt <- ggplot(y_sec_a_brt, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_a_brt.png", plot = p_x_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_a_brt.png", plot = p_y_sec_a_brt, width = 6, height = 5)

### z 
p_z_sec_a_brt <- ggplot(z_sec_a_brt, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_a_c_brt <- ggplot(z_sec_a_c_brt, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_a_brt.png", plot = p_z_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_a_c_brt.png", plot = p_z_sec_a_c_brt, width = 6, height = 5)

### dist_w 
p_dist_sec_a_brt <- ggplot(dist_sec_a_brt, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_a_c_brt <- ggplot(dist_sec_a_brt, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_a_brt.png", plot = p_dist_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_a_c_brt.png", plot = p_dist_sec_a_c_brt, width = 6, height = 5)

### cat_v
p_cv_sec_a_brt <- ggplot(cv_sec_a_brt, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_a_c_brt <- ggplot(cv_sec_a_brt, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_a_brt.png", plot = p_cv_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_a_c_brt.png", plot = p_cv_sec_a_c_brt, width = 6, height = 5)

### alg_cover 
p_ac_sec_a_brt <- ggplot(ac_sec_a_brt, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_a_c_brt <- ggplot(ac_sec_a_brt, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_a_brt.png", plot = p_ac_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_a_c_brt.png", plot = p_ac_sec_a_c_brt, width = 6, height = 5)

### moos_cover
p_mc_sec_a_brt <- ggplot(mc_sec_a_brt, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_a_c_brt <- ggplot(mc_sec_a_brt, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_a_brt.png", plot = p_mc_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_a_c_brt.png", plot = p_mc_sec_a_c_brt, width = 6, height = 5)

### cpom_cover 
p_cc_sec_a_brt <- ggplot(cc_sec_a_brt, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_a_c_brt <- ggplot(cc_sec_a_brt, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_a_brt.png", plot = p_cc_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_a_c_brt.png", plot = p_cc_sec_a_c_brt, width = 6, height = 5)

### clog_3 
p_clog_3_sec_a_brt <- ggplot(clog_3_sec_a_brt, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_a_c_brt <- ggplot(clog_3_sec_a_brt, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_a_brt.png", plot = p_clog_3_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_a_c_brt.png", plot = p_clog_3_sec_a_c_brt, width = 6, height = 5)

### clog_6 
p_clog_6_sec_a_brt <- ggplot(clog_6_sec_a_brt, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_a_c_brt <- ggplot(clog_6_sec_a_brt, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_a_brt.png", plot = p_clog_6_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_a_c_brt.png", plot = p_clog_6_sec_a_c_brt, width = 6, height = 5)

### sub_type
p_sub_sec_a_brt <- ggplot(sub_sec_a_brt, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_a_c_brt <- ggplot(sub_sec_a_brt, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_a_brt.png", plot = p_sub_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_a_c_brt.png", plot = p_sub_sec_a_c_brt, width = 6, height = 5)

### pH_before
p_phb_sec_a_brt <- ggplot(phb_sec_a_brt, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_a_c_brt <- ggplot(phb_sec_a_brt, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_a_brt.png", plot = p_phb_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_a_c_brt.png", plot = p_phb_sec_a_c_brt, width = 6, height = 5)

### pH_during
p_phd_sec_a_brt <- ggplot(phd_sec_a_brt, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_a_c_brt <- ggplot(phd_sec_a_brt, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_a_brt.png", plot = p_phd_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_a_c_brt.png", plot = p_phd_sec_a_c_brt, width = 6, height = 5)

### pH_after
p_pha_sec_a_brt <- ggplot(pha_sec_a_brt, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_a_c_brt <- ggplot(pha_sec_a_brt, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_a_brt.png", plot = p_pha_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_a_c_brt.png", plot = p_pha_sec_a_c_brt, width = 6, height = 5)

### conduct_before
p_cb_sec_a_brt <- ggplot(cb_sec_a_brt, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_a_c_brt <- ggplot(cb_sec_a_brt, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_a_brt.png", plot = p_cb_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_a_c_brt.png", plot = p_cb_sec_a_c_brt, width = 6, height = 5)

### conduct_during
p_cd_sec_a_brt <- ggplot(cd_sec_a_brt, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_a_c_brt <- ggplot(cd_sec_a_brt, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_a_brt.png", plot = p_cd_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_a_c_brt.png", plot = p_cd_sec_a_c_brt, width = 6, height = 5)

### conduct_after
p_ca_sec_a_brt <- ggplot(ca_sec_a_brt, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_a_c_brt <- ggplot(ca_sec_a_brt, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_a_brt.png", plot = p_ca_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_a_c_brt.png", plot = p_ca_sec_a_c_brt, width = 6, height = 5)

### ox_before
p_ob_sec_a_brt <- ggplot(ob_sec_a_brt, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_a_c_brt <- ggplot(ob_sec_a_brt, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_a_brt.png", plot = p_ob_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_a_c_brt.png", plot = p_ob_sec_a_c_brt, width = 6, height = 5)

### ox_during
p_od_sec_a_brt <- ggplot(od_sec_a_brt, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_a_c_brt <- ggplot(od_sec_a_brt, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_a_brt.png", plot = p_od_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_a_c_brt.png", plot = p_od_sec_a_c_brt, width = 6, height = 5)

### ox_after
p_oa_sec_a_brt <- ggplot(oa_sec_a_brt, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_a_c_brt <- ggplot(oa_sec_a_brt, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_a_brt.png", plot = p_oa_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_a_c_brt.png", plot = p_oa_sec_a_c_brt, width = 6, height = 5)

### turb_before
p_tb_sec_a_brt <- ggplot(tb_sec_a_brt, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_a_c_brt <- ggplot(tb_sec_a_brt, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_a_brt.png", plot = p_tb_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_a_c_brt.png", plot = p_tb_sec_a_c_brt, width = 6, height = 5)

### turb_during
p_td_sec_a_brt <- ggplot(td_sec_a_brt, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_a_c_brt <- ggplot(td_sec_a_brt, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_a_brt.png", plot = p_td_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_a_c_brt.png", plot = p_td_sec_a_c_brt, width = 6, height = 5)

### turb_after
p_ta_sec_a_brt <- ggplot(ta_sec_a_brt, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_a_c_brt <- ggplot(ta_sec_a_brt, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_a_brt.png", plot = p_ta_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_a_c_brt.png", plot = p_ta_sec_a_c_brt, width = 6, height = 5)

### temp_before
p_teb_sec_a_brt <- ggplot(teb_sec_a_brt, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_a_c_brt <- ggplot(teb_sec_a_brt, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_a_brt.png", plot = p_teb_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_a_c_brt.png", plot = p_teb_sec_a_c_brt, width = 6, height = 5)

### temp_during
p_ted_sec_a_brt <- ggplot(ted_sec_a_brt, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_a_c_brt <- ggplot(ted_sec_a_brt, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_a_brt.png", plot = p_ted_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_a_c_brt.png", plot = p_ted_sec_a_c_brt, width = 6, height = 5)

### temp_after
p_tea_sec_a_brt <- ggplot(tea_sec_a_brt, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_a_c_brt <- ggplot(tea_sec_a_brt, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_a_brt.png", plot = p_tea_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_a_c_brt.png", plot = p_tea_sec_a_c_brt, width = 6, height = 5)

### q_before
p_qb_sec_a_brt <- ggplot(qb_sec_a_brt, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_a_c_brt <- ggplot(qb_sec_a_brt, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_a_brt.png", plot = p_qb_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_a_c_brt.png", plot = p_qb_sec_a_c_brt, width = 6, height = 5)

### q_during
p_qd_sec_a_brt <- ggplot(qd_sec_a_brt, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_a_c_brt <- ggplot(qd_sec_a_brt, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_a_brt.png", plot = p_qd_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_a_c_brt.png", plot = p_qd_sec_a_c_brt, width = 6, height = 5)

### q_after
p_qa_sec_a_brt <- ggplot(qa_sec_a_brt, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_a_c_brt <- ggplot(qa_sec_a_brt, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_a_brt.png", plot = p_qa_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_a_c_brt.png", plot = p_qa_sec_a_c_brt, width = 6, height = 5)

### gaug_before
p_gb_sec_a_brt <- ggplot(gb_sec_a_brt, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_a_c_brt <- ggplot(gb_sec_a_brt, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_a_brt.png", plot = p_gb_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_a_c_brt.png", plot = p_gb_sec_a_c_brt, width = 6, height = 5)

### gaug_during
p_gd_sec_a_brt <- ggplot(gd_sec_a_brt, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_a_c_brt <- ggplot(gd_sec_a_brt, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_a_brt.png", plot = p_gd_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_a_c_brt.png", plot = p_gd_sec_a_c_brt, width = 6, height = 5)

### gaug_after
p_ga_sec_a_brt <- ggplot(ga_sec_a_brt, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_a_c_brt <- ggplot(ga_sec_a_brt, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_a_brt.png", plot = p_ga_sec_a_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_a_c_brt.png", plot = p_ga_sec_a_c_brt, width = 6, height = 5)

# With rel_abundance as response --------------------------------------------------
### velocity
p_v_sec_ra_brt <- ggplot(v_sec_ra_brt, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_ra_c_brt <- ggplot(v_sec_ra_c_brt, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_ra_brt.png", plot = p_v_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_ra_c_brt.png", plot = p_v_sec_ra_c_brt, width = 6, height = 5)

### wd_m 
p_wd_sec_ra_brt <- ggplot(wd_sec_ra_brt, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_ra_c_brt <- ggplot(wd_sec_ra_c_brt, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_ra_brt.png", plot = p_wd_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_ra_c_brt.png", plot = p_wd_sec_ra_c_brt, width = 6, height = 5)


### x/y
p_x_sec_ra_brt <- ggplot(x_sec_ra_brt, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_ra_brt <- ggplot(y_sec_ra_brt, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_ra_brt.png", plot = p_x_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_ra_brt.png", plot = p_y_sec_ra_brt, width = 6, height = 5)

### z 
p_z_sec_ra_brt <- ggplot(z_sec_ra_brt, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_ra_c_brt <- ggplot(z_sec_ra_c_brt, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_ra_brt.png", plot = p_z_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_ra_c_brt.png", plot = p_z_sec_ra_c_brt, width = 6, height = 5)

### dist_w 
p_dist_sec_ra_brt <- ggplot(dist_sec_ra_brt, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_ra_c_brt <- ggplot(dist_sec_ra_brt, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_ra_brt.png", plot = p_dist_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_ra_c_brt.png", plot = p_dist_sec_ra_c_brt, width = 6, height = 5)

### cat_v
p_cv_sec_ra_brt <- ggplot(cv_sec_ra_brt, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_ra_c_brt <- ggplot(cv_sec_ra_brt, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_ra_brt.png", plot = p_cv_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_ra_c_brt.png", plot = p_cv_sec_ra_c_brt, width = 6, height = 5)

### alg_cover 
p_ac_sec_ra_brt <- ggplot(ac_sec_ra_brt, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_ra_c_brt <- ggplot(ac_sec_ra_brt, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_ra_brt.png", plot = p_ac_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_ra_c_brt.png", plot = p_ac_sec_ra_c_brt, width = 6, height = 5)

### moos_cover
p_mc_sec_ra_brt <- ggplot(mc_sec_ra_brt, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_ra_c_brt <- ggplot(mc_sec_ra_brt, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_ra_brt.png", plot = p_mc_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_ra_c_brt.png", plot = p_mc_sec_ra_c_brt, width = 6, height = 5)

### cpom_cover 
p_cc_sec_ra_brt <- ggplot(cc_sec_ra_brt, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_ra_c_brt <- ggplot(cc_sec_ra_brt, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_ra_brt.png", plot = p_cc_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_ra_c_brt.png", plot = p_cc_sec_ra_c_brt, width = 6, height = 5)

### clog_3 
p_clog_3_sec_ra_brt <- ggplot(clog_3_sec_ra_brt, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_ra_c_brt <- ggplot(clog_3_sec_ra_brt, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_ra_brt.png", plot = p_clog_3_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_ra_c_brt.png", plot = p_clog_3_sec_ra_c_brt, width = 6, height = 5)

### clog_6 
p_clog_6_sec_ra_brt <- ggplot(clog_6_sec_ra_brt, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_ra_c_brt <- ggplot(clog_6_sec_ra_brt, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_ra_brt.png", plot = p_clog_6_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_ra_c_brt.png", plot = p_clog_6_sec_ra_c_brt, width = 6, height = 5)

### sub_type
p_sub_sec_ra_brt <- ggplot(sub_sec_ra_brt, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_ra_c_brt <- ggplot(sub_sec_ra_brt, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_ra_brt.png", plot = p_sub_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_ra_c_brt.png", plot = p_sub_sec_ra_c_brt, width = 6, height = 5)

### pH_before
p_phb_sec_ra_brt <- ggplot(phb_sec_ra_brt, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_ra_c_brt <- ggplot(phb_sec_ra_brt, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_ra_brt.png", plot = p_phb_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_ra_c_brt.png", plot = p_phb_sec_ra_c_brt, width = 6, height = 5)

### pH_during
p_phd_sec_ra_brt <- ggplot(phd_sec_ra_brt, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_ra_c_brt <- ggplot(phd_sec_ra_brt, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_ra_brt.png", plot = p_phd_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_ra_c_brt.png", plot = p_phd_sec_ra_c_brt, width = 6, height = 5)

### pH_after
p_pha_sec_ra_brt <- ggplot(pha_sec_ra_brt, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_ra_c_brt <- ggplot(pha_sec_ra_brt, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_ra_brt.png", plot = p_pha_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_ra_c_brt.png", plot = p_pha_sec_ra_c_brt, width = 6, height = 5)

### conduct_before
p_cb_sec_ra_brt <- ggplot(cb_sec_ra_brt, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_ra_c_brt <- ggplot(cb_sec_ra_brt, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_ra_brt.png", plot = p_cb_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_ra_c_brt.png", plot = p_cb_sec_ra_c_brt, width = 6, height = 5)

### conduct_during
p_cd_sec_ra_brt <- ggplot(cd_sec_ra_brt, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_ra_c_brt <- ggplot(cd_sec_ra_brt, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_ra_brt.png", plot = p_cd_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_ra_c_brt.png", plot = p_cd_sec_ra_c_brt, width = 6, height = 5)

### conduct_after
p_ca_sec_ra_brt <- ggplot(ca_sec_ra_brt, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_ra_c_brt <- ggplot(ca_sec_ra_brt, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_ra_brt.png", plot = p_ca_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_ra_c_brt.png", plot = p_ca_sec_ra_c_brt, width = 6, height = 5)

### ox_before
p_ob_sec_ra_brt <- ggplot(ob_sec_ra_brt, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_ra_c_brt <- ggplot(ob_sec_ra_brt, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_ra_brt.png", plot = p_ob_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_ra_c_brt.png", plot = p_ob_sec_ra_c_brt, width = 6, height = 5)

### ox_during
p_od_sec_ra_brt <- ggplot(od_sec_ra_brt, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_ra_c_brt <- ggplot(od_sec_ra_brt, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_ra_brt.png", plot = p_od_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_ra_c_brt.png", plot = p_od_sec_ra_c_brt, width = 6, height = 5)

### ox_after
p_oa_sec_ra_brt <- ggplot(oa_sec_ra_brt, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_ra_c_brt <- ggplot(oa_sec_ra_brt, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_ra_brt.png", plot = p_oa_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_ra_c_brt.png", plot = p_oa_sec_ra_c_brt, width = 6, height = 5)

### turb_before
p_tb_sec_ra_brt <- ggplot(tb_sec_ra_brt, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_ra_c_brt <- ggplot(tb_sec_ra_brt, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_ra_brt.png", plot = p_tb_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_ra_c_brt.png", plot = p_tb_sec_ra_c_brt, width = 6, height = 5)

### turb_during
p_td_sec_ra_brt <- ggplot(td_sec_ra_brt, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_ra_c_brt <- ggplot(td_sec_ra_brt, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_ra_brt.png", plot = p_td_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_ra_c_brt.png", plot = p_td_sec_ra_c_brt, width = 6, height = 5)

### turb_after
p_ta_sec_ra_brt <- ggplot(ta_sec_ra_brt, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_ra_c_brt <- ggplot(ta_sec_ra_brt, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_ra_brt.png", plot = p_ta_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_ra_c_brt.png", plot = p_ta_sec_ra_c_brt, width = 6, height = 5)

### temp_before
p_teb_sec_ra_brt <- ggplot(teb_sec_ra_brt, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_ra_c_brt <- ggplot(teb_sec_ra_brt, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_ra_brt.png", plot = p_teb_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_ra_c_brt.png", plot = p_teb_sec_ra_c_brt, width = 6, height = 5)

### temp_during
p_ted_sec_ra_brt <- ggplot(ted_sec_ra_brt, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_ra_c_brt <- ggplot(ted_sec_ra_brt, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_ra_brt.png", plot = p_ted_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_ra_c_brt.png", plot = p_ted_sec_ra_c_brt, width = 6, height = 5)

### temp_after
p_tea_sec_ra_brt <- ggplot(tea_sec_ra_brt, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_ra_c_brt <- ggplot(tea_sec_ra_brt, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_ra_brt.png", plot = p_tea_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_ra_c_brt.png", plot = p_tea_sec_ra_c_brt, width = 6, height = 5)

### q_before
p_qb_sec_ra_brt <- ggplot(qb_sec_ra_brt, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_ra_c_brt <- ggplot(qb_sec_ra_brt, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_ra_brt.png", plot = p_qb_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_ra_c_brt.png", plot = p_qb_sec_ra_c_brt, width = 6, height = 5)

### q_during
p_qd_sec_ra_brt <- ggplot(qd_sec_ra_brt, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_ra_c_brt <- ggplot(qd_sec_ra_brt, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_ra_brt.png", plot = p_qd_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_ra_c_brt.png", plot = p_qd_sec_ra_c_brt, width = 6, height = 5)

### q_after
p_qa_sec_ra_brt <- ggplot(qa_sec_ra_brt, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_ra_c_brt <- ggplot(qa_sec_ra_brt, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_ra_brt.png", plot = p_qa_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_ra_c_brt.png", plot = p_qa_sec_ra_c_brt, width = 6, height = 5)

### gaug_before
p_gb_sec_ra_brt <- ggplot(gb_sec_ra_brt, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_ra_c_brt <- ggplot(gb_sec_ra_brt, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_ra_brt.png", plot = p_gb_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_ra_c_brt.png", plot = p_gb_sec_ra_c_brt, width = 6, height = 5)

### gaug_during
p_gd_sec_ra_brt <- ggplot(gd_sec_ra_brt, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_ra_c_brt <- ggplot(gd_sec_ra_brt, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_ra_brt.png", plot = p_gd_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_ra_c_brt.png", plot = p_gd_sec_ra_c_brt, width = 6, height = 5)

### gaug_after
p_ga_sec_ra_brt <- ggplot(ga_sec_ra_brt, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_ra_c_brt <- ggplot(ga_sec_ra_brt, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_ra_brt.png", plot = p_ga_sec_ra_brt, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_ra_c_brt.png", plot = p_ga_sec_ra_c_brt, width = 6, height = 5)
```
...
# With k_index as response ----------------------------------------------------
### froude 
p_f_samp_k_brt_add <- ggplot(f_samp_k_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_samp_k_brt_add.png", plot = p_f_samp_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_samp_k_c_brt_add.png", plot = p_f_samp_k_c_brt_add, width = 6, height = 5)

### shear_stress 
p_s_samp_k_brt_add <- ggplot(s_samp_k_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_samp_k_brt_add.png", plot = p_s_samp_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_samp_k_c_brt_add.png", plot = p_s_samp_k_c_brt_add, width = 6, height = 5)

### stream_power 
p_sp_samp_k_brt_add <- ggplot(sp_samp_k_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_samp_k_brt_add.png", plot = p_sp_samp_k_brt_add, width = 6, height = 5)
...
# With shannon index as response ----------------------------------------------
### froude 
p_f_samp_s_brt_add <- ggplot(f_samp_s_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
p_f_samp_s_c_brt_add <- ggplot(f_samp_s_c_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_samp_s_brt_add.png", plot = p_f_samp_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_samp_s_c_brt_add.png", plot = p_f_samp_s_c_brt_add, width = 6, height = 5)

### shear_stress 
p_s_samp_s_brt_add <- ggplot(s_samp_s_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
p_s_samp_s_c_brt_add <- ggplot(s_samp_s_c_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_samp_s_brt_add.png", plot = p_s_samp_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_samp_s_c_brt_add.png", plot = p_s_samp_s_c_brt_add, width = 6, height = 5)

### stream_power 
p_sp_samp_s_brt_add <- ggplot(sp_samp_s_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
p_sp_samp_s_c_brt_add <- ggplot(sp_samp_s_c_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_samp_s_brt_add.png", plot = p_sp_samp_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sp_samp_s_c_brt_add.png", plot = p_sp_samp_s_c_brt_add, width = 6, height = 5)
...
# With abundance as response --------------------------------------------------
### froude 
p_f_samp_a_brt_add <- ggplot(f_samp_a_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_samp_a_brt_add.png", plot = p_f_samp_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_samp_a_c_brt_add.png", plot = p_f_samp_a_c_brt_add, width = 6, height = 5)

### shear_stress 
p_s_samp_a_brt_add <- ggplot(s_samp_a_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_samp_a_brt_add.png", plot = p_s_samp_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_samp_a_c_brt_add.png", plot = p_s_samp_a_c_brt_add, width = 6, height = 5)

### stream_power 
p_sp_samp_a_brt_add <- ggplot(sp_samp_a_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_samp_a_brt_add.png", plot = p_sp_samp_a_brt_add, width = 6, height = 5)
...
# With rel_abundance as response --------------------------------------------------
### froude 
p_f_samp_ra_brt_add <- ggplot(f_samp_ra_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_samp_ra_brt_add.png", plot = p_f_samp_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_samp_ra_c_brt_add.png", plot = p_f_samp_ra_c_brt_add, width = 6, height = 5)

### shear_stress 
p_s_samp_ra_brt_add <- ggplot(s_samp_ra_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_samp_ra_brt_add.png", plot = p_s_samp_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_samp_ra_c_brt_add.png", plot = p_s_samp_ra_c_brt_add, width = 6, height = 5)

### stream_power 
p_sp_samp_ra_brt_add <- ggplot(sp_samp_ra_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_samp_ra_brt_add.png", plot = p_sp_samp_ra_brt_add, width = 6, height = 5)
...
# With k_index as response ----------------------------------------------------
### froude 
p_f_sec_k_brt_add <- ggplot(f_sec_k_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
p_f_sec_k_c_brt_add <- ggplot(f_sec_k_c_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_sec_k_brt_add.png", plot = p_f_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_sec_k_c_brt_add.png", plot = p_f_sec_k_c_brt_add, width = 6, height = 5)

### shear_stress 
p_s_sec_k_brt_add <- ggplot(s_sec_k_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
p_s_sec_k_c_brt_add <- ggplot(s_sec_k_c_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_sec_k_brt_add.png", plot = p_s_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_sec_k_c_brt_add.png", plot = p_s_sec_k_c_brt_add, width = 6, height = 5)

### stream_power 
p_sp_sec_k_brt_add <- ggplot(sp_sec_k_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
p_sp_sec_k_c_brt_add <- ggplot(sp_sec_k_c_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_sec_k_brt_add.png", plot = p_sp_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sp_sec_k_c_brt_add.png", plot = p_sp_sec_k_c_brt_add, width = 6, height = 5)

### velocity 
p_v_sec_k_brt_add <- ggplot(v_sec_k_brt_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_k_c_brt_add <- ggplot(v_sec_k_c_brt_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_k_brt_add.png", plot = p_v_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_k_c_brt_add.png", plot = p_v_sec_k_c_brt_add, width = 6, height = 5)

### wd_m 
p_wd_sec_k_brt_add <- ggplot(wd_sec_k_brt_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_k_c_brt_add <- ggplot(wd_sec_k_c_brt_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_k_brt_add.png", plot = p_wd_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_k_c_brt_add.png", plot = p_wd_sec_k_c_brt_add, width = 6, height = 5)

### x/y
p_x_sec_k_brt_add <- ggplot(x_sec_k_brt_add, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_k_brt_add <- ggplot(y_sec_k_brt_add, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_k_brt_add.png", plot = p_x_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_k_brt_add.png", plot = p_y_sec_k_brt_add, width = 6, height = 5)

### z 
p_z_sec_k_brt_add <- ggplot(z_sec_k_brt_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_k_c_brt_add <- ggplot(z_sec_k_c_brt_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_k_brt_add.png", plot = p_z_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_k_c_brt_add.png", plot = p_z_sec_k_c_brt_add, width = 6, height = 5)

### dist_w 
p_dist_sec_k_brt_add <- ggplot(dist_sec_k_brt_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_k_c_brt_add <- ggplot(dist_sec_k_brt_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_k_brt_add.png", plot = p_dist_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_k_c_brt_add.png", plot = p_dist_sec_k_c_brt_add, width = 6, height = 5)

### cat_v
p_cv_sec_k_brt_add <- ggplot(cv_sec_k_brt_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_k_c_brt_add <- ggplot(cv_sec_k_brt_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_k_brt_add.png", plot = p_cv_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_k_c_brt_add.png", plot = p_cv_sec_k_c_brt_add, width = 6, height = 5)

### alg_cover 
p_ac_sec_k_brt_add <- ggplot(ac_sec_k_brt_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_k_c_brt_add <- ggplot(ac_sec_k_brt_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_k_brt_add.png", plot = p_ac_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_k_c_brt_add.png", plot = p_ac_sec_k_c_brt_add, width = 6, height = 5)

### moos_cover
p_mc_sec_k_brt_add <- ggplot(mc_sec_k_brt_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_k_c_brt_add <- ggplot(mc_sec_k_brt_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_k_brt_add.png", plot = p_mc_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_k_c_brt_add.png", plot = p_mc_sec_k_c_brt_add, width = 6, height = 5)

### cpom_cover 
p_cc_sec_k_brt_add <- ggplot(cc_sec_k_brt_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_k_c_brt_add <- ggplot(cc_sec_k_brt_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_k_brt_add.png", plot = p_cc_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_k_c_brt_add.png", plot = p_cc_sec_k_c_brt_add, width = 6, height = 5)

### clog_3 
p_clog_3_sec_k_brt_add <- ggplot(clog_3_sec_k_brt_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_k_c_brt_add <- ggplot(clog_3_sec_k_brt_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_k_brt_add.png", plot = p_clog_3_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_k_c_brt_add.png", plot = p_clog_3_sec_k_c_brt_add, width = 6, height = 5)

### clog_6 
p_clog_6_sec_k_brt_add <- ggplot(clog_6_sec_k_brt_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_k_c_brt_add <- ggplot(clog_6_sec_k_brt_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_k_brt_add.png", plot = p_clog_6_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_k_c_brt_add.png", plot = p_clog_6_sec_k_c_brt_add, width = 6, height = 5)

### sub_type
p_sub_sec_k_brt_add <- ggplot(sub_sec_k_brt_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_k_c_brt_add <- ggplot(sub_sec_k_brt_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_k_brt_add.png", plot = p_sub_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_k_c_brt_add.png", plot = p_sub_sec_k_c_brt_add, width = 6, height = 5)

### pH_before
p_phb_sec_k_brt_add <- ggplot(phb_sec_k_brt_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_k_c_brt_add <- ggplot(phb_sec_k_brt_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_k_brt_add.png", plot = p_phb_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_k_c_brt_add.png", plot = p_phb_sec_k_c_brt_add, width = 6, height = 5)

### pH_during
p_phd_sec_k_brt_add <- ggplot(phd_sec_k_brt_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_k_c_brt_add <- ggplot(phd_sec_k_brt_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_k_brt_add.png", plot = p_phd_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_k_c_brt_add.png", plot = p_phd_sec_k_c_brt_add, width = 6, height = 5)

### pH_after
p_pha_sec_k_brt_add <- ggplot(pha_sec_k_brt_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_k_c_brt_add <- ggplot(pha_sec_k_brt_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_k_brt_add.png", plot = p_pha_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_k_c_brt_add.png", plot = p_pha_sec_k_c_brt_add, width = 6, height = 5)

### conduct_before
p_cb_sec_k_brt_add <- ggplot(cb_sec_k_brt_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_k_c_brt_add <- ggplot(cb_sec_k_brt_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_k_brt_add.png", plot = p_cb_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_k_c_brt_add.png", plot = p_cb_sec_k_c_brt_add, width = 6, height = 5)

### conduct_during
p_cd_sec_k_brt_add <- ggplot(cd_sec_k_brt_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_k_c_brt_add <- ggplot(cd_sec_k_brt_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_k_brt_add.png", plot = p_cd_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_k_c_brt_add.png", plot = p_cd_sec_k_c_brt_add, width = 6, height = 5)

### conduct_after
p_ca_sec_k_brt_add <- ggplot(ca_sec_k_brt_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_k_c_brt_add <- ggplot(ca_sec_k_brt_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_k_brt_add.png", plot = p_ca_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_k_c_brt_add.png", plot = p_ca_sec_k_c_brt_add, width = 6, height = 5)

### ox_before
p_ob_sec_k_brt_add <- ggplot(ob_sec_k_brt_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_k_c_brt_add <- ggplot(ob_sec_k_brt_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_k_brt_add.png", plot = p_ob_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_k_c_brt_add.png", plot = p_ob_sec_k_c_brt_add, width = 6, height = 5)

### ox_during
p_od_sec_k_brt_add <- ggplot(od_sec_k_brt_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_k_c_brt_add <- ggplot(od_sec_k_brt_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_k_brt_add.png", plot = p_od_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_k_c_brt_add.png", plot = p_od_sec_k_c_brt_add, width = 6, height = 5)

### ox_after
p_oa_sec_k_brt_add <- ggplot(oa_sec_k_brt_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_k_c_brt_add <- ggplot(oa_sec_k_brt_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_k_brt_add.png", plot = p_oa_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_k_c_brt_add.png", plot = p_oa_sec_k_c_brt_add, width = 6, height = 5)

### turb_before
p_tb_sec_k_brt_add <- ggplot(tb_sec_k_brt_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_k_c_brt_add <- ggplot(tb_sec_k_brt_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_k_brt_add.png", plot = p_tb_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_k_c_brt_add.png", plot = p_tb_sec_k_c_brt_add, width = 6, height = 5)

### turb_during
p_td_sec_k_brt_add <- ggplot(td_sec_k_brt_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_k_c_brt_add <- ggplot(td_sec_k_brt_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_k_brt_add.png", plot = p_td_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_k_c_brt_add.png", plot = p_td_sec_k_c_brt_add, width = 6, height = 5)

### turb_after
p_ta_sec_k_brt_add <- ggplot(ta_sec_k_brt_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_k_c_brt_add <- ggplot(ta_sec_k_brt_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_k_brt_add.png", plot = p_ta_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_k_c_brt_add.png", plot = p_ta_sec_k_c_brt_add, width = 6, height = 5)

### temp_before
p_teb_sec_k_brt_add <- ggplot(teb_sec_k_brt_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_k_c_brt_add <- ggplot(teb_sec_k_brt_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_k_brt_add.png", plot = p_teb_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_k_c_brt_add.png", plot = p_teb_sec_k_c_brt_add, width = 6, height = 5)

### temp_during
p_ted_sec_k_brt_add <- ggplot(ted_sec_k_brt_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_k_c_brt_add <- ggplot(ted_sec_k_brt_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_k_brt_add.png", plot = p_ted_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_k_c_brt_add.png", plot = p_ted_sec_k_c_brt_add, width = 6, height = 5)

### temp_after
p_tea_sec_k_brt_add <- ggplot(tea_sec_k_brt_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_k_c_brt_add <- ggplot(tea_sec_k_brt_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_k_brt_add.png", plot = p_tea_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_k_c_brt_add.png", plot = p_tea_sec_k_c_brt_add, width = 6, height = 5)

### q_before
p_qb_sec_k_brt_add <- ggplot(qb_sec_k_brt_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_k_c_brt_add <- ggplot(qb_sec_k_brt_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_k_brt_add.png", plot = p_qb_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_k_c_brt_add.png", plot = p_qb_sec_k_c_brt_add, width = 6, height = 5)

### q_during
p_qd_sec_k_brt_add <- ggplot(qd_sec_k_brt_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_k_c_brt_add <- ggplot(qd_sec_k_brt_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_k_brt_add.png", plot = p_qd_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_k_c_brt_add.png", plot = p_qd_sec_k_c_brt_add, width = 6, height = 5)

### q_after
p_qa_sec_k_brt_add <- ggplot(qa_sec_k_brt_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_k_c_brt_add <- ggplot(qa_sec_k_brt_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_k_brt_add.png", plot = p_qa_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_k_c_brt_add.png", plot = p_qa_sec_k_c_brt_add, width = 6, height = 5)

### gaug_before
p_gb_sec_k_brt_add <- ggplot(gb_sec_k_brt_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_k_c_brt_add <- ggplot(gb_sec_k_brt_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_k_brt_add.png", plot = p_gb_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_k_c_brt_add.png", plot = p_gb_sec_k_c_brt_add, width = 6, height = 5)

### gaug_during
p_gd_sec_k_brt_add <- ggplot(gd_sec_k_brt_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_k_c_brt_add <- ggplot(gd_sec_k_brt_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_k_brt_add.png", plot = p_gd_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_k_c_brt_add.png", plot = p_gd_sec_k_c_brt_add, width = 6, height = 5)

### gaug_after
p_ga_sec_k_brt_add <- ggplot(ga_sec_k_brt_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_k_c_brt_add <- ggplot(ga_sec_k_brt_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_k_brt_add.png", plot = p_ga_sec_k_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_k_c_brt_add.png", plot = p_ga_sec_k_c_brt_add, width = 6, height = 5)

# With shannon index as response ----------------------------------------------
### froude 
p_f_sec_s_brt_add <- ggplot(f_sec_s_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
p_f_sec_s_c_brt_add <- ggplot(f_sec_s_c_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_sec_s_brt_add.png", plot = p_f_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_sec_s_c_brt_add.png", plot = p_f_sec_s_c_brt_add, width = 6, height = 5)

### shear_stress 
p_s_sec_s_brt_add <- ggplot(s_sec_s_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
p_s_sec_s_c_brt_add <- ggplot(s_sec_s_c_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_sec_s_brt_add.png", plot = p_s_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_sec_s_c_brt_add.png", plot = p_s_sec_s_c_brt_add, width = 6, height = 5)

### stream_power 
p_sp_sec_s_brt_add <- ggplot(sp_sec_s_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
p_sp_sec_s_c_brt_add <- ggplot(sp_sec_s_c_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_sec_s_brt_add.png", plot = p_sp_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sp_sec_s_c_brt_add.png", plot = p_sp_sec_s_c_brt_add, width = 6, height = 5)

### velocity
p_v_sec_s_brt_add <- ggplot(v_sec_s_brt_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_s_c_brt_add <- ggplot(v_sec_s_c_brt_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_s_brt_add.png", plot = p_v_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_s_c_brt_add.png", plot = p_v_sec_s_c_brt_add, width = 6, height = 5)

### wd_m 
p_wd_sec_s_brt_add <- ggplot(wd_sec_s_brt_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_s_c_brt_add <- ggplot(wd_sec_s_c_brt_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_s_brt_add.png", plot = p_wd_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_s_c_brt_add.png", plot = p_wd_sec_s_c_brt_add, width = 6, height = 5)


### x/y
p_x_sec_s_brt_add <- ggplot(x_sec_s_brt_add, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_s_brt_add <- ggplot(y_sec_s_brt_add, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_s_brt_add.png", plot = p_x_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_s_brt_add.png", plot = p_y_sec_s_brt_add, width = 6, height = 5)

### z 
p_z_sec_s_brt_add <- ggplot(z_sec_s_brt_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_s_c_brt_add <- ggplot(z_sec_s_c_brt_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_s_brt_add.png", plot = p_z_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_s_c_brt_add.png", plot = p_z_sec_s_c_brt_add, width = 6, height = 5)

### dist_w 
p_dist_sec_s_brt_add <- ggplot(dist_sec_s_brt_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_s_c_brt_add <- ggplot(dist_sec_s_brt_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_s_brt_add.png", plot = p_dist_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_s_c_brt_add.png", plot = p_dist_sec_s_c_brt_add, width = 6, height = 5)

### cat_v
p_cv_sec_s_brt_add <- ggplot(cv_sec_s_brt_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_s_c_brt_add <- ggplot(cv_sec_s_brt_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_s_brt_add.png", plot = p_cv_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_s_c_brt_add.png", plot = p_cv_sec_s_c_brt_add, width = 6, height = 5)

### alg_cover 
p_ac_sec_s_brt_add <- ggplot(ac_sec_s_brt_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_s_c_brt_add <- ggplot(ac_sec_s_brt_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_s_brt_add.png", plot = p_ac_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_s_c_brt_add.png", plot = p_ac_sec_s_c_brt_add, width = 6, height = 5)

### moos_cover
p_mc_sec_s_brt_add <- ggplot(mc_sec_s_brt_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_s_c_brt_add <- ggplot(mc_sec_s_brt_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_s_brt_add.png", plot = p_mc_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_s_c_brt_add.png", plot = p_mc_sec_s_c_brt_add, width = 6, height = 5)

### cpom_cover 
p_cc_sec_s_brt_add <- ggplot(cc_sec_s_brt_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_s_c_brt_add <- ggplot(cc_sec_s_brt_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_s_brt_add.png", plot = p_cc_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_s_c_brt_add.png", plot = p_cc_sec_s_c_brt_add, width = 6, height = 5)

### clog_3 
p_clog_3_sec_s_brt_add <- ggplot(clog_3_sec_s_brt_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_s_c_brt_add <- ggplot(clog_3_sec_s_brt_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_s_brt_add.png", plot = p_clog_3_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_s_c_brt_add.png", plot = p_clog_3_sec_s_c_brt_add, width = 6, height = 5)

### clog_6 
p_clog_6_sec_s_brt_add <- ggplot(clog_6_sec_s_brt_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_s_c_brt_add <- ggplot(clog_6_sec_s_brt_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_s_brt_add.png", plot = p_clog_6_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_s_c_brt_add.png", plot = p_clog_6_sec_s_c_brt_add, width = 6, height = 5)

### sub_type
p_sub_sec_s_brt_add <- ggplot(sub_sec_s_brt_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_s_c_brt_add <- ggplot(sub_sec_s_brt_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_s_brt_add.png", plot = p_sub_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_s_c_brt_add.png", plot = p_sub_sec_s_c_brt_add, width = 6, height = 5)

### pH_before
p_phb_sec_s_brt_add <- ggplot(phb_sec_s_brt_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_s_c_brt_add <- ggplot(phb_sec_s_brt_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_s_brt_add.png", plot = p_phb_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_s_c_brt_add.png", plot = p_phb_sec_s_c_brt_add, width = 6, height = 5)

### pH_during
p_phd_sec_s_brt_add <- ggplot(phd_sec_s_brt_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_s_c_brt_add <- ggplot(phd_sec_s_brt_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_s_brt_add.png", plot = p_phd_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_s_c_brt_add.png", plot = p_phd_sec_s_c_brt_add, width = 6, height = 5)

### pH_after
p_pha_sec_s_brt_add <- ggplot(pha_sec_s_brt_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_s_c_brt_add <- ggplot(pha_sec_s_brt_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_s_brt_add.png", plot = p_pha_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_s_c_brt_add.png", plot = p_pha_sec_s_c_brt_add, width = 6, height = 5)

### conduct_before
p_cb_sec_s_brt_add <- ggplot(cb_sec_s_brt_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_s_c_brt_add <- ggplot(cb_sec_s_brt_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_s_brt_add.png", plot = p_cb_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_s_c_brt_add.png", plot = p_cb_sec_s_c_brt_add, width = 6, height = 5)

### conduct_during
p_cd_sec_s_brt_add <- ggplot(cd_sec_s_brt_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_s_c_brt_add <- ggplot(cd_sec_s_brt_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_s_brt_add.png", plot = p_cd_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_s_c_brt_add.png", plot = p_cd_sec_s_c_brt_add, width = 6, height = 5)

### conduct_after
p_ca_sec_s_brt_add <- ggplot(ca_sec_s_brt_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_s_c_brt_add <- ggplot(ca_sec_s_brt_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_s_brt_add.png", plot = p_ca_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_s_c_brt_add.png", plot = p_ca_sec_s_c_brt_add, width = 6, height = 5)

### ox_before
p_ob_sec_s_brt_add <- ggplot(ob_sec_s_brt_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_s_c_brt_add <- ggplot(ob_sec_s_brt_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_s_brt_add.png", plot = p_ob_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_s_c_brt_add.png", plot = p_ob_sec_s_c_brt_add, width = 6, height = 5)

### ox_during
p_od_sec_s_brt_add <- ggplot(od_sec_s_brt_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_s_c_brt_add <- ggplot(od_sec_s_brt_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_s_brt_add.png", plot = p_od_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_s_c_brt_add.png", plot = p_od_sec_s_c_brt_add, width = 6, height = 5)

### ox_after
p_oa_sec_s_brt_add <- ggplot(oa_sec_s_brt_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_s_c_brt_add <- ggplot(oa_sec_s_brt_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_s_brt_add.png", plot = p_oa_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_s_c_brt_add.png", plot = p_oa_sec_s_c_brt_add, width = 6, height = 5)

### turb_before
p_tb_sec_s_brt_add <- ggplot(tb_sec_s_brt_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_s_c_brt_add <- ggplot(tb_sec_s_c_brt_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_s_brt_add.png", plot = p_tb_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_s_c_brt_add.png", plot = p_tb_sec_s_c_brt_add, width = 6, height = 5)

### turb_during
p_td_sec_s_brt_add <- ggplot(td_sec_s_brt_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_s_c_brt_add <- ggplot(td_sec_s_brt_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_s_brt_add.png", plot = p_td_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_s_c_brt_add.png", plot = p_td_sec_s_c_brt_add, width = 6, height = 5)

### turb_after
p_ta_sec_s_brt_add <- ggplot(ta_sec_s_brt_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_s_c_brt_add <- ggplot(ta_sec_s_brt_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_s_brt_add.png", plot = p_ta_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_s_c_brt_add.png", plot = p_ta_sec_s_c_brt_add, width = 6, height = 5)

### temp_before
p_teb_sec_s_brt_add <- ggplot(teb_sec_s_brt_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_s_c_brt_add <- ggplot(teb_sec_s_brt_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_s_brt_add.png", plot = p_teb_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_s_c_brt_add.png", plot = p_teb_sec_s_c_brt_add, width = 6, height = 5)

### temp_during
p_ted_sec_s_brt_add <- ggplot(ted_sec_s_brt_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_s_c_brt_add <- ggplot(ted_sec_s_brt_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_s_brt_add.png", plot = p_ted_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_s_c_brt_add.png", plot = p_ted_sec_s_c_brt_add, width = 6, height = 5)

### temp_after
p_tea_sec_s_brt_add <- ggplot(tea_sec_s_brt_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_s_c_brt_add <- ggplot(tea_sec_s_brt_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_s_brt_add.png", plot = p_tea_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_s_c_brt_add.png", plot = p_tea_sec_s_c_brt_add, width = 6, height = 5)

### q_before
p_qb_sec_s_brt_add <- ggplot(qb_sec_s_brt_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_s_c_brt_add <- ggplot(qb_sec_s_brt_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_s_brt_add.png", plot = p_qb_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_s_c_brt_add.png", plot = p_qb_sec_s_c_brt_add, width = 6, height = 5)

### q_during
p_qd_sec_s_brt_add <- ggplot(qd_sec_s_brt_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_s_c_brt_add <- ggplot(qd_sec_s_brt_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_s_brt_add.png", plot = p_qd_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_s_c_brt_add.png", plot = p_qd_sec_s_c_brt_add, width = 6, height = 5)

### q_after
p_qa_sec_s_brt_add <- ggplot(qa_sec_s_brt_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_s_c_brt_add <- ggplot(qa_sec_s_brt_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_s_brt_add.png", plot = p_qa_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_s_c_brt_add.png", plot = p_qa_sec_s_c_brt_add, width = 6, height = 5)

### gaug_before
p_gb_sec_s_brt_add <- ggplot(gb_sec_s_brt_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_s_c_brt_add <- ggplot(gb_sec_s_brt_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_s_brt_add.png", plot = p_gb_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_s_c_brt_add.png", plot = p_gb_sec_s_c_brt_add, width = 6, height = 5)

### gaug_during
p_gd_sec_s_brt_add <- ggplot(gd_sec_s_brt_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_s_c_brt_add <- ggplot(gd_sec_s_brt_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_s_brt_add.png", plot = p_gd_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_s_c_brt_add.png", plot = p_gd_sec_s_c_brt_add, width = 6, height = 5)

### gaug_after
p_ga_sec_s_brt_add <- ggplot(ga_sec_s_brt_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_s_c_brt_add <- ggplot(ga_sec_s_brt_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_s_brt_add.png", plot = p_ga_sec_s_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_s_c_brt_add.png", plot = p_ga_sec_s_c_brt_add, width = 6, height = 5)

# With abundance as response --------------------------------------------------
### froude 
p_f_sec_a_brt_add <- ggplot(f_sec_a_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
p_f_sec_a_c_brt_add <- ggplot(f_sec_a_c_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_sec_a_brt_add.png", plot = p_f_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_sec_a_c_brt_add.png", plot = p_f_sec_a_c_brt_add, width = 6, height = 5)

### shear_stress 
p_s_sec_a_brt_add <- ggplot(s_sec_a_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
p_s_sec_a_c_brt_add <- ggplot(s_sec_a_c_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_sec_a_brt_add.png", plot = p_s_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_sec_a_c_brt_add.png", plot = p_s_sec_a_c_brt_add, width = 6, height = 5)

### stream_power 
p_sp_sec_a_brt_add <- ggplot(sp_sec_a_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
p_sp_sec_a_c_brt_add <- ggplot(sp_sec_a_c_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_sec_a_brt_add.png", plot = p_sp_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sp_sec_a_c_brt_add.png", plot = p_sp_sec_a_c_brt_add, width = 6, height = 5)

### velocity
p_v_sec_a_brt_add <- ggplot(v_sec_a_brt_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_a_c_brt_add <- ggplot(v_sec_a_c_brt_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_a_brt_add.png", plot = p_v_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_a_c_brt_add.png", plot = p_v_sec_a_c_brt_add, width = 6, height = 5)

### wd_m 
p_wd_sec_a_brt_add <- ggplot(wd_sec_a_brt_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_a_c_brt_add <- ggplot(wd_sec_a_c_brt_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_a_brt_add.png", plot = p_wd_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_a_c_brt_add.png", plot = p_wd_sec_a_c_brt_add, width = 6, height = 5)

### x/y
p_x_sec_a_brt_add <- ggplot(x_sec_a_brt_add, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_a_brt_add <- ggplot(y_sec_a_brt_add, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_a_brt_add.png", plot = p_x_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_a_brt_add.png", plot = p_y_sec_a_brt_add, width = 6, height = 5)

### z 
p_z_sec_a_brt_add <- ggplot(z_sec_a_brt_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_a_c_brt_add <- ggplot(z_sec_a_c_brt_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_a_brt_add.png", plot = p_z_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_a_c_brt_add.png", plot = p_z_sec_a_c_brt_add, width = 6, height = 5)

### dist_w 
p_dist_sec_a_brt_add <- ggplot(dist_sec_a_brt_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_a_c_brt_add <- ggplot(dist_sec_a_brt_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_a_brt_add.png", plot = p_dist_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_a_c_brt_add.png", plot = p_dist_sec_a_c_brt_add, width = 6, height = 5)

### cat_v
p_cv_sec_a_brt_add <- ggplot(cv_sec_a_brt_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_a_c_brt_add <- ggplot(cv_sec_a_brt_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_a_brt_add.png", plot = p_cv_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_a_c_brt_add.png", plot = p_cv_sec_a_c_brt_add, width = 6, height = 5)

### alg_cover 
p_ac_sec_a_brt_add <- ggplot(ac_sec_a_brt_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_a_c_brt_add <- ggplot(ac_sec_a_brt_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_a_brt_add.png", plot = p_ac_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_a_c_brt_add.png", plot = p_ac_sec_a_c_brt_add, width = 6, height = 5)

### moos_cover
p_mc_sec_a_brt_add <- ggplot(mc_sec_a_brt_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_a_c_brt_add <- ggplot(mc_sec_a_brt_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_a_brt_add.png", plot = p_mc_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_a_c_brt_add.png", plot = p_mc_sec_a_c_brt_add, width = 6, height = 5)

### cpom_cover 
p_cc_sec_a_brt_add <- ggplot(cc_sec_a_brt_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_a_c_brt_add <- ggplot(cc_sec_a_brt_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_a_brt_add.png", plot = p_cc_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_a_c_brt_add.png", plot = p_cc_sec_a_c_brt_add, width = 6, height = 5)

### clog_3 
p_clog_3_sec_a_brt_add <- ggplot(clog_3_sec_a_brt_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_a_c_brt_add <- ggplot(clog_3_sec_a_brt_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_a_brt_add.png", plot = p_clog_3_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_a_c_brt_add.png", plot = p_clog_3_sec_a_c_brt_add, width = 6, height = 5)

### clog_6 
p_clog_6_sec_a_brt_add <- ggplot(clog_6_sec_a_brt_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_a_c_brt_add <- ggplot(clog_6_sec_a_brt_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_a_brt_add.png", plot = p_clog_6_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_a_c_brt_add.png", plot = p_clog_6_sec_a_c_brt_add, width = 6, height = 5)

### sub_type
p_sub_sec_a_brt_add <- ggplot(sub_sec_a_brt_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_a_c_brt_add <- ggplot(sub_sec_a_brt_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_a_brt_add.png", plot = p_sub_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_a_c_brt_add.png", plot = p_sub_sec_a_c_brt_add, width = 6, height = 5)

### pH_before
p_phb_sec_a_brt_add <- ggplot(phb_sec_a_brt_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_a_c_brt_add <- ggplot(phb_sec_a_brt_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_a_brt_add.png", plot = p_phb_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_a_c_brt_add.png", plot = p_phb_sec_a_c_brt_add, width = 6, height = 5)

### pH_during
p_phd_sec_a_brt_add <- ggplot(phd_sec_a_brt_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_a_c_brt_add <- ggplot(phd_sec_a_brt_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_a_brt_add.png", plot = p_phd_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_a_c_brt_add.png", plot = p_phd_sec_a_c_brt_add, width = 6, height = 5)

### pH_after
p_pha_sec_a_brt_add <- ggplot(pha_sec_a_brt_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_a_c_brt_add <- ggplot(pha_sec_a_brt_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_a_brt_add.png", plot = p_pha_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_a_c_brt_add.png", plot = p_pha_sec_a_c_brt_add, width = 6, height = 5)

### conduct_before
p_cb_sec_a_brt_add <- ggplot(cb_sec_a_brt_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_a_c_brt_add <- ggplot(cb_sec_a_brt_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_a_brt_add.png", plot = p_cb_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_a_c_brt_add.png", plot = p_cb_sec_a_c_brt_add, width = 6, height = 5)

### conduct_during
p_cd_sec_a_brt_add <- ggplot(cd_sec_a_brt_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_a_c_brt_add <- ggplot(cd_sec_a_brt_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_a_brt_add.png", plot = p_cd_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_a_c_brt_add.png", plot = p_cd_sec_a_c_brt_add, width = 6, height = 5)

### conduct_after
p_ca_sec_a_brt_add <- ggplot(ca_sec_a_brt_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_a_c_brt_add <- ggplot(ca_sec_a_brt_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_a_brt_add.png", plot = p_ca_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_a_c_brt_add.png", plot = p_ca_sec_a_c_brt_add, width = 6, height = 5)

### ox_before
p_ob_sec_a_brt_add <- ggplot(ob_sec_a_brt_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_a_c_brt_add <- ggplot(ob_sec_a_brt_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_a_brt_add.png", plot = p_ob_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_a_c_brt_add.png", plot = p_ob_sec_a_c_brt_add, width = 6, height = 5)

### ox_during
p_od_sec_a_brt_add <- ggplot(od_sec_a_brt_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_a_c_brt_add <- ggplot(od_sec_a_brt_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_a_brt_add.png", plot = p_od_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_a_c_brt_add.png", plot = p_od_sec_a_c_brt_add, width = 6, height = 5)

### ox_after
p_oa_sec_a_brt_add <- ggplot(oa_sec_a_brt_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_a_c_brt_add <- ggplot(oa_sec_a_brt_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_a_brt_add.png", plot = p_oa_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_a_c_brt_add.png", plot = p_oa_sec_a_c_brt_add, width = 6, height = 5)

### turb_before
p_tb_sec_a_brt_add <- ggplot(tb_sec_a_brt_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_a_c_brt_add <- ggplot(tb_sec_a_brt_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_a_brt_add.png", plot = p_tb_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_a_c_brt_add.png", plot = p_tb_sec_a_c_brt_add, width = 6, height = 5)

### turb_during
p_td_sec_a_brt_add <- ggplot(td_sec_a_brt_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_a_c_brt_add <- ggplot(td_sec_a_brt_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_a_brt_add.png", plot = p_td_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_a_c_brt_add.png", plot = p_td_sec_a_c_brt_add, width = 6, height = 5)

### turb_after
p_ta_sec_a_brt_add <- ggplot(ta_sec_a_brt_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_a_c_brt_add <- ggplot(ta_sec_a_brt_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_a_brt_add.png", plot = p_ta_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_a_c_brt_add.png", plot = p_ta_sec_a_c_brt_add, width = 6, height = 5)

### temp_before
p_teb_sec_a_brt_add <- ggplot(teb_sec_a_brt_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_a_c_brt_add <- ggplot(teb_sec_a_brt_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_a_brt_add.png", plot = p_teb_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_a_c_brt_add.png", plot = p_teb_sec_a_c_brt_add, width = 6, height = 5)

### temp_during
p_ted_sec_a_brt_add <- ggplot(ted_sec_a_brt_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_a_c_brt_add <- ggplot(ted_sec_a_brt_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_a_brt_add.png", plot = p_ted_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_a_c_brt_add.png", plot = p_ted_sec_a_c_brt_add, width = 6, height = 5)

### temp_after
p_tea_sec_a_brt_add <- ggplot(tea_sec_a_brt_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_a_c_brt_add <- ggplot(tea_sec_a_brt_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_a_brt_add.png", plot = p_tea_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_a_c_brt_add.png", plot = p_tea_sec_a_c_brt_add, width = 6, height = 5)

### q_before
p_qb_sec_a_brt_add <- ggplot(qb_sec_a_brt_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_a_c_brt_add <- ggplot(qb_sec_a_brt_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_a_brt_add.png", plot = p_qb_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_a_c_brt_add.png", plot = p_qb_sec_a_c_brt_add, width = 6, height = 5)

### q_during
p_qd_sec_a_brt_add <- ggplot(qd_sec_a_brt_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_a_c_brt_add <- ggplot(qd_sec_a_brt_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_a_brt_add.png", plot = p_qd_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_a_c_brt_add.png", plot = p_qd_sec_a_c_brt_add, width = 6, height = 5)

### q_after
p_qa_sec_a_brt_add <- ggplot(qa_sec_a_brt_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_a_c_brt_add <- ggplot(qa_sec_a_brt_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_a_brt_add.png", plot = p_qa_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_a_c_brt_add.png", plot = p_qa_sec_a_c_brt_add, width = 6, height = 5)

### gaug_before
p_gb_sec_a_brt_add <- ggplot(gb_sec_a_brt_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_a_c_brt_add <- ggplot(gb_sec_a_brt_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_a_brt_add.png", plot = p_gb_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_a_c_brt_add.png", plot = p_gb_sec_a_c_brt_add, width = 6, height = 5)

### gaug_during
p_gd_sec_a_brt_add <- ggplot(gd_sec_a_brt_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_a_c_brt_add <- ggplot(gd_sec_a_brt_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_a_brt_add.png", plot = p_gd_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_a_c_brt_add.png", plot = p_gd_sec_a_c_brt_add, width = 6, height = 5)

### gaug_after
p_ga_sec_a_brt_add <- ggplot(ga_sec_a_brt_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_a_c_brt_add <- ggplot(ga_sec_a_brt_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_a_brt_add.png", plot = p_ga_sec_a_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ga_sec_a_c_brt_add.png", plot = p_ga_sec_a_c_brt_add, width = 6, height = 5)

# With rel_abundance as response --------------------------------------------------
### froude 
p_f_sec_ra_brt_add <- ggplot(f_sec_ra_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
p_f_sec_ra_c_brt_add <- ggplot(f_sec_ra_c_brt_add, aes(froude, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Froude",
...
# save the plots 
ggsave("ML_model/plots/pdp_f_sec_ra_brt_add.png", plot = p_f_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_f_sec_ra_c_brt_add.png", plot = p_f_sec_ra_c_brt_add, width = 6, height = 5)

### shear_stress 
p_s_sec_ra_brt_add <- ggplot(s_sec_ra_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
p_s_sec_ra_c_brt_add <- ggplot(s_sec_ra_c_brt_add, aes(shear_stress, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Shear Stress",
...
# save the plots 
ggsave("ML_model/plots/pdp_s_sec_ra_brt_add.png", plot = p_s_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_s_sec_ra_c_brt_add.png", plot = p_s_sec_ra_c_brt_add, width = 6, height = 5)

### stream_power 
p_sp_sec_ra_brt_add <- ggplot(sp_sec_ra_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
p_sp_sec_ra_c_brt_add <- ggplot(sp_sec_ra_c_brt_add, aes(stream_power, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Stream Power",
...
# save the plots 
ggsave("ML_model/plots/pdp_sp_sec_ra_brt_add.png", plot = p_sp_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sp_sec_ra_c_brt_add.png", plot = p_sp_sec_ra_c_brt_add, width = 6, height = 5)

### velocity
p_v_sec_ra_brt_add <- ggplot(v_sec_ra_brt_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
p_v_sec_ra_c_brt_add <- ggplot(v_sec_ra_c_brt_add, aes(velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Velocity (m/s)",
...
# save the plots 
ggsave("ML_model/plots/pdp_v_sec_ra_brt_add.png", plot = p_v_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_v_sec_ra_c_brt_add.png", plot = p_v_sec_ra_c_brt_add, width = 6, height = 5)

### wd_m 
p_wd_sec_ra_brt_add <- ggplot(wd_sec_ra_brt_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
p_wd_sec_ra_c_brt_add <- ggplot(wd_sec_ra_c_brt_add, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_wd_sec_ra_brt_add.png", plot = p_wd_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_wd_sec_ra_c_brt_add.png", plot = p_wd_sec_ra_c_brt_add, width = 6, height = 5)


### x/y
p_x_sec_ra_brt_add <- ggplot(x_sec_ra_brt_add, aes(x, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "X Coordinate (CH1903+/LV95)",
...
p_y_sec_ra_brt_add <- ggplot(y_sec_ra_brt_add, aes(y, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Y Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_x_sec_ra_brt_add.png", plot = p_x_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_y_sec_ra_brt_add.png", plot = p_y_sec_ra_brt_add, width = 6, height = 5)

### z 
p_z_sec_ra_brt_add <- ggplot(z_sec_ra_brt_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
p_z_sec_ra_c_brt_add <- ggplot(z_sec_ra_c_brt_add, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Z Coordinate (CH1903+/LV95)",
...
# save the plots 
ggsave("ML_model/plots/pdp_z_sec_ra_brt_add.png", plot = p_z_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_z_sec_ra_c_brt_add.png", plot = p_z_sec_ra_c_brt_add, width = 6, height = 5)

### dist_w 
p_dist_sec_ra_brt_add <- ggplot(dist_sec_ra_brt_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
p_dist_sec_ra_c_brt_add <- ggplot(dist_sec_ra_brt_add, aes(dist_w, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Distance Waterline (m)",
...
# save the plots 
ggsave("ML_model/plots/pdp_dist_sec_ra_brt_add.png", plot = p_dist_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_dist_sec_ra_c_brt_add.png", plot = p_dist_sec_ra_c_brt_add, width = 6, height = 5)

### cat_v
p_cv_sec_ra_brt_add <- ggplot(cv_sec_ra_brt_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
p_cv_sec_ra_c_brt_add <- ggplot(cv_sec_ra_brt_add, aes(cat_velocity, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Category Velocity Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cv_sec_ra_brt_add.png", plot = p_cv_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cv_sec_ra_c_brt_add.png", plot = p_cv_sec_ra_c_brt_add, width = 6, height = 5)

### alg_cover 
p_ac_sec_ra_brt_add <- ggplot(ac_sec_ra_brt_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
p_ac_sec_ra_c_brt_add <- ggplot(ac_sec_ra_brt_add, aes(alg_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Algea Cover Class (1-5)",
...
# save the plots 
ggsave("ML_model/plots/pdp_ac_sec_ra_brt_add.png", plot = p_ac_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ac_sec_ra_c_brt_add.png", plot = p_ac_sec_ra_c_brt_add, width = 6, height = 5)

### moos_cover
p_mc_sec_ra_brt_add <- ggplot(mc_sec_ra_brt_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
p_mc_sec_ra_c_brt_add <- ggplot(mc_sec_ra_brt_add, aes(moos_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Moos Cover Class (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_mc_sec_ra_brt_add.png", plot = p_mc_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_mc_sec_ra_c_brt_add.png", plot = p_mc_sec_ra_c_brt_add, width = 6, height = 5)

### cpom_cover 
p_cc_sec_ra_brt_add <- ggplot(cc_sec_ra_brt_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
p_cc_sec_ra_c_brt_add <- ggplot(cc_sec_ra_brt_add, aes(cpom_cover, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "CPOM Cover Class (1-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_cc_sec_ra_brt_add.png", plot = p_cc_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cc_sec_ra_c_brt_add.png", plot = p_cc_sec_ra_c_brt_add, width = 6, height = 5)

### clog_3 
p_clog_3_sec_ra_brt_add <- ggplot(clog_3_sec_ra_brt_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
p_clog_3_sec_ra_c_brt_add <- ggplot(clog_3_sec_ra_brt_add, aes(clog_3_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 3 Class (0-2)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_3_sec_ra_brt_add.png", plot = p_clog_3_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_3_sec_ra_c_brt_add.png", plot = p_clog_3_sec_ra_c_brt_add, width = 6, height = 5)

### clog_6 
p_clog_6_sec_ra_brt_add <- ggplot(clog_6_sec_ra_brt_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
p_clog_6_sec_ra_c_brt_add <- ggplot(clog_6_sec_ra_brt_add, aes(clog_6_class_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Clogging 6 Class (0-6)",
...
# save the plots 
ggsave("ML_model/plots/pdp_clog_6_sec_ra_brt_add.png", plot = p_clog_6_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_clog_6_sec_ra_c_brt_add.png", plot = p_clog_6_sec_ra_c_brt_add, width = 6, height = 5)

### sub_type
p_sub_sec_ra_brt_add <- ggplot(sub_sec_ra_brt_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
p_sub_sec_ra_c_brt_add <- ggplot(sub_sec_ra_brt_add, aes(sub_type_int, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Substrate Type (0-3)",
...
# save the plots 
ggsave("ML_model/plots/pdp_sub_sec_ra_brt_add.png", plot = p_sub_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_sub_sec_ra_c_brt_add.png", plot = p_sub_sec_ra_c_brt_add, width = 6, height = 5)

### pH_before
p_phb_sec_ra_brt_add <- ggplot(phb_sec_ra_brt_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
p_phb_sec_ra_c_brt_add <- ggplot(phb_sec_ra_brt_add, aes(pH_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phb_sec_ra_brt_add.png", plot = p_phb_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phb_sec_ra_c_brt_add.png", plot = p_phb_sec_ra_c_brt_add, width = 6, height = 5)

### pH_during
p_phd_sec_ra_brt_add <- ggplot(phd_sec_ra_brt_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
p_phd_sec_ra_c_brt_add <- ggplot(phd_sec_ra_brt_add, aes(pH_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_phd_sec_ra_brt_add.png", plot = p_phd_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_phd_sec_ra_c_brt_add.png", plot = p_phd_sec_ra_c_brt_add, width = 6, height = 5)

### pH_after
p_pha_sec_ra_brt_add <- ggplot(pha_sec_ra_brt_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
p_pha_sec_ra_c_brt_add <- ggplot(pha_sec_ra_brt_add, aes(pH_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "pH after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_pha_sec_ra_brt_add.png", plot = p_pha_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_pha_sec_ra_c_brt_add.png", plot = p_pha_sec_ra_c_brt_add, width = 6, height = 5)

### conduct_before
p_cb_sec_ra_brt_add <- ggplot(cb_sec_ra_brt_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
p_cb_sec_ra_c_brt_add <- ggplot(cb_sec_ra_brt_add, aes(conduct_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cb_sec_ra_brt_add.png", plot = p_cb_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cb_sec_ra_c_brt_add.png", plot = p_cb_sec_ra_c_brt_add, width = 6, height = 5)

### conduct_during
p_cd_sec_ra_brt_add <- ggplot(cd_sec_ra_brt_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
p_cd_sec_ra_c_brt_add <- ggplot(cd_sec_ra_brt_add, aes(conduct_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_cd_sec_ra_brt_add.png", plot = p_cd_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_cd_sec_ra_c_brt_add.png", plot = p_cd_sec_ra_c_brt_add, width = 6, height = 5)

### conduct_after
p_ca_sec_ra_brt_add <- ggplot(ca_sec_ra_brt_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
p_ca_sec_ra_c_brt_add <- ggplot(ca_sec_ra_brt_add, aes(conduct_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Conduction after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ca_sec_ra_brt_add.png", plot = p_ca_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ca_sec_ra_c_brt_add.png", plot = p_ca_sec_ra_c_brt_add, width = 6, height = 5)

### ox_before
p_ob_sec_ra_brt_add <- ggplot(ob_sec_ra_brt_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
p_ob_sec_ra_c_brt_add <- ggplot(ob_sec_ra_brt_add, aes(ox_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ob_sec_ra_brt_add.png", plot = p_ob_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ob_sec_ra_c_brt_add.png", plot = p_ob_sec_ra_c_brt_add, width = 6, height = 5)

### ox_during
p_od_sec_ra_brt_add <- ggplot(od_sec_ra_brt_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
p_od_sec_ra_c_brt_add <- ggplot(od_sec_ra_brt_add, aes(ox_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_od_sec_ra_brt_add.png", plot = p_od_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_od_sec_ra_c_brt_add.png", plot = p_od_sec_ra_c_brt_add, width = 6, height = 5)

### ox_after
p_oa_sec_ra_brt_add <- ggplot(oa_sec_ra_brt_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
p_oa_sec_ra_c_brt_add <- ggplot(oa_sec_ra_brt_add, aes(ox_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Oxygen after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_oa_sec_ra_brt_add.png", plot = p_oa_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_oa_sec_ra_c_brt_add.png", plot = p_oa_sec_ra_c_brt_add, width = 6, height = 5)

### turb_before
p_tb_sec_ra_brt_add <- ggplot(tb_sec_ra_brt_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
p_tb_sec_ra_c_brt_add <- ggplot(tb_sec_ra_brt_add, aes(turb_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tb_sec_ra_brt_add.png", plot = p_tb_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tb_sec_ra_c_brt_add.png", plot = p_tb_sec_ra_c_brt_add, width = 6, height = 5)

### turb_during
p_td_sec_ra_brt_add <- ggplot(td_sec_ra_brt_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
p_td_sec_ra_c_brt_add <- ggplot(td_sec_ra_brt_add, aes(turb_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_td_sec_ra_brt_add.png", plot = p_td_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_td_sec_ra_c_brt_add.png", plot = p_td_sec_ra_c_brt_add, width = 6, height = 5)

### turb_after
p_ta_sec_ra_brt_add <- ggplot(ta_sec_ra_brt_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
p_ta_sec_ra_c_brt_add <- ggplot(ta_sec_ra_brt_add, aes(turb_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Turbidity [NTU] after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ta_sec_ra_brt_add.png", plot = p_ta_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ta_sec_ra_c_brt_add.png", plot = p_ta_sec_ra_c_brt_add, width = 6, height = 5)

### temp_before
p_teb_sec_ra_brt_add <- ggplot(teb_sec_ra_brt_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
p_teb_sec_ra_c_brt_add <- ggplot(teb_sec_ra_brt_add, aes(temp_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_teb_sec_ra_brt_add.png", plot = p_teb_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_teb_sec_ra_c_brt_add.png", plot = p_teb_sec_ra_c_brt_add, width = 6, height = 5)

### temp_during
p_ted_sec_ra_brt_add <- ggplot(ted_sec_ra_brt_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
p_ted_sec_ra_c_brt_add <- ggplot(ted_sec_ra_brt_add, aes(temp_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ted_sec_ra_brt_add.png", plot = p_ted_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_ted_sec_ra_c_brt_add.png", plot = p_ted_sec_ra_c_brt_add, width = 6, height = 5)

### temp_after
p_tea_sec_ra_brt_add <- ggplot(tea_sec_ra_brt_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
p_tea_sec_ra_c_brt_add <- ggplot(tea_sec_ra_brt_add, aes(temp_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Temperature (°C) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_tea_sec_ra_brt_add.png", plot = p_tea_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_tea_sec_ra_c_brt_add.png", plot = p_tea_sec_ra_c_brt_add, width = 6, height = 5)

### q_before
p_qb_sec_ra_brt_add <- ggplot(qb_sec_ra_brt_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
p_qb_sec_ra_c_brt_add <- ggplot(qb_sec_ra_brt_add, aes(q_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qb_sec_ra_brt_add.png", plot = p_qb_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qb_sec_ra_c_brt_add.png", plot = p_qb_sec_ra_c_brt_add, width = 6, height = 5)

### q_during
p_qd_sec_ra_brt_add <- ggplot(qd_sec_ra_brt_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
p_qd_sec_ra_c_brt_add <- ggplot(qd_sec_ra_brt_add, aes(q_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qd_sec_ra_brt_add.png", plot = p_qd_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qd_sec_ra_c_brt_add.png", plot = p_qd_sec_ra_c_brt_add, width = 6, height = 5)

### q_after
p_qa_sec_ra_brt_add <- ggplot(qa_sec_ra_brt_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
p_qa_sec_ra_c_brt_add <- ggplot(qa_sec_ra_brt_add, aes(q_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_qa_sec_ra_brt_add.png", plot = p_qa_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_qa_sec_ra_c_brt_add.png", plot = p_qa_sec_ra_c_brt_add, width = 6, height = 5)

### gaug_before
p_gb_sec_ra_brt_add <- ggplot(gb_sec_ra_brt_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
p_gb_sec_ra_c_brt_add <- ggplot(gb_sec_ra_brt_add, aes(gaug_before, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station before Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gb_sec_ra_brt_add.png", plot = p_gb_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gb_sec_ra_c_brt_add.png", plot = p_gb_sec_ra_c_brt_add, width = 6, height = 5)

### gaug_during
p_gd_sec_ra_brt_add <- ggplot(gd_sec_ra_brt_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
p_gd_sec_ra_c_brt_add <- ggplot(gd_sec_ra_brt_add, aes(gaug_during, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station during Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_gd_sec_ra_brt_add.png", plot = p_gd_sec_ra_brt_add, width = 6, height = 5)
ggsave("ML_model/plots/pdp_gd_sec_ra_c_brt_add.png", plot = p_gd_sec_ra_c_brt_add, width = 6, height = 5)

### gaug_after
p_ga_sec_ra_brt_add <- ggplot(ga_sec_ra_brt_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
p_ga_sec_ra_c_brt_add <- ggplot(ga_sec_ra_brt_add, aes(gaug_after, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Discharge (m3/s) at Gauging Station after Sampling",
...
# save the plots 
ggsave("ML_model/plots/pdp_ga_sec_ra_brt_add.png", plot = p_ga_sec_ra_brt_add, width = 6, height = 5)
...
v_k_rf <- v_k_rf |>
  mutate(mod = "random forest / v")

v_k_rf_add <- v_k_rf_add |>
  mutate(mod = "random forest / v add")

v_k_brt <- v_k_brt |>
  mutate(mod = "brt / v")

v_k_brt_add <- v_k_brt_add |>
  mutate(mod = "brt / v add")
...
mod_k_wd <- rbind(wd_k_rf, wd_k_rf_add, wd_k_brt, wd_k_brt_add)
mod_k_wd_c <- rbind(wd_k_c_rf, wd_k_c_rf_add, wd_k_c_brt, wd_k_c_brt_add)

mod_k_x <- rbind(x_k_rf, x_k_rf_add, x_k_brt, x_k_brt_add)
mod_k_y <- rbind(y_k_rf, y_k_rf_add, y_k_brt, y_k_brt_add)
```
