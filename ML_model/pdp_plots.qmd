...
# With k_index as response ----------------------------------------------------
### velocity 
p_v_var_k_c_rf <- ggplot(v_var_k_c_rf, aes(velocity, yhat)) + 
...
### wd_m 
p_wd_var_k_c_rf <- ggplot(wd_var_k_c_rf, aes(x = wd_m, y = yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
    x = "Water Depth (m)",
...
### z 
p_z_var_k_c_rf <- ggplot(z_var_k_c_rf, aes(z, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
...
### Nitrogen
p_n_var_k_c_rf <- ggplot(n_var_k_c_rf, aes(mean_diff_nitrogen, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
...
### phosphor
p_p_var_k_c_rf <- ggplot(p_var_k_c_rf, aes(mean_diff_phosphor, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line() + 
  labs(
...
### ecomorph_class
p_e_var_k_c_rf <- ggplot(e_var_k_c_rf, aes(ecomorph, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
...
p_b_var_k_c_rf <- ggplot(b_var_k_c_rf, aes(biogeo_order, yhat)) + 
  # yhat ist die response variable (k-index, simpson oder shannon)
  geom_line(aes(group = 1)) + 
  labs(
    x = "Bioregion",
...
# Load WUA / HHS Data
```{r}
wua_hhs <- read_delim("ML_Model/scenarios/wua_hhs_shannon_vbrt.csv") 
```

## Plots
```{r}
# WUA Plot --------------------------------------------------------
ggplot(wua_hhs, aes(x = discharge, y = wua, col = section)) +
  geom_line(aes(x = discharge, y = wua, linetype = section), lwd = 0.6) +
  geom_point() +
  theme_minimal()

# HHS Plot --------------------------------------------------------
ggplot(wua_hhs, aes(x = discharge, y = hhs, col = section)) +
  geom_line() +
  geom_point()
```
