...
# HHS Plot --------------------------------------------------------
hhs <- ggplot(wua_hhs, aes(x = Q, y = hhs, col = section)) +
  geom_line() +
  geom_point() + 
  labs(
    x = "Discharge [m3/s]",
...
# save the plots 
ggsave("Stat_Analysis/plots/wua.png", plot = wua, width = 7, height = 5)
ggsave("Stat_Analysis/plots/hhs.png", plot = hhs, width = 7, height = 5)
```
