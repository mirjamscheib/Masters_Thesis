...
#   mtry sample.fraction min.node.size 
#1:    2       0.2344958            10                  
rf_model_samp_s <- ranger(formula = shannon ~., data = training_samp_s, mtry = 2, sample.fraction = 0.2344958, min.node.size = 10, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    5       0.4502511             2                  
rf_model_samp_a <- ranger(formula = abundance ~., data = training_samp_a, mtry = 5, sample.fraction = 0.4502511, min.node.size = 2, importance = "impurity")

# With rel_abundance as response
#   mtry sample.fraction min.node.size 
#1:    6       0.7228589             2                    
rf_model_samp_ra <- ranger(formula = rel_abundance ~., data = training_samp_ra, mtry = 6, sample.fraction = 0.7228589, min.node.size = 2, importance = "impurity")
...
#   mtry sample.fraction min.node.size 
#1:    6       0.8348447             1                   
rf_model_sec_s <- ranger(formula = shannon ~., data = training_sec_s, mtry = 6, sample.fraction = 0.8348447, min.node.size = 1, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    2       0.5495946             3                   
rf_model_sec_a <- ranger(formula = abundance ~., data = training_sec_a, mtry = 2, sample.fraction = 0.5495946, min.node.size = 3, importance = "impurity")
...
#   mtry sample.fraction min.node.size 
#1:    2       0.2344958            10                  
rf_model_samp_s_c <- ranger(formula = shannon ~., data = training_samp_s_c, mtry = 2, sample.fraction = 0.2344958, min.node.size = 10, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    5       0.4502511             2                  
rf_model_samp_a_c <- ranger(formula = abundance ~., data = training_samp_a_c, mtry = 5, sample.fraction = 0.4502511, min.node.size = 2, importance = "impurity")

# With rel_abundance as response
#   mtry sample.fraction min.node.size 
#1:    6       0.7228589             2                    
rf_model_samp_ra_c <- ranger(formula = rel_abundance ~., data = training_samp_ra_c, mtry = 6, sample.fraction = 0.7228589, min.node.size = 2, importance = "impurity")
...
#   mtry sample.fraction min.node.size 
#1:    6       0.8348447             1                   
rf_model_sec_s_c <- ranger(formula = shannon ~., data = training_sec_s_c, mtry = 6, sample.fraction = 0.8348447, min.node.size = 1, importance = "impurity")
