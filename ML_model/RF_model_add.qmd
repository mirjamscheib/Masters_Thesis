...
# Ranger Models 
## Ranger w/ coordinates 
```{r}
### PREDICTOR: VELOCITY ### --------------------------------------------------
# With k_index as response
#   mtry sample.fraction min.node.size 
#1:    2       0.2059293            10          
rf_model_v_k <- ranger(formula = k_index ~., data = training_v_k, mtry = 2, sample.fraction = 0.2059293, min.node.size = 10, importance = "impurity")

# With shannon index as response
#   mtry sample.fraction min.node.size 
#1:    1       0.2443021             5          
rf_model_v_s <- ranger(formula = shannon ~., data = training_v_s, mtry = 1, sample.fraction = 0.2443021, min.node.size = 5, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    4       0.2741381             8         
rf_model_v_a <- ranger(formula = abundance ~., data = training_v_a, mtry = 4, sample.fraction = 0.2741381, min.node.size = 8, importance = "impurity")

# With rel_abundance as response
#   mtry sample.fraction min.node.size 
#1:    4       0.2679696             2         
rf_model_v_ra <- ranger(formula = rel_abundance ~., data = training_v_ra, mtry = 4, sample.fraction = 0.2679696, min.node.size = 2, importance = "impurity")

### PREDICTORS: VELOCITY + WD ### ---------------------------------------------
# With k_index as response
#   mtry sample.fraction min.node.size 
#1:    4       0.2170115             6          
rf_model_wd_k <- ranger(formula = k_index ~., data = training_wd_k, mtry = 4, sample.fraction = 0.2170115, min.node.size = 6, importance = "impurity")

# With shannon index as response
#   mtry sample.fraction min.node.size 
#1:    1       0.2068668             5          
rf_model_wd_s <- ranger(formula = shannon ~., data = training_wd_s, mtry = 1, sample.fraction = 0.2068668, min.node.size = 5, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    4       0.2132617             4          
rf_model_wd_a <- ranger(formula = abundance ~., data = training_wd_a, mtry = 4, sample.fraction = 0.2132617, min.node.size = 4, importance = "impurity")

# With rel_abundance as response
#   mtry sample.fraction min.node.size 
#1:    1       0.2197985             6          
rf_model_wd_ra <- ranger(formula = rel_abundance ~., data = training_wd_ra, mtry = 1, sample.fraction = 0.2197985, min.node.size = 6, importance = "impurity")

### PREDICTORS: SAMPLING LOCATIONS ### ----------------------------------------
# With k_index as response
#   mtry sample.fraction min.node.size 
#1:    1       0.3387031             5          
rf_model_samp_k <- ranger(formula = k_index ~., data = training_samp_k, mtry = 1, sample.fraction = 0.3387031, min.node.size = 5, importance = "impurity")

# With shannon index as response
#   mtry sample.fraction min.node.size 
#1:    1       0.2275265             6          
rf_model_samp_s <- ranger(formula = shannon ~., data = training_samp_s, mtry = 1, sample.fraction = 0.2275265, min.node.size = 6, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:   14       0.4662279             2          
rf_model_samp_a <- ranger(formula = abundance ~., data = training_samp_a, mtry = 14, sample.fraction = 0.4662279, min.node.size = 2, importance = "impurity")

# With rel_abundance as response
#   mtry sample.fraction min.node.size 
#1:    9        0.827493             7          
rf_model_samp_ra <- ranger(formula = rel_abundance ~., data = training_samp_ra, mtry = 9, sample.fraction = 0.827493, min.node.size = 7, importance = "impurity")

### PREDICTORS: ALL PREDICTORS ### --------------------------------------------
# With k_index as response
#   mtry sample.fraction min.node.size 
#1:    1        0.233596             2         
rf_model_sec_k <- ranger(formula = k_index ~., data = training_sec_k, mtry = 1, sample.fraction = 0.233596, min.node.size = 2, importance = "impurity")

# With shannon index as response
#   mtry sample.fraction min.node.size 
#1:    5       0.2253738             7          
rf_model_sec_s <- ranger(formula = shannon ~., data = training_sec_s, mtry = 5, sample.fraction = 0.2253738, min.node.size = 7, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    4       0.2463606             1          
rf_model_sec_a <- ranger(formula = abundance ~., data = training_sec_a, mtry = 4, sample.fraction = 0.2463606, min.node.size = 1, importance = "impurity")

# With rel_abundance as response
#   mtry sample.fraction min.node.size 
#1:    1       0.4203471            10          
rf_model_sec_ra <- ranger(formula = rel_abundance ~., data = training_sec_ra, mtry = 1, sample.fraction = 0.4203471, min.node.size = 10, importance = "impurity")
```
...
#   mtry sample.fraction min.node.size 
#1:    1        0.233596             2         
rf_model_sec_k_c <- ranger(formula = k_index ~., data = training_sec_k_c, mtry = 1, sample.fraction = 0.233596, min.node.size = 2, importance = "impurity")

# With shannon index as response
#   mtry sample.fraction min.node.size 
#1:    5       0.2253738             7          
rf_model_sec_s_c <- ranger(formula = shannon ~., data = training_sec_s_c, mtry = 5, sample.fraction = 0.2253738, min.node.size = 7, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    4       0.2463606             1          
rf_model_sec_a_c <- ranger(formula = abundance ~., data = training_sec_a_c, mtry = 4, sample.fraction = 0.2463606, min.node.size = 1, importance = "impurity")
...
write.csv(vi_rf_model_v, "ML_model/var_imp/vi_rf_model_v_add.csv", row.names = FALSE)
write.csv(vi_rel_rf_model_v, "ML_model/var_imp/vi_rel_rf_model_v_add.csv", row.names = FALSE)
...
write.csv(vi_rf_model_wd, "ML_model/var_imp/vi_rf_model_wd_add.csv", row.names = FALSE)
write.csv(vi_rel_rf_model_wd, "ML_model/var_imp/vi_rel_rf_model_wd_add.csv", row.names = FALSE)
...
write.csv(vi_rf_model_samp, "ML_model/var_imp/vi_rf_model_samp_add.csv", row.names = FALSE)
write.csv(vi_rel_rf_model_samp, "ML_model/var_imp/vi_rel_rf_model_samp_add.csv", row.names = FALSE)
...
write.csv(vi_rf_model_sec, "ML_model/var_imp/vi_rf_model_sec_add.csv", row.names = FALSE)
write.csv(vi_rel_rf_model_sec, "ML_model/var_imp/vi_rel_rf_model_sec_add.csv", row.names = FALSE)
...
### VARIABLE IMPORTANCE FROM AUTOTUNER ### ------------------------------------
### PREDICTOR: VELOCITY ### ---------------------------------------------------
...
# write results into .csv -----------------------------------------------------
write.csv(vi_rf_v, "ML_model/var_imp/vi_rf_v_add.csv", row.names = FALSE)
write.csv(vi_rel_rf_v, "ML_model/var_imp/vi_rel_rf_v_add.csv", row.names = FALSE)

write.csv(vi_rf_wd, "ML_model/var_imp/vi_rf_wd_add.csv", row.names = FALSE)
write.csv(vi_rel_rf_wd, "ML_model/var_imp/vi_rel_rf_wd_add.csv", row.names = FALSE)

write.csv(vi_rf_samp, "ML_model/var_imp/vi_rf_samp_add.csv", row.names = FALSE)
write.csv(vi_rel_rf_samp, "ML_model/var_imp/vi_rel_rf_samp_add.csv", row.names = FALSE)

write.csv(vi_rf_sec, "ML_model/var_imp/vi_rf_sec_add.csv", row.names = FALSE)
write.csv(vi_rel_rf_sec, "ML_model/var_imp/vi_rel_rf_sec_add.csv", row.names = FALSE)
```
...
# export data 
write.csv(pdp_model_v_k, "ML_Model/pdp_data/pdp_v_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_f_v_k, "ML_Model/pdp_data/pdp_f_v_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_s_v_k, "ML_Model/pdp_data/pdp_s_v_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sp_v_k, "ML_Model/pdp_data/pdp_sp_v_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_v_k, "ML_Model/pdp_data/pdp_x_v_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_v_k, "ML_Model/pdp_data/pdp_y_v_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_s, "ML_Model/pdp_data/pdp_v_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_f_v_s, "ML_Model/pdp_data/pdp_f_v_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_s_v_s, "ML_Model/pdp_data/pdp_s_v_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sp_v_s, "ML_Model/pdp_data/pdp_sp_v_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_v_s, "ML_Model/pdp_data/pdp_x_v_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_v_s, "ML_Model/pdp_data/pdp_y_v_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_a, "ML_Model/pdp_data/pdp_v_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_f_v_a, "ML_Model/pdp_data/pdp_f_v_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_s_v_a, "ML_Model/pdp_data/pdp_s_v_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sp_v_a, "ML_Model/pdp_data/pdp_sp_v_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_v_a, "ML_Model/pdp_data/pdp_x_v_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_v_a, "ML_Model/pdp_data/pdp_y_v_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_ra, "ML_Model/pdp_data/pdp_v_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_f_v_ra, "ML_Model/pdp_data/pdp_f_v_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_s_v_ra, "ML_Model/pdp_data/pdp_s_v_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sp_v_ra, "ML_Model/pdp_data/pdp_sp_v_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_v_ra, "ML_Model/pdp_data/pdp_x_v_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_v_ra, "ML_Model/pdp_data/pdp_y_v_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_wd_k, "ML_Model/pdp_data/pdp_v_wd_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_wd_k_c, "ML_Model/pdp_data/pdp_v_wd_k_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_wd_k <- pdp::partial(rf_model_wd_k, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "v + wd w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_f_wd_k, "ML_Model/pdp_data/pdp_f_wd_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_wd_k_c, "ML_Model/pdp_data/pdp_f_wd_k_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_wd_k <- pdp::partial(rf_model_wd_k, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "v + wd w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_s_wd_k, "ML_Model/pdp_data/pdp_s_wd_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_wd_k_c, "ML_Model/pdp_data/pdp_s_wd_k_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_wd_k <- pdp::partial(rf_model_wd_k, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "v + wd w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_sp_wd_k, "ML_Model/pdp_data/pdp_sp_wd_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_k, "ML_Model/pdp_data/pdp_wd_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_wd_k, "ML_Model/pdp_data/pdp_x_wd_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_k, "ML_Model/pdp_data/pdp_y_wd_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_wd_s, "ML_Model/pdp_data/pdp_v_wd_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_wd_s_c, "ML_Model/pdp_data/pdp_v_wd_s_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_wd_s <- pdp::partial(rf_model_wd_s, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "v + wd w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_f_wd_s, "ML_Model/pdp_data/pdp_f_wd_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_wd_s_c, "ML_Model/pdp_data/pdp_f_wd_s_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_wd_s <- pdp::partial(rf_model_wd_s, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "v + wd w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_s_wd_s, "ML_Model/pdp_data/pdp_s_wd_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_wd_s_c, "ML_Model/pdp_data/pdp_s_wd_s_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_wd_s <- pdp::partial(rf_model_wd_s, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "v + wd w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_sp_wd_s, "ML_Model/pdp_data/pdp_sp_wd_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_s, "ML_Model/pdp_data/pdp_wd_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_wd_s, "ML_Model/pdp_data/pdp_x_wd_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_s, "ML_Model/pdp_data/pdp_y_wd_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_wd_a, "ML_Model/pdp_data/pdp_v_wd_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_wd_a_c, "ML_Model/pdp_data/pdp_v_wd_a_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_wd_a <- pdp::partial(rf_model_wd_a, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "v + wd w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_f_wd_a, "ML_Model/pdp_data/pdp_f_wd_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_wd_a_c, "ML_Model/pdp_data/pdp_f_wd_a_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_wd_a <- pdp::partial(rf_model_wd_a, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "v + wd w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_s_wd_a, "ML_Model/pdp_data/pdp_s_wd_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_wd_a_c, "ML_Model/pdp_data/pdp_s_wd_a_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_wd_a <- pdp::partial(rf_model_wd_a, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "v + wd w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_sp_wd_a, "ML_Model/pdp_data/pdp_sp_wd_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_a, "ML_Model/pdp_data/pdp_wd_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_wd_a, "ML_Model/pdp_data/pdp_x_wd_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_a, "ML_Model/pdp_data/pdp_y_wd_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_wd_ra, "ML_Model/pdp_data/pdp_v_wd_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_wd_ra_c, "ML_Model/pdp_data/pdp_v_wd_ra_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_wd_ra <- pdp::partial(rf_model_wd_ra, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "v + wd w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_f_wd_ra, "ML_Model/pdp_data/pdp_f_wd_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_wd_ra_c, "ML_Model/pdp_data/pdp_f_wd_ra_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_wd_ra <- pdp::partial(rf_model_wd_ra, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "v + wd w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_s_wd_ra, "ML_Model/pdp_data/pdp_s_wd_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_wd_ra_c, "ML_Model/pdp_data/pdp_s_wd_ra_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_wd_ra <- pdp::partial(rf_model_wd_ra, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "v + wd w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_sp_wd_ra, "ML_Model/pdp_data/pdp_sp_wd_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_ra, "ML_Model/pdp_data/pdp_wd_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_wd_ra, "ML_Model/pdp_data/pdp_x_wd_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_ra, "ML_Model/pdp_data/pdp_y_wd_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_samp_k, "ML_Model/pdp_data/pdp_v_samp_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_samp_k_c, "ML_Model/pdp_data/pdp_v_samp_k_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_samp_k <- pdp::partial(rf_model_samp_k, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_f_samp_k, "ML_Model/pdp_data/pdp_f_samp_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_samp_k_c, "ML_Model/pdp_data/pdp_f_samp_k_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_samp_k <- pdp::partial(rf_model_samp_k, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_s_samp_k, "ML_Model/pdp_data/pdp_s_samp_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_samp_k_c, "ML_Model/pdp_data/pdp_s_samp_k_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_samp_k <- pdp::partial(rf_model_samp_k, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_sp_samp_k, "ML_Model/pdp_data/pdp_sp_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_samp_k, "ML_Model/pdp_data/pdp_wd_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_samp_k, "ML_Model/pdp_data/pdp_x_samp_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_k, "ML_Model/pdp_data/pdp_y_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_samp_k, "ML_Model/pdp_data/pdp_z_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_samp_k, "ML_Model/pdp_data/pdp_dist_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_samp_k, "ML_Model/pdp_data/pdp_cv_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_samp_k, "ML_Model/pdp_data/pdp_ac_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_samp_k, "ML_Model/pdp_data/pdp_mc_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_samp_k, "ML_Model/pdp_data/pdp_cc_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_samp_k, "ML_Model/pdp_data/pdp_clog_3_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_samp_k, "ML_Model/pdp_data/pdp_clog_6_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_samp_k, "ML_Model/pdp_data/pdp_sub_samp_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_samp_s, "ML_Model/pdp_data/pdp_v_samp_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_samp_s_c, "ML_Model/pdp_data/pdp_v_samp_s_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_samp_s <- pdp::partial(rf_model_samp_s, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_f_samp_s, "ML_Model/pdp_data/pdp_f_samp_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_samp_s_c, "ML_Model/pdp_data/pdp_f_samp_s_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_samp_s <- pdp::partial(rf_model_samp_s, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_s_samp_s, "ML_Model/pdp_data/pdp_s_samp_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_samp_s_c, "ML_Model/pdp_data/pdp_s_samp_s_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_samp_s <- pdp::partial(rf_model_samp_s, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_sp_samp_s, "ML_Model/pdp_data/pdp_sp_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_samp_s, "ML_Model/pdp_data/pdp_wd_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_samp_s, "ML_Model/pdp_data/pdp_x_samp_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_s, "ML_Model/pdp_data/pdp_y_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_samp_s, "ML_Model/pdp_data/pdp_z_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_samp_s, "ML_Model/pdp_data/pdp_dist_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_samp_s, "ML_Model/pdp_data/pdp_cv_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_samp_s, "ML_Model/pdp_data/pdp_ac_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_samp_s, "ML_Model/pdp_data/pdp_mc_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_samp_s, "ML_Model/pdp_data/pdp_cc_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_samp_s, "ML_Model/pdp_data/pdp_clog_3_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_samp_s, "ML_Model/pdp_data/pdp_clog_6_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_samp_s, "ML_Model/pdp_data/pdp_sub_samp_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_samp_a, "ML_Model/pdp_data/pdp_v_samp_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_samp_a_c, "ML_Model/pdp_data/pdp_v_samp_a_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_samp_a <- pdp::partial(rf_model_samp_a, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_f_samp_a, "ML_Model/pdp_data/pdp_f_samp_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_samp_a_c, "ML_Model/pdp_data/pdp_f_samp_a_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_samp_a <- pdp::partial(rf_model_samp_a, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_s_samp_a, "ML_Model/pdp_data/pdp_s_samp_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_samp_a_c, "ML_Model/pdp_data/pdp_s_samp_a_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_samp_a <- pdp::partial(rf_model_samp_a, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_sp_samp_a, "ML_Model/pdp_data/pdp_sp_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_samp_a, "ML_Model/pdp_data/pdp_wd_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_samp_a, "ML_Model/pdp_data/pdp_x_samp_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_a, "ML_Model/pdp_data/pdp_y_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_samp_a, "ML_Model/pdp_data/pdp_z_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_samp_a, "ML_Model/pdp_data/pdp_dist_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_samp_a, "ML_Model/pdp_data/pdp_cv_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_samp_a, "ML_Model/pdp_data/pdp_ac_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_samp_a, "ML_Model/pdp_data/pdp_mc_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_samp_a, "ML_Model/pdp_data/pdp_cc_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_samp_a, "ML_Model/pdp_data/pdp_clog_3_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_samp_a, "ML_Model/pdp_data/pdp_clog_6_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_samp_a, "ML_Model/pdp_data/pdp_sub_samp_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_samp_ra, "ML_Model/pdp_data/pdp_v_samp_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_samp_ra_c, "ML_Model/pdp_data/pdp_v_samp_ra_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_samp_ra <- pdp::partial(rf_model_samp_ra, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_f_samp_ra, "ML_Model/pdp_data/pdp_f_samp_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_samp_ra_c, "ML_Model/pdp_data/pdp_f_samp_ra_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_samp_ra <- pdp::partial(rf_model_samp_ra, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_s_samp_ra, "ML_Model/pdp_data/pdp_s_samp_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_samp_ra_c, "ML_Model/pdp_data/pdp_s_samp_ra_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_samp_ra <- pdp::partial(rf_model_samp_ra, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_sp_samp_ra, "ML_Model/pdp_data/pdp_sp_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_samp_ra, "ML_Model/pdp_data/pdp_wd_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_samp_ra, "ML_Model/pdp_data/pdp_x_samp_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_ra, "ML_Model/pdp_data/pdp_y_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_samp_ra, "ML_Model/pdp_data/pdp_z_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_samp_ra, "ML_Model/pdp_data/pdp_dist_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_samp_ra, "ML_Model/pdp_data/pdp_cv_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_samp_ra, "ML_Model/pdp_data/pdp_ac_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_samp_ra, "ML_Model/pdp_data/pdp_mc_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_samp_ra, "ML_Model/pdp_data/pdp_cc_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_samp_ra, "ML_Model/pdp_data/pdp_clog_3_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_samp_ra, "ML_Model/pdp_data/pdp_clog_6_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_samp_ra, "ML_Model/pdp_data/pdp_sub_samp_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_sec_k, "ML_Model/pdp_data/pdp_v_sec_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_sec_k_c, "ML_Model/pdp_data/pdp_v_sec_k_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_sec_k <- pdp::partial(rf_model_sec_k, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "all predictors w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_f_sec_k, "ML_Model/pdp_data/pdp_f_sec_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_sec_k_c, "ML_Model/pdp_data/pdp_f_sec_k_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_sec_k <- pdp::partial(rf_model_sec_k, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "all predictors w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_s_sec_k, "ML_Model/pdp_data/pdp_s_sec_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_sec_k_c, "ML_Model/pdp_data/pdp_s_sec_k_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_sec_k <- pdp::partial(rf_model_sec_k, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "all predictors w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_sp_sec_k, "ML_Model/pdp_data/pdp_sp_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_sec_k, "ML_Model/pdp_data/pdp_wd_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_sec_k, "ML_Model/pdp_data/pdp_x_sec_k_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_sec_k, "ML_Model/pdp_data/pdp_y_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_sec_k, "ML_Model/pdp_data/pdp_z_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_sec_k, "ML_Model/pdp_data/pdp_dist_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_sec_k, "ML_Model/pdp_data/pdp_cv_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_sec_k, "ML_Model/pdp_data/pdp_ac_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_sec_k, "ML_Model/pdp_data/pdp_mc_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_sec_k, "ML_Model/pdp_data/pdp_cc_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_sec_k, "ML_Model/pdp_data/pdp_clog_3_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_sec_k, "ML_Model/pdp_data/pdp_clog_6_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_sec_k, "ML_Model/pdp_data/pdp_sub_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phb_sec_k, "ML_Model/pdp_data/pdp_phb_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phd_sec_k, "ML_Model/pdp_data/pdp_phd_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_pha_sec_k, "ML_Model/pdp_data/pdp_pha_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cb_sec_k, "ML_Model/pdp_data/pdp_cb_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cd_sec_k, "ML_Model/pdp_data/pdp_cd_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ca_sec_k, "ML_Model/pdp_data/pdp_ca_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ob_sec_k, "ML_Model/pdp_data/pdp_ob_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_od_sec_k, "ML_Model/pdp_data/pdp_od_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_oa_sec_k, "ML_Model/pdp_data/pdp_oa_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tb_sec_k, "ML_Model/pdp_data/pdp_tb_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_td_sec_k, "ML_Model/pdp_data/pdp_td_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ta_sec_k, "ML_Model/pdp_data/pdp_ta_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_teb_sec_k, "ML_Model/pdp_data/pdp_teb_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ted_sec_k, "ML_Model/pdp_data/pdp_ted_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tea_sec_k, "ML_Model/pdp_data/pdp_tea_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qb_sec_k, "ML_Model/pdp_data/pdp_qb_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qd_sec_k, "ML_Model/pdp_data/pdp_qd_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qa_sec_k, "ML_Model/pdp_data/pdp_qa_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gb_sec_k, "ML_Model/pdp_data/pdp_gb_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gd_sec_k, "ML_Model/pdp_data/pdp_gd_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ga_sec_k, "ML_Model/pdp_data/pdp_ga_sec_k_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_sec_s, "ML_Model/pdp_data/pdp_v_sec_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_sec_s_c, "ML_Model/pdp_data/pdp_v_sec_s_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_sec_s <- pdp::partial(rf_model_sec_s, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "all predictors w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_f_sec_s, "ML_Model/pdp_data/pdp_f_sec_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_sec_s_c, "ML_Model/pdp_data/pdp_f_sec_s_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_sec_s <- pdp::partial(rf_model_sec_s, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "all predictors w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_s_sec_s, "ML_Model/pdp_data/pdp_s_sec_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_sec_s_c, "ML_Model/pdp_data/pdp_s_sec_s_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_sec_s <- pdp::partial(rf_model_sec_s, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "all predictors w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_sp_sec_s, "ML_Model/pdp_data/pdp_sp_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_sec_s, "ML_Model/pdp_data/pdp_wd_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_sec_s, "ML_Model/pdp_data/pdp_x_sec_s_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_sec_s, "ML_Model/pdp_data/pdp_y_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_sec_s, "ML_Model/pdp_data/pdp_z_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_sec_s, "ML_Model/pdp_data/pdp_dist_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_sec_s, "ML_Model/pdp_data/pdp_cv_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_sec_s, "ML_Model/pdp_data/pdp_ac_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_sec_s, "ML_Model/pdp_data/pdp_mc_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_sec_s, "ML_Model/pdp_data/pdp_cc_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_sec_s, "ML_Model/pdp_data/pdp_clog_3_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_sec_s, "ML_Model/pdp_data/pdp_clog_6_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_sec_s, "ML_Model/pdp_data/pdp_sub_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phb_sec_s, "ML_Model/pdp_data/pdp_phb_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phd_sec_s, "ML_Model/pdp_data/pdp_phd_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_pha_sec_s, "ML_Model/pdp_data/pdp_pha_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cb_sec_s, "ML_Model/pdp_data/pdp_cb_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cd_sec_s, "ML_Model/pdp_data/pdp_cd_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ca_sec_s, "ML_Model/pdp_data/pdp_ca_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ob_sec_s, "ML_Model/pdp_data/pdp_ob_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_od_sec_s, "ML_Model/pdp_data/pdp_od_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_oa_sec_s, "ML_Model/pdp_data/pdp_oa_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tb_sec_s, "ML_Model/pdp_data/pdp_tb_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_td_sec_s, "ML_Model/pdp_data/pdp_td_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ta_sec_s, "ML_Model/pdp_data/pdp_ta_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_teb_sec_s, "ML_Model/pdp_data/pdp_teb_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ted_sec_s, "ML_Model/pdp_data/pdp_ted_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tea_sec_s, "ML_Model/pdp_data/pdp_tea_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qb_sec_s, "ML_Model/pdp_data/pdp_qb_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qd_sec_s, "ML_Model/pdp_data/pdp_qd_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qa_sec_s, "ML_Model/pdp_data/pdp_qa_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gb_sec_s, "ML_Model/pdp_data/pdp_gb_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gd_sec_s, "ML_Model/pdp_data/pdp_gd_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ga_sec_s, "ML_Model/pdp_data/pdp_ga_sec_s_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_sec_a, "ML_Model/pdp_data/pdp_v_sec_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_sec_a_c, "ML_Model/pdp_data/pdp_v_sec_a_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_sec_a <- pdp::partial(rf_model_sec_a, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "all predictors w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_f_sec_a, "ML_Model/pdp_data/pdp_f_sec_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_sec_a_c, "ML_Model/pdp_data/pdp_f_sec_a_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_sec_a <- pdp::partial(rf_model_sec_a, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "all predictors w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_s_sec_a, "ML_Model/pdp_data/pdp_s_sec_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_sec_a_c, "ML_Model/pdp_data/pdp_s_sec_a_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_sec_a <- pdp::partial(rf_model_sec_a, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "all predictors w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_sp_sec_a, "ML_Model/pdp_data/pdp_sp_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_sec_a, "ML_Model/pdp_data/pdp_wd_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_sec_a, "ML_Model/pdp_data/pdp_x_sec_a_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_sec_a, "ML_Model/pdp_data/pdp_y_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_sec_a, "ML_Model/pdp_data/pdp_z_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_sec_a, "ML_Model/pdp_data/pdp_dist_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_sec_a, "ML_Model/pdp_data/pdp_cv_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_sec_a, "ML_Model/pdp_data/pdp_ac_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_sec_a, "ML_Model/pdp_data/pdp_mc_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_sec_a, "ML_Model/pdp_data/pdp_cc_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_sec_a, "ML_Model/pdp_data/pdp_clog_3_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_sec_a, "ML_Model/pdp_data/pdp_clog_6_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_sec_a, "ML_Model/pdp_data/pdp_sub_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phb_sec_a, "ML_Model/pdp_data/pdp_phb_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phd_sec_a, "ML_Model/pdp_data/pdp_phd_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_pha_sec_a, "ML_Model/pdp_data/pdp_pha_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cb_sec_a, "ML_Model/pdp_data/pdp_cb_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cd_sec_a, "ML_Model/pdp_data/pdp_cd_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ca_sec_a, "ML_Model/pdp_data/pdp_ca_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ob_sec_a, "ML_Model/pdp_data/pdp_ob_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_od_sec_a, "ML_Model/pdp_data/pdp_od_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_oa_sec_a, "ML_Model/pdp_data/pdp_oa_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tb_sec_a, "ML_Model/pdp_data/pdp_tb_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_td_sec_a, "ML_Model/pdp_data/pdp_td_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ta_sec_a, "ML_Model/pdp_data/pdp_ta_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_teb_sec_a, "ML_Model/pdp_data/pdp_teb_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ted_sec_a, "ML_Model/pdp_data/pdp_ted_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tea_sec_a, "ML_Model/pdp_data/pdp_tea_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qb_sec_a, "ML_Model/pdp_data/pdp_qb_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qd_sec_a, "ML_Model/pdp_data/pdp_qd_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qa_sec_a, "ML_Model/pdp_data/pdp_qa_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gb_sec_a, "ML_Model/pdp_data/pdp_gb_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gd_sec_a, "ML_Model/pdp_data/pdp_gd_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ga_sec_a, "ML_Model/pdp_data/pdp_ga_sec_a_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_sec_ra, "ML_Model/pdp_data/pdp_v_sec_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_v_sec_ra_c, "ML_Model/pdp_data/pdp_v_sec_ra_c_rf_add.csv", row.names = FALSE)

### froude
pdp_model_f_sec_ra <- pdp::partial(rf_model_sec_ra, pred.var = "froude") |>
  mutate(predictors = "froude",
         model = "all predictors w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_f_sec_ra, "ML_Model/pdp_data/pdp_f_sec_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_f_sec_ra_c, "ML_Model/pdp_data/pdp_f_sec_ra_c_rf_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_sec_ra <- pdp::partial(rf_model_sec_ra, pred.var = "shear_stress") |>
  mutate(predictors = "shear_stress",
         model = "all predictors w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_s_sec_ra, "ML_Model/pdp_data/pdp_s_sec_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_s_sec_ra_c, "ML_Model/pdp_data/pdp_s_sec_ra_c_rf_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_sec_ra <- pdp::partial(rf_model_sec_ra, pred.var = "stream_power") |>
  mutate(predictors = "stream_power",
         model = "all predictors w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_sp_sec_ra, "ML_Model/pdp_data/pdp_sp_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_sec_ra, "ML_Model/pdp_data/pdp_wd_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_sec_ra, "ML_Model/pdp_data/pdp_x_sec_ra_rf_add.csv", row.names = FALSE)
write.csv(pdp_model_y_sec_ra, "ML_Model/pdp_data/pdp_y_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_sec_ra, "ML_Model/pdp_data/pdp_z_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_sec_ra, "ML_Model/pdp_data/pdp_dist_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_sec_ra, "ML_Model/pdp_data/pdp_cv_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_sec_ra, "ML_Model/pdp_data/pdp_ac_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_sec_ra, "ML_Model/pdp_data/pdp_mc_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_sec_ra, "ML_Model/pdp_data/pdp_cc_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_sec_ra, "ML_Model/pdp_data/pdp_clog_3_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_sec_ra, "ML_Model/pdp_data/pdp_clog_6_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_sec_ra, "ML_Model/pdp_data/pdp_sub_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phb_sec_ra, "ML_Model/pdp_data/pdp_phb_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phd_sec_ra, "ML_Model/pdp_data/pdp_phd_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_pha_sec_ra, "ML_Model/pdp_data/pdp_pha_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cb_sec_ra, "ML_Model/pdp_data/pdp_cb_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cd_sec_ra, "ML_Model/pdp_data/pdp_cd_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ca_sec_ra, "ML_Model/pdp_data/pdp_ca_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ob_sec_ra, "ML_Model/pdp_data/pdp_ob_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_od_sec_ra, "ML_Model/pdp_data/pdp_od_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_oa_sec_ra, "ML_Model/pdp_data/pdp_oa_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tb_sec_ra, "ML_Model/pdp_data/pdp_tb_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_td_sec_ra, "ML_Model/pdp_data/pdp_td_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ta_sec_ra, "ML_Model/pdp_data/pdp_ta_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_teb_sec_ra, "ML_Model/pdp_data/pdp_teb_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ted_sec_ra, "ML_Model/pdp_data/pdp_ted_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tea_sec_ra, "ML_Model/pdp_data/pdp_tea_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qb_sec_ra, "ML_Model/pdp_data/pdp_qb_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qd_sec_ra, "ML_Model/pdp_data/pdp_qd_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qa_sec_ra, "ML_Model/pdp_data/pdp_qa_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gb_sec_ra, "ML_Model/pdp_data/pdp_gb_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gd_sec_ra, "ML_Model/pdp_data/pdp_gd_sec_ra_rf_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ga_sec_ra, "ML_Model/pdp_data/pdp_ga_sec_ra_rf_add.csv", row.names = FALSE)
...
### PREDICTOR: VELOCITY ### ---------------------------------------------------
# With k_index as response
rmse_v_k <- Metrics::rmse(actual = responses_v_k, predicted = rf_predictions_v_k)
rmse_model_v_k <- Metrics::rmse(actual = responses_v_k, predicted = rf_pred_model_v_k)
rmse_model_v_k_c <- Metrics::rmse(actual = responses_v_k, predicted = rf_pred_model_v_k_c)

mae_v_k <- Metrics::mae(actual = responses_v_k, predicted = rf_predictions_v_k)
mae_model_v_k <- Metrics::mae(actual = responses_v_k, predicted = rf_pred_model_v_k)
mae_model_v_k_c <- Metrics::mae(actual = responses_v_k, predicted = rf_pred_model_v_k_c)

# With shannon index as response
rmse_v_s <- Metrics::rmse(actual = responses_v_s, predicted = rf_predictions_v_s)
rmse_model_v_s <- Metrics::rmse(actual = responses_v_s, predicted = rf_pred_model_v_s)
rmse_model_v_s_c <- Metrics::rmse(actual = responses_v_s, predicted = rf_pred_model_v_s_c)

mae_v_s <- Metrics::mae(actual = responses_v_s, predicted = rf_predictions_v_s)
mae_model_v_s <- Metrics::mae(actual = responses_v_s, predicted = rf_pred_model_v_s)
mae_model_v_s_c <- Metrics::mae(actual = responses_v_s, predicted = rf_pred_model_v_s_c)

# With abundance as response
rmse_v_a <- Metrics::rmse(actual = responses_v_a, predicted = rf_predictions_v_a)
rmse_model_v_a <- Metrics::rmse(actual = responses_v_a, predicted = rf_pred_model_v_a)
rmse_model_v_a_c <- Metrics::rmse(actual = responses_v_a, predicted = rf_pred_model_v_a_c)

mae_v_a <- Metrics::mae(actual = responses_v_a, predicted = rf_predictions_v_a)
mae_model_v_a <- Metrics::mae(actual = responses_v_a, predicted = rf_pred_model_v_a)
mae_model_v_a_c <- Metrics::mae(actual = responses_v_a, predicted = rf_pred_model_v_a_c)

# With rel_abundance as response
rmse_v_ra <- Metrics::rmse(actual = responses_v_ra, predicted = rf_predictions_v_ra)
rmse_model_v_ra <- Metrics::rmse(actual = responses_v_ra, predicted = rf_pred_model_v_ra)
rmse_model_v_ra_c <- Metrics::rmse(actual = responses_v_ra, predicted = rf_pred_model_v_ra_c)

mae_v_ra <- Metrics::mae(actual = responses_v_ra, predicted = rf_predictions_v_ra)
mae_model_v_ra <- Metrics::mae(actual = responses_v_ra, predicted = rf_pred_model_v_ra)
mae_model_v_ra_c <- Metrics::mae(actual = responses_v_ra, predicted = rf_pred_model_v_ra_c)

### PREDICTORS: VELOCITY + WD ### ---------------------------------------------
# With k_index as response
rmse_wd_k <- Metrics::rmse(actual = responses_wd_k, predicted = rf_predictions_wd_k)
rmse_model_wd_k <- Metrics::rmse(actual = responses_wd_k, predicted = rf_pred_model_wd_k)
rmse_model_wd_k_c <- Metrics::rmse(actual = responses_wd_k, predicted = rf_pred_model_wd_k_c)

mae_wd_k <- Metrics::mae(actual = responses_wd_k, predicted = rf_predictions_wd_k)
mae_model_wd_k <- Metrics::mae(actual = responses_wd_k, predicted = rf_pred_model_wd_k)
mae_model_wd_k_c <- Metrics::mae(actual = responses_wd_k, predicted = rf_pred_model_wd_k_c)

# With shannon index as response
rmse_wd_s <- Metrics::rmse(actual = responses_wd_s, predicted = rf_predictions_wd_s)
rmse_model_wd_s <- Metrics::rmse(actual = responses_wd_s, predicted = rf_pred_model_wd_s)
rmse_model_wd_s_c <- Metrics::rmse(actual = responses_wd_s, predicted = rf_pred_model_wd_s_c)

mae_wd_s <- Metrics::mae(actual = responses_wd_s, predicted = rf_predictions_wd_s)
mae_model_wd_s <- Metrics::mae(actual = responses_wd_s, predicted = rf_pred_model_wd_s)
mae_model_wd_s_c <- Metrics::mae(actual = responses_wd_s, predicted = rf_pred_model_wd_s_c)

# With abundance as response
rmse_wd_a <- Metrics::rmse(actual = responses_wd_a, predicted = rf_predictions_wd_a)
rmse_model_wd_a <- Metrics::rmse(actual = responses_wd_a, predicted = rf_pred_model_wd_a)
rmse_model_wd_a_c <- Metrics::rmse(actual = responses_wd_a, predicted = rf_pred_model_wd_a_c)

mae_wd_a <- Metrics::mae(actual = responses_wd_a, predicted = rf_predictions_wd_a)
mae_model_wd_a <- Metrics::mae(actual = responses_wd_a, predicted = rf_pred_model_wd_a)
mae_model_wd_a_c <- Metrics::mae(actual = responses_wd_a, predicted = rf_pred_model_wd_a_c)

# With rel_abundance as response
rmse_wd_ra <- Metrics::rmse(actual = responses_wd_ra, predicted = rf_predictions_wd_ra)
rmse_model_wd_ra <- Metrics::rmse(actual = responses_wd_ra, predicted = rf_pred_model_wd_ra)
rmse_model_wd_ra_c <- Metrics::rmse(actual = responses_wd_ra, predicted = rf_pred_model_wd_ra_c)

mae_wd_ra <- Metrics::mae(actual = responses_wd_ra, predicted = rf_predictions_wd_ra)
mae_model_wd_ra <- Metrics::mae(actual = responses_wd_ra, predicted = rf_pred_model_wd_ra)
mae_model_wd_ra_c <- Metrics::mae(actual = responses_wd_ra, predicted = rf_pred_model_wd_ra_c)

### PREDICTORS: SAMPLING LOCATIONS ### ----------------------------------------
# With k_index as response
rmse_samp_k <- Metrics::rmse(actual = responses_samp_k, predicted = rf_predictions_samp_k)
rmse_model_samp_k <- Metrics::rmse(actual = responses_samp_k, predicted = rf_pred_model_samp_k)
rmse_model_samp_k_c <- Metrics::rmse(actual = responses_samp_k, predicted = rf_pred_model_samp_k_c)

mae_samp_k <- Metrics::mae(actual = responses_samp_k, predicted = rf_predictions_samp_k)
mae_model_samp_k <- Metrics::mae(actual = responses_samp_k, predicted = rf_pred_model_samp_k)
mae_model_samp_k_c <- Metrics::mae(actual = responses_samp_k, predicted = rf_pred_model_samp_k_c)

# With shannon index as response
rmse_samp_s <- Metrics::rmse(actual = responses_samp_s, predicted = rf_predictions_samp_s)
rmse_model_samp_s <- Metrics::rmse(actual = responses_samp_s, predicted = rf_pred_model_samp_s)
rmse_model_samp_s_c <- Metrics::rmse(actual = responses_samp_s, predicted = rf_pred_model_samp_s_c)

mae_samp_s <- Metrics::mae(actual = responses_samp_s, predicted = rf_predictions_samp_s)
mae_model_samp_s <- Metrics::mae(actual = responses_samp_s, predicted = rf_pred_model_samp_s)
mae_model_samp_s_c <- Metrics::mae(actual = responses_samp_s, predicted = rf_pred_model_samp_s_c)

# With abundance as response
rmse_samp_a <- Metrics::rmse(actual = responses_samp_a, predicted = rf_predictions_samp_a)
rmse_model_samp_a <- Metrics::rmse(actual = responses_samp_a, predicted = rf_pred_model_samp_a)
rmse_model_samp_a_c <- Metrics::rmse(actual = responses_samp_a, predicted = rf_pred_model_samp_a_c)

mae_samp_a <- Metrics::mae(actual = responses_samp_a, predicted = rf_predictions_samp_a)
mae_model_samp_a <- Metrics::mae(actual = responses_samp_a, predicted = rf_pred_model_samp_a)
mae_model_samp_a_c <- Metrics::mae(actual = responses_samp_a, predicted = rf_pred_model_samp_a_c)

# With rel_abundance as response
rmse_samp_ra <- Metrics::rmse(actual = responses_samp_ra, predicted = rf_predictions_samp_ra)
rmse_model_samp_ra <- Metrics::rmse(actual = responses_samp_ra, predicted = rf_pred_model_samp_ra)
rmse_model_samp_ra_c <- Metrics::rmse(actual = responses_samp_ra, predicted = rf_pred_model_samp_ra_c)

mae_samp_ra <- Metrics::mae(actual = responses_samp_ra, predicted = rf_predictions_samp_ra)
mae_model_samp_ra <- Metrics::mae(actual = responses_samp_ra, predicted = rf_pred_model_samp_ra)
mae_model_samp_ra_c <- Metrics::mae(actual = responses_samp_ra, predicted = rf_pred_model_samp_ra_c)

### PREDICTORS: ALL PREDICTORS ### --------------------------------------------
# With k_index as response
rmse_sec_k <- Metrics::rmse(actual = responses_sec_k, predicted = rf_predictions_sec_k)
rmse_model_sec_k <- Metrics::rmse(actual = responses_sec_k, predicted = rf_pred_model_sec_k)
rmse_model_sec_k_c <- Metrics::rmse(actual = responses_sec_k, predicted = rf_pred_model_sec_k_c)

mae_sec_k <- Metrics::mae(actual = responses_sec_k, predicted = rf_predictions_sec_k)
mae_model_sec_k <- Metrics::mae(actual = responses_sec_k, predicted = rf_pred_model_sec_k)
mae_model_sec_k_c <- Metrics::mae(actual = responses_sec_k, predicted = rf_pred_model_sec_k_c)

# With shannon index as response
rmse_sec_s <- Metrics::rmse(actual = responses_sec_s, predicted = rf_predictions_sec_s)
rmse_model_sec_s <- Metrics::rmse(actual = responses_sec_s, predicted = rf_pred_model_sec_s)
rmse_model_sec_s_c <- Metrics::rmse(actual = responses_sec_s, predicted = rf_pred_model_sec_s_c)

mae_sec_s <- Metrics::mae(actual = responses_sec_s, predicted = rf_predictions_sec_s)
mae_model_sec_s <- Metrics::mae(actual = responses_sec_s, predicted = rf_pred_model_sec_s)
mae_model_sec_s_c <- Metrics::mae(actual = responses_sec_s, predicted = rf_pred_model_sec_s_c)

# With abundance as response
rmse_sec_a <- Metrics::rmse(actual = responses_sec_a, predicted = rf_predictions_sec_a)
rmse_model_sec_a <- Metrics::rmse(actual = responses_sec_a, predicted = rf_pred_model_sec_a)
rmse_model_sec_a_c <- Metrics::rmse(actual = responses_sec_a, predicted = rf_pred_model_sec_a_c)

mae_sec_a <- Metrics::mae(actual = responses_sec_a, predicted = rf_predictions_sec_a)
mae_model_sec_a <- Metrics::mae(actual = responses_sec_a, predicted = rf_pred_model_sec_a)
mae_model_sec_a_c <- Metrics::mae(actual = responses_sec_a, predicted = rf_pred_model_sec_a_c)

# With rel_abundance as response
rmse_sec_ra <- Metrics::rmse(actual = responses_sec_ra, predicted = rf_predictions_sec_ra)
rmse_model_sec_ra <- Metrics::rmse(actual = responses_sec_ra, predicted = rf_pred_model_sec_ra)
rmse_model_sec_ra_c <- Metrics::rmse(actual = responses_sec_ra, predicted = rf_pred_model_sec_ra_c)

mae_sec_ra <- Metrics::mae(actual = responses_sec_ra, predicted = rf_predictions_sec_ra)
mae_model_sec_ra <- Metrics::mae(actual = responses_sec_ra, predicted = rf_pred_model_sec_ra)
...
### PREDICTORS: SAMPLING LOCATIONS ### ----------------------------------------
# With k_index as response
bias_samp_k <- bias(observados = responses_samp_k, estimados = rf_predictions_samp_k)
bias_model_samp_k <- bias(observados = responses_samp_k, estimados = rf_pred_model_samp_k)
bias_model_samp_k_c <- bias(observados = responses_samp_k, estimados = rf_pred_model_samp_k_c)

# With shannon index as response
bias_samp_s <- bias(observados = responses_samp_s, estimados = rf_predictions_samp_s)
bias_model_samp_s <- bias(observados = responses_samp_s, estimados = rf_pred_model_samp_s)
bias_model_samp_s_c <- bias(observados = responses_samp_s, estimados = rf_pred_model_samp_s_c)

# With abundance as response
bias_samp_a <- bias(observados = responses_samp_a, estimados = rf_predictions_samp_a)
bias_model_samp_a <- bias(observados = responses_samp_a, estimados = rf_pred_model_samp_a)
bias_model_samp_a_c <- bias(observados = responses_samp_a, estimados = rf_pred_model_samp_a_c)

# With rel_abundance as response
bias_samp_ra <- bias(observados = responses_samp_ra, estimados = rf_predictions_samp_ra)
bias_model_samp_ra <- bias(observados = responses_samp_ra, estimados = rf_pred_model_samp_ra)
bias_model_samp_ra_c <- bias(observados = responses_samp_ra, estimados = rf_pred_model_samp_ra_c)

### PREDICTORS: ALL PREDICTORS ### --------------------------------------------
# With k_index as response
bias_sec_k <- bias(observados = responses_sec_k, estimados = rf_predictions_sec_k)
bias_model_sec_k <- bias(observados = responses_sec_k, estimados = rf_pred_model_sec_k)
bias_model_sec_k_c <- bias(observados = responses_sec_k, estimados = rf_pred_model_sec_k_c)

# With shannon index as response
bias_sec_s <- bias(observados = responses_sec_s, estimados = rf_predictions_sec_s)
bias_model_sec_s <- bias(observados = responses_sec_s, estimados = rf_pred_model_sec_s)
bias_model_sec_s_c <- bias(observados = responses_sec_s, estimados = rf_pred_model_sec_s_c)

# With abundance as response
bias_sec_a <- bias(observados = responses_sec_a, estimados = rf_predictions_sec_a)
bias_model_sec_a <- bias(observados = responses_sec_a, estimados = rf_pred_model_sec_a)
bias_model_sec_a_c <- bias(observados = responses_sec_a, estimados = rf_pred_model_sec_a_c)

# With rel_abundance as response
bias_sec_ra <- bias(observados = responses_sec_ra, estimados = rf_predictions_sec_ra)
bias_model_sec_ra <- bias(observados = responses_sec_ra, estimados = rf_pred_model_sec_ra)
...
# GL1 - predictors: v + wd ----------------------------------------------------
GL1_ezg_wd_k <- terra::predict(GL1_ezg, model = autotuner_rf_wd_k, fun = predict, index = 5)
GL1_ezg_wd_s <- terra::predict(GL1_ezg, model = autotuner_rf_wd_s, fun = predict, index = 5)
GL1_ezg_wd_a <- terra::predict(GL1_ezg, model = autotuner_rf_wd_a, fun = predict, index = 5)
GL1_ezg_wd_ra <- terra::predict(GL1_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 5)

#GL1_q_wd_k <- terra::predict(GL1_q, model = autotuner_rf_wd_k, fun = predict, index = 5)
#GL1_q_wd_s <- terra::predict(GL1_q, model = autotuner_rf_wd_s, fun = predict, index = 5)
#GL1_q_wd_a <- terra::predict(GL1_q, model = autotuner_rf_wd_a, fun = predict, index = 5)
#GL1_q_wd_ra <- terra::predict(GL1_q, model = autotuner_rf_wd_ra, fun = predict, index = 5)

# GL1 - predictor: velocity ---------------------------------------------------
GL1_ezg_v_k <- terra::predict(GL1_ezg, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
GL1_ezg_v_s <- terra::predict(GL1_ezg, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
GL1_ezg_v_a <- terra::predict(GL1_ezg, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
GL1_ezg_v_ra <- terra::predict(GL1_ezg, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

#GL1_q_v_k <- terra::predict(GL1_q, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#GL1_q_v_s <- terra::predict(GL1_q, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#GL1_q_v_a <- terra::predict(GL1_q, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#GL1_q_v_ra <- terra::predict(GL1_q, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

# GL2 - predictors: v + wd ----------------------------------------------------
GL2_ezg_wd_k <- terra::predict(GL2_ezg, model = autotuner_rf_wd_k, fun = predict, index = 5)
GL2_ezg_wd_s <- terra::predict(GL2_ezg, model = autotuner_rf_wd_s, fun = predict, index = 5)
GL2_ezg_wd_a <- terra::predict(GL2_ezg, model = autotuner_rf_wd_a, fun = predict, index = 5)
GL2_ezg_wd_ra <- terra::predict(GL2_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 5)

#GL2_q_wd_k <- terra::predict(GL2_q, model = autotuner_rf_wd_k, fun = predict, index = 5)
#GL2_q_wd_s <- terra::predict(GL2_q, model = autotuner_rf_wd_s, fun = predict, index = 5)
#GL2_q_wd_a <- terra::predict(GL2_q, model = autotuner_rf_wd_a, fun = predict, index = 5)
#GL2_q_wd_ra <- terra::predict(GL2_q, model = autotuner_rf_wd_ra, fun = predict, index = 5)

# GL2 - predictor: velocity ---------------------------------------------------
GL2_ezg_v_k <- terra::predict(GL2_ezg, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
GL2_ezg_v_s <- terra::predict(GL2_ezg, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
GL2_ezg_v_a <- terra::predict(GL2_ezg, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
GL2_ezg_v_ra <- terra::predict(GL2_ezg, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

#GL2_q_v_k <- terra::predict(GL2_q, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#GL2_q_v_s <- terra::predict(GL2_q, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#GL2_q_v_a <- terra::predict(GL2_q, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#GL2_q_v_ra <- terra::predict(GL2_q, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

# L2 - predictors: v + wd -----------------------------------------------------
L2_ezg_wd_k <- terra::predict(L2_ezg, model = autotuner_rf_wd_k, fun = predict, index = 5)
L2_ezg_wd_s <- terra::predict(L2_ezg, model = autotuner_rf_wd_s, fun = predict, index = 5)
L2_ezg_wd_a <- terra::predict(L2_ezg, model = autotuner_rf_wd_a, fun = predict, index = 5)
L2_ezg_wd_ra <- terra::predict(L2_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 5)

#L2_q_wd_k <- terra::predict(L2_q, model = autotuner_rf_wd_k, fun = predict, index = 5)
#L2_q_wd_s <- terra::predict(L2_q, model = autotuner_rf_wd_s, fun = predict, index = 5)
#L2_q_wd_a <- terra::predict(L2_q, model = autotuner_rf_wd_a, fun = predict, index = 5)
#L2_q_wd_ra <- terra::predict(L2_q, model = autotuner_rf_wd_ra, fun = predict, index = 5)

# L2 - predictor: velocity ----------------------------------------------------
L2_ezg_v_k <- terra::predict(L2_ezg, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
L2_ezg_v_s <- terra::predict(L2_ezg, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
L2_ezg_v_a <- terra::predict(L2_ezg, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
L2_ezg_v_ra <- terra::predict(L2_ezg, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

#L2_q_v_k <- terra::predict(L2_q, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#L2_q_v_s <- terra::predict(L2_q, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#L2_q_v_a <- terra::predict(L2_q, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#L2_q_v_ra <- terra::predict(L2_q, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

# M1  - predictors: v + wd -----------------------------------------------------
M1_ezg_wd_k <- terra::predict(M1_ezg, model = autotuner_rf_wd_k, fun = predict, index = 5)
M1_ezg_wd_s <- terra::predict(M1_ezg, model = autotuner_rf_wd_s, fun = predict, index = 5)
M1_ezg_wd_a <- terra::predict(M1_ezg, model = autotuner_rf_wd_a, fun = predict, index = 5)
M1_ezg_wd_ra <- terra::predict(M1_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 5)

#M1_q_wd_k <- terra::predict(M1_q, model = autotuner_rf_wd_k, fun = predict, index = 5)
#M1_q_wd_s <- terra::predict(M1_q, model = autotuner_rf_wd_s, fun = predict, index = 5)
#M1_q_wd_a <- terra::predict(M1_q, model = autotuner_rf_wd_a, fun = predict, index = 5)
#M1_q_wd_ra <- terra::predict(M1_q, model = autotuner_rf_wd_ra, fun = predict, index = 5)

# M1  - predictor: velocity ---------------------------------------------------
M1_ezg_v_k <- terra::predict(M1_ezg, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
M1_ezg_v_s <- terra::predict(M1_ezg, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
M1_ezg_v_a <- terra::predict(M1_ezg, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
M1_ezg_v_ra <- terra::predict(M1_ezg, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

#M1_q_v_k <- terra::predict(M1_q, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#M1_q_v_s <- terra::predict(M1_q, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#M1_q_v_a <- terra::predict(M1_q, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#M1_q_v_ra <- terra::predict(M1_q, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

# S1  - predictors: v + wd ----------------------------------------------------
S1_ezg_wd_k <- terra::predict(S1_ezg, model = autotuner_rf_wd_k, fun = predict, index = 5)
S1_ezg_wd_s <- terra::predict(S1_ezg, model = autotuner_rf_wd_s, fun = predict, index = 5)
S1_ezg_wd_a <- terra::predict(S1_ezg, model = autotuner_rf_wd_a, fun = predict, index = 5)
S1_ezg_wd_ra <- terra::predict(S1_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 5)

#S1_q_wd_k <- terra::predict(S1_q, model = autotuner_rf_wd_k, fun = predict, index = 5)
#S1_q_wd_s <- terra::predict(S1_q, model = autotuner_rf_wd_s, fun = predict, index = 5)
#S1_q_wd_a <- terra::predict(S1_q, model = autotuner_rf_wd_a, fun = predict, index = 5)
#S1_q_wd_ra <- terra::predict(S1_q, model = autotuner_rf_wd_ra, fun = predict, index = 5)

# S1  - predictor: velocity ---------------------------------------------------
S1_ezg_v_k <- terra::predict(S1_ezg, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
S1_ezg_v_s <- terra::predict(S1_ezg, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
S1_ezg_v_a <- terra::predict(S1_ezg, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
S1_ezg_v_ra <- terra::predict(S1_ezg, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

#S1_q_v_k <- terra::predict(S1_q, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#S1_q_v_s <- terra::predict(S1_q, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#S1_q_v_a <- terra::predict(S1_q, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#S1_q_v_ra <- terra::predict(S1_q, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

# S2  - predictors: v + wd ----------------------------------------------------
S2_ezg_wd_k <- terra::predict(S2_ezg, model = autotuner_rf_wd_k, fun = predict, index = 5)
S2_ezg_wd_s <- terra::predict(S2_ezg, model = autotuner_rf_wd_s, fun = predict, index = 5)
S2_ezg_wd_a <- terra::predict(S2_ezg, model = autotuner_rf_wd_a, fun = predict, index = 5)
S2_ezg_wd_ra <- terra::predict(S2_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 5)

#S2_q_wd_k <- terra::predict(S2_q, model = autotuner_rf_wd_k, fun = predict, index = 5)
#S2_q_wd_s <- terra::predict(S2_q, model = autotuner_rf_wd_s, fun = predict, index = 5)
#S2_q_wd_a <- terra::predict(S2_q, model = autotuner_rf_wd_a, fun = predict, index = 5)
#S2_q_wd_ra <- terra::predict(S2_q, model = autotuner_rf_wd_ra, fun = predict, index = 5)

# S2  - predictor: velocity ---------------------------------------------------
S2_ezg_v_k <- terra::predict(S2_ezg, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
S2_ezg_v_s <- terra::predict(S2_ezg, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
S2_ezg_v_a <- terra::predict(S2_ezg, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
S2_ezg_v_ra <- terra::predict(S2_ezg, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

#S2_q_v_k <- terra::predict(S2_q, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#S2_q_v_s <- terra::predict(S2_q, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#S2_q_v_a <- terra::predict(S2_q, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#S2_q_v_ra <- terra::predict(S2_q, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

# TH4  - predictors: v + wd ---------------------------------------------------
TH4_ezg_wd_k <- terra::predict(TH4_ezg, model = autotuner_rf_wd_k, fun = predict, index = 5)
TH4_ezg_wd_s <- terra::predict(TH4_ezg, model = autotuner_rf_wd_s, fun = predict, index = 5)
TH4_ezg_wd_a <- terra::predict(TH4_ezg, model = autotuner_rf_wd_a, fun = predict, index = 5)
TH4_ezg_wd_ra <- terra::predict(TH4_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 5)

#TH4_q_wd_k <- terra::predict(TH4_q, model = autotuner_rf_wd_k, fun = predict, index = 5)
#TH4_q_wd_s <- terra::predict(TH4_q, model = autotuner_rf_wd_s, fun = predict, index = 5)
#TH4_q_wd_a <- terra::predict(TH4_q, model = autotuner_rf_wd_a, fun = predict, index = 5)
#TH4_q_wd_ra <- terra::predict(TH4_q, model = autotuner_rf_wd_ra, fun = predict, index = 5)

# TH4  - predictor: velocity --------------------------------------------------
TH4_ezg_v_k <- terra::predict(TH4_ezg, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
TH4_ezg_v_s <- terra::predict(TH4_ezg, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
TH4_ezg_v_a <- terra::predict(TH4_ezg, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
TH4_ezg_v_ra <- terra::predict(TH4_ezg, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

#TH4_q_v_k <- terra::predict(TH4_q, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#TH4_q_v_s <- terra::predict(TH4_q, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#TH4_q_v_a <- terra::predict(TH4_q, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#TH4_q_v_ra <- terra::predict(TH4_q, model = autotuner_rf_v_ra, fun = predict, index = "c("velocity", "froude", "shear_stress", "stream_power"))

# VR3  - predictors: v + wd ---------------------------------------------------
VR3_ezg_wd_k <- terra::predict(VR3_ezg, model = autotuner_rf_wd_k, fun = predict, index = 5)
VR3_ezg_wd_s <- terra::predict(VR3_ezg, model = autotuner_rf_wd_s, fun = predict, index = 5)
VR3_ezg_wd_a <- terra::predict(VR3_ezg, model = autotuner_rf_wd_a, fun = predict, index = 5)
VR3_ezg_wd_ra <- terra::predict(VR3_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 5)

#VR3_q_wd_k <- terra::predict(VR3_q, model = autotuner_rf_wd_k, fun = predict, index = 5)
#VR3_q_wd_s <- terra::predict(VR3_q, model = autotuner_rf_wd_s, fun = predict, index = 5)
#VR3_q_wd_a <- terra::predict(VR3_q, model = autotuner_rf_wd_a, fun = predict, index = 5)
#VR3_q_wd_ra <- terra::predict(VR3_q, model = autotuner_rf_wd_ra, fun = predict, index = 5)

# VR3  - predictor: velocity --------------------------------------------------
VR3_ezg_v_k <- terra::predict(VR3_ezg, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
VR3_ezg_v_s <- terra::predict(VR3_ezg, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
VR3_ezg_v_a <- terra::predict(VR3_ezg, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
VR3_ezg_v_ra <- terra::predict(VR3_ezg, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))

#VR3_q_v_k <- terra::predict(VR3_q, model = autotuner_rf_v_k, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#VR3_q_v_s <- terra::predict(VR3_q, model = autotuner_rf_v_s, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#VR3_q_v_a <- terra::predict(VR3_q, model = autotuner_rf_v_a, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
#VR3_q_v_ra <- terra::predict(VR3_q, model = autotuner_rf_v_ra, fun = predict, index = c("velocity", "froude", "shear_stress", "stream_power"))
```
...
# GL1 - predictor: velocity ---------------------------------------------------
GL1_ezg_m2_v_k <- raster::predict(GL1_ezg, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL1_ezg_m2_v_s <- raster::predict(GL1_ezg, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL1_ezg_m2_v_a <- raster::predict(GL1_ezg, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL1_ezg_m2_v_ra <- raster::predict(GL1_ezg, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL1_q_m2_v_k <- raster::predict(GL1_q, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL1_q_m2_v_s <- raster::predict(GL1_q, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL1_q_m2_v_a <- raster::predict(GL1_q, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL1_q_m2_v_ra <- raster::predict(GL1_q, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# GL2 - predictor: velocity ---------------------------------------------------
GL2_ezg_m2_v_k <- raster::predict(GL2_ezg, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL2_ezg_m2_v_s <- raster::predict(GL2_ezg, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL2_ezg_m2_v_a <- raster::predict(GL2_ezg, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL2_ezg_m2_v_ra <- raster::predict(GL2_ezg, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL2_q_m2_v_k <- raster::predict(GL2_q, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL2_q_m2_v_s <- raster::predict(GL2_q, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL2_q_m2_v_a <- raster::predict(GL2_q, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL2_q_m2_v_ra <- raster::predict(GL2_q, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# L2 - predictor: velocity ----------------------------------------------------
L2_ezg_m2_v_k <- raster::predict(L2_ezg, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

L2_ezg_m2_v_s <- raster::predict(L2_ezg, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

L2_ezg_m2_v_a <- raster::predict(L2_ezg, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

L2_ezg_m2_v_ra <- raster::predict(L2_ezg, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)


#L2_q_m2_v_k <- raster::predict(L2_q, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#L2_q_m2_v_s <- raster::predict(L2_q, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#L2_q_m2_v_a <- raster::predict(L2_q, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#L2_q_m2_v_ra <- raster::predict(L2_q, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# M1  - predictor: velocity ---------------------------------------------------
M1_ezg_m2_v_k <- raster::predict(M1_ezg, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

M1_ezg_m2_v_s <- raster::predict(M1_ezg, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

M1_ezg_m2_v_a <- raster::predict(M1_ezg, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

M1_ezg_m2_v_ra <- raster::predict(M1_ezg, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)


#M1_q_m2_v_k <- raster::predict(M1_q, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#M1_q_m2_v_s <- raster::predict(M1_q, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#M1_q_m2_v_a <- raster::predict(M1_q, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#M1_q_m2_v_ra <- raster::predict(M1_q, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# S1  - predictor: velocity ---------------------------------------------------
S1_ezg_m2_v_k <- raster::predict(S1_ezg, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S1_ezg_m2_v_s <- raster::predict(S1_ezg, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S1_ezg_m2_v_a <- raster::predict(S1_ezg, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S1_ezg_m2_v_ra <- raster::predict(S1_ezg, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S1_q_m2_v_k <- raster::predict(S1_q, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S1_q_m2_v_s <- raster::predict(S1_q, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S1_q_m2_v_a <- raster::predict(S1_q, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S1_q_m2_v_ra <- raster::predict(S1_q, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# S2  - predictor: velocity ---------------------------------------------------
S2_ezg_m2_v_k <- raster::predict(S2_ezg, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S2_ezg_m2_v_s <- raster::predict(S2_ezg, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S2_ezg_m2_v_a <- raster::predict(S2_ezg, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S2_ezg_m2_v_ra <- raster::predict(S2_ezg, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S2_q_m2_v_k <- raster::predict(S2_q, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S2_q_m2_v_s <- raster::predict(S2_q, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S2_q_m2_v_a <- raster::predict(S2_q, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S2_q_m2_v_ra <- raster::predict(S2_q, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# TH4  - predictor: velocity --------------------------------------------------
TH4_ezg_m2_v_k <- raster::predict(TH4_ezg, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

TH4_ezg_m2_v_s <- raster::predict(TH4_ezg, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

TH4_ezg_m2_v_a <- raster::predict(TH4_ezg, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

TH4_ezg_m2_v_ra <- raster::predict(TH4_ezg, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#TH4_q_m2_v_k <- raster::predict(TH4_q, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#TH4_q_m2_v_s <- raster::predict(TH4_q, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#TH4_q_m2_v_a <- raster::predict(TH4_q, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#TH4_q_m2_v_ra <- raster::predict(TH4_q, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# VR3  - predictor: velocity --------------------------------------------------
VR3_ezg_m2_v_k <- raster::predict(VR3_ezg, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

VR3_ezg_m2_v_s <- raster::predict(VR3_ezg, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

VR3_ezg_m2_v_a <- raster::predict(VR3_ezg, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

VR3_ezg_m2_v_ra <- raster::predict(VR3_ezg, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#VR3_q_m2_v_k <- raster::predict(VR3_q, rf_model_v_k_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#VR3_q_m2_v_s <- raster::predict(VR3_q, rf_model_v_s_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#VR3_q_m2_v_a <- raster::predict(VR3_q, rf_model_v_a_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#VR3_q_m2_v_ra <- raster::predict(VR3_q, rf_model_v_ra_c, index = c("velocity", "froude", "shear_stress", "stream_power"), type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
```
