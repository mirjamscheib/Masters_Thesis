...
data_wd <- read_delim("Pre_Processing/abiotic_mi_sampling/lab_ml_wd_v_add.csv") 
...
rf_model_sec_a <- ranger(formula = abundance ~., data = training_sec_a, mtry = 35, sample.fraction = 0.7833582, min.node.size = 2, importance = "impurity")
