...
### velocity -----------------------------------------------------------
# pdp_v_s <- partial(autotuner_rf_v_s, pred.var = c("velocity"))
pdp_model_wd_s <- pdp::partial(rf_model_wd_s, pred.var = "velocity") |>
  mutate(predictors = "velocity")
pdp_model_wd_s_c <- pdp::partial(rf_model_wd_s_c, pred.var = "velocity")|>
  mutate(predictors = "velocity_c")
...
### velocity -----------------------------------------------------------
# pdp_v_a <- partial(autotuner_rf_v_a, pred.var = c("velocity"))
pdp_model_wd_a <- pdp::partial(rf_model_wd_a, pred.var = "velocity") |>
  mutate(predictors = "velocity")
pdp_model_wd_a_c <- pdp::partial(rf_model_wd_a_c, pred.var = "velocity")|>
  mutate(predictors = "velocity_c")
...
### velocity -----------------------------------------------------------
# pdp_v_ra <- partial(autotuner_rf_v_ra, pred.var = c("velocity"))
pdp_model_wd_ra <- pdp::partial(rf_model_wd_ra, pred.var = "velocity") |>
  mutate(predictors = "velocity")
pdp_model_wd_ra_c <- pdp::partial(rf_model_wd_ra_c, pred.var = "velocity")|>
  mutate(predictors = "velocity_c")
...
pdp_model_clog_3_samp_k_c <- pdp::partial(rf_model_samp_k_c, pred.var = "sub_type_int") |>
...
pdp_model_sub_samp_s <- pdp::partial(rf_model_samp_s, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type")
pdp_model_clog_3_samp_s_c <- pdp::partial(rf_model_samp_s_c, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type_c")
...
pdp_model_sub_samp_a <- pdp::partial(rf_model_samp_a, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type")
pdp_model_clog_3_samp_a_c <- pdp::partial(rf_model_samp_a_c, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type_c")
...
pdp_model_sub_samp_ra <- pdp::partial(rf_model_samp_ra, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type")
pdp_model_clog_3_samp_ra_c <- pdp::partial(rf_model_samp_ra_c, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type_c")
```
...
pdp_model_wd_sec_k <- pdp::partial(rf_model_sec_k, pred.var = "wd_m") |>
  mutate(predictors = "wd_m")
pdp_model_sec_k_c <- pdp::partial(rf_model_sec_k_c, pred.var = "wd_m")|>
  mutate(predictors = "wd_m_c")
...
pdp_model_sub_sec_k <- pdp::partial(rf_model_sec_k, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type")
pdp_model_clog_3_sec_k_c <- pdp::partial(rf_model_sec_k_c, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type_c")
...
### reach --------------------------------------------------------
pdp_model_r_sec_s <- pdp::partial(rf_model_sec_s, pred.var = "Reach_Untersuchungsstelle") |>
  mutate(predictors = "Reach_Untersuchungsstelle")
pdp_model_r_sec_s_c <- pdp::partial(rf_model_sec_s_c, pred.var = "Reach_Untersuchungsstelle") |>
  mutate(predictors = "Reach_Untersuchungsstelle_c")
...
pdp_model_sub_sec_s <- pdp::partial(rf_model_sec_s, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type")
pdp_model_clog_3_sec_s_c <- pdp::partial(rf_model_sec_s_c, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type_c")
...
pdp_model_sub_sec_a <- pdp::partial(rf_model_sec_a, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type")
pdp_model_clog_3_sec_a_c <- pdp::partial(rf_model_sec_a_c, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type_c")
...
pdp_model_sub_sec_ra <- pdp::partial(rf_model_sec_ra, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type")
pdp_model_clog_3_sec_ra_c <- pdp::partial(rf_model_sec_ra_c, pred.var = "sub_type_int") |>
  mutate(predictors = "sub_type_c")
```
