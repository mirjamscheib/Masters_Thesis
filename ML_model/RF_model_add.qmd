...
#   mtry sample.fraction min.node.size 
#1:    1       0.4870585             7         
rf_model_sec_k <- ranger(formula = k_index ~., data = training_sec_k, mtry = 1, sample.fraction = 0.4870585, min.node.size = 7, importance = "impurity")

# With shannon index as response
#   mtry sample.fraction min.node.size 
#1:   32        0.365004             8         
rf_model_sec_s <- ranger(formula = shannon ~., data = training_sec_s, mtry = 32, sample.fraction = 0.365004, min.node.size = 8, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    1       0.3062136             4           
rf_model_sec_a <- ranger(formula = abundance ~., data = training_sec_a, mtry = 1, sample.fraction = 0.3062136, min.node.size = 4, importance = "impurity")
