...
# predict ML model to rasters with velocity and wd 
# GL1 - predictor: velocity ---------------------------------------------------
GL1_a_min <- raster::predict(GL1_min, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
GL1_a_max <- raster::predict(GL1_max, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
GL1_a_pers <- mask(GL1_a_max, GL1_a_min)

GL1_ra_min <- raster::predict(GL1_min, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
GL1_ra_max <- raster::predict(GL1_max, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
GL1_ra_pers <- mask(GL1_ra_max, GL1_ra_min)

# GL1 write rasters ---------------------
writeRaster(GL1_a_min, "ML_model/scenarios/GL1_a_min_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(GL1_a_max, "ML_model/scenarios/GL1_a_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(GL1_a_pers, "ML_model/scenarios/GL1_a_pers_rf.tif", format = "GTiff", overwrite = TRUE)

writeRaster(GL1_ra_min, "ML_model/scenarios/GL1_ra_min_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(GL1_ra_max, "ML_model/scenarios/GL1_ra_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(GL1_ra_pers, "ML_model/scenarios/GL1_ra_pers_rf.tif", format = "GTiff", overwrite = TRUE)

# GL2 - predictor: velocity ---------------------------------------------------
GL2_a_min <- raster::predict(GL2_min, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
GL2_a_max <- raster::predict(GL2_max, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
GL2_a_pers <- mask(GL2_a_max, GL2_a_min)

GL2_ra_min <- raster::predict(GL2_min, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
GL2_ra_max <- raster::predict(GL2_max, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
GL2_ra_pers <- mask(GL2_ra_max, GL2_ra_min)

# GL2 write rasters ---------------------
writeRaster(GL2_a_min, "ML_model/scenarios/GL2_a_min_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(GL2_a_max, "ML_model/scenarios/GL2_a_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(GL2_a_pers, "ML_model/scenarios/GL2_a_pers_rf.tif", format = "GTiff", overwrite = TRUE)

writeRaster(GL2_ra_min, "ML_model/scenarios/GL2_ra_min_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(GL2_ra_max, "ML_model/scenarios/GL2_ra_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(GL2_ra_pers, "ML_model/scenarios/GL2_ra_pers_rf.tif", format = "GTiff", overwrite = TRUE)

# L2 - predictor: velocity ----------------------------------------------------
L2_a_base <- raster::predict(L2_base, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
L2_a_peak <- raster::predict(L2_peak, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
L2_a_max <- raster::predict(L2_max, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
L2_a_pers <- mask(L2_a_peak, L2_a_base)

L2_ra_base <- raster::predict(L2_base, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
L2_ra_peak <- raster::predict(L2_peak, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
L2_ra_max <- raster::predict(L2_max, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
L2_ra_pers <- mask(L2_ra_peak, L2_ra_base)

# L2 write rasters ---------------------
writeRaster(L2_a_base, "ML_model/scenarios/L2_a_base_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(L2_a_peak, "ML_model/scenarios/L2_a_peak_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(L2_a_max, "ML_model/scenarios/L2_a_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(L2_a_pers, "ML_model/scenarios/L2_a_pers_rf.tif", format = "GTiff", overwrite = TRUE)

writeRaster(L2_ra_base, "ML_model/scenarios/L2_ra_base_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(L2_ra_peak, "ML_model/scenarios/L2_ra_peak_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(L2_ra_max, "ML_model/scenarios/L2_ra_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(L2_ra_pers, "ML_model/scenarios/L2_ra_pers_rf.tif", format = "GTiff", overwrite = TRUE)

# M1  - predictor: velocity ---------------------------------------------------
M1_a_base <- raster::predict(M1_base, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
M1_a_peak <- raster::predict(M1_peak, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
M1_a_max <- raster::predict(M1_max, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
M1_a_pers <- mask(M1_a_peak, M1_a_base)

M1_ra_base <- raster::predict(M1_base, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
M1_ra_peak <- raster::predict(M1_peak, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
M1_ra_max <- raster::predict(M1_max, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
M1_ra_pers <- mask(M1_ra_peak, M1_ra_base)

# M1 write rasters ---------------------
writeRaster(M1_a_base, "ML_model/scenarios/M1_a_base_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(M1_a_peak, "ML_model/scenarios/M1_a_peak_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(M1_a_max, "ML_model/scenarios/M1_a_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(M1_a_pers, "ML_model/scenarios/M1_a_pers_rf.tif", format = "GTiff", overwrite = TRUE)

writeRaster(M1_ra_base, "ML_model/scenarios/M1_ra_base_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(M1_ra_peak, "ML_model/scenarios/M1_ra_peak_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(M1_ra_max, "ML_model/scenarios/M1_ra_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(M1_ra_pers, "ML_model/scenarios/M1_ra_pers_rf.tif", format = "GTiff", overwrite = TRUE)

# S1  - predictor: velocity ---------------------------------------------------
S1_a_base <- raster::predict(S1_base, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S1_a_peak <- raster::predict(S1_peak, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S1_a_max <- raster::predict(S1_max, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S1_a_pers <- mask(S1_a_peak, S1_a_base)

S1_ra_base <- raster::predict(S1_base, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S1_ra_peak <- raster::predict(S1_peak, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S1_ra_max <- raster::predict(S1_max, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S1_ra_pers <- mask(S1_ra_peak, S1_ra_base)

# S1 write rasters ---------------------
writeRaster(S1_a_base, "ML_model/scenarios/S1_a_base_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S1_a_peak, "ML_model/scenarios/S1_a_peak_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S1_a_max, "ML_model/scenarios/S1_a_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S1_a_pers, "ML_model/scenarios/S1_a_pers_rf.tif", format = "GTiff", overwrite = TRUE)

writeRaster(S1_ra_base, "ML_model/scenarios/S1_ra_base_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S1_ra_peak, "ML_model/scenarios/S1_ra_peak_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S1_ra_max, "ML_model/scenarios/S1_ra_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S1_ra_pers, "ML_model/scenarios/S1_ra_pers_rf.tif", format = "GTiff", overwrite = TRUE)

# S2  - predictor: velocity ---------------------------------------------------
S2_a_base <- raster::predict(S2_base, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S2_a_peak <- raster::predict(S2_peak, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S2_a_max <- raster::predict(S2_max, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S2_a_pers <- mask(S2_a_peak, S2_a_base)

S2_ra_base <- raster::predict(S2_base, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S2_ra_peak <- raster::predict(S2_peak, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S2_ra_max <- raster::predict(S2_max, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
S2_ra_pers <- mask(S2_ra_peak, S2_ra_base)

# S2 write rasters ---------------------
writeRaster(S2_a_base, "ML_model/scenarios/S2_a_base_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S2_a_peak, "ML_model/scenarios/S2_a_peak_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S2_a_max, "ML_model/scenarios/S2_a_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S2_a_pers, "ML_model/scenarios/S2_a_pers_rf.tif", format = "GTiff", overwrite = TRUE)

writeRaster(S2_ra_base, "ML_model/scenarios/S2_ra_base_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S2_ra_peak, "ML_model/scenarios/S2_ra_peak_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S2_ra_max, "ML_model/scenarios/S2_ra_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(S2_ra_pers, "ML_model/scenarios/S2_ra_pers_rf.tif", format = "GTiff", overwrite = TRUE)

# TH4  - predictor: velocity --------------------------------------------------
TH4_a_min <- raster::predict(TH4_min, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
TH4_a_max <- raster::predict(TH4_max, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
TH4_a_pers <- mask(TH4_a_max, TH4_a_min)

TH4_ra_min <- raster::predict(TH4_min, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
TH4_ra_max <- raster::predict(TH4_max, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
TH4_ra_pers <- mask(TH4_ra_max, TH4_ra_min)

# TH4 write rasters ---------------------
writeRaster(TH4_a_min, "ML_model/scenarios/TH4_a_min_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(TH4_a_max, "ML_model/scenarios/TH4_a_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(TH4_a_pers, "ML_model/scenarios/TH4_a_pers_rf.tif", format = "GTiff", overwrite = TRUE)

writeRaster(TH4_ra_min, "ML_model/scenarios/TH4_ra_min_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(TH4_ra_max, "ML_model/scenarios/TH4_ra_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(TH4_ra_pers, "ML_model/scenarios/TH4_ra_pers_rf.tif", format = "GTiff", overwrite = TRUE)

# VR3  - predictor: velocity --------------------------------------------------
VR3_a_base <- raster::predict(VR3_base, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
VR3_a_peak <- raster::predict(VR3_peak, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
VR3_a_max <- raster::predict(VR3_max, rf_model_v_a_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
VR3_a_pers <- mask(VR3_a_peak, VR3_a_base)

VR3_ra_base <- raster::predict(VR3_base, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
VR3_ra_peak <- raster::predict(VR3_peak, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
VR3_ra_max <- raster::predict(VR3_max, rf_model_v_ra_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
VR3_ra_pers <- mask(VR3_ra_peak, VR3_ra_base)

# VR3 write rasters ---------------------
writeRaster(VR3_a_base, "ML_model/scenarios/VR3_a_base_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(VR3_a_peak, "ML_model/scenarios/VR3_a_peak_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(VR3_a_max, "ML_model/scenarios/VR3_a_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(VR3_a_pers, "ML_model/scenarios/VR3_a_pers_rf.tif", format = "GTiff", overwrite = TRUE)

writeRaster(VR3_ra_base, "ML_model/scenarios/VR3_ra_base_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(VR3_ra_peak, "ML_model/scenarios/VR3_ra_peak_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(VR3_ra_max, "ML_model/scenarios/VR3_ra_max_rf.tif", format = "GTiff", overwrite = TRUE)
writeRaster(VR3_ra_pers, "ML_model/scenarios/VR3_ra_pers_rf.tif", format = "GTiff", overwrite = TRUE)
```