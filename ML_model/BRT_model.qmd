...
# With k_index as response
#          eta nrounds max_depth subsample 
#1: 0.5636679     288      6809 0.6401843                       
...
# With shannon index as response 
#        eta nrounds max_depth subsample 
#1: 0.1276577     317      4543 0.6723684                       
...
# With abundance as response
#        eta nrounds max_depth subsample 
#1: 0.5152168     998      2426 0.7190905                        
...
# With rel_abundance as response 
#         eta nrounds max_depth subsample 
#1: 0.2697786     591      5146 0.7175143                        
...
# With k_index as response
#           eta nrounds max_depth subsample 
#1: 0.002298211      85      2617 0.5574753                     
...
# With shannon index as response 
#        eta nrounds max_depth subsample
#1: 0.4108909     913      3270 0.6627291                  
...
# With abundance as response
#         eta nrounds max_depth subsample
#1: 0.3661002     927      2711 0.6581734                      
...
# With rel_abundance as response 
#         eta nrounds max_depth subsample
#1: 0.00985118     113      9656  0.519288                    
...
write.csv(pred_train_2, "Stat_Analysis/stat_analysis_data/regr_pred_train_2_brt.csv", row.names = FALSE)
```
...
write.csv(metric_results_measured, "Stat_Analysis/stat_analysis_data/ml_evaluation_metrics_measured_brt.csv", row.names = FALSE)

write.csv(metric_results_raster, "Stat_Analysis/stat_analysis_data/ml_evaluation_metrics_raster_brt.csv", row.names = FALSE)

write.csv(metrics_training, "Stat_Analysis/stat_analysis_data/ml_evaluation_metrics_training_brt.csv", row.names = FALSE)

write.csv(all_metrics, "Stat_Analysis/stat_analysis_data/ml_evaluation_metrics_all_brt.csv", row.names = FALSE)
```
