...
#brt_pred_model_v_k_c <- predict(xgb_v_k_c, newdata = testx_v_k_c[ ,-1])
...
### VELOCITY + WD AS PREDICTORS ###
# k_index and velocity + wd
xbrt_pred_wd_k <- predict(autotuner_xbrt_wd_k, newdata = test_wd_k)
xbrt_pred_model_wd_k <- predict(xgb_wd_ra, newdata = testx_wd_k[ ,-1])
xbrt_pred_model_wd_k_c <- predict(xgb_wd_ra_c, newdata = testx_wd_k_c[ ,-1])
