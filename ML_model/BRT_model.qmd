...
bias_model_sec_s <- bias(observados = responses_model_sec_s, 
                    estimados = brt_pred_model_sec_s)
bias_model_sec_s_c <- bias(observados = responses_model_sec_s, 
...
### ONLY VELOCITY AS PREDICTOR ###
# k_index and velocity
nse_v_k <- 1 - sum((responses_v_k - brt_pred_v_k)^2) / sum((responses_v_k - mean(responses_v_k))^2)

nse_v_k_test <- NSE(sim = brt_pred_v_k, obs = responses_v_k)
