...
data_section <- read_delim("Pre_Processing/abiotic_mi_sampling/lab_ml_section.csv") |>
  ...
  mutate(date_time = as.POSIXct(date_time, format = "%d.%m.%Y.%H:%M",tz = "UTC"),
         ...
         hydr_riv_type = as.factor(Hydropeaking_river_type),
         hydr_type = as.factor(Hydrokeaking_residual_flow_natural_near_natural),
  ...
  dplyr::select(-date_time, -time_before, -time_during, -time_after, -Hydropeaking_river_type, -Hydrokeaking_residual_flow_natural_near_natural)
```
