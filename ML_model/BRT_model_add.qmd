...
# export data 
write.csv(pdp_model_v_wd_ra, "ML_Model/pdp_data/pdp_v_wd_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_wd_ra_c, "ML_Model/pdp_data/pdp_v_wd_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_ra, "ML_Model/pdp_data/pdp_wd_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_ra_c, "ML_Model/pdp_data/pdp_wd_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_wd_ra, "ML_Model/pdp_data/pdp_x_wd_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_ra, "ML_Model/pdp_data/pdp_y_wd_ra_brt_add.csv", row.names = FALSE)
...
# GL1 - predictors: v + wd ----------------------------------------------------
GL1_ezg_wd_k <- terra::predict(GL1_ezg, model = autotuner_xbrt_wd_k, fun = predict)
GL1_ezg_wd_s <- terra::predict(GL1_ezg, model = autotuner_xbrt_wd_s, fun = predict)
GL1_ezg_wd_a <- terra::predict(GL1_ezg, model = autotuner_xbrt_wd_a, fun = predict)
GL1_ezg_wd_ra <- terra::predict(GL1_ezg, model = autotuner_xbrt_wd_ra, fun = predict)

#GL1_q_wd_k <- terra::predict(GL1_q, model = autotuner_xbrt_wd_k, fun = predict)
#GL1_q_wd_s <- terra::predict(GL1_q, model = autotuner_xbrt_wd_s, fun = predict)
#GL1_q_wd_a <- terra::predict(GL1_q, model = autotuner_xbrt_wd_a, fun = predict)
#GL1_q_wd_ra <- terra::predict(GL1_q, model = autotuner_xbrt_wd_ra, fun = predict)

# GL1 - predictor: velocity ---------------------------------------------------
GL1_ezg_v_k <- terra::predict(GL1_v_ezg, model = autotuner_xbrt_v_k, fun = predict)
GL1_ezg_v_s <- terra::predict(GL1_v_ezg, model = autotuner_xbrt_v_s, fun = predict)
GL1_ezg_v_a <- terra::predict(GL1_v_ezg, model = autotuner_xbrt_v_a, fun = predict)
GL1_ezg_v_ra <- terra::predict(GL1_v_ezg, model = autotuner_xbrt_v_ra, fun = predict)

#GL1_q_v_k <- terra::predict(GL1_v_q, model = autotuner_xbrt_v_k, fun = predict)
#GL1_q_v_s <- terra::predict(GL1_v_q, model = autotuner_xbrt_v_s, fun = predict)
#GL1_q_v_a <- terra::predict(GL1_v_q, model = autotuner_xbrt_v_a, fun = predict)
#GL1_q_v_ra <- terra::predict(GL1_v_q, model = autotuner_xbrt_v_ra, fun = predict)

# GL2 - predictors: v + wd ----------------------------------------------------
GL2_ezg_wd_k <- terra::predict(GL2_ezg, model = autotuner_xbrt_wd_k, fun = predict)
GL2_ezg_wd_s <- terra::predict(GL2_ezg, model = autotuner_xbrt_wd_s, fun = predict)
GL2_ezg_wd_a <- terra::predict(GL2_ezg, model = autotuner_xbrt_wd_a, fun = predict)
GL2_ezg_wd_ra <- terra::predict(GL2_ezg, model = autotuner_xbrt_wd_ra, fun = predict)

#GL2_q_wd_k <- terra::predict(GL2_q, model = autotuner_xbrt_wd_k, fun = predict)
#GL2_q_wd_s <- terra::predict(GL2_q, model = autotuner_xbrt_wd_s, fun = predict)
#GL2_q_wd_a <- terra::predict(GL2_q, model = autotuner_xbrt_wd_a, fun = predict)
#GL2_q_wd_ra <- terra::predict(GL2_q, model = autotuner_xbrt_wd_ra, fun = predict)

# GL2 - predictor: velocity ---------------------------------------------------
GL2_ezg_v_k <- terra::predict(GL2_v_ezg, model = autotuner_xbrt_v_k, fun = predict)
GL2_ezg_v_s <- terra::predict(GL2_v_ezg, model = autotuner_xbrt_v_s, fun = predict)
GL2_ezg_v_a <- terra::predict(GL2_v_ezg, model = autotuner_xbrt_v_a, fun = predict)
GL2_ezg_v_ra <- terra::predict(GL2_v_ezg, model = autotuner_xbrt_v_ra, fun = predict)

#GL2_q_v_k <- terra::predict(GL2_v_q, model = autotuner_xbrt_v_k, fun = predict)
#GL2_q_v_s <- terra::predict(GL2_v_q, model = autotuner_xbrt_v_s, fun = predict)
#GL2_q_v_a <- terra::predict(GL2_v_q, model = autotuner_xbrt_v_a, fun = predict)
#GL2_q_v_ra <- terra::predict(GL2_v_q, model = autotuner_xbrt_v_ra, fun = predict)

# L2 - predictors: v + wd -----------------------------------------------------
L2_ezg_wd_k <- terra::predict(L2_ezg, model = autotuner_xbrt_wd_k, fun = predict)
L2_ezg_wd_s <- terra::predict(L2_ezg, model = autotuner_xbrt_wd_s, fun = predict)
L2_ezg_wd_a <- terra::predict(L2_ezg, model = autotuner_xbrt_wd_a, fun = predict)
L2_ezg_wd_ra <- terra::predict(L2_ezg, model = autotuner_xbrt_wd_ra, fun = predict)

#L2_q_wd_k <- terra::predict(L2_q, model = autotuner_xbrt_wd_k, fun = predict)
#L2_q_wd_s <- terra::predict(L2_q, model = autotuner_xbrt_wd_s, fun = predict)
#L2_q_wd_a <- terra::predict(L2_q, model = autotuner_xbrt_wd_a, fun = predict)
#L2_q_wd_ra <- terra::predict(L2_q, model = autotuner_xbrt_wd_ra, fun = predict)

# L2 - predictor: velocity ----------------------------------------------------
L2_ezg_v_k <- terra::predict(L2_v_ezg, model = autotuner_xbrt_v_k, fun = predict)
L2_ezg_v_s <- terra::predict(L2_v_ezg, model = autotuner_xbrt_v_s, fun = predict)
L2_ezg_v_a <- terra::predict(L2_v_ezg, model = autotuner_xbrt_v_a, fun = predict)
L2_ezg_v_ra <- terra::predict(L2_v_ezg, model = autotuner_xbrt_v_ra, fun = predict)

#L2_q_v_k <- terra::predict(L2_v_q, model = autotuner_xbrt_v_k, fun = predict)
#L2_q_v_s <- terra::predict(L2_v_q, model = autotuner_xbrt_v_s, fun = predict)
#L2_q_v_a <- terra::predict(L2_v_q, model = autotuner_xbrt_v_a, fun = predict)
#L2_q_v_ra <- terra::predict(L2_v_q, model = autotuner_xbrt_v_ra, fun = predict)

# M1  - predictors: v + wd -----------------------------------------------------
M1_ezg_wd_k <- terra::predict(M1_ezg, model = autotuner_xbrt_wd_k, fun = predict)
M1_ezg_wd_s <- terra::predict(M1_ezg, model = autotuner_xbrt_wd_s, fun = predict)
M1_ezg_wd_a <- terra::predict(M1_ezg, model = autotuner_xbrt_wd_a, fun = predict)
M1_ezg_wd_ra <- terra::predict(M1_ezg, model = autotuner_xbrt_wd_ra, fun = predict)

#M1_q_wd_k <- terra::predict(M1_q, model = autotuner_xbrt_wd_k, fun = predict)
#M1_q_wd_s <- terra::predict(M1_q, model = autotuner_xbrt_wd_s, fun = predict)
#M1_q_wd_a <- terra::predict(M1_q, model = autotuner_xbrt_wd_a, fun = predict)
#M1_q_wd_ra <- terra::predict(M1_q, model = autotuner_xbrt_wd_ra, fun = predict)

# M1  - predictor: velocity ---------------------------------------------------
M1_ezg_v_k <- terra::predict(M1_v_ezg, model = autotuner_xbrt_v_k, fun = predict)
M1_ezg_v_s <- terra::predict(M1_v_ezg, model = autotuner_xbrt_v_s, fun = predict)
M1_ezg_v_a <- terra::predict(M1_v_ezg, model = autotuner_xbrt_v_a, fun = predict)
M1_ezg_v_ra <- terra::predict(M1_v_ezg, model = autotuner_xbrt_v_ra, fun = predict)

#M1_q_v_k <- terra::predict(M1_v_q, model = autotuner_xbrt_v_k, fun = predict)
#M1_q_v_s <- terra::predict(M1_v_q, model = autotuner_xbrt_v_s, fun = predict)
#M1_q_v_a <- terra::predict(M1_v_q, model = autotuner_xbrt_v_a, fun = predict)
#M1_q_v_ra <- terra::predict(M1_v_q, model = autotuner_xbrt_v_ra, fun = predict)

# S1  - predictors: v + wd ----------------------------------------------------
S1_ezg_wd_k <- terra::predict(S1_ezg, model = autotuner_xbrt_wd_k, fun = predict)
S1_ezg_wd_s <- terra::predict(S1_ezg, model = autotuner_xbrt_wd_s, fun = predict)
S1_ezg_wd_a <- terra::predict(S1_ezg, model = autotuner_xbrt_wd_a, fun = predict)
S1_ezg_wd_ra <- terra::predict(S1_ezg, model = autotuner_xbrt_wd_ra, fun = predict)

#S1_q_wd_k <- terra::predict(S1_q, model = autotuner_xbrt_wd_k, fun = predict)
#S1_q_wd_s <- terra::predict(S1_q, model = autotuner_xbrt_wd_s, fun = predict)
#S1_q_wd_a <- terra::predict(S1_q, model = autotuner_xbrt_wd_a, fun = predict)
#S1_q_wd_ra <- terra::predict(S1_q, model = autotuner_xbrt_wd_ra, fun = predict)

# S1  - predictor: velocity ---------------------------------------------------
S1_ezg_v_k <- terra::predict(S1_v_ezg, model = autotuner_xbrt_v_k, fun = predict)
S1_ezg_v_s <- terra::predict(S1_v_ezg, model = autotuner_xbrt_v_s, fun = predict)
S1_ezg_v_a <- terra::predict(S1_v_ezg, model = autotuner_xbrt_v_a, fun = predict)
S1_ezg_v_ra <- terra::predict(S1_v_ezg, model = autotuner_xbrt_v_ra, fun = predict)

#S1_q_v_k <- terra::predict(S1_v_q, model = autotuner_xbrt_v_k, fun = predict)
#S1_q_v_s <- terra::predict(S1_v_q, model = autotuner_xbrt_v_s, fun = predict)
#S1_q_v_a <- terra::predict(S1_v_q, model = autotuner_xbrt_v_a, fun = predict)
#S1_q_v_ra <- terra::predict(S1_v_q, model = autotuner_xbrt_v_ra, fun = predict)

# S2  - predictors: v + wd ----------------------------------------------------
S2_ezg_wd_k <- terra::predict(S2_ezg, model = autotuner_xbrt_wd_k, fun = predict)
S2_ezg_wd_s <- terra::predict(S2_ezg, model = autotuner_xbrt_wd_s, fun = predict)
S2_ezg_wd_a <- terra::predict(S2_ezg, model = autotuner_xbrt_wd_a, fun = predict)
S2_ezg_wd_ra <- terra::predict(S2_ezg, model = autotuner_xbrt_wd_ra, fun = predict)

#S2_q_wd_k <- terra::predict(S2_q, model = autotuner_xbrt_wd_k, fun = predict)
#S2_q_wd_s <- terra::predict(S2_q, model = autotuner_xbrt_wd_s, fun = predict)
#S2_q_wd_a <- terra::predict(S2_q, model = autotuner_xbrt_wd_a, fun = predict)
#S2_q_wd_ra <- terra::predict(S2_q, model = autotuner_xbrt_wd_ra, fun = predict)

# S2  - predictor: velocity ---------------------------------------------------
S2_ezg_v_k <- terra::predict(S2_v_ezg, model = autotuner_xbrt_v_k, fun = predict)
S2_ezg_v_s <- terra::predict(S2_v_ezg, model = autotuner_xbrt_v_s, fun = predict)
S2_ezg_v_a <- terra::predict(S2_v_ezg, model = autotuner_xbrt_v_a, fun = predict)
S2_ezg_v_ra <- terra::predict(S2_v_ezg, model = autotuner_xbrt_v_ra, fun = predict)

#S2_q_v_k <- terra::predict(S2_v_q, model = autotuner_xbrt_v_k, fun = predict)
#S2_q_v_s <- terra::predict(S2_v_q, model = autotuner_xbrt_v_s, fun = predict)
#S2_q_v_a <- terra::predict(S2_v_q, model = autotuner_xbrt_v_a, fun = predict)
#S2_q_v_ra <- terra::predict(S2_v_q, model = autotuner_xbrt_v_ra, fun = predict)

# TH4  - predictors: v + wd ---------------------------------------------------
TH4_ezg_wd_k <- terra::predict(TH4_ezg, model = autotuner_xbrt_wd_k, fun = predict)
TH4_ezg_wd_s <- terra::predict(TH4_ezg, model = autotuner_xbrt_wd_s, fun = predict)
TH4_ezg_wd_a <- terra::predict(TH4_ezg, model = autotuner_xbrt_wd_a, fun = predict)
TH4_ezg_wd_ra <- terra::predict(TH4_ezg, model = autotuner_xbrt_wd_ra, fun = predict)

#TH4_q_wd_k <- terra::predict(TH4_q, model = autotuner_xbrt_wd_k, fun = predict)
#TH4_q_wd_s <- terra::predict(TH4_q, model = autotuner_xbrt_wd_s, fun = predict)
#TH4_q_wd_a <- terra::predict(TH4_q, model = autotuner_xbrt_wd_a, fun = predict)
#TH4_q_wd_ra <- terra::predict(TH4_q, model = autotuner_xbrt_wd_ra, fun = predict)

# TH4  - predictor: velocity --------------------------------------------------
TH4_ezg_v_k <- terra::predict(TH4_v_ezg, model = autotuner_xbrt_v_k, fun = predict)
TH4_ezg_v_s <- terra::predict(TH4_v_ezg, model = autotuner_xbrt_v_s, fun = predict)
TH4_ezg_v_a <- terra::predict(TH4_v_ezg, model = autotuner_xbrt_v_a, fun = predict)
TH4_ezg_v_ra <- terra::predict(TH4_v_ezg, model = autotuner_xbrt_v_ra, fun = predict)

#TH4_q_v_k <- terra::predict(TH4_v_q, model = autotuner_xbrt_v_k, fun = predict)
#TH4_q_v_s <- terra::predict(TH4_v_q, model = autotuner_xbrt_v_s, fun = predict)
#TH4_q_v_a <- terra::predict(TH4_v_q, model = autotuner_xbrt_v_a, fun = predict)
#TH4_q_v_ra <- terra::predict(TH4_v_q, model = autotuner_xbrt_v_ra, fun = predict)

# VR3  - predictors: v + wd ---------------------------------------------------
VR3_ezg_wd_k <- terra::predict(VR3_ezg, model = autotuner_xbrt_wd_k, fun = predict)
VR3_ezg_wd_s <- terra::predict(VR3_ezg, model = autotuner_xbrt_wd_s, fun = predict)
VR3_ezg_wd_a <- terra::predict(VR3_ezg, model = autotuner_xbrt_wd_a, fun = predict)
VR3_ezg_wd_ra <- terra::predict(VR3_ezg, model = autotuner_xbrt_wd_ra, fun = predict)

#VR3_q_wd_k <- terra::predict(VR3_q, model = autotuner_xbrt_wd_k, fun = predict)
#VR3_q_wd_s <- terra::predict(VR3_q, model = autotuner_xbrt_wd_s, fun = predict)
#VR3_q_wd_a <- terra::predict(VR3_q, model = autotuner_xbrt_wd_a, fun = predict)
#VR3_q_wd_ra <- terra::predict(VR3_q, model = autotuner_xbrt_wd_ra, fun = predict)

# VR3  - predictor: velocity --------------------------------------------------
VR3_ezg_v_k <- terra::predict(VR3_v_ezg, model = autotuner_xbrt_v_k, fun = predict)
VR3_ezg_v_s <- terra::predict(VR3_v_ezg, model = autotuner_xbrt_v_s, fun = predict)
VR3_ezg_v_a <- terra::predict(VR3_v_ezg, model = autotuner_xbrt_v_a, fun = predict)
VR3_ezg_v_ra <- terra::predict(VR3_v_ezg, model = autotuner_xbrt_v_ra, fun = predict)

#VR3_q_v_k <- terra::predict(VR3_v_q, model = autotuner_xbrt_v_k, fun = predict)
#VR3_q_v_s <- terra::predict(VR3_v_q, model = autotuner_xbrt_v_s, fun = predict)
#VR3_q_v_a <- terra::predict(VR3_v_q, model = autotuner_xbrt_v_a, fun = predict)
#VR3_q_v_ra <- terra::predict(VR3_v_q, model = autotuner_xbrt_v_ra, fun = predict)
```
