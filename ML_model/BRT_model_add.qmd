...
pdp_model_v_k <- pdp::partial(xgb_v_k, pred.var = "velocity", train = trainx_v_k[ ,-1]) |>
  mutate(predictors = "velocity",
         ...
         index = "k_index")
pdp_model_v_k_c <- pdp::partial(xgb_v_k_c, pred.var = "velocity", train = trainx_v_k_c[ ,-1])|>
  mutate(predictors = "velocity_c",
         model = "velocity w/o coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_v_k, "ML_Model/pdp_data/pdp_v_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_k_c, "ML_Model/pdp_data/pdp_v_k_c_brt_add.csv", row.names = FALSE)

### x/y
pdp_model_x_v_k <- pdp::partial(xgb_v_k, pred.var = "x", train = trainx_v_k[ ,-1]) |>
  mutate(predictors = "x",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_y_v_k <- pdp::partial(xgb_v_k, pred.var = "y", train = trainx_v_k[ ,-1]) |>
  mutate(predictors = "y",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_x_v_k, "ML_Model/pdp_data/pdp_x_v_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_v_k, "ML_Model/pdp_data/pdp_y_v_k_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_v_k <- pdp::partial(xgb_v_k, pred.var = "froude", train = trainx_v_k[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_f_v_k_c <- pdp::partial(xgb_v_k_c, pred.var = "froude", train = trainx_v_k_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_f_v_k, "ML_Model/pdp_data/pdp_f_v_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_v_k_c, "ML_Model/pdp_data/pdp_f_v_k_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_v_k <- pdp::partial(xgb_v_k, pred.var = "shear_stress", train = trainx_v_k[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_s_v_k_c <- pdp::partial(xgb_v_k_c, pred.var = "shear_stress", train = trainx_v_k_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_s_v_k, "ML_Model/pdp_data/pdp_s_v_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_v_k_c, "ML_Model/pdp_data/pdp_s_v_k_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_v_k <- pdp::partial(xgb_v_k, pred.var = "stream_power", train = trainx_v_k[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_sp_v_k_c <- pdp::partial(xgb_v_k_c, pred.var = "stream_power", train = trainx_v_k_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_sp_v_k, "ML_Model/pdp_data/pdp_sp_v_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_v_k_c, "ML_Model/pdp_data/pdp_sp_v_k_c_brt_add.csv", row.names = FALSE)

# With shannon index as response ----------------------------------------------
### velocity 
pdp_model_v_s <- pdp::partial(xgb_v_s, pred.var = "velocity", train = trainx_v_s[ ,-1]) |>
  mutate(predictors = "velocity",
         model = "velocity w/ coordinates",
         index = "shannon index")
pdp_model_v_s_c <- pdp::partial(xgb_v_s_c, pred.var = "velocity", train = trainx_v_s_c[ ,-1])|>
  mutate(predictors = "velocity_c",
         model = "velocity w/o coordinates",
         index = "shannon index")

# export data 
write.csv(pdp_model_v_s, "ML_Model/pdp_data/pdp_v_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_s_c, "ML_Model/pdp_data/pdp_v_s_c_brt_add.csv", row.names = FALSE)

### x/y
pdp_model_x_v_s <- pdp::partial(xgb_v_k, pred.var = "x", train = trainx_v_k[ ,-1]) |>
  mutate(predictors = "x",
         model = "velocity w/ coordinates",
         index = "shannon index")
pdp_model_y_v_s <- pdp::partial(xgb_v_k, pred.var = "y", train = trainx_v_k[ ,-1]) |>
  mutate(predictors = "y",
         model = "velocity w/ coordinates",
         index = "shannon index")

# export data 
write.csv(pdp_model_x_v_s, "ML_Model/pdp_data/pdp_x_v_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_v_s, "ML_Model/pdp_data/pdp_y_v_s_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_v_s <- pdp::partial(xgb_v_s, pred.var = "froude", train = trainx_v_s[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_f_v_s_c <- pdp::partial(xgb_v_s_c, pred.var = "froude", train = trainx_v_s_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_f_v_s, "ML_Model/pdp_data/pdp_f_v_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_v_s_c, "ML_Model/pdp_data/pdp_f_v_s_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_v_s <- pdp::partial(xgb_v_s, pred.var = "shear_stress", train = trainx_v_s[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_s_v_s_c <- pdp::partial(xgb_v_s_c, pred.var = "shear_stress", train = trainx_v_s_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_s_v_s, "ML_Model/pdp_data/pdp_s_v_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_v_s_c, "ML_Model/pdp_data/pdp_s_v_s_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_v_s <- pdp::partial(xgb_v_s, pred.var = "stream_power", train = trainx_v_s[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_sp_v_s_c <- pdp::partial(xgb_v_s_c, pred.var = "stream_power", train = trainx_v_s_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_sp_v_s, "ML_Model/pdp_data/pdp_sp_v_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_v_s_c, "ML_Model/pdp_data/pdp_sp_v_s_c_brt_add.csv", row.names = FALSE)

# With abundance as response --------------------------------------------------
### velocity 
pdp_model_v_a <- pdp::partial(xgb_v_a, pred.var = "velocity", train = trainx_v_a[ ,-1]) |>
  mutate(predictors = "velocity",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_v_a_c <- pdp::partial(xgb_v_a_c, pred.var = "velocity", train = trainx_v_a_c[ ,-1])|>
  mutate(predictors = "velocity_c",
         model = "velocity w/o coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_v_a, "ML_Model/pdp_data/pdp_v_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_a_c, "ML_Model/pdp_data/pdp_v_a_c_brt_add.csv", row.names = FALSE)

### x/y
pdp_model_x_v_a <- pdp::partial(xgb_v_a, pred.var = "x", train = trainx_v_a[ ,-1]) |>
  mutate(predictors = "x",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_y_v_a <- pdp::partial(xgb_v_a, pred.var = "y", train = trainx_v_a[ ,-1]) |>
  mutate(predictors = "y",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_x_v_a, "ML_Model/pdp_data/pdp_x_v_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_v_a, "ML_Model/pdp_data/pdp_y_v_a_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_v_a <- pdp::partial(xgb_v_a, pred.var = "froude", train = trainx_v_a[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_f_v_a_c <- pdp::partial(xgb_v_a_c, pred.var = "froude", train = trainx_v_a_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_f_v_a, "ML_Model/pdp_data/pdp_f_v_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_v_a_c, "ML_Model/pdp_data/pdp_f_v_a_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_v_a <- pdp::partial(xgb_v_a, pred.var = "shear_stress", train = trainx_v_a[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_s_v_a_c <- pdp::partial(xgb_v_a_c, pred.var = "shear_stress", train = trainx_v_a_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_s_v_a, "ML_Model/pdp_data/pdp_s_v_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_v_a_c, "ML_Model/pdp_data/pdp_s_v_a_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_v_a <- pdp::partial(xgb_v_a, pred.var = "stream_power", train = trainx_v_a[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_sp_v_a_c <- pdp::partial(xgb_v_a_c, pred.var = "stream_power", train = trainx_v_a_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_sp_v_a, "ML_Model/pdp_data/pdp_sp_v_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_v_a_c, "ML_Model/pdp_data/pdp_sp_v_a_c_brt_add.csv", row.names = FALSE)

# With rel_abundance as response ----------------------------------------------
### velocity 
pdp_model_v_ra <- pdp::partial(xgb_v_ra, pred.var = "velocity", train = trainx_v_ra[ ,-1]) |>
  mutate(predictors = "velocity",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_v_ra_c <- pdp::partial(xgb_v_ra_c, pred.var = "velocity", train = trainx_v_ra_c[ ,-1])|>
  mutate(predictors = "velocity_c",
         model = "velocity w/o coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_v_ra, "ML_Model/pdp_data/pdp_v_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_ra_c, "ML_Model/pdp_data/pdp_v_ra_c_brt_add.csv", row.names = FALSE)

### x/y
pdp_model_x_v_ra <- pdp::partial(xgb_v_ra, pred.var = "x", train = trainx_v_ra[ ,-1]) |>
  mutate(predictors = "x",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_y_v_ra <- pdp::partial(xgb_v_ra, pred.var = "y", train = trainx_v_ra[ ,-1]) |>
  mutate(predictors = "y",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_x_v_ra, "ML_Model/pdp_data/pdp_x_v_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_v_ra, "ML_Model/pdp_data/pdp_y_v_ra_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_v_ra <- pdp::partial(xgb_v_ra, pred.var = "froude", train = trainx_v_ra[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_f_v_ra_c <- pdp::partial(xgb_v_ra_c, pred.var = "froude", train = trainx_v_ra_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_f_v_ra, "ML_Model/pdp_data/pdp_f_v_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_v_ra_c, "ML_Model/pdp_data/pdp_f_v_ra_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_v_ra <- pdp::partial(xgb_v_ra, pred.var = "shear_stress", train = trainx_v_ra[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_s_v_ra_c <- pdp::partial(xgb_v_ra_c, pred.var = "shear_stress", train = trainx_v_ra_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_s_v_ra, "ML_Model/pdp_data/pdp_s_v_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_v_ra_c, "ML_Model/pdp_data/pdp_s_v_ra_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_v_ra <- pdp::partial(xgb_v_ra, pred.var = "stream_power", train = trainx_v_ra[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_sp_v_ra_c <- pdp::partial(xgb_v_ra_c, pred.var = "stream_power", train = trainx_v_ra_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_sp_v_ra, "ML_Model/pdp_data/pdp_sp_v_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_v_ra_c, "ML_Model/pdp_data/pdp_sp_v_ra_c_brt_add.csv", row.names = FALSE)

### PREDICTORS: VELOCITY + WD ### --------------------------------------------
# With k_index as response ---------------------------------------------------
### velocity 
pdp_model_v_wd_k <- pdp::partial(xgb_wd_k, pred.var = "velocity", train = trainx_wd_k[ ,-1]) |>
  mutate(predictors = "velocity",
...
# export data 
write.csv(pdp_model_v_wd_k, "ML_Model/pdp_data/pdp_v_wd_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_wd_k_c, "ML_Model/pdp_data/pdp_v_wd_k_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_wd_k <- pdp::partial(xgb_wd_k, pred.var = "froude", train = trainx_wd_k[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_f_wd_k_c <- pdp::partial(xgb_wd_k_c, pred.var = "froude", train = trainx_wd_k_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_f_wd_k, "ML_Model/pdp_data/pdp_f_wd_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_wd_k_c, "ML_Model/pdp_data/pdp_f_wd_k_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_wd_k <- pdp::partial(xgb_wd_k, pred.var = "shear_stress", train = trainx_wd_k[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_s_wd_k_c <- pdp::partial(xgb_wd_k_c, pred.var = "shear_stress", train = trainx_wd_k_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_s_wd_k, "ML_Model/pdp_data/pdp_s_wd_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_wd_k_c, "ML_Model/pdp_data/pdp_s_wd_k_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_wd_k <- pdp::partial(xgb_wd_k, pred.var = "stream_power", train = trainx_wd_k[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_sp_wd_k_c <- pdp::partial(xgb_wd_k_c, pred.var = "stream_power", train = trainx_wd_k_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_sp_wd_k, "ML_Model/pdp_data/pdp_sp_wd_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_wd_k_c, "ML_Model/pdp_data/pdp_sp_wd_k_c_brt_add.csv", row.names = FALSE)

### wd_m 
pdp_model_wd_k <- pdp::partial(xgb_wd_k, pred.var = "wd_m", train = trainx_wd_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_wd_k, "ML_Model/pdp_data/pdp_wd_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_k_c, "ML_Model/pdp_data/pdp_wd_k_c_brt_add.csv", row.names = FALSE)

### x/y
pdp_model_x_wd_k <- pdp::partial(xgb_wd_k, pred.var = "x", train = trainx_wd_k[ ,-1]) |>
  mutate(predictors = "x",
         model = "v + wd w/ coordinates",
         index = "k_index")
pdp_model_y_wd_k <- pdp::partial(xgb_wd_k, pred.var = "y", train = trainx_wd_k[ ,-1]) |>
  mutate(predictors = "y",
         model = "v + wd w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_x_wd_k, "ML_Model/pdp_data/pdp_x_wd_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_k, "ML_Model/pdp_data/pdp_y_wd_k_brt_add.csv", row.names = FALSE)

# With shannon index as response ----------------------------------------------
### velocity 
pdp_model_v_wd_s <- pdp::partial(xgb_wd_s, pred.var = "velocity", train = trainx_wd_s[ ,-1]) |>
  mutate(predictors = "velocity",
         model = "v + wd w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_v_wd_s, "ML_Model/pdp_data/pdp_v_wd_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_wd_s_c, "ML_Model/pdp_data/pdp_v_wd_s_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_wd_s <- pdp::partial(xgb_wd_s, pred.var = "froude", train = trainx_wd_s[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_f_wd_s_c <- pdp::partial(xgb_wd_s_c, pred.var = "froude", train = trainx_wd_s_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_f_wd_s, "ML_Model/pdp_data/pdp_f_wd_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_wd_s_c, "ML_Model/pdp_data/pdp_f_wd_s_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_wd_s <- pdp::partial(xgb_wd_s, pred.var = "shear_stress", train = trainx_wd_s[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_s_wd_s_c <- pdp::partial(xgb_wd_s_c, pred.var = "shear_stress", train = trainx_wd_s_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_s_wd_s, "ML_Model/pdp_data/pdp_s_wd_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_wd_s_c, "ML_Model/pdp_data/pdp_s_wd_s_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_wd_s <- pdp::partial(xgb_wd_s, pred.var = "stream_power", train = trainx_wd_s[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_sp_wd_s_c <- pdp::partial(xgb_wd_s_c, pred.var = "stream_power", train = trainx_wd_s_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_sp_wd_s, "ML_Model/pdp_data/pdp_sp_wd_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_wd_s_c, "ML_Model/pdp_data/pdp_sp_wd_s_c_brt_add.csv", row.names = FALSE)

### wd_m
pdp_model_wd_s <- pdp::partial(xgb_wd_s, pred.var = "wd_m", train = trainx_wd_s[ ,-1]) |>
  mutate(predictors = "wd_m",
         model = "v + wd w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_wd_s, "ML_Model/pdp_data/pdp_wd_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_s_c, "ML_Model/pdp_data/pdp_wd_s_c_brt_add.csv", row.names = FALSE)

### x/y
pdp_model_x_wd_s <- pdp::partial(xgb_wd_s, pred.var = "x", train = trainx_wd_s[ ,-1]) |>
  mutate(predictors = "x",
         model = "v + wd w/ coordinates",
         index = "shannon_index")
pdp_model_y_wd_s <- pdp::partial(xgb_wd_s, pred.var = "y", train = trainx_wd_s[ ,-1]) |>
  mutate(predictors = "y",
         model = "v + wd w/o coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_x_wd_s, "ML_Model/pdp_data/pdp_x_wd_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_s, "ML_Model/pdp_data/pdp_y_wd_s_brt_add.csv", row.names = FALSE)

# With abundance as response --------------------------------------------------
### velocity 
pdp_model_v_wd_a <- pdp::partial(xgb_wd_a, pred.var = "velocity", train = trainx_wd_a[ ,-1]) |>
  mutate(predictors = "velocity",
         model = "v + wd w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_v_wd_a, "ML_Model/pdp_data/pdp_v_wd_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_wd_a_c, "ML_Model/pdp_data/pdp_v_wd_a_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_wd_a <- pdp::partial(xgb_wd_a, pred.var = "froude", train = trainx_wd_a[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_f_wd_a_c <- pdp::partial(xgb_wd_a_c, pred.var = "froude", train = trainx_wd_a_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_f_wd_a, "ML_Model/pdp_data/pdp_f_wd_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_wd_a_c, "ML_Model/pdp_data/pdp_f_wd_a_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_wd_a <- pdp::partial(xgb_wd_a, pred.var = "shear_stress", train = trainx_wd_a[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_s_wd_a_c <- pdp::partial(xgb_wd_a_c, pred.var = "shear_stress", train = trainx_wd_a_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_s_wd_a, "ML_Model/pdp_data/pdp_s_wd_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_wd_a_c, "ML_Model/pdp_data/pdp_s_wd_a_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_wd_a <- pdp::partial(xgb_wd_a, pred.var = "stream_power", train = trainx_wd_a[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_sp_wd_a_c <- pdp::partial(xgb_wd_a_c, pred.var = "stream_power", train = trainx_wd_a_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_sp_wd_a, "ML_Model/pdp_data/pdp_sp_wd_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_wd_a_c, "ML_Model/pdp_data/pdp_sp_wd_a_c_brt_add.csv", row.names = FALSE)

### wd_m 
pdp_model_wd_a <- pdp::partial(xgb_wd_a, pred.var = "wd_m", train = trainx_wd_a[ ,-1]) |>
  mutate(predictors = "wd_m",
         model = "v + wd w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_wd_a, "ML_Model/pdp_data/pdp_wd_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_a_c, "ML_Model/pdp_data/pdp_wd_a_c_brt_add.csv", row.names = FALSE)

### x/y
pdp_model_x_wd_a <- pdp::partial(xgb_wd_a, pred.var = "x", train = trainx_wd_a[ ,-1]) |>
  mutate(predictors = "x",
         model = "v + wd w/ coordinates",
         index = "abundance")
pdp_model_y_wd_a <- pdp::partial(xgb_wd_a, pred.var = "y", train = trainx_wd_a[ ,-1]) |>
  mutate(predictors = "y",
         model = "v + wd w/o coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_x_wd_a, "ML_Model/pdp_data/pdp_x_wd_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_a, "ML_Model/pdp_data/pdp_y_wd_a_brt_add.csv", row.names = FALSE)

# With rel_abundance as response ---------------------------------------------
### velocity
pdp_model_v_wd_ra <- pdp::partial(xgb_wd_ra, pred.var = "velocity", train = trainx_wd_ra[ ,-1]) |>
  mutate(predictors = "velocity",
         model = "v + wd w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_v_wd_ra, "ML_Model/pdp_data/pdp_v_wd_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_wd_ra_c, "ML_Model/pdp_data/pdp_v_wd_a_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_wd_ra <- pdp::partial(xgb_wd_ra, pred.var = "froude", train = trainx_wd_ra[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_f_wd_ra_c <- pdp::partial(xgb_wd_ra_c, pred.var = "froude", train = trainx_wd_ra_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_f_wd_ra, "ML_Model/pdp_data/pdp_f_wd_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_wd_ra_c, "ML_Model/pdp_data/pdp_f_wd_ra_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_wd_ra <- pdp::partial(xgb_wd_ra, pred.var = "shear_stress", train = trainx_wd_ra[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_s_wd_ra_c <- pdp::partial(xgb_wd_ra_c, pred.var = "shear_stress", train = trainx_wd_ra_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_s_wd_ra, "ML_Model/pdp_data/pdp_s_wd_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_wd_ra_c, "ML_Model/pdp_data/pdp_s_wd_ra_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_wd_ra <- pdp::partial(xgb_wd_ra, pred.var = "stream_power", train = trainx_wd_ra[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_sp_wd_ra_c <- pdp::partial(xgb_wd_ra_c, pred.var = "stream_power", train = trainx_wd_ra_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_sp_wd_ra, "ML_Model/pdp_data/pdp_sp_wd_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_wd_ra_c, "ML_Model/pdp_data/pdp_sp_wd_ra_c_brt_add.csv", row.names = FALSE)

### wd_m 
pdp_model_wd_ra <- pdp::partial(xgb_wd_ra, pred.var = "wd_m", train = trainx_wd_ra[ ,-1]) |>
  mutate(predictors = "wd_m",
         model = "v + wd w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_wd_ra, "ML_Model/pdp_data/pdp_wd_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_ra_c, "ML_Model/pdp_data/pdp_wd_a_c_brt_add.csv", row.names = FALSE)

### x/y
pdp_model_x_wd_ra <- pdp::partial(xgb_wd_ra, pred.var = "x", train = trainx_wd_ra[ ,-1]) |>
  mutate(predictors = "x",
         model = "v + wd w/ coordinates",
         index = "rel_abundance")
pdp_model_y_wd_ra <- pdp::partial(xgb_wd_ra, pred.var = "y", train = trainx_wd_ra[ ,-1]) |>
  mutate(predictors = "y",
         model = "v + wd w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_x_wd_ra, "ML_Model/pdp_data/pdp_x_wd_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_ra, "ML_Model/pdp_data/pdp_y_wd_a_brt_add.csv", row.names = FALSE)

### PREDICTORS: SAMPLING LOCATIONS ### ---------------------------------------
# With k_index as response ---------------------------------------------------
### velocity 
pdp_model_v_samp_k <- pdp::partial(xgb_samp_k, pred.var = "velocity", train = trainx_samp_k[ ,-1]) |>
  mutate(predictors = "velocity",
...
# export data 
write.csv(pdp_model_v_samp_k, "ML_Model/pdp_data/pdp_v_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_samp_k_c, "ML_Model/pdp_data/pdp_v_samp_k_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_samp_k <- pdp::partial(xgb_samp_k, pred.var = "froude", train = trainx_samp_k[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_f_samp_k_c <- pdp::partial(xgb_samp_k_c, pred.var = "froude", train = trainx_samp_k_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_f_samp_k, "ML_Model/pdp_data/pdp_f_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_samp_k_c, "ML_Model/pdp_data/pdp_f_samp_k_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_samp_k <- pdp::partial(xgb_samp_k, pred.var = "shear_stress", train = trainx_samp_k[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_s_samp_k_c <- pdp::partial(xgb_samp_k_c, pred.var = "shear_stress", train = trainx_samp_k_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_s_samp_k, "ML_Model/pdp_data/pdp_s_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_samp_k_c, "ML_Model/pdp_data/pdp_s_samp_k_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_samp_k <- pdp::partial(xgb_samp_k, pred.var = "stream_power", train = trainx_samp_k[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_sp_samp_k_c <- pdp::partial(xgb_samp_k_c, pred.var = "stream_power", train = trainx_samp_k_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_sp_samp_k, "ML_Model/pdp_data/pdp_sp_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_samp_k_c, "ML_Model/pdp_data/pdp_sp_samp_k_c_brt_add.csv", row.names = FALSE)

### wd_m 
pdp_model_wd_samp_k <- pdp::partial(xgb_samp_k_c, pred.var = "wd_m", train = trainx_samp_k_c[ ,-1]) |>
  mutate(predictors = "wd_m",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_wd_samp_k, "ML_Model/pdp_data/pdp_wd_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_samp_k_c, "ML_Model/pdp_data/pdp_wd_samp_k_c_brt_add.csv", row.names = FALSE)

### x / y 
pdp_model_x_samp_k <- pdp::partial(xgb_samp_k, pred.var = "x", train = trainx_samp_k[ ,-1]) |>
  mutate(predictors = "x",
         model = "sampling w/ coordinates",
         index = "k_index")
pdp_model_y_samp_k <- pdp::partial(xgb_samp_k, pred.var = "y", train = trainx_samp_k[ ,-1]) |>
  mutate(predictors = "y",
         model = "sampling w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_x_samp_k, "ML_Model/pdp_data/pdp_x_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_k, "ML_Model/pdp_data/pdp_y_samp_k_brt_add.csv", row.names = FALSE)

### z 
pdp_model_z_samp_k <- pdp::partial(xgb_samp_k, pred.var = "z", train = trainx_samp_k[ ,-1]) |>
  mutate(predictors = "z",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_z_samp_k, "ML_Model/pdp_data/pdp_z_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_z_samp_k_c, "ML_Model/pdp_data/pdp_z_samp_k_c_brt_add.csv", row.names = FALSE)

### dist_w 
pdp_model_dist_samp_k <- pdp::partial(xgb_samp_k, pred.var = "dist_w", train = trainx_samp_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_dist_samp_k, "ML_Model/pdp_data/pdp_dist_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_dist_samp_k_c, "ML_Model/pdp_data/pdp_dist_samp_k_c_brt_add.csv", row.names = FALSE)

### cat_v 
pdp_model_cv_samp_k <- pdp::partial(xgb_samp_k, pred.var = "cat_velocity", train = trainx_samp_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_cv_samp_k, "ML_Model/pdp_data/pdp_cv_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cv_samp_k_c, "ML_Model/pdp_data/pdp_cv_samp_k_c_brt_add.csv", row.names = FALSE)

### alg_cover 
pdp_model_ac_samp_k <- pdp::partial(xgb_samp_k, pred.var = "alg_cover", train = trainx_samp_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_ac_samp_k, "ML_Model/pdp_data/pdp_ac_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ac_samp_k_c, "ML_Model/pdp_data/pdp_ac_samp_k_c_brt_add.csv", row.names = FALSE)

### moos_cover 
pdp_model_mc_samp_k <- pdp::partial(xgb_samp_k, pred.var = "moos_cover", train = trainx_samp_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_mc_samp_k, "ML_Model/pdp_data/pdp_mc_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_mc_samp_k_c, "ML_Model/pdp_data/pdp_mc_samp_k_c_brt_add.csv", row.names = FALSE)

### cpom_cover 
pdp_model_cc_samp_k <- pdp::partial(xgb_samp_k, pred.var = "cpom_cover", train = trainx_samp_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_cc_samp_k, "ML_Model/pdp_data/pdp_cc_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cc_samp_k_c, "ML_Model/pdp_data/pdp_cc_samp_k_c_brt_add.csv", row.names = FALSE)

### clog_3 
pdp_model_clog_3_samp_k <- pdp::partial(xgb_samp_k, pred.var = "clog_3_class_int", train = trainx_samp_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_clog_3_samp_k, "ML_Model/pdp_data/pdp_clog_3_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_3_samp_k_c, "ML_Model/pdp_data/pdp_clog_3_samp_k_c_brt_add.csv", row.names = FALSE)

### clog_6
pdp_model_clog_6_samp_k <- pdp::partial(xgb_samp_k, pred.var = "clog_6_class_int", train = trainx_samp_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_clog_6_samp_k, "ML_Model/pdp_data/pdp_clog_6_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_6_samp_k_c, "ML_Model/pdp_data/pdp_clog_6_samp_k_c_brt_add.csv", row.names = FALSE)

### sub_type
pdp_model_sub_samp_k <- pdp::partial(xgb_samp_k, pred.var = "sub_type_int", train = trainx_samp_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_sub_samp_k, "ML_Model/pdp_data/pdp_sub_samp_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sub_samp_k_c, "ML_Model/pdp_data/pdp_sub_samp_k_c_brt_add.csv", row.names = FALSE)

# With shannon index as response ----------------------------------------------
### velocity 
pdp_model_v_samp_s <- pdp::partial(xgb_samp_s, pred.var = "velocity", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "velocity",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_v_samp_s, "ML_Model/pdp_data/pdp_v_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_samp_s_c, "ML_Model/pdp_data/pdp_v_samp_s_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_samp_s <- pdp::partial(xgb_samp_s, pred.var = "froude", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_f_samp_s_c <- pdp::partial(xgb_samp_s_c, pred.var = "froude", train = trainx_samp_s_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_f_samp_s, "ML_Model/pdp_data/pdp_f_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_samp_s_c, "ML_Model/pdp_data/pdp_f_samp_s_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_samp_s <- pdp::partial(xgb_samp_s, pred.var = "shear_stress", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_s_samp_s_c <- pdp::partial(xgb_samp_s_c, pred.var = "shear_stress", train = trainx_samp_s_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_s_samp_s, "ML_Model/pdp_data/pdp_s_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_samp_s_c, "ML_Model/pdp_data/pdp_s_samp_s_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_samp_s <- pdp::partial(xgb_samp_s, pred.var = "stream_power", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_sp_samp_s_c <- pdp::partial(xgb_samp_s_c, pred.var = "stream_power", train = trainx_samp_s_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_sp_samp_s, "ML_Model/pdp_data/pdp_sp_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_samp_s_c, "ML_Model/pdp_data/pdp_sp_samp_s_c_brt_add.csv", row.names = FALSE)

### wd_m 
pdp_model_wd_samp_s <- pdp::partial(xgb_samp_s, pred.var = "wd_m", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "wd_m",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_wd_samp_s, "ML_Model/pdp_data/pdp_wd_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_samp_s_c, "ML_Model/pdp_data/pdp_wd_samp_s_c_brt_add.csv", row.names = FALSE)

### x / y 
pdp_model_x_samp_s <- pdp::partial(xgb_samp_s, pred.var = "x", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "x",
         model = "sampling w/ coordinates",
         index = "shannon_index")
pdp_model_y_samp_s <- pdp::partial(xgb_samp_s, pred.var = "y", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "y",
         model = "sampling w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_x_samp_s, "ML_Model/pdp_data/pdp_x_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_s, "ML_Model/pdp_data/pdp_y_samp_s_brt_add.csv", row.names = FALSE)

### z 
pdp_model_z_samp_s <- pdp::partial(xgb_samp_s, pred.var = "z", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "z",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_z_samp_s, "ML_Model/pdp_data/pdp_z_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_z_samp_s_c, "ML_Model/pdp_data/pdp_z_samp_s_c_brt_add.csv", row.names = FALSE)

### dist_w 
pdp_model_dist_samp_s <- pdp::partial(xgb_samp_s, pred.var = "dist_w", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "dist_w",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_dist_samp_s, "ML_Model/pdp_data/pdp_dist_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_dist_samp_s_c, "ML_Model/pdp_data/pdp_dist_samp_s_c_brt_add.csv", row.names = FALSE)

### cat_v 
pdp_model_cv_samp_s <- pdp::partial(xgb_samp_s, pred.var = "cat_velocity", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "cat_velocity",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_cv_samp_s, "ML_Model/pdp_data/pdp_cv_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cv_samp_s_c, "ML_Model/pdp_data/pdp_cv_samp_s_c_brt_add.csv", row.names = FALSE)

### alg_cover 
pdp_model_ac_samp_s <- pdp::partial(xgb_samp_s, pred.var = "alg_cover", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "alg_cover",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_ac_samp_s, "ML_Model/pdp_data/pdp_ac_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ac_samp_s_c, "ML_Model/pdp_data/pdp_ac_samp_s_c_brt_add.csv", row.names = FALSE)

### moos_cover 
pdp_model_mc_samp_s <- pdp::partial(xgb_samp_s, pred.var = "moos_cover", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "moos_cover",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_mc_samp_s, "ML_Model/pdp_data/pdp_mc_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_mc_samp_s_c, "ML_Model/pdp_data/pdp_mc_samp_s_c_brt_add.csv", row.names = FALSE)

### cpom_cover
pdp_model_cc_samp_s <- pdp::partial(xgb_samp_s, pred.var = "cpom_cover", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "cpom_cover",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_cc_samp_s, "ML_Model/pdp_data/pdp_cc_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cc_samp_s_c, "ML_Model/pdp_data/pdp_cc_samp_s_c_brt_add.csv", row.names = FALSE)

### clog_3 
pdp_model_clog_3_samp_s <- pdp::partial(xgb_samp_s, pred.var = "clog_3_class_int", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "clog_3_class",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_clog_3_samp_s, "ML_Model/pdp_data/pdp_clog_3_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_3_samp_s_c, "ML_Model/pdp_data/pdp_clog_3_samp_s_c_brt_add.csv", row.names = FALSE)

### clog_6
pdp_model_clog_6_samp_s <- pdp::partial(xgb_samp_s, pred.var = "clog_6_class_int", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "clog_6_class",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_clog_6_samp_s, "ML_Model/pdp_data/pdp_clog_6_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_6_samp_s_c, "ML_Model/pdp_data/pdp_clog_6_samp_s_c_brt_add.csv", row.names = FALSE)

### sub_type 
pdp_model_sub_samp_s <- pdp::partial(xgb_samp_s, pred.var = "sub_type_int", train = trainx_samp_s[ ,-1]) |>
  mutate(predictors = "sub_type",
         model = "sampling w/ coordinates",
         index = "shannon_index")
...
# export data 
write.csv(pdp_model_sub_samp_s, "ML_Model/pdp_data/pdp_sub_samp_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sub_samp_s_c, "ML_Model/pdp_data/pdp_sub_samp_s_c_brt_add.csv", row.names = FALSE)

# With abundance as response --------------------------------------------------
### velocity 
pdp_model_v_samp_a <- pdp::partial(xgb_samp_a, pred.var = "velocity", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "velocity",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_v_samp_a, "ML_Model/pdp_data/pdp_v_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_samp_a_c, "ML_Model/pdp_data/pdp_v_samp_a_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_samp_a <- pdp::partial(xgb_samp_a, pred.var = "froude", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_f_samp_a_c <- pdp::partial(xgb_samp_a_c, pred.var = "froude", train = trainx_samp_a_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_f_samp_a, "ML_Model/pdp_data/pdp_f_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_samp_a_c, "ML_Model/pdp_data/pdp_f_samp_a_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_samp_a <- pdp::partial(xgb_samp_a, pred.var = "shear_stress", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_s_samp_a_c <- pdp::partial(xgb_samp_a_c, pred.var = "shear_stress", train = trainx_samp_a_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_s_samp_a, "ML_Model/pdp_data/pdp_s_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_samp_a_c, "ML_Model/pdp_data/pdp_s_samp_a_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_samp_a <- pdp::partial(xgb_samp_a, pred.var = "stream_power", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_sp_samp_a_c <- pdp::partial(xgb_samp_a_c, pred.var = "stream_power", train = trainx_samp_a_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_sp_samp_a, "ML_Model/pdp_data/pdp_sp_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_samp_a_c, "ML_Model/pdp_data/pdp_sp_samp_a_c_brt_add.csv", row.names = FALSE)

### wd_m 
pdp_model_wd_samp_a <- pdp::partial(xgb_samp_a, pred.var = "wd_m", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "wd_m",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_wd_samp_a, "ML_Model/pdp_data/pdp_wd_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_samp_a_c, "ML_Model/pdp_data/pdp_wd_samp_a_c_brt_add.csv", row.names = FALSE)

### x / y 
pdp_model_x_samp_a <- pdp::partial(xgb_samp_a, pred.var = "x", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "x",
         model = "sampling w/ coordinates",
         index = "abundance")
pdp_model_y_samp_a <- pdp::partial(xgb_samp_a, pred.var = "y", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "y",
         model = "sampling w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_x_samp_a, "ML_Model/pdp_data/pdp_x_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_a, "ML_Model/pdp_data/pdp_y_samp_a_brt_add.csv", row.names = FALSE)

### z 
pdp_model_z_samp_a <- pdp::partial(xgb_samp_a, pred.var = "z", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "z",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_z_samp_a, "ML_Model/pdp_data/pdp_z_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_z_samp_a_c, "ML_Model/pdp_data/pdp_z_samp_a_c_brt_add.csv", row.names = FALSE)

### dist_w 
pdp_model_dist_samp_a <- pdp::partial(xgb_samp_a, pred.var = "dist_w", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "dist_w",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_dist_samp_a, "ML_Model/pdp_data/pdp_dist_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_dist_samp_a_c, "ML_Model/pdp_data/pdp_dist_samp_a_c_brt_add.csv", row.names = FALSE)

### cat_v 
pdp_model_cv_samp_a <- pdp::partial(xgb_samp_a, pred.var = "cat_velocity", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "cat_velocity",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_cv_samp_a, "ML_Model/pdp_data/pdp_cv_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cv_samp_a_c, "ML_Model/pdp_data/pdp_cv_samp_a_c_brt_add.csv", row.names = FALSE)

### alg_cover 
pdp_model_ac_samp_a <- pdp::partial(xgb_samp_a, pred.var = "alg_cover", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "alg_cover",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_ac_samp_a, "ML_Model/pdp_data/pdp_ac_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ac_samp_a_c, "ML_Model/pdp_data/pdp_ac_samp_a_c_brt_add.csv", row.names = FALSE)

### moos_cover 
pdp_model_mc_samp_a <- pdp::partial(xgb_samp_a, pred.var = "moos_cover", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "moos_cover",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_mc_samp_a, "ML_Model/pdp_data/pdp_mc_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_mc_samp_a_c, "ML_Model/pdp_data/pdp_mc_samp_a_c_brt_add.csv", row.names = FALSE)

### cpom_cover 
pdp_model_cc_samp_a <- pdp::partial(xgb_samp_a, pred.var = "cpom_cover", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "cpom_cover",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_cc_samp_a, "ML_Model/pdp_data/pdp_cc_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cc_samp_a_c, "ML_Model/pdp_data/pdp_cc_samp_a_c_brt_add.csv", row.names = FALSE)

### clog_3 
pdp_model_clog_3_samp_a <- pdp::partial(xgb_samp_a, pred.var = "clog_3_class_int", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "clog_3_class",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_clog_3_samp_a, "ML_Model/pdp_data/pdp_clog_3_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_3_samp_a_c, "ML_Model/pdp_data/pdp_clog_3_samp_a_c_brt_add.csv", row.names = FALSE)

### clog_6
pdp_model_clog_6_samp_a <- pdp::partial(xgb_samp_a, pred.var = "clog_6_class_int", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "clog_6_class",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_clog_6_samp_a, "ML_Model/pdp_data/pdp_clog_6_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_6_samp_a_c, "ML_Model/pdp_data/pdp_clog_6_samp_a_c_brt_add.csv", row.names = FALSE)

### sub_type 
pdp_model_sub_samp_a <- pdp::partial(xgb_samp_a, pred.var = "sub_type_int", train = trainx_samp_a[ ,-1]) |>
  mutate(predictors = "sub_type",
         model = "sampling w/ coordinates",
         index = "abundance")
...
# export data 
write.csv(pdp_model_sub_samp_a, "ML_Model/pdp_data/pdp_sub_samp_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sub_samp_a_c, "ML_Model/pdp_data/pdp_sub_samp_a_c_brt_add.csv", row.names = FALSE)

# With rel_abundance as response ----------------------------------------------
### velocity 
pdp_model_v_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "velocity", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "velocity",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_v_samp_ra, "ML_Model/pdp_data/pdp_v_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_samp_ra_c, "ML_Model/pdp_data/pdp_v_samp_ra_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "froude", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_f_samp_ra_c <- pdp::partial(xgb_samp_ra_c, pred.var = "froude", train = trainx_samp_ra_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_f_samp_ra, "ML_Model/pdp_data/pdp_f_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_samp_ra_c, "ML_Model/pdp_data/pdp_f_samp_ra_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "shear_stress", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_s_samp_ra_c <- pdp::partial(xgb_samp_ra_c, pred.var = "shear_stress", train = trainx_samp_ra_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_s_samp_ra, "ML_Model/pdp_data/pdp_s_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_samp_ra_c, "ML_Model/pdp_data/pdp_s_samp_ra_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "stream_power", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_sp_samp_ra_c <- pdp::partial(xgb_samp_ra_c, pred.var = "stream_power", train = trainx_samp_ra_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_sp_samp_ra, "ML_Model/pdp_data/pdp_sp_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_samp_ra_c, "ML_Model/pdp_data/pdp_sp_samp_ra_c_brt_add.csv", row.names = FALSE)

### wd_m 
pdp_model_wd_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "wd_m", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "wd_m",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_wd_samp_ra, "ML_Model/pdp_data/pdp_wd_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_samp_ra_c, "ML_Model/pdp_data/pdp_wd_samp_ra_c_brt_add.csv", row.names = FALSE)

### x / y 
pdp_model_x_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "x", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "x",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
pdp_model_y_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "y", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "y",
         model = "sampling w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_x_samp_ra, "ML_Model/pdp_data/pdp_x_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_ra, "ML_Model/pdp_data/pdp_y_samp_ra_brt_add.csv", row.names = FALSE)

### z 
pdp_model_z_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "z", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "z",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_z_samp_ra, "ML_Model/pdp_data/pdp_z_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_z_samp_ra_c, "ML_Model/pdp_data/pdp_z_samp_ra_c_brt_add.csv", row.names = FALSE)

### dist_w 
pdp_model_dist_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "dist_w", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "dist_w",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_dist_samp_ra, "ML_Model/pdp_data/pdp_dist_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_dist_samp_ra_c, "ML_Model/pdp_data/pdp_dist_samp_ra_c_brt_add.csv", row.names = FALSE)

### cat_v 
pdp_model_cv_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "cat_velocity", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "cat_velocity",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_cv_samp_ra, "ML_Model/pdp_data/pdp_cv_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cv_samp_ra_c, "ML_Model/pdp_data/pdp_cv_samp_ra_c_brt_add.csv", row.names = FALSE)

### alg_cover 
pdp_model_ac_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "alg_cover", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "alg_cover",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_ac_samp_ra, "ML_Model/pdp_data/pdp_ac_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ac_samp_ra_c, "ML_Model/pdp_data/pdp_ac_samp_ra_c_brt_add.csv", row.names = FALSE)

### moos_cover 
pdp_model_mc_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "moos_cover", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "moos_cover",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_mc_samp_ra, "ML_Model/pdp_data/pdp_mc_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_mc_samp_ra_c, "ML_Model/pdp_data/pdp_mc_samp_ra_c_brt_add.csv", row.names = FALSE)

### cpom_cover 
pdp_model_cc_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "cpom_cover", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "cpom_cover",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_cc_samp_ra, "ML_Model/pdp_data/pdp_cc_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cc_samp_ra_c, "ML_Model/pdp_data/pdp_cc_samp_ra_c_brt_add.csv", row.names = FALSE)

### clog_3 
pdp_model_clog_3_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "clog_3_class_int", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "clog_3_class",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_clog_3_samp_ra, "ML_Model/pdp_data/pdp_clog_3_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_3_samp_ra_c, "ML_Model/pdp_data/pdp_clog_3_samp_ra_c_brt_add.csv", row.names = FALSE)

### clog_6
pdp_model_clog_6_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "clog_6_class_int", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "clog_6_class",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_clog_6_samp_ra, "ML_Model/pdp_data/pdp_clog_6_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_6_samp_ra_c, "ML_Model/pdp_data/pdp_clog_6_samp_ra_c_brt_add.csv", row.names = FALSE)

### sub_type 
pdp_model_sub_samp_ra <- pdp::partial(xgb_samp_ra, pred.var = "sub_type_int", train = trainx_samp_ra[ ,-1]) |>
  mutate(predictors = "sub_type",
         model = "sampling w/ coordinates",
         index = "rel_abundance")
...
# export data 
write.csv(pdp_model_sub_samp_ra, "ML_Model/pdp_data/pdp_sub_samp_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sub_samp_ra_c, "ML_Model/pdp_data/pdp_sub_samp_ra_c_brt_add.csv", row.names = FALSE)

### PREDICTORS: ALL PREDICTORS ### --------------------------------------------
# With k_index as response ----------------------------------------------------
### velocity 
pdp_model_v_sec_k <- pdp::partial(xgb_sec_k, pred.var = "velocity", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "velocity",
...
# export data 
write.csv(pdp_model_v_sec_k, "ML_Model/pdp_data/pdp_v_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_sec_k_c, "ML_Model/pdp_data/pdp_v_sec_k_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_sec_k <- pdp::partial(xgb_sec_k, pred.var = "froude", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_f_sec_k_c <- pdp::partial(xgb_sec_k_c, pred.var = "froude", train = trainx_sec_k_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_f_sec_k, "ML_Model/pdp_data/pdp_f_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_sec_k_c, "ML_Model/pdp_data/pdp_f_sec_k_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_sec_k <- pdp::partial(xgb_sec_k, pred.var = "shear_stress", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_s_sec_k_c <- pdp::partial(xgb_sec_k_c, pred.var = "shear_stress", train = trainx_sec_k_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_s_sec_k, "ML_Model/pdp_data/pdp_s_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_sec_k_c, "ML_Model/pdp_data/pdp_s_sec_k_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_sec_k <- pdp::partial(xgb_sec_k, pred.var = "stream_power", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "k_index")
pdp_model_sp_sec_k_c <- pdp::partial(xgb_sec_k_c, pred.var = "stream_power", train = trainx_sec_k_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_sp_sec_k, "ML_Model/pdp_data/pdp_sp_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_sec_k_c, "ML_Model/pdp_data/pdp_sp_sec_k_c_brt_add.csv", row.names = FALSE)

### wd_m 
pdp_model_wd_sec_k <- pdp::partial(xgb_sec_k, pred.var = "wd_m", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "wd_m",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_wd_sec_k, "ML_Model/pdp_data/pdp_wd_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_sec_k_c, "ML_Model/pdp_data/pdp_wd_sec_k_c_brt_add.csv", row.names = FALSE)

### x / y 
pdp_model_x_sec_k <- pdp::partial(xgb_sec_k, pred.var = "x", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "x",
         model = "sampling w/ coordinates",
         index = "k_index")
pdp_model_y_sec_k <- pdp::partial(xgb_sec_k, pred.var = "y", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "y",
         model = "sampling w/ coordinates",
         index = "k_index")

# export data 
write.csv(pdp_model_x_sec_k, "ML_Model/pdp_data/pdp_x_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_sec_k, "ML_Model/pdp_data/pdp_y_sec_k_brt_add.csv", row.names = FALSE)

### z 
pdp_model_z_sec_k <- pdp::partial(xgb_sec_k, pred.var = "z", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "z",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_z_sec_k, "ML_Model/pdp_data/pdp_z_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_z_sec_k_c, "ML_Model/pdp_data/pdp_z_sec_k_c_brt_add.csv", row.names = FALSE)

### dist_w 
pdp_model_dist_sec_k <- pdp::partial(xgb_sec_k, pred.var = "dist_w", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "dist_w",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_dist_sec_k, "ML_Model/pdp_data/pdp_dist_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_dist_sec_k_c, "ML_Model/pdp_data/pdp_dist_sec_k_c_brt_add.csv", row.names = FALSE)

### cat_v 
pdp_model_cv_sec_k <- pdp::partial(xgb_sec_k, pred.var = "cat_velocity", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "cat_velocity",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_cv_sec_k, "ML_Model/pdp_data/pdp_cv_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cv_sec_k_c, "ML_Model/pdp_data/pdp_cv_sec_k_c_brt_add.csv", row.names = FALSE)

### alg_cover 
pdp_model_ac_sec_k <- pdp::partial(xgb_sec_k, pred.var = "alg_cover", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "alg_cover",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_ac_sec_k, "ML_Model/pdp_data/pdp_ac_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ac_sec_k_c, "ML_Model/pdp_data/pdp_ac_sec_k_c_brt_add.csv", row.names = FALSE)

### moos_cover 
pdp_model_mc_sec_k <- pdp::partial(xgb_sec_k, pred.var = "moos_cover", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "moos_cover",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_mc_sec_k, "ML_Model/pdp_data/pdp_mc_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_mc_sec_k_c, "ML_Model/pdp_data/pdp_mc_sec_k_c_brt_add.csv", row.names = FALSE)

### cpom_cover 
pdp_model_cc_sec_k <- pdp::partial(xgb_sec_k, pred.var = "cpom_cover", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "cpom_cover",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_cc_sec_k, "ML_Model/pdp_data/pdp_cc_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cc_sec_k_c, "ML_Model/pdp_data/pdp_cc_sec_k_c_brt_add.csv", row.names = FALSE)

### clog_3 
pdp_model_clog_3_sec_k <- pdp::partial(xgb_sec_k, pred.var = "clog_3_class_int", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "clog_3_class",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_clog_3_sec_k, "ML_Model/pdp_data/pdp_clog_3_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_3_sec_k_c, "ML_Model/pdp_data/pdp_clog_3_sec_k_c_brt_add.csv", row.names = FALSE)

### clog_6
pdp_model_clog_6_sec_k <- pdp::partial(xgb_sec_k, pred.var = "clog_6_class_int", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "clog_6_class",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_clog_6_sec_k, "ML_Model/pdp_data/pdp_clog_6_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_6_sec_k_c, "ML_Model/pdp_data/pdp_clog_6_sec_k_c_brt_add.csv", row.names = FALSE)

### sub_type 
pdp_model_sub_sec_k <- pdp::partial(xgb_sec_k, pred.var = "sub_type_int", train = trainx_sec_k[ ,-1]) |>
  mutate(predictors = "sub_type",
         model = "sampling w/ coordinates",
         index = "k_index")
...
# export data 
write.csv(pdp_model_sub_sec_k, "ML_Model/pdp_data/pdp_sub_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sub_sec_k_c, "ML_Model/pdp_data/pdp_sub_sec_k_c_brt_add.csv", row.names = FALSE)

### pH_before
pdp_model_phb_sec_k <- pdp::partial(xgb_sec_k, pred.var = "pH_before", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_phb_sec_k, "ML_Model/pdp_data/pdp_phb_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_phb_sec_k_c, "ML_Model/pdp_data/pdp_phb_sec_k_c_brt_add.csv", row.names = FALSE)

### pH_during
pdp_model_phd_sec_k <- pdp::partial(xgb_sec_k, pred.var = "pH_during", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_phd_sec_k, "ML_Model/pdp_data/pdp_phd_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_phd_sec_k_c, "ML_Model/pdp_data/pdp_phd_sec_k_c_brt_add.csv", row.names = FALSE)

### pH_after
pdp_model_pha_sec_k <- pdp::partial(xgb_sec_k, pred.var = "pH_after", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_pha_sec_k, "ML_Model/pdp_data/pdp_pha_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_pha_sec_k_c, "ML_Model/pdp_data/pdp_pha_sec_k_c_brt_add.csv", row.names = FALSE)

### conduct_before
pdp_model_cb_sec_k <- pdp::partial(xgb_sec_k, pred.var = "conduct_before", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_cb_sec_k, "ML_Model/pdp_data/pdp_cb_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cb_sec_k_c, "ML_Model/pdp_data/pdp_cb_sec_k_c_brt_add.csv", row.names = FALSE)

### conduct_during
pdp_model_cd_sec_k <- pdp::partial(xgb_sec_k, pred.var = "conduct_during", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_cd_sec_k, "ML_Model/pdp_data/pdp_cd_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cd_sec_k_c, "ML_Model/pdp_data/pdp_cd_sec_k_c_brt_add.csv", row.names = FALSE)

### conduct_after
pdp_model_ca_sec_k <- pdp::partial(xgb_sec_k, pred.var = "conduct_after", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_ca_sec_k, "ML_Model/pdp_data/pdp_ca_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ca_sec_k_c, "ML_Model/pdp_data/pdp_ca_sec_k_c_brt_add.csv", row.names = FALSE)

### ox_before
pdp_model_ob_sec_k <- pdp::partial(xgb_sec_k, pred.var = "ox_before", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_ob_sec_k, "ML_Model/pdp_data/pdp_ob_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ob_sec_k_c, "ML_Model/pdp_data/pdp_ob_sec_k_c_brt_add.csv", row.names = FALSE)

### ox_during
pdp_model_od_sec_k <- pdp::partial(xgb_sec_k, pred.var = "ox_during", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_od_sec_k, "ML_Model/pdp_data/pdp_od_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_od_sec_k_c, "ML_Model/pdp_data/pdp_od_sec_k_c_brt_add.csv", row.names = FALSE)

### ox_after
pdp_model_oa_sec_k <- pdp::partial(xgb_sec_k, pred.var = "ox_after", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_oa_sec_k, "ML_Model/pdp_data/pdp_oa_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_oa_sec_k_c, "ML_Model/pdp_data/pdp_oa_sec_k_c_brt_add.csv", row.names = FALSE)

### turb_before
pdp_model_tb_sec_k <- pdp::partial(xgb_sec_k, pred.var = "turb_before", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_tb_sec_k, "ML_Model/pdp_data/pdp_tb_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_tb_sec_k_c, "ML_Model/pdp_data/pdp_tb_sec_k_c_brt_add.csv", row.names = FALSE)

### turb_during
pdp_model_td_sec_k <- pdp::partial(xgb_sec_k, pred.var = "turb_during", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_td_sec_k, "ML_Model/pdp_data/pdp_td_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_td_sec_k_c, "ML_Model/pdp_data/pdp_td_sec_k_c_brt_add.csv", row.names = FALSE)

### turb_after
pdp_model_ta_sec_k <- pdp::partial(xgb_sec_k, pred.var = "turb_after", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_ta_sec_k, "ML_Model/pdp_data/pdp_ta_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ta_sec_k_c, "ML_Model/pdp_data/pdp_ta_sec_k_c_brt_add.csv", row.names = FALSE)

### temp_before
pdp_model_teb_sec_k <- pdp::partial(xgb_sec_k, pred.var = "temp_before", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_teb_sec_k, "ML_Model/pdp_data/pdp_teb_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_teb_sec_k_c, "ML_Model/pdp_data/pdp_teb_sec_k_c_brt_add.csv", row.names = FALSE)

### temp_during
pdp_model_ted_sec_k <- pdp::partial(xgb_sec_k, pred.var = "temp_during", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_ted_sec_k, "ML_Model/pdp_data/pdp_ted_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ted_sec_k_c, "ML_Model/pdp_data/pdp_ted_sec_k_c_brt_add.csv", row.names = FALSE)

### temp_after
pdp_model_tea_sec_k <- pdp::partial(xgb_sec_k, pred.var = "temp_after", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_tea_sec_k, "ML_Model/pdp_data/pdp_tea_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_tea_sec_k_c, "ML_Model/pdp_data/pdp_tea_sec_k_c_brt_add.csv", row.names = FALSE)

### q_before
pdp_model_qb_sec_k <- pdp::partial(xgb_sec_k, pred.var = "q_before", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_qb_sec_k, "ML_Model/pdp_data/pdp_qb_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qb_sec_k_c, "ML_Model/pdp_data/pdp_qb_sec_k_c_brt_add.csv", row.names = FALSE)

### q_during
pdp_model_qd_sec_k <- pdp::partial(xgb_sec_k, pred.var = "q_during", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_qd_sec_k, "ML_Model/pdp_data/pdp_qd_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qd_sec_k_c, "ML_Model/pdp_data/pdp_qd_sec_k_c_brt_add.csv", row.names = FALSE)

### q_after
pdp_model_qa_sec_k <- pdp::partial(xgb_sec_k, pred.var = "q_after", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_qa_sec_k, "ML_Model/pdp_data/pdp_qa_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qa_sec_k_c, "ML_Model/pdp_data/pdp_qa_sec_k_c_brt_add.csv", row.names = FALSE)

### gaug_before
pdp_model_gb_sec_k <- pdp::partial(xgb_sec_k, pred.var = "gaug_before", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_gb_sec_k, "ML_Model/pdp_data/pdp_gb_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_gb_sec_k_c, "ML_Model/pdp_data/pdp_gb_sec_k_c_brt_add.csv", row.names = FALSE)

### gaug_during
pdp_model_gd_sec_k <- pdp::partial(xgb_sec_k, pred.var = "gaug_during", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_gd_sec_k, "ML_Model/pdp_data/pdp_gd_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_gd_sec_k_c, "ML_Model/pdp_data/pdp_gd_sec_k_c_brt_add.csv", row.names = FALSE)

### gaug_after
pdp_model_ga_sec_k <- pdp::partial(xgb_sec_k, pred.var = "gaug_after", train = trainx_sec_k[ ,-1]) |>
...
# export data 
write.csv(pdp_model_ga_sec_k, "ML_Model/pdp_data/pdp_ga_sec_k_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ga_sec_k_c, "ML_Model/pdp_data/pdp_ga_sec_k_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_sec_s, "ML_Model/pdp_data/pdp_v_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_sec_s_c, "ML_Model/pdp_data/pdp_v_sec_s_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_sec_s <- pdp::partial(xgb_sec_s, pred.var = "froude", train = trainx_sec_s[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_f_sec_s_c <- pdp::partial(xgb_sec_s_c, pred.var = "froude", train = trainx_sec_s_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_f_sec_s, "ML_Model/pdp_data/pdp_f_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_sec_s_c, "ML_Model/pdp_data/pdp_f_sec_s_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_sec_s <- pdp::partial(xgb_sec_s, pred.var = "shear_stress", train = trainx_sec_s[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_s_sec_s_c <- pdp::partial(xgb_sec_s_c, pred.var = "shear_stress", train = trainx_sec_s_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_s_sec_s, "ML_Model/pdp_data/pdp_s_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_sec_s_c, "ML_Model/pdp_data/pdp_s_sec_s_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_sec_s <- pdp::partial(xgb_sec_s, pred.var = "stream_power", train = trainx_sec_s[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "shannon_index")
pdp_model_sp_sec_s_c <- pdp::partial(xgb_sec_s_c, pred.var = "stream_power", train = trainx_sec_s_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "shannon_index")

# export data 
write.csv(pdp_model_sp_sec_s, "ML_Model/pdp_data/pdp_sp_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_sec_s_c, "ML_Model/pdp_data/pdp_sp_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_sec_s, "ML_Model/pdp_data/pdp_wd_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_sec_s_c, "ML_Model/pdp_data/pdp_wd_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_sec_s, "ML_Model/pdp_data/pdp_x_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_sec_s, "ML_Model/pdp_data/pdp_y_sec_s_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_sec_s, "ML_Model/pdp_data/pdp_z_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_z_sec_s_c, "ML_Model/pdp_data/pdp_z_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_sec_s, "ML_Model/pdp_data/pdp_dist_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_dist_sec_s_c, "ML_Model/pdp_data/pdp_dist_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_sec_s, "ML_Model/pdp_data/pdp_cv_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cv_sec_s_c, "ML_Model/pdp_data/pdp_cv_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_sec_s, "ML_Model/pdp_data/pdp_ac_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ac_sec_s_c, "ML_Model/pdp_data/pdp_ac_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_sec_s, "ML_Model/pdp_data/pdp_mc_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_mc_sec_s_c, "ML_Model/pdp_data/pdp_mc_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_sec_s, "ML_Model/pdp_data/pdp_cc_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cc_sec_s_c, "ML_Model/pdp_data/pdp_cc_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_sec_s, "ML_Model/pdp_data/pdp_clog_3_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_3_sec_s_c, "ML_Model/pdp_data/pdp_clog_3_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_sec_s, "ML_Model/pdp_data/pdp_clog_6_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_6_sec_s_c, "ML_Model/pdp_data/pdp_clog_6_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_sec_s, "ML_Model/pdp_data/pdp_sub_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sub_sec_s_c, "ML_Model/pdp_data/pdp_sub_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phb_sec_s, "ML_Model/pdp_data/pdp_phb_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_phb_sec_s_c, "ML_Model/pdp_data/pdp_phb_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phd_sec_s, "ML_Model/pdp_data/pdp_phd_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_phd_sec_s_c, "ML_Model/pdp_data/pdp_phd_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_pha_sec_s, "ML_Model/pdp_data/pdp_pha_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_pha_sec_s_c, "ML_Model/pdp_data/pdp_pha_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cb_sec_s, "ML_Model/pdp_data/pdp_cb_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cb_sec_s_c, "ML_Model/pdp_data/pdp_cb_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cd_sec_s, "ML_Model/pdp_data/pdp_cd_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cd_sec_s_c, "ML_Model/pdp_data/pdp_cd_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ca_sec_s, "ML_Model/pdp_data/pdp_ca_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ca_sec_s_c, "ML_Model/pdp_data/pdp_ca_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ob_sec_s, "ML_Model/pdp_data/pdp_ob_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ob_sec_s_c, "ML_Model/pdp_data/pdp_ob_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_od_sec_s, "ML_Model/pdp_data/pdp_od_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_od_sec_s_c, "ML_Model/pdp_data/pdp_od_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_oa_sec_s, "ML_Model/pdp_data/pdp_oa_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_oa_sec_s_c, "ML_Model/pdp_data/pdp_oa_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tb_sec_s, "ML_Model/pdp_data/pdp_tb_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_tb_sec_s_c, "ML_Model/pdp_data/pdp_tb_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_td_sec_s, "ML_Model/pdp_data/pdp_td_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_td_sec_s_c, "ML_Model/pdp_data/pdp_td_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ta_sec_s, "ML_Model/pdp_data/pdp_ta_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ta_sec_s_c, "ML_Model/pdp_data/pdp_ta_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_teb_sec_s, "ML_Model/pdp_data/pdp_teb_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_teb_sec_s_c, "ML_Model/pdp_data/pdp_teb_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ted_sec_s, "ML_Model/pdp_data/pdp_ted_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ted_sec_s_c, "ML_Model/pdp_data/pdp_ted_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tea_sec_s, "ML_Model/pdp_data/pdp_tea_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_tea_sec_s_c, "ML_Model/pdp_data/pdp_tea_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qb_sec_s, "ML_Model/pdp_data/pdp_qb_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qb_sec_s_c, "ML_Model/pdp_data/pdp_qb_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qd_sec_s, "ML_Model/pdp_data/pdp_qd_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qd_sec_s_c, "ML_Model/pdp_data/pdp_qd_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qa_sec_s, "ML_Model/pdp_data/pdp_qa_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qa_sec_s_c, "ML_Model/pdp_data/pdp_qa_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gb_sec_s, "ML_Model/pdp_data/pdp_gb_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_gb_sec_s_c, "ML_Model/pdp_data/pdp_gb_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gd_sec_s, "ML_Model/pdp_data/pdp_gd_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_gd_sec_s_c, "ML_Model/pdp_data/pdp_gd_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ga_sec_s, "ML_Model/pdp_data/pdp_ga_sec_s_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ga_sec_s_c, "ML_Model/pdp_data/pdp_ga_sec_s_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_sec_a, "ML_Model/pdp_data/pdp_v_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_sec_a_c, "ML_Model/pdp_data/pdp_v_sec_a_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_sec_a <- pdp::partial(xgb_sec_a, pred.var = "froude", train = trainx_sec_a[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_f_sec_a_c <- pdp::partial(xgb_sec_a_c, pred.var = "froude", train = trainx_sec_a_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_f_sec_a, "ML_Model/pdp_data/pdp_f_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_sec_a_c, "ML_Model/pdp_data/pdp_f_sec_a_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_sec_a <- pdp::partial(xgb_sec_a, pred.var = "shear_stress", train = trainx_sec_a[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_s_sec_a_c <- pdp::partial(xgb_sec_a_c, pred.var = "shear_stress", train = trainx_sec_a_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_s_sec_a, "ML_Model/pdp_data/pdp_s_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_sec_a_c, "ML_Model/pdp_data/pdp_s_sec_a_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_sec_a <- pdp::partial(xgb_sec_a, pred.var = "stream_power", train = trainx_sec_a[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "abundance")
pdp_model_sp_sec_a_c <- pdp::partial(xgb_sec_a_c, pred.var = "stream_power", train = trainx_sec_a_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "abundance")

# export data 
write.csv(pdp_model_sp_sec_a, "ML_Model/pdp_data/pdp_sp_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_sec_a_c, "ML_Model/pdp_data/pdp_sp_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_sec_a, "ML_Model/pdp_data/pdp_wd_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_sec_a_c, "ML_Model/pdp_data/pdp_wd_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_sec_a, "ML_Model/pdp_data/pdp_x_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_sec_a, "ML_Model/pdp_data/pdp_y_sec_a_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_sec_a, "ML_Model/pdp_data/pdp_z_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_z_sec_a_c, "ML_Model/pdp_data/pdp_z_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_sec_a, "ML_Model/pdp_data/pdp_dist_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_dist_sec_a_c, "ML_Model/pdp_data/pdp_dist_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_sec_a, "ML_Model/pdp_data/pdp_cv_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cv_sec_a_c, "ML_Model/pdp_data/pdp_cv_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_sec_a, "ML_Model/pdp_data/pdp_ac_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ac_sec_a_c, "ML_Model/pdp_data/pdp_ac_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_sec_a, "ML_Model/pdp_data/pdp_mc_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_mc_sec_a_c, "ML_Model/pdp_data/pdp_mc_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_sec_a, "ML_Model/pdp_data/pdp_cc_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cc_sec_a_c, "ML_Model/pdp_data/pdp_cc_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_sec_a, "ML_Model/pdp_data/pdp_clog_3_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_3_sec_a_c, "ML_Model/pdp_data/pdp_clog_3_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_sec_a, "ML_Model/pdp_data/pdp_clog_6_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_6_sec_a_c, "ML_Model/pdp_data/pdp_clog_6_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_sec_a, "ML_Model/pdp_data/pdp_sub_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sub_sec_a_c, "ML_Model/pdp_data/pdp_sub_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phb_sec_a, "ML_Model/pdp_data/pdp_phb_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_phb_sec_a_c, "ML_Model/pdp_data/pdp_phb_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phd_sec_a, "ML_Model/pdp_data/pdp_phd_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_phd_sec_a_c, "ML_Model/pdp_data/pdp_phd_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_pha_sec_a, "ML_Model/pdp_data/pdp_pha_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_pha_sec_a_c, "ML_Model/pdp_data/pdp_pha_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cb_sec_a, "ML_Model/pdp_data/pdp_cb_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cb_sec_a_c, "ML_Model/pdp_data/pdp_cb_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cd_sec_a, "ML_Model/pdp_data/pdp_cd_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cd_sec_a_c, "ML_Model/pdp_data/pdp_cd_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ca_sec_a, "ML_Model/pdp_data/pdp_ca_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ca_sec_a_c, "ML_Model/pdp_data/pdp_ca_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ob_sec_a, "ML_Model/pdp_data/pdp_ob_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ob_sec_a_c, "ML_Model/pdp_data/pdp_ob_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_od_sec_a, "ML_Model/pdp_data/pdp_od_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_od_sec_a_c, "ML_Model/pdp_data/pdp_od_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_oa_sec_a, "ML_Model/pdp_data/pdp_oa_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_oa_sec_a_c, "ML_Model/pdp_data/pdp_oa_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tb_sec_a, "ML_Model/pdp_data/pdp_tb_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_tb_sec_a_c, "ML_Model/pdp_data/pdp_tb_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_td_sec_a, "ML_Model/pdp_data/pdp_td_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_td_sec_a_c, "ML_Model/pdp_data/pdp_td_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ta_sec_a, "ML_Model/pdp_data/pdp_ta_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ta_sec_a_c, "ML_Model/pdp_data/pdp_ta_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_teb_sec_a, "ML_Model/pdp_data/pdp_teb_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_teb_sec_a_c, "ML_Model/pdp_data/pdp_teb_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ted_sec_a, "ML_Model/pdp_data/pdp_ted_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ted_sec_a_c, "ML_Model/pdp_data/pdp_ted_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tea_sec_a, "ML_Model/pdp_data/pdp_tea_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_tea_sec_a_c, "ML_Model/pdp_data/pdp_tea_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qb_sec_a, "ML_Model/pdp_data/pdp_qb_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qb_sec_a_c, "ML_Model/pdp_data/pdp_qb_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qd_sec_a, "ML_Model/pdp_data/pdp_qd_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qd_sec_a_c, "ML_Model/pdp_data/pdp_qd_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qa_sec_a, "ML_Model/pdp_data/pdp_qa_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qa_sec_a_c, "ML_Model/pdp_data/pdp_qa_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gb_sec_a, "ML_Model/pdp_data/pdp_gb_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_gb_sec_a_c, "ML_Model/pdp_data/pdp_gb_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gd_sec_a, "ML_Model/pdp_data/pdp_gd_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_gd_sec_a_c, "ML_Model/pdp_data/pdp_gd_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ga_sec_a, "ML_Model/pdp_data/pdp_ga_sec_a_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ga_sec_a_c, "ML_Model/pdp_data/pdp_ga_sec_a_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_sec_ra, "ML_Model/pdp_data/pdp_v_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_v_sec_ra_c, "ML_Model/pdp_data/pdp_v_sec_ra_c_brt_add.csv", row.names = FALSE)

### froude
pdp_model_f_sec_ra <- pdp::partial(xgb_sec_ra, pred.var = "froude", train = trainx_sec_ra[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_f_sec_ra_c <- pdp::partial(xgb_sec_ra_c, pred.var = "froude", train = trainx_sec_ra_c[ ,-1]) |>
  mutate(predictors = "froude",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_f_sec_ra, "ML_Model/pdp_data/pdp_f_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_f_sec_ra_c, "ML_Model/pdp_data/pdp_f_sec_ra_c_brt_add.csv", row.names = FALSE)

### shear_stress
pdp_model_s_sec_ra <- pdp::partial(xgb_sec_ra, pred.var = "shear_stress", train = trainx_sec_ra[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_s_sec_ra_c <- pdp::partial(xgb_sec_ra_c, pred.var = "shear_stress", train = trainx_sec_ra_c[ ,-1]) |>
  mutate(predictors = "shear_stress",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_s_sec_ra, "ML_Model/pdp_data/pdp_s_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_s_sec_ra_c, "ML_Model/pdp_data/pdp_s_sec_ra_c_brt_add.csv", row.names = FALSE)

### stream_power
pdp_model_sp_sec_ra <- pdp::partial(xgb_sec_ra, pred.var = "stream_power", train = trainx_sec_ra[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "rel_abundance")
pdp_model_sp_sec_ra_c <- pdp::partial(xgb_sec_ra_c, pred.var = "stream_power", train = trainx_sec_ra_c[ ,-1]) |>
  mutate(predictors = "stream_power",
         model = "velocity w/ coordinates",
         index = "rel_abundance")

# export data 
write.csv(pdp_model_sp_sec_ra, "ML_Model/pdp_data/pdp_sp_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sp_sec_ra_c, "ML_Model/pdp_data/pdp_sp_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_sec_ra, "ML_Model/pdp_data/pdp_wd_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_wd_sec_ra_c, "ML_Model/pdp_data/pdp_wd_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_sec_ra, "ML_Model/pdp_data/pdp_x_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_y_sec_ra, "ML_Model/pdp_data/pdp_y_sec_ra_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_sec_ra, "ML_Model/pdp_data/pdp_z_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_z_sec_ra_c, "ML_Model/pdp_data/pdp_z_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_sec_ra, "ML_Model/pdp_data/pdp_dist_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_dist_sec_ra_c, "ML_Model/pdp_data/pdp_dist_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_sec_ra, "ML_Model/pdp_data/pdp_cv_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cv_sec_ra_c, "ML_Model/pdp_data/pdp_cv_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_sec_ra, "ML_Model/pdp_data/pdp_ac_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ac_sec_ra_c, "ML_Model/pdp_data/pdp_ac_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_sec_ra, "ML_Model/pdp_data/pdp_mc_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_mc_sec_ra_c, "ML_Model/pdp_data/pdp_mc_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_sec_ra, "ML_Model/pdp_data/pdp_cc_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cc_sec_ra_c, "ML_Model/pdp_data/pdp_cc_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_sec_ra, "ML_Model/pdp_data/pdp_clog_3_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_3_sec_ra_c, "ML_Model/pdp_data/pdp_clog_3_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_sec_ra, "ML_Model/pdp_data/pdp_clog_6_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_clog_6_sec_ra_c, "ML_Model/pdp_data/pdp_clog_6_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_sec_ra, "ML_Model/pdp_data/pdp_sub_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_sub_sec_ra_c, "ML_Model/pdp_data/pdp_sub_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phb_sec_ra, "ML_Model/pdp_data/pdp_phb_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_phb_sec_ra_c, "ML_Model/pdp_data/pdp_phb_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phd_sec_ra, "ML_Model/pdp_data/pdp_phd_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_phd_sec_ra_c, "ML_Model/pdp_data/pdp_phd_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_pha_sec_ra, "ML_Model/pdp_data/pdp_pha_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_pha_sec_ra_c, "ML_Model/pdp_data/pdp_pha_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cb_sec_ra, "ML_Model/pdp_data/pdp_cb_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cb_sec_ra_c, "ML_Model/pdp_data/pdp_cb_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cd_sec_ra, "ML_Model/pdp_data/pdp_cd_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_cd_sec_ra_c, "ML_Model/pdp_data/pdp_cd_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ca_sec_ra, "ML_Model/pdp_data/pdp_ca_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ca_sec_ra_c, "ML_Model/pdp_data/pdp_ca_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ob_sec_ra, "ML_Model/pdp_data/pdp_ob_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ob_sec_ra_c, "ML_Model/pdp_data/pdp_ob_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_od_sec_ra, "ML_Model/pdp_data/pdp_od_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_od_sec_ra_c, "ML_Model/pdp_data/pdp_od_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_oa_sec_ra, "ML_Model/pdp_data/pdp_oa_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_oa_sec_ra_c, "ML_Model/pdp_data/pdp_oa_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tb_sec_ra, "ML_Model/pdp_data/pdp_tb_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_tb_sec_ra_c, "ML_Model/pdp_data/pdp_tb_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_td_sec_ra, "ML_Model/pdp_data/pdp_td_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_td_sec_ra_c, "ML_Model/pdp_data/pdp_td_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ta_sec_ra, "ML_Model/pdp_data/pdp_ta_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ta_sec_ra_c, "ML_Model/pdp_data/pdp_ta_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_teb_sec_ra, "ML_Model/pdp_data/pdp_teb_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_teb_sec_ra_c, "ML_Model/pdp_data/pdp_teb_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ted_sec_ra, "ML_Model/pdp_data/pdp_ted_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ted_sec_ra_c, "ML_Model/pdp_data/pdp_ted_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tea_sec_ra, "ML_Model/pdp_data/pdp_tea_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_tea_sec_ra_c, "ML_Model/pdp_data/pdp_tea_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qb_sec_ra, "ML_Model/pdp_data/pdp_qb_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qb_sec_ra_c, "ML_Model/pdp_data/pdp_qb_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qd_sec_ra, "ML_Model/pdp_data/pdp_qd_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qd_sec_ra_c, "ML_Model/pdp_data/pdp_qd_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qa_sec_ra, "ML_Model/pdp_data/pdp_qa_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_qa_sec_ra_c, "ML_Model/pdp_data/pdp_qa_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gb_sec_ra, "ML_Model/pdp_data/pdp_gb_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_gb_sec_ra_c, "ML_Model/pdp_data/pdp_gb_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gd_sec_ra, "ML_Model/pdp_data/pdp_gd_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_gd_sec_ra_c, "ML_Model/pdp_data/pdp_gd_sec_ra_c_brt_add.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ga_sec_ra, "ML_Model/pdp_data/pdp_ga_sec_ra_brt_add.csv", row.names = FALSE)
write.csv(pdp_model_ga_sec_ra_c, "ML_Model/pdp_data/pdp_ga_sec_ra_c_brt_add.csv", row.names = FALSE)
```
...
# GL1 - predictors: v + wd ----------------------------------------------------
GL1_ezg_wd_k <- terra::predict(GL1_ezg, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
GL1_ezg_wd_s <- terra::predict(GL1_ezg, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
GL1_ezg_wd_a <- terra::predict(GL1_ezg, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
GL1_ezg_wd_ra <- terra::predict(GL1_ezg, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

#GL1_q_wd_k <- terra::predict(GL1_q, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
#GL1_q_wd_s <- terra::predict(GL1_q, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
#GL1_q_wd_a <- terra::predict(GL1_q, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
#GL1_q_wd_ra <- terra::predict(GL1_q, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

# GL1 - predictor: velocity ---------------------------------------------------
GL1_ezg_v_k <- terra::predict(GL1_v_ezg, model = autotuner_xbrt_v_k, fun = predict, index = 4)
GL1_ezg_v_s <- terra::predict(GL1_v_ezg, model = autotuner_xbrt_v_s, fun = predict, index = 4)
GL1_ezg_v_a <- terra::predict(GL1_v_ezg, model = autotuner_xbrt_v_a, fun = predict, index = 4)
GL1_ezg_v_ra <- terra::predict(GL1_v_ezg, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

#GL1_q_v_k <- terra::predict(GL1_v_q, model = autotuner_xbrt_v_k, fun = predict, index = 4)
#GL1_q_v_s <- terra::predict(GL1_v_q, model = autotuner_xbrt_v_s, fun = predict, index = 4)
#GL1_q_v_a <- terra::predict(GL1_v_q, model = autotuner_xbrt_v_a, fun = predict, index = 4)
#GL1_q_v_ra <- terra::predict(GL1_v_q, model = autotuner_xbrt_v_ra, fun = predict, index 4)

# GL2 - predictors: v + wd ----------------------------------------------------
GL2_ezg_wd_k <- terra::predict(GL2_ezg, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
GL2_ezg_wd_s <- terra::predict(GL2_ezg, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
GL2_ezg_wd_a <- terra::predict(GL2_ezg, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
GL2_ezg_wd_ra <- terra::predict(GL2_ezg, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

#GL2_q_wd_k <- terra::predict(GL2_q, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
#GL2_q_wd_s <- terra::predict(GL2_q, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
#GL2_q_wd_a <- terra::predict(GL2_q, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
#GL2_q_wd_ra <- terra::predict(GL2_q, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

# GL2 - predictor: velocity ---------------------------------------------------
GL2_ezg_v_k <- terra::predict(GL2_v_ezg, model = autotuner_xbrt_v_k, fun = predict, index = 4)
GL2_ezg_v_s <- terra::predict(GL2_v_ezg, model = autotuner_xbrt_v_s, fun = predict, index = 4)
GL2_ezg_v_a <- terra::predict(GL2_v_ezg, model = autotuner_xbrt_v_a, fun = predict, index = 4)
GL2_ezg_v_ra <- terra::predict(GL2_v_ezg, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

#GL2_q_v_k <- terra::predict(GL2_v_q, model = autotuner_xbrt_v_k, fun = predict, index = 4)
#GL2_q_v_s <- terra::predict(GL2_v_q, model = autotuner_xbrt_v_s, fun = predict, index = 4)
#GL2_q_v_a <- terra::predict(GL2_v_q, model = autotuner_xbrt_v_a, fun = predict, index = 4)
#GL2_q_v_ra <- terra::predict(GL2_v_q, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

# L2 - predictors: v + wd -----------------------------------------------------
L2_ezg_wd_k <- terra::predict(L2_ezg, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
L2_ezg_wd_s <- terra::predict(L2_ezg, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
L2_ezg_wd_a <- terra::predict(L2_ezg, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
L2_ezg_wd_ra <- terra::predict(L2_ezg, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

#L2_q_wd_k <- terra::predict(L2_q, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
#L2_q_wd_s <- terra::predict(L2_q, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
#L2_q_wd_a <- terra::predict(L2_q, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
#L2_q_wd_ra <- terra::predict(L2_q, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

# L2 - predictor: velocity ----------------------------------------------------
L2_ezg_v_k <- terra::predict(L2_v_ezg, model = autotuner_xbrt_v_k, fun = predict, index = 4)
L2_ezg_v_s <- terra::predict(L2_v_ezg, model = autotuner_xbrt_v_s, fun = predict, index = 4)
L2_ezg_v_a <- terra::predict(L2_v_ezg, model = autotuner_xbrt_v_a, fun = predict, index = 4)
L2_ezg_v_ra <- terra::predict(L2_v_ezg, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

#L2_q_v_k <- terra::predict(L2_v_q, model = autotuner_xbrt_v_k, fun = predict, index = 4)
#L2_q_v_s <- terra::predict(L2_v_q, model = autotuner_xbrt_v_s, fun = predict, index = 4)
#L2_q_v_a <- terra::predict(L2_v_q, model = autotuner_xbrt_v_a, fun = predict, index = 4)
#L2_q_v_ra <- terra::predict(L2_v_q, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

# M1  - predictors: v + wd -----------------------------------------------------
M1_ezg_wd_k <- terra::predict(M1_ezg, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
M1_ezg_wd_s <- terra::predict(M1_ezg, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
M1_ezg_wd_a <- terra::predict(M1_ezg, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
M1_ezg_wd_ra <- terra::predict(M1_ezg, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

#M1_q_wd_k <- terra::predict(M1_q, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
#M1_q_wd_s <- terra::predict(M1_q, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
#M1_q_wd_a <- terra::predict(M1_q, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
#M1_q_wd_ra <- terra::predict(M1_q, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

# M1  - predictor: velocity ---------------------------------------------------
M1_ezg_v_k <- terra::predict(M1_v_ezg, model = autotuner_xbrt_v_k, fun = predict, index = 4)
M1_ezg_v_s <- terra::predict(M1_v_ezg, model = autotuner_xbrt_v_s, fun = predict, index = 4)
M1_ezg_v_a <- terra::predict(M1_v_ezg, model = autotuner_xbrt_v_a, fun = predict, index = 4)
M1_ezg_v_ra <- terra::predict(M1_v_ezg, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

#M1_q_v_k <- terra::predict(M1_v_q, model = autotuner_xbrt_v_k, fun = predict, index = 4)
#M1_q_v_s <- terra::predict(M1_v_q, model = autotuner_xbrt_v_s, fun = predict, index = 4)
#M1_q_v_a <- terra::predict(M1_v_q, model = autotuner_xbrt_v_a, fun = predict, index = 4)
#M1_q_v_ra <- terra::predict(M1_v_q, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

# S1  - predictors: v + wd ----------------------------------------------------
S1_ezg_wd_k <- terra::predict(S1_ezg, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
S1_ezg_wd_s <- terra::predict(S1_ezg, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
S1_ezg_wd_a <- terra::predict(S1_ezg, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
S1_ezg_wd_ra <- terra::predict(S1_ezg, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

#S1_q_wd_k <- terra::predict(S1_q, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
#S1_q_wd_s <- terra::predict(S1_q, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
#S1_q_wd_a <- terra::predict(S1_q, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
#S1_q_wd_ra <- terra::predict(S1_q, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

# S1  - predictor: velocity ---------------------------------------------------
S1_ezg_v_k <- terra::predict(S1_v_ezg, model = autotuner_xbrt_v_k, fun = predict, index = 4)
S1_ezg_v_s <- terra::predict(S1_v_ezg, model = autotuner_xbrt_v_s, fun = predict, index = 4)
S1_ezg_v_a <- terra::predict(S1_v_ezg, model = autotuner_xbrt_v_a, fun = predict, index = 4)
S1_ezg_v_ra <- terra::predict(S1_v_ezg, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

#S1_q_v_k <- terra::predict(S1_v_q, model = autotuner_xbrt_v_k, fun = predict, index = 4)
#S1_q_v_s <- terra::predict(S1_v_q, model = autotuner_xbrt_v_s, fun = predict, index = 4)
#S1_q_v_a <- terra::predict(S1_v_q, model = autotuner_xbrt_v_a, fun = predict, index = 4)
#S1_q_v_ra <- terra::predict(S1_v_q, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

# S2  - predictors: v + wd ----------------------------------------------------
S2_ezg_wd_k <- terra::predict(S2_ezg, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
S2_ezg_wd_s <- terra::predict(S2_ezg, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
S2_ezg_wd_a <- terra::predict(S2_ezg, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
S2_ezg_wd_ra <- terra::predict(S2_ezg, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

#S2_q_wd_k <- terra::predict(S2_q, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
#S2_q_wd_s <- terra::predict(S2_q, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
#S2_q_wd_a <- terra::predict(S2_q, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
#S2_q_wd_ra <- terra::predict(S2_q, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

# S2  - predictor: velocity ---------------------------------------------------
S2_ezg_v_k <- terra::predict(S2_v_ezg, model = autotuner_xbrt_v_k, fun = predict, index = 4)
S2_ezg_v_s <- terra::predict(S2_v_ezg, model = autotuner_xbrt_v_s, fun = predict, index = 4)
S2_ezg_v_a <- terra::predict(S2_v_ezg, model = autotuner_xbrt_v_a, fun = predict, index = 4)
S2_ezg_v_ra <- terra::predict(S2_v_ezg, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

#S2_q_v_k <- terra::predict(S2_v_q, model = autotuner_xbrt_v_k, fun = predict, index = 4)
#S2_q_v_s <- terra::predict(S2_v_q, model = autotuner_xbrt_v_s, fun = predict, index = 4)
#S2_q_v_a <- terra::predict(S2_v_q, model = autotuner_xbrt_v_a, fun = predict, index = 4)
#S2_q_v_ra <- terra::predict(S2_v_q, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

# TH4  - predictors: v + wd ---------------------------------------------------
TH4_ezg_wd_k <- terra::predict(TH4_ezg, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
TH4_ezg_wd_s <- terra::predict(TH4_ezg, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
TH4_ezg_wd_a <- terra::predict(TH4_ezg, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
TH4_ezg_wd_ra <- terra::predict(TH4_ezg, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

#TH4_q_wd_k <- terra::predict(TH4_q, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
#TH4_q_wd_s <- terra::predict(TH4_q, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
#TH4_q_wd_a <- terra::predict(TH4_q, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
#TH4_q_wd_ra <- terra::predict(TH4_q, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

# TH4  - predictor: velocity --------------------------------------------------
TH4_ezg_v_k <- terra::predict(TH4_v_ezg, model = autotuner_xbrt_v_k, fun = predict, index = 4)
TH4_ezg_v_s <- terra::predict(TH4_v_ezg, model = autotuner_xbrt_v_s, fun = predict, index = 4)
TH4_ezg_v_a <- terra::predict(TH4_v_ezg, model = autotuner_xbrt_v_a, fun = predict, index = 4)
TH4_ezg_v_ra <- terra::predict(TH4_v_ezg, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

#TH4_q_v_k <- terra::predict(TH4_v_q, model = autotuner_xbrt_v_k, fun = predict, index = 4)
#TH4_q_v_s <- terra::predict(TH4_v_q, model = autotuner_xbrt_v_s, fun = predict, index = 4)
#TH4_q_v_a <- terra::predict(TH4_v_q, model = autotuner_xbrt_v_a, fun = predict, index = 4)
#TH4_q_v_ra <- terra::predict(TH4_v_q, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

# VR3  - predictors: v + wd ---------------------------------------------------
VR3_ezg_wd_k <- terra::predict(VR3_ezg, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
VR3_ezg_wd_s <- terra::predict(VR3_ezg, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
VR3_ezg_wd_a <- terra::predict(VR3_ezg, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
VR3_ezg_wd_ra <- terra::predict(VR3_ezg, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

#VR3_q_wd_k <- terra::predict(VR3_q, model = autotuner_xbrt_wd_k, fun = predict, index = 5)
#VR3_q_wd_s <- terra::predict(VR3_q, model = autotuner_xbrt_wd_s, fun = predict, index = 5)
#VR3_q_wd_a <- terra::predict(VR3_q, model = autotuner_xbrt_wd_a, fun = predict, index = 5)
#VR3_q_wd_ra <- terra::predict(VR3_q, model = autotuner_xbrt_wd_ra, fun = predict, index = 5)

# VR3  - predictor: velocity --------------------------------------------------
VR3_ezg_v_k <- terra::predict(VR3_v_ezg, model = autotuner_xbrt_v_k, fun = predict, index = 4)
VR3_ezg_v_s <- terra::predict(VR3_v_ezg, model = autotuner_xbrt_v_s, fun = predict, index = 4)
VR3_ezg_v_a <- terra::predict(VR3_v_ezg, model = autotuner_xbrt_v_a, fun = predict, index = 4)
VR3_ezg_v_ra <- terra::predict(VR3_v_ezg, model = autotuner_xbrt_v_ra, fun = predict, index = 4)

#VR3_q_v_k <- terra::predict(VR3_v_q, model = autotuner_xbrt_v_k, fun = predict, index = 4)
#VR3_q_v_s <- terra::predict(VR3_v_q, model = autotuner_xbrt_v_s, fun = predict, index = 4)
#VR3_q_v_a <- terra::predict(VR3_v_q, model = autotuner_xbrt_v_a, fun = predict, index = 4)
#VR3_q_v_ra <- terra::predict(VR3_v_q, model = autotuner_xbrt_v_ra, fun = predict, index = 4)
```
...
# GL1 -------------------------------------------------------------------------
data_GL1 <- cbind(regr_GL1_wd_k, regr_GL1_wd_s, regr_GL1_wd_a, regr_GL1_wd_ra, regr_GL1_v_k, regr_GL1_v_s, regr_GL1_v_a, regr_GL1_v_ra, regr_m2_GL1_wd_k, regr_m2_GL1_wd_s, regr_m2_GL1_wd_a, regr_m2_GL1_wd_ra, regr_m2_GL1_v_k, regr_m2_GL1_v_s, regr_m2_GL1_v_a, regr_m2_GL1_v_ra, GL1) |>
  dplyr::rename(auto_k_index_wd = regr_GL1_wd_k,
         auto_shannon_wd = regr_GL1_wd_s,
         auto_abundance_wd = regr_GL1_wd_a,
         auto_rel_abundance_wd = regr_GL1_wd_ra,
         auto_k_index_v = regr_GL1_v_k,
         auto_shannon_v = regr_GL1_v_s,
         auto_abundance_v = regr_GL1_v_a,
         auto_rel_abundance_v = regr_GL1_v_ra,
...
# GL2 -------------------------------------------------------------------------
data_GL2 <- cbind(regr_GL2_wd_k, regr_GL2_wd_s, regr_GL2_wd_a, regr_GL2_wd_ra, regr_GL2_v_k, regr_GL2_v_s, regr_GL2_v_a, regr_GL2_v_ra, regr_m2_GL2_wd_k, regr_m2_GL2_wd_s, regr_m2_GL2_wd_a, regr_m2_GL2_wd_ra, regr_m2_GL2_v_k, regr_m2_GL2_v_s, regr_m2_GL2_v_a, regr_m2_GL2_v_ra, GL2) |>
  dplyr::rename(auto_k_index_wd = regr_GL2_wd_k,
         auto_shannon_wd = regr_GL2_wd_s,
         auto_abundance_wd = regr_GL2_wd_a,
         auto_rel_abundance_wd = regr_GL2_wd_ra,
         auto_k_index_v = regr_GL2_v_k,
         auto_shannon_v = regr_GL2_v_s,
         auto_abundance_v = regr_GL2_v_a,
         auto_rel_abundance_v = regr_GL2_v_ra,
...
# L2 --------------------------------------------------------------------------
data_L2 <- cbind(regr_L2_wd_k, regr_L2_wd_s, regr_L2_wd_a, regr_L2_wd_ra, regr_L2_v_k, regr_L2_v_s, regr_L2_v_a, regr_L2_v_ra, regr_m2_L2_wd_k, regr_m2_L2_wd_s, regr_m2_L2_wd_a, regr_m2_L2_wd_ra, regr_m2_L2_v_k, regr_m2_L2_v_s, regr_m2_L2_v_a, regr_m2_L2_v_ra, L2) |>
  dplyr::rename(auto_k_index_wd = regr_L2_wd_k,
         auto_shannon_wd = regr_L2_wd_s,
         auto_abundance_wd = regr_L2_wd_a,
         auto_rel_abundance_wd = regr_L2_wd_ra,
         auto_k_index_v = regr_L2_v_k,
         auto_shannon_v = regr_L2_v_s,
         auto_abundance_v = regr_L2_v_a,
         auto_rel_abundance_v = regr_L2_v_ra,
...
# M1 --------------------------------------------------------------------------
data_M1 <- cbind(regr_M1_wd_k, regr_M1_wd_s, regr_M1_wd_a, regr_M1_wd_ra, regr_M1_v_k, regr_M1_v_s, regr_M1_v_a, regr_M1_v_ra, regr_m2_M1_wd_k, regr_m2_M1_wd_s, regr_m2_M1_wd_a, regr_m2_M1_wd_ra, regr_m2_M1_v_k, regr_m2_M1_v_s, regr_m2_M1_v_a, regr_m2_M1_v_ra, M1) |>
  dplyr::rename(auto_k_index_wd = regr_M1_wd_k,
         auto_shannon_wd = regr_M1_wd_s,
         auto_abundance_wd = regr_M1_wd_a,
         auto_rel_abundance_wd = regr_M1_wd_ra,
         auto_k_index_v = regr_M1_v_k,
         auto_shannon_v = regr_M1_v_s,
         auto_abundance_v = regr_M1_v_a,
         auto_rel_abundance_v = regr_M1_v_ra,
...
# S1 --------------------------------------------------------------------------
data_S1 <- cbind(regr_S1_wd_k, regr_S1_wd_s, regr_S1_wd_a, regr_S1_wd_ra, regr_S1_v_k, regr_S1_v_s, regr_S1_v_a, regr_S1_v_ra, regr_m2_S1_wd_k, regr_m2_S1_wd_s, regr_m2_S1_wd_a, regr_m2_S1_wd_ra, regr_m2_S1_v_k, regr_m2_S1_v_s, regr_m2_S1_v_a, regr_m2_S1_v_ra, S1) |>
  dplyr::rename(auto_k_index_wd = regr_S1_wd_k,
         auto_shannon_wd = regr_S1_wd_s,
         auto_abundance_wd = regr_S1_wd_a,
         auto_rel_abundance_wd = regr_S1_wd_ra,
         auto_k_index_v = regr_S1_v_k,
         auto_shannon_v = regr_S1_v_s,
         auto_abundance_v = regr_S1_v_a,
         auto_rel_abundance_v = regr_S1_v_ra,
...
# S2 --------------------------------------------------------------------------
data_S2 <- cbind(regr_S2_wd_k, regr_S2_wd_s, regr_S2_wd_a, regr_S2_wd_ra, regr_S2_v_k, regr_S2_v_s, regr_S2_v_a, regr_S2_v_ra, regr_m2_S2_wd_k, regr_m2_S2_wd_s, regr_m2_S2_wd_a, regr_m2_S2_wd_ra, regr_m2_S2_v_k, regr_m2_S2_v_s, regr_m2_S2_v_a, regr_m2_S2_v_ra, S2) |>
  dplyr::rename(auto_k_index_wd = regr_S2_wd_k,
         auto_shannon_wd = regr_S2_wd_s,
         auto_abundance_wd = regr_S2_wd_a,
         auto_rel_abundance_wd = regr_S2_wd_ra,
         auto_k_index_v = regr_S2_v_k,
         auto_shannon_v = regr_S2_v_s,
         auto_abundance_v = regr_S2_v_a,
         auto_rel_abundance_v = regr_S2_v_ra,
...
# TH4 -------------------------------------------------------------------------
data_TH4 <- cbind(regr_TH4_wd_k, regr_TH4_wd_s, regr_TH4_wd_a, regr_TH4_wd_ra, regr_TH4_v_k, regr_TH4_v_s, regr_TH4_v_a, regr_TH4_v_ra, regr_m2_TH4_wd_k, regr_m2_TH4_wd_s, regr_m2_TH4_wd_a, regr_m2_TH4_wd_ra, regr_m2_TH4_v_k, regr_m2_TH4_v_s, regr_m2_TH4_v_a, regr_m2_TH4_v_ra, TH4) |>
  dplyr::rename(auto_k_index_wd = regr_TH4_wd_k,
         auto_shannon_wd = regr_TH4_wd_s,
         auto_abundance_wd = regr_TH4_wd_a,
         auto_rel_abundance_wd = regr_TH4_wd_ra,
         auto_k_index_v = regr_TH4_v_k,
         auto_shannon_v = regr_TH4_v_s,
         auto_abundance_v = regr_TH4_v_a,
         auto_rel_abundance_v = regr_TH4_v_ra,
...
# VR3 -------------------------------------------------------------------------
data_VR3 <- cbind(regr_VR3_wd_k, regr_VR3_wd_s, regr_VR3_wd_a, regr_VR3_wd_ra, regr_VR3_v_k, regr_VR3_v_s, regr_VR3_v_a, regr_VR3_v_ra, regr_m2_VR3_wd_k, regr_m2_VR3_wd_s, regr_m2_VR3_wd_a, regr_m2_VR3_wd_ra, regr_m2_VR3_v_k, regr_m2_VR3_v_s, regr_m2_VR3_v_a, regr_m2_VR3_v_ra, VR3) |>
  dplyr::rename(auto_k_index_wd = regr_VR3_wd_k,
         auto_shannon_wd = regr_VR3_wd_s,
         auto_abundance_wd = regr_VR3_wd_a,
         auto_rel_abundance_wd = regr_VR3_wd_ra,
         auto_k_index_v = regr_VR3_v_k,
         auto_shannon_v = regr_VR3_v_s,
         auto_abundance_v = regr_VR3_v_a,
         auto_rel_abundance_v = regr_VR3_v_ra,
