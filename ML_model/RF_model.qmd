...
data_section <- read_delim("Pre_Processing/abiotic_mi_sampling/lab_ml_section.csv") |>
  ...
  dplyr::select(-Hydropeaking_river_type, -Hydrokeaking_residual_flow_natural_near_natural, -Category_Water_depth, -date, -time, -time_before, -time_during, -time_after, -clog_3_class, -clog_6_class, -sub_type, -hydr_type_int, -ox_sat_after, -ox_sat_before, -ox_sat_during, -Number_Taxa, -EPT_Taxa)
```
...
write.csv(vi_rf_model_v, "ML_model/vi_rf_model_v.csv", row.names = FALSE)
write.csv(vi_rf_model_v_c, "ML_model/vi_rf_model_v_c.csv", row.names = FALSE)
write.csv(vi_rf_model_wd, "ML_model/vi_rf_model_wd.csv", row.names = FALSE)
write.csv(vi_rf_model_wd_c, "ML_model/vi_rf_model_wd_c.csv", row.names = FALSE)
write.csv(vi_rf_model_samp, "ML_model/vi_rf_model_samp.csv", row.names = FALSE)
write.csv(vi_rf_model_samp_c, "ML_model/vi_rf_model_samp_c.csv", row.names = FALSE)
write.csv(vi_rf_model_sec, "ML_model/vi_rf_model_sec.csv", row.names = FALSE)
write.csv(vi_rf_model_sec_c, "ML_model/vi_rf_model_sec_c.csv", row.names = FALSE)
```
