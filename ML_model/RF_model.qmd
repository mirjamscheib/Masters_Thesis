...
data_section <- data_section[-seq(2, nrow(data_section), by = 2), ]
...
# Remove every second row
data_var <- data_var[-seq(2, nrow(data_var), by = 2), ]
```
...
# with training data 
r2_train_v_k <- R2(pred = pred_train_v_k, obs = training_v_k_c$k_index, na.rm = TRUE)
...
# with training data 
r2_train_v_s <- R2(pred = pred_train_v_s, obs = training_v_s_c$shannon, na.rm = TRUE)
...
# with training data 
r2_train_v_a <- R2(pred = pred_train_v_a, obs = training_v_a_c$abundance, na.rm = TRUE)
...
# with training data 
r2_train_v_ra <- R2(pred = pred_train_v_ra, obs = training_v_ra_c$rel_abundance, na.rm = TRUE)
...
# with training data 
r2_train_wd_k <- R2(pred = pred_train_wd_k, obs = training_wd_k_c$k_index, na.rm = TRUE)
...
# with training data 
r2_train_wd_s <- R2(pred = pred_train_wd_s, obs = training_wd_s_c$shannon, na.rm = TRUE)
...
# with training data 
r2_train_wd_a <- R2(pred = pred_train_wd_a, obs = training_wd_a_c$abundance, na.rm = TRUE)
...
# with training data 
r2_train_wd_ra <- R2(pred = pred_train_wd_ra, obs = training_wd_ra_c$rel_abundance, na.rm = TRUE)
...
# with training data 
r2_train_samp_k <- R2(pred = pred_train_samp_k, obs = training_v_k_c$k_index, na.rm = TRUE)
...
# with training data 
r2_train_samp_s <- R2(pred = pred_train_samp_s, obs = training_v_s_c$shannon, na.rm = TRUE)
...
# with training data 
r2_train_samp_a <- R2(pred = pred_train_samp_a, obs = training_v_a_c$abundance, na.rm = TRUE)
...
# with training data 
r2_train_samp_ra <- R2(pred = pred_train_samp_ra, obs = training_v_ra_c$rel_abundance, na.rm = TRUE)
...
# with training data 
r2_train_sec_k <- R2(pred = pred_train_sec_k, obs = training_v_k_c$k_index, na.rm = TRUE)
...
# with training data 
r2_train_sec_s <- R2(pred = pred_train_sec_s, obs = training_v_s_c$shannon, na.rm = TRUE)
...
# with training data 
r2_train_sec_a <- R2(pred = pred_train_sec_a, obs = training_v_a_c$abundance, na.rm = TRUE)
...
# with training data 
r2_train_sec_ra <- R2(pred = pred_train_sec_ra, obs = training_v_ra_c$rel_abundance, na.rm = TRUE)
...
# with model using raster extracted values - test set
r2_rast_var_k <- R2(pred = p_rast_var_k, obs = responses_var_k, na.rm = TRUE)

# with training data 
r2_train_var_k <- R2(pred = pred_train_var_k, obs = training_v_k_c$k_index, na.rm = TRUE)
...
# with model using raster extracted values - test set
r2_rast_var_s <- R2(pred = p_rast_var_s, obs = responses_var_s, na.rm = TRUE)

# with training data 
r2_train_var_s <- R2(pred = pred_train_var_s, obs = training_v_s_c$shannon, na.rm = TRUE)
...
# with model using raster extracted values - test set
r2_rast_var_a <- R2(pred = p_rast_var_a, obs = responses_var_a, na.rm = TRUE)

# with training data 
r2_train_var_a <- R2(pred = pred_train_var_a, obs = training_v_a_c$abundance, na.rm = TRUE)
...
# with model using raster extracted values - test set
r2_rast_var_ra <- R2(pred = p_rast_var_ra, obs = responses_var_ra, na.rm = TRUE)

# with training data 
r2_train_var_ra <- R2(pred = pred_train_var_ra, obs = training_v_ra_c$rel_abundance, na.rm = TRUE)
```
...
# with model using raster extracted values - test set
rmse_rast_v_k <- Metrics::rmse(actual = responses_v_k, predicted = p_rast_v_k)
...
# with model using raster extracted values - test set
mae_rast_v_k <- Metrics::mae(actual = responses_v_k, predicted = p_rast_v_k)
...
# with model using raster extracted values - test set
rmse_rast_v_s <- Metrics::rmse(actual = responses_v_s, predicted = p_rast_v_s)

# with training data 
rmse_train_v_s <- Metrics::rmse(actual = responses_v_s, predicted = pred_train_v_s)
...
# with model using raster extracted values - test set
mae_rast_v_s <- Metrics::mae(actual = responses_v_s, predicted = p_rast_v_s)

# with training data 
mae_train_v_s <- Metrics::mae(actual = responses_v_s, predicted = pred_train_v_s)
...
# with model using raster extracted values - test set
rmse_rast_v_a <- Metrics::rmse(actual = responses_v_a, predicted = p_rast_v_a)

# with training data 
rmse_train_v_a <- Metrics::rmse(actual = responses_v_a, predicted = pred_train_v_a)
...
# with model using raster extracted values - test set
mae_rast_v_a <- Metrics::mae(actual = responses_v_a, predicted = p_rast_v_a)

# with training data 
mae_train_v_a <- Metrics::mae(actual = responses_v_a, predicted = pred_train_v_a)
...
# with model using raster extracted values - test set
rmse_rast_v_ra <- Metrics::rmse(actual = responses_v_ra, predicted = p_rast_v_ra)

# with training data 
rmse_train_v_ra <- Metrics::rmse(actual = responses_v_ra, predicted = pred_train_v_ra)
...
# with model using raster extracted values - test set
mae_rast_v_ra <- Metrics::mae(actual = responses_v_ra, predicted = p_rast_v_ra)

# with training data 
mae_train_v_ra <- Metrics::mae(actual = responses_v_ra, predicted = pred_train_v_ra)
...
# with model using raster extracted values - test set
rmse_rast_wd_k <- Metrics::rmse(actual = responses_wd_k, predicted = p_rast_wd_k)
...
# with model using raster extracted values - test set
mae_rast_wd_k <- Metrics::mae(actual = responses_wd_k, predicted = p_rast_wd_k)
...
# with model using raster extracted values - test set
rmse_rast_wd_s <- Metrics::rmse(actual = responses_wd_s, predicted = p_rast_wd_s)

# with training data 
rmse_train_wd_s <- Metrics::rmse(actual = responses_wd_s, predicted = pred_train_wd_s)
...
# with model using raster extracted values - test set
mae_rast_wd_s <- Metrics::mae(actual = responses_wd_s, predicted = p_rast_wd_s)

# with training data 
mae_train_wd_s <- Metrics::mae(actual = responses_wd_s, predicted = pred_train_wd_s)

# With abundance as response -----------------------
rmse_model_wd_a_c <- Metrics::rmse(actual = responses_wd_a, predicted = rf_pred_model_wd_a_c)
rmse_rast_wd_a <- Metrics::rmse(actual = responses_wd_a, predicted = p_rast_wd_a)

mae_model_wd_a_c <- Metrics::mae(actual = responses_wd_a, predicted = rf_pred_model_wd_a_c)
mae_rast_wd_a <- Metrics::mae(actual = responses_wd_a, predicted = p_rast_wd_a)

# With rel_abundance as response
rmse_model_wd_ra_c <- Metrics::rmse(actual = responses_wd_ra, predicted = rf_pred_model_wd_ra_c)
rmse_rast_wd_ra <- Metrics::rmse(actual = responses_wd_ra, predicted = p_rast_wd_ra)

mae_model_wd_ra_c <- Metrics::mae(actual = responses_wd_ra, predicted = rf_pred_model_wd_ra_c)
mae_rast_wd_ra <- Metrics::mae(actual = responses_wd_ra, predicted = p_rast_wd_ra)
...
predictors = c("velocity", "velocity", "velocity", "velocity",
"wd", "wd", "wd", "wd",
"samp", "samp", "samp", "samp",
"all", "all", "all", "all", 
"var", "var", "var", "var")
...
bias_rast_var_k <- bias(observados = responses_var_k, estimados = p_rast_var_k)

# With shannon index as response
bias_model_var_s_c <- bias(observados = responses_var_s, estimados = rf_pred_model_var_s_c)
bias_rast_var_s <- bias(observados = responses_var_s, estimados = p_rast_var_s)

# With abundance as response
bias_model_var_a_c <- bias(observados = responses_var_a, estimados = rf_pred_model_var_a_c)
bias_rast_var_a <- bias(observados = responses_var_a, estimados = p_rast_var_a)

# With rel_abundance as response
bias_model_var_ra_c <- bias(observados = responses_var_ra, estimados = rf_pred_model_var_ra_c)
bias_rast_var_ra <- bias(observados = responses_var_ra, estimados = p_rast_var_ra)
```
...
nse_rast_var_k <- NSE(sim = p_rast_var_k, obs = responses_var_k)

# With shannon index as response
nse_model_var_s_c <- NSE(sim = rf_pred_model_var_s_c, obs = responses_var_s)
nse_rast_var_s <- NSE(sim = p_rast_var_s, obs = responses_var_s)

# With abundance as response
nse_model_var_a_c <- NSE(sim = rf_pred_model_var_a_c, obs = responses_var_a)
nse_rast_var_a <- NSE(sim = p_rast_var_a, obs = responses_var_a)

# With rel_abundance as response
nse_model_var_ra_c <- NSE(sim = rf_pred_model_var_ra_c, obs = responses_var_ra)
nse_rast_var_ra <- NSE(sim = p_rast_var_ra, obs = responses_var_ra)
```
...
metric_results_measured <- data.frame(lm_p_value = c(p_v_k, p_v_s, p_v_a, p_v_ra,  
