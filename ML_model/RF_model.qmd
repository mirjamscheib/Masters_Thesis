...
```{r}
### GL1 ### ----------------------------------------------------------------
GL1_2_56_ezg_var <- stack("Pre_Processing/rasters_stacked/GL1_2_56_ezg_var.grd")
GL1_min_3_28_var <- stack("Pre_Processing/rasters_stacked/GL1_3_28_var.grd")
GL1_6_00_var <- stack("Pre_Processing/rasters_stacked/GL1_6_00_var.grd")
GL1_9_00_var <- stack("Pre_Processing/rasters_stacked/GL1_9_00_var.grd")
GL1_12_68_var <- stack("Pre_Processing/rasters_stacked/GL1_12_68_var.grd")
GL1_16_00_var <- stack("Pre_Processing/rasters_stacked/GL1_16_00_var.grd")
GL1_19_00_var <- stack("Pre_Processing/rasters_stacked/GL1_19_00_var.grd")
GL1_22_00_var <- stack("Pre_Processing/rasters_stacked/GL1_22_00_var.grd")
GL1_25_00_var <- stack("Pre_Processing/rasters_stacked/GL1_25_00_var.grd")
GL1_28_00_var <- stack("Pre_Processing/rasters_stacked/GL1_28_00_var.grd")
GL1_max_31_76_var <- stack("Pre_Processing/rasters_stacked/GL1_31_76_var.grd")
...
# read rasters containing wd and velocity 
# GL1 ------------------------------------------------------------
GL1_min_var <- stack("Pre_Processing/raster_files/GL1_3_28_var.tif")
GL1_max_var <- stack("Pre_Processing/raster_files/GL1_31_76_var.tif")

# GL2 --------------------------------------------------------------
GL2_min_var <- stack("Pre_Processing/raster_files/GL2_3_21_var.tif")
GL2_max_var <- stack("Pre_Processing/raster_files/GL2_31_53_var.tif")

# L2 --------------------------------------------------------------
L2_base_var <- stack("Pre_Processing/raster_files/L2_2_40_var.tif")
L2_peak_var <- stack("Pre_Processing/raster_files/L2_9_24_var.tif") 
L2_max_var <- stack("Pre_Processing/raster_files/L2_18_90_var.tif") 

# M1 --------------------------------------------------------------
M1_base_var <- stack("Pre_Processing/raster_files/M1_0_47_var.tif") 
M1_peak_var <- stack("Pre_Processing/raster_files/M1_18_84_var.tif") 
M1_max_var <- stack("Pre_Processing/raster_files/M1_22_84_var.tif") 

# S1 --------------------------------------------------------------
S1_base_var <- stack("Pre_Processing/raster_files/S1_2_00_var.tif") 
S1_peak_var <- stack("Pre_Processing/raster_files/S1_18_00_var.tif") 
S1_max_var <- stack("Pre_Processing/raster_files/S1_20_00_var.tif") 

# S2 --------------------------------------------------------------
S2_base_var <- stack("Pre_Processing/raster_files/S2_2_00_var.tif") 
S2_peak_var <- stack("Pre_Processing/raster_files/S2_18_00_var.tif") 
S2_max_var <- stack("Pre_Processing/raster_files/S2_20_00_var.tif") 

# TH4 ---------------------------------------------------------------
TH4_min_var <- stack("Pre_Processing/raster_files/TH4_11_45_var.tif") 
TH4_max_var <- stack("Pre_Processing/raster_files/TH4_32_93_var.tif")

# VR3 ----------------------------------------------------------------
VR3_base_var <- stack("Pre_Processing/raster_files/VR3_2_90_var.tif") 
VR3_peak_var <- stack("Pre_Processing/raster_files/VR3_40_10_var.tif") 
VR3_max_var <- stack("Pre_Processing/raster_files/VR3_52_90_var.tif")
```
...
# predict ML model to rasters with velocity and wd 
# GL1 - predictor: velocity ---------------------------------------------------
GL1_k_min_var <- raster::predict(GL1_min_var, rf_model_var_k_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
GL1_k_max_var <- raster::predict(GL1_max_var, rf_model_var_k_c, type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
GL1_k_pers_var <- mask(GL1_a_max_var, GL1_a_min_var)
