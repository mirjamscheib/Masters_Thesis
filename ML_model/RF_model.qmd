...
#  mtry sample.fraction min.node.size 
#1:  1       0.2051194             4                 
rf_model_wd_k <- ranger(formula = k_index ~., data = training_wd_k, mtry = 1, sample.fraction = 0.2051194, min.node.size = 4, importance = "impurity")
...
#   mtry sample.fraction min.node.size 
#1:    1       0.2247722             6                    
rf_model_wd_a <- ranger(formula = abundance ~., data = training_wd_a, mtry = 1, sample.fraction = 0.2247722, min.node.size = 6, importance = "impurity")
...
#   mtry sample.fraction min.node.size 
#1:    8       0.3110138             4                   
rf_model_samp_s <- ranger(formula = shannon ~., data = training_samp_s, mtry = 8, sample.fraction = 0.3110138, min.node.size = 4, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    6       0.7228589             2                  
rf_model_samp_a <- ranger(formula = abundance ~., data = training_samp_a, mtry = 6, sample.fraction = 0.7228589, min.node.size = 2, importance = "impurity")

# With rel_abundance as response
#   mtry sample.fraction min.node.size 
#1:    9       0.8202065             2                    
rf_model_samp_ra <- ranger(formula = rel_abundance ~., data = training_samp_ra, mtry = 9, sample.fraction = 0.8202065, min.node.size = 2, importance = "impurity")

### PREDICTORS: ALL PREDICTORS ### --------------------------------------------
# With k_index as response
#   mtry sample.fraction min.node.size 
#1:    4       0.2253738             7                  
rf_model_sec_k <- ranger(formula = k_index ~., data = training_sec_k, mtry = 4, sample.fraction = 0.2253738, min.node.size = 7, importance = "impurity")

# With shannon index as response
#   mtry sample.fraction min.node.size 
#1:    1       0.3062136             4                  
rf_model_sec_s <- ranger(formula = shannon ~., data = training_sec_s, mtry = 1, sample.fraction = 0.3062136, min.node.size = 4, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    1       0.4203471            10                   
rf_model_sec_a <- ranger(formula = abundance ~., data = training_sec_a, mtry = 1, sample.fraction = 0.4203471, min.node.size = 10, importance = "impurity")

# With rel_abundance as response
#   mtry sample.fraction min.node.size 
#1:    1       0.8692302             8                   
rf_model_sec_ra <- ranger(formula = rel_abundance ~., data = training_sec_ra, mtry = 1, sample.fraction = 0.8692302, min.node.size = 8, importance = "impurity")
```
...
#  mtry sample.fraction min.node.size 
#1:  1       0.2051194             4                 
rf_model_wd_k_c <- ranger(formula = k_index ~., data = training_wd_k_c, mtry = 1, sample.fraction = 0.2051194, min.node.size = 4, importance = "impurity")
...
#   mtry sample.fraction min.node.size 
#1:    1       0.2247722             6                    
rf_model_wd_a_c <- ranger(formula = abundance ~., data = training_wd_a_c, mtry = 1, sample.fraction = 0.2247722, min.node.size = 6, importance = "impurity")
...
#   mtry sample.fraction min.node.size 
#1:    8       0.3110138             4                   
rf_model_samp_s_c <- ranger(formula = shannon ~., data = training_samp_s_c, mtry = 8, sample.fraction = 0.3110138, min.node.size = 4, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    6       0.7228589             2                  
rf_model_samp_a_c <- ranger(formula = abundance ~., data = training_samp_a_c, mtry = 6, sample.fraction = 0.7228589, min.node.size = 2, importance = "impurity")

# With rel_abundance as response
#   mtry sample.fraction min.node.size 
#1:    9       0.8202065             2                    
rf_model_samp_ra_c <- ranger(formula = rel_abundance ~., data = training_samp_ra_c, mtry = 9, sample.fraction = 0.8202065, min.node.size = 2, importance = "impurity")

### PREDICTORS: ALL PREDICTORS ### --------------------------------------------
# With k_index as response
#   mtry sample.fraction min.node.size 
#1:    4       0.2253738             7                  
rf_model_sec_k_c <- ranger(formula = k_index ~., data = training_sec_k_c, mtry = 4, sample.fraction = 0.2253738, min.node.size = 7, importance = "impurity")

# With shannon index as response
#   mtry sample.fraction min.node.size 
#1:    1       0.3062136             4                  
rf_model_sec_s_c <- ranger(formula = shannon ~., data = training_sec_s_c, mtry = 1, sample.fraction = 0.3062136, min.node.size = 4, importance = "impurity")

# With abundance as response
#   mtry sample.fraction min.node.size 
#1:    1       0.4203471            10                   
rf_model_sec_a_c <- ranger(formula = abundance ~., data = training_sec_a_c, mtry = 1, sample.fraction = 0.4203471, min.node.size = 10, importance = "impurity")

# With rel_abundance as response
#   mtry sample.fraction min.node.size 
#1:    1       0.8692302             8                   
rf_model_sec_ra_c <- ranger(formula = rel_abundance ~., data = training_sec_ra_c, mtry = 1, sample.fraction = 0.8692302, min.node.size = 8, importance = "impurity")
```
...
write.csv(vi_rf_model_v, "ML_model/var_imp/vi_rf_model_v.csv", row.names = FALSE)
write.csv(vi_rel_rf_model_v, "ML_model/var_imp/vi_rel_rf_model_v.csv", row.names = FALSE)
...
write.csv(vi_rf_model_wd, "ML_model/var_imp/vi_rf_model_wd.csv", row.names = FALSE)
write.csv(vi_rel_rf_model_wd, "ML_model/var_imp/vi_rel_rf_model_wd.csv", row.names = FALSE)
...
write.csv(vi_rf_model_samp, "ML_model/var_imp/vi_rf_model_samp.csv", row.names = FALSE)
write.csv(vi_rel_rf_model_samp, "ML_model/var_imp/vi_rel_rf_model_samp.csv", row.names = FALSE)
...
write.csv(vi_rf_model_sec, "ML_model/var_imp/vi_rf_model_sec.csv", row.names = FALSE)
write.csv(vi_rel_rf_model_sec, "ML_model/var_imp/vi_rel_rf_model_sec.csv", row.names = FALSE)
...
# write results into .csv -----------------------------------------------------
write.csv(vi_rf_v, "ML_model/var_imp/vi_rf_v.csv", row.names = FALSE)
write.csv(vi_rel_rf_v, "ML_model/var_imp/vi_rel_rf_v.csv", row.names = FALSE)

write.csv(vi_rf_wd, "ML_model/var_imp/vi_rf_wd.csv", row.names = FALSE)
write.csv(vi_rel_rf_wd, "ML_model/var_imp/vi_rel_rf_wd.csv", row.names = FALSE)

write.csv(vi_rf_samp, "ML_model/var_imp/vi_rf_samp.csv", row.names = FALSE)
write.csv(vi_rel_rf_samp, "ML_model/var_imp/vi_rel_rf_samp.csv", row.names = FALSE)

write.csv(vi_rf_sec, "ML_model/var_imp/vi_rf_sec.csv", row.names = FALSE)
write.csv(vi_rel_rf_sec, "ML_model/var_imp/vi_rel_rf_sec.csv", row.names = FALSE)
```
...
# GL1 - predictors: v + wd ----------------------------------------------------
GL1_ezg_wd_k <- terra::predict(GL1_ezg, model = autotuner_rf_wd_k, fun = predict, index = 2)
GL1_ezg_wd_s <- terra::predict(GL1_ezg, model = autotuner_rf_wd_s, fun = predict, index = 2)
GL1_ezg_wd_a <- terra::predict(GL1_ezg, model = autotuner_rf_wd_a, fun = predict, index = 2)
GL1_ezg_wd_ra <- terra::predict(GL1_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 2)

#GL1_q_wd_k <- terra::predict(GL1_q, model = autotuner_rf_wd_k, fun = predict, index = 2)
#GL1_q_wd_s <- terra::predict(GL1_q, model = autotuner_rf_wd_s, fun = predict, index = 2)
#GL1_q_wd_a <- terra::predict(GL1_q, model = autotuner_rf_wd_a, fun = predict, index = 2)
#GL1_q_wd_ra <- terra::predict(GL1_q, model = autotuner_rf_wd_ra, fun = predict, index = 2)

# GL1 - predictor: velocity ---------------------------------------------------
GL1_ezg_v_k <- terra::predict(GL1_ezg, model = autotuner_rf_v_k, fun = predict, index = "velocity")
GL1_ezg_v_s <- terra::predict(GL1_ezg, model = autotuner_rf_v_s, fun = predict, index = "velocity")
GL1_ezg_v_a <- terra::predict(GL1_ezg, model = autotuner_rf_v_a, fun = predict, index = "velocity")
GL1_ezg_v_ra <- terra::predict(GL1_ezg, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

#GL1_q_v_k <- terra::predict(GL1_q, model = autotuner_rf_v_k, fun = predict, index = "velocity")
#GL1_q_v_s <- terra::predict(GL1_q, model = autotuner_rf_v_s, fun = predict, index = "velocity")
#GL1_q_v_a <- terra::predict(GL1_q, model = autotuner_rf_v_a, fun = predict, index = "velocity")
#GL1_q_v_ra <- terra::predict(GL1_q, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

# GL2 - predictors: v + wd ----------------------------------------------------
GL2_ezg_wd_k <- terra::predict(GL2_ezg, model = autotuner_rf_wd_k, fun = predict, index = 2)
GL2_ezg_wd_s <- terra::predict(GL2_ezg, model = autotuner_rf_wd_s, fun = predict, index = 2)
GL2_ezg_wd_a <- terra::predict(GL2_ezg, model = autotuner_rf_wd_a, fun = predict, index = 2)
GL2_ezg_wd_ra <- terra::predict(GL2_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 2)

#GL2_q_wd_k <- terra::predict(GL2_q, model = autotuner_rf_wd_k, fun = predict, index = 2)
#GL2_q_wd_s <- terra::predict(GL2_q, model = autotuner_rf_wd_s, fun = predict, index = 2)
#GL2_q_wd_a <- terra::predict(GL2_q, model = autotuner_rf_wd_a, fun = predict, index = 2)
#GL2_q_wd_ra <- terra::predict(GL2_q, model = autotuner_rf_wd_ra, fun = predict, index = 2)

# GL2 - predictor: velocity ---------------------------------------------------
GL2_ezg_v_k <- terra::predict(GL2_ezg, model = autotuner_rf_v_k, fun = predict, index = "velocity")
GL2_ezg_v_s <- terra::predict(GL2_ezg, model = autotuner_rf_v_s, fun = predict, index = "velocity")
GL2_ezg_v_a <- terra::predict(GL2_ezg, model = autotuner_rf_v_a, fun = predict, index = "velocity")
GL2_ezg_v_ra <- terra::predict(GL2_ezg, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

#GL2_q_v_k <- terra::predict(GL2_q, model = autotuner_rf_v_k, fun = predict, index = "velocity")
#GL2_q_v_s <- terra::predict(GL2_q, model = autotuner_rf_v_s, fun = predict, index = "velocity")
#GL2_q_v_a <- terra::predict(GL2_q, model = autotuner_rf_v_a, fun = predict, index = "velocity")
#GL2_q_v_ra <- terra::predict(GL2_q, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

# L2 - predictors: v + wd -----------------------------------------------------
L2_ezg_wd_k <- terra::predict(L2_ezg, model = autotuner_rf_wd_k, fun = predict, index = 2)
L2_ezg_wd_s <- terra::predict(L2_ezg, model = autotuner_rf_wd_s, fun = predict, index = 2)
L2_ezg_wd_a <- terra::predict(L2_ezg, model = autotuner_rf_wd_a, fun = predict, index = 2)
L2_ezg_wd_ra <- terra::predict(L2_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 2)

#L2_q_wd_k <- terra::predict(L2_q, model = autotuner_rf_wd_k, fun = predict, index = 2)
#L2_q_wd_s <- terra::predict(L2_q, model = autotuner_rf_wd_s, fun = predict, index = 2)
#L2_q_wd_a <- terra::predict(L2_q, model = autotuner_rf_wd_a, fun = predict, index = 2)
#L2_q_wd_ra <- terra::predict(L2_q, model = autotuner_rf_wd_ra, fun = predict, index = 2)

# L2 - predictor: velocity ----------------------------------------------------
L2_ezg_v_k <- terra::predict(L2_ezg, model = autotuner_rf_v_k, fun = predict, index = "velocity")
L2_ezg_v_s <- terra::predict(L2_ezg, model = autotuner_rf_v_s, fun = predict, index = "velocity")
L2_ezg_v_a <- terra::predict(L2_ezg, model = autotuner_rf_v_a, fun = predict, index = "velocity")
L2_ezg_v_ra <- terra::predict(L2_ezg, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

#L2_q_v_k <- terra::predict(L2_q, model = autotuner_rf_v_k, fun = predict, index = "velocity")
#L2_q_v_s <- terra::predict(L2_q, model = autotuner_rf_v_s, fun = predict, index = "velocity")
#L2_q_v_a <- terra::predict(L2_q, model = autotuner_rf_v_a, fun = predict, index = "velocity")
#L2_q_v_ra <- terra::predict(L2_q, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

# M1  - predictors: v + wd -----------------------------------------------------
M1_ezg_wd_k <- terra::predict(M1_ezg, model = autotuner_rf_wd_k, fun = predict, index = 2)
M1_ezg_wd_s <- terra::predict(M1_ezg, model = autotuner_rf_wd_s, fun = predict, index = 2)
M1_ezg_wd_a <- terra::predict(M1_ezg, model = autotuner_rf_wd_a, fun = predict, index = 2)
M1_ezg_wd_ra <- terra::predict(M1_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 2)

#M1_q_wd_k <- terra::predict(M1_q, model = autotuner_rf_wd_k, fun = predict, index = 2)
#M1_q_wd_s <- terra::predict(M1_q, model = autotuner_rf_wd_s, fun = predict, index = 2)
#M1_q_wd_a <- terra::predict(M1_q, model = autotuner_rf_wd_a, fun = predict, index = 2)
#M1_q_wd_ra <- terra::predict(M1_q, model = autotuner_rf_wd_ra, fun = predict, index = 2)

# M1  - predictor: velocity ---------------------------------------------------
M1_ezg_v_k <- terra::predict(M1_ezg, model = autotuner_rf_v_k, fun = predict, index = "velocity")
M1_ezg_v_s <- terra::predict(M1_ezg, model = autotuner_rf_v_s, fun = predict, index = "velocity")
M1_ezg_v_a <- terra::predict(M1_ezg, model = autotuner_rf_v_a, fun = predict, index = "velocity")
M1_ezg_v_ra <- terra::predict(M1_ezg, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

#M1_q_v_k <- terra::predict(M1_q, model = autotuner_rf_v_k, fun = predict, index = "velocity")
#M1_q_v_s <- terra::predict(M1_q, model = autotuner_rf_v_s, fun = predict, index = "velocity")
#M1_q_v_a <- terra::predict(M1_q, model = autotuner_rf_v_a, fun = predict, index = "velocity")
#M1_q_v_ra <- terra::predict(M1_q, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

# S1  - predictors: v + wd ----------------------------------------------------
S1_ezg_wd_k <- terra::predict(S1_ezg, model = autotuner_rf_wd_k, fun = predict, index = 2)
S1_ezg_wd_s <- terra::predict(S1_ezg, model = autotuner_rf_wd_s, fun = predict, index = 2)
S1_ezg_wd_a <- terra::predict(S1_ezg, model = autotuner_rf_wd_a, fun = predict, index = 2)
S1_ezg_wd_ra <- terra::predict(S1_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 2)

#S1_q_wd_k <- terra::predict(S1_q, model = autotuner_rf_wd_k, fun = predict, index = 2)
#S1_q_wd_s <- terra::predict(S1_q, model = autotuner_rf_wd_s, fun = predict, index = 2)
#S1_q_wd_a <- terra::predict(S1_q, model = autotuner_rf_wd_a, fun = predict, index = 2)
#S1_q_wd_ra <- terra::predict(S1_q, model = autotuner_rf_wd_ra, fun = predict, index = 2)

# S1  - predictor: velocity ---------------------------------------------------
S1_ezg_v_k <- terra::predict(S1_ezg, model = autotuner_rf_v_k, fun = predict, index = "velocity")
S1_ezg_v_s <- terra::predict(S1_ezg, model = autotuner_rf_v_s, fun = predict, index = "velocity")
S1_ezg_v_a <- terra::predict(S1_ezg, model = autotuner_rf_v_a, fun = predict, index = "velocity")
S1_ezg_v_ra <- terra::predict(S1_ezg, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

#S1_q_v_k <- terra::predict(S1_q, model = autotuner_rf_v_k, fun = predict, index = "velocity")
#S1_q_v_s <- terra::predict(S1_q, model = autotuner_rf_v_s, fun = predict, index = "velocity")
#S1_q_v_a <- terra::predict(S1_q, model = autotuner_rf_v_a, fun = predict, index = "velocity")
#S1_q_v_ra <- terra::predict(S1_q, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

# S2  - predictors: v + wd ----------------------------------------------------
S2_ezg_wd_k <- terra::predict(S2_ezg, model = autotuner_rf_wd_k, fun = predict, index = 2)
S2_ezg_wd_s <- terra::predict(S2_ezg, model = autotuner_rf_wd_s, fun = predict, index = 2)
S2_ezg_wd_a <- terra::predict(S2_ezg, model = autotuner_rf_wd_a, fun = predict, index = 2)
S2_ezg_wd_ra <- terra::predict(S2_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 2)

#S2_q_wd_k <- terra::predict(S2_q, model = autotuner_rf_wd_k, fun = predict, index = 2)
#S2_q_wd_s <- terra::predict(S2_q, model = autotuner_rf_wd_s, fun = predict, index = 2)
#S2_q_wd_a <- terra::predict(S2_q, model = autotuner_rf_wd_a, fun = predict, index = 2)
#S2_q_wd_ra <- terra::predict(S2_q, model = autotuner_rf_wd_ra, fun = predict, index = 2)

# S2  - predictor: velocity ---------------------------------------------------
S2_ezg_v_k <- terra::predict(S2_ezg, model = autotuner_rf_v_k, fun = predict, index = "velocity")
S2_ezg_v_s <- terra::predict(S2_ezg, model = autotuner_rf_v_s, fun = predict, index = "velocity")
S2_ezg_v_a <- terra::predict(S2_ezg, model = autotuner_rf_v_a, fun = predict, index = "velocity")
S2_ezg_v_ra <- terra::predict(S2_ezg, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

#S2_q_v_k <- terra::predict(S2_q, model = autotuner_rf_v_k, fun = predict, index = "velocity")
#S2_q_v_s <- terra::predict(S2_q, model = autotuner_rf_v_s, fun = predict, index = "velocity")
#S2_q_v_a <- terra::predict(S2_q, model = autotuner_rf_v_a, fun = predict, index = "velocity")
#S2_q_v_ra <- terra::predict(S2_q, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

# TH4  - predictors: v + wd ---------------------------------------------------
TH4_ezg_wd_k <- terra::predict(TH4_ezg, model = autotuner_rf_wd_k, fun = predict, index = 2)
TH4_ezg_wd_s <- terra::predict(TH4_ezg, model = autotuner_rf_wd_s, fun = predict, index = 2)
TH4_ezg_wd_a <- terra::predict(TH4_ezg, model = autotuner_rf_wd_a, fun = predict, index = 2)
TH4_ezg_wd_ra <- terra::predict(TH4_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 2)

#TH4_q_wd_k <- terra::predict(TH4_q, model = autotuner_rf_wd_k, fun = predict, index = 2)
#TH4_q_wd_s <- terra::predict(TH4_q, model = autotuner_rf_wd_s, fun = predict, index = 2)
#TH4_q_wd_a <- terra::predict(TH4_q, model = autotuner_rf_wd_a, fun = predict, index = 2)
#TH4_q_wd_ra <- terra::predict(TH4_q, model = autotuner_rf_wd_ra, fun = predict, index = 2)

# TH4  - predictor: velocity --------------------------------------------------
TH4_ezg_v_k <- terra::predict(TH4_ezg, model = autotuner_rf_v_k, fun = predict, index = "velocity")
TH4_ezg_v_s <- terra::predict(TH4_ezg, model = autotuner_rf_v_s, fun = predict, index = "velocity")
TH4_ezg_v_a <- terra::predict(TH4_ezg, model = autotuner_rf_v_a, fun = predict, index = "velocity")
TH4_ezg_v_ra <- terra::predict(TH4_ezg, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

#TH4_q_v_k <- terra::predict(TH4_q, model = autotuner_rf_v_k, fun = predict, index = "velocity")
#TH4_q_v_s <- terra::predict(TH4_q, model = autotuner_rf_v_s, fun = predict, index = "velocity")
#TH4_q_v_a <- terra::predict(TH4_q, model = autotuner_rf_v_a, fun = predict, index = "velocity")
#TH4_q_v_ra <- terra::predict(TH4_q, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

# VR3  - predictors: v + wd ---------------------------------------------------
VR3_ezg_wd_k <- terra::predict(VR3_ezg, model = autotuner_rf_wd_k, fun = predict, index = 2)
VR3_ezg_wd_s <- terra::predict(VR3_ezg, model = autotuner_rf_wd_s, fun = predict, index = 2)
VR3_ezg_wd_a <- terra::predict(VR3_ezg, model = autotuner_rf_wd_a, fun = predict, index = 2)
VR3_ezg_wd_ra <- terra::predict(VR3_ezg, model = autotuner_rf_wd_ra, fun = predict, index = 2)

#VR3_q_wd_k <- terra::predict(VR3_q, model = autotuner_rf_wd_k, fun = predict, index = 2)
#VR3_q_wd_s <- terra::predict(VR3_q, model = autotuner_rf_wd_s, fun = predict, index = 2)
#VR3_q_wd_a <- terra::predict(VR3_q, model = autotuner_rf_wd_a, fun = predict, index = 2)
#VR3_q_wd_ra <- terra::predict(VR3_q, model = autotuner_rf_wd_ra, fun = predict, index = 2)

# VR3  - predictor: velocity --------------------------------------------------
VR3_ezg_v_k <- terra::predict(VR3_ezg, model = autotuner_rf_v_k, fun = predict, index = "velocity")
VR3_ezg_v_s <- terra::predict(VR3_ezg, model = autotuner_rf_v_s, fun = predict, index = "velocity")
VR3_ezg_v_a <- terra::predict(VR3_ezg, model = autotuner_rf_v_a, fun = predict, index = "velocity")
VR3_ezg_v_ra <- terra::predict(VR3_ezg, model = autotuner_rf_v_ra, fun = predict, index = "velocity")

#VR3_q_v_k <- terra::predict(VR3_q, model = autotuner_rf_v_k, fun = predict, index = "velocity")
#VR3_q_v_s <- terra::predict(VR3_q, model = autotuner_rf_v_s, fun = predict, index = "velocity")
#VR3_q_v_a <- terra::predict(VR3_q, model = autotuner_rf_v_a, fun = predict, index = "velocity")
#VR3_q_v_ra <- terra::predict(VR3_q, model = autotuner_rf_v_ra, fun = predict, index = "velocity")
```
...
# GL1 - predictor: velocity ---------------------------------------------------
GL1_ezg_m2_v_k <- raster::predict(GL1_ezg, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL1_ezg_m2_v_s <- raster::predict(GL1_ezg, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL1_ezg_m2_v_a <- raster::predict(GL1_ezg, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL1_ezg_m2_v_ra <- raster::predict(GL1_ezg, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL1_q_m2_v_k <- raster::predict(GL1_q, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL1_q_m2_v_s <- raster::predict(GL1_q, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL1_q_m2_v_a <- raster::predict(GL1_q, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL1_q_m2_v_ra <- raster::predict(GL1_q, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# GL2 - predictor: velocity ---------------------------------------------------
GL2_ezg_m2_v_k <- raster::predict(GL2_ezg, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL2_ezg_m2_v_s <- raster::predict(GL2_ezg, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL2_ezg_m2_v_a <- raster::predict(GL2_ezg, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

GL2_ezg_m2_v_ra <- raster::predict(GL2_ezg, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL2_q_m2_v_k <- raster::predict(GL2_q, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL2_q_m2_v_s <- raster::predict(GL2_q, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL2_q_m2_v_a <- raster::predict(GL2_q, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#GL2_q_m2_v_ra <- raster::predict(GL2_q, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# L2 - predictor: velocity ----------------------------------------------------
L2_ezg_m2_v_k <- raster::predict(L2_ezg, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

L2_ezg_m2_v_s <- raster::predict(L2_ezg, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

L2_ezg_m2_v_a <- raster::predict(L2_ezg, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

L2_ezg_m2_v_ra <- raster::predict(L2_ezg, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)


#L2_q_m2_v_k <- raster::predict(L2_q, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#L2_q_m2_v_s <- raster::predict(L2_q, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#L2_q_m2_v_a <- raster::predict(L2_q, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#L2_q_m2_v_ra <- raster::predict(L2_q, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# M1  - predictor: velocity ---------------------------------------------------
M1_ezg_m2_v_k <- raster::predict(M1_ezg, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

M1_ezg_m2_v_s <- raster::predict(M1_ezg, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

M1_ezg_m2_v_a <- raster::predict(M1_ezg, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

M1_ezg_m2_v_ra <- raster::predict(M1_ezg, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)


#M1_q_m2_v_k <- raster::predict(M1_q, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#M1_q_m2_v_s <- raster::predict(M1_q, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#M1_q_m2_v_a <- raster::predict(M1_q, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#M1_q_m2_v_ra <- raster::predict(M1_q, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# S1  - predictor: velocity ---------------------------------------------------
S1_ezg_m2_v_k <- raster::predict(S1_ezg, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S1_ezg_m2_v_s <- raster::predict(S1_ezg, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S1_ezg_m2_v_a <- raster::predict(S1_ezg, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S1_ezg_m2_v_ra <- raster::predict(S1_ezg, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S1_q_m2_v_k <- raster::predict(S1_q, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S1_q_m2_v_s <- raster::predict(S1_q, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S1_q_m2_v_a <- raster::predict(S1_q, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S1_q_m2_v_ra <- raster::predict(S1_q, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# S2  - predictor: velocity ---------------------------------------------------
S2_ezg_m2_v_k <- raster::predict(S2_ezg, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S2_ezg_m2_v_s <- raster::predict(S2_ezg, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S2_ezg_m2_v_a <- raster::predict(S2_ezg, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

S2_ezg_m2_v_ra <- raster::predict(S2_ezg, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S2_q_m2_v_k <- raster::predict(S2_q, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S2_q_m2_v_s <- raster::predict(S2_q, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S2_q_m2_v_a <- raster::predict(S2_q, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#S2_q_m2_v_ra <- raster::predict(S2_q, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# TH4  - predictor: velocity --------------------------------------------------
TH4_ezg_m2_v_k <- raster::predict(TH4_ezg, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

TH4_ezg_m2_v_s <- raster::predict(TH4_ezg, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

TH4_ezg_m2_v_a <- raster::predict(TH4_ezg, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

TH4_ezg_m2_v_ra <- raster::predict(TH4_ezg, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#TH4_q_m2_v_k <- raster::predict(TH4_q, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#TH4_q_m2_v_s <- raster::predict(TH4_q, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#TH4_q_m2_v_a <- raster::predict(TH4_q, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#TH4_q_m2_v_ra <- raster::predict(TH4_q, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
...
# VR3  - predictor: velocity --------------------------------------------------
VR3_ezg_m2_v_k <- raster::predict(VR3_ezg, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

VR3_ezg_m2_v_s <- raster::predict(VR3_ezg, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

VR3_ezg_m2_v_a <- raster::predict(VR3_ezg, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

VR3_ezg_m2_v_ra <- raster::predict(VR3_ezg, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#VR3_q_m2_v_k <- raster::predict(VR3_q, rf_model_v_k_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#VR3_q_m2_v_s <- raster::predict(VR3_q, rf_model_v_s_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#VR3_q_m2_v_a <- raster::predict(VR3_q, rf_model_v_a_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)

#VR3_q_m2_v_ra <- raster::predict(VR3_q, rf_model_v_ra_c, index = "velocity", type='response', progress='window', fun = function(model, ...) predict(model, ...)$predictions)
```
