...
unique(data_section$Hydrokeaking_residual_flow_natural_near_natural)

colnames(data_section)
...
pdp_plot_wd_k <- partial(autotuner_rf_samp_k, pred.var = c("velocity", "wd_cm"), center = TRUE, plot = TRUE, rug = TRUE, alpha = 0.1, plot.engine = "ggplot2", train = training_wd_k, type = "regression")
...
regr_rf_data_GL1_wd_s <- extract(GL1_ezg_rf_wd_s, coord_GL1) 
regr_rf_data_GL1_wd_a <- extract(GL1_ezg_rf_wd_a, coord_GL1) 

regr_rf_data_GL1_v_k <- extract(GL1_ezg_rf_v_k, coord_GL1) 
regr_rf_data_GL1_v_s <- extract(GL1_ezg_rf_v_s, coord_GL1) 
regr_rf_data_GL1_v_a <- extract(GL1_ezg_rf_v_a, coord_GL1) 

# GL2
regr_rf_data_GL2_wd_k <- extract(GL2_ezg_rf_wd_k, coord_GL2) 
regr_rf_data_GL2_wd_s <- extract(GL2_ezg_rf_wd_s, coord_GL2) 
regr_rf_data_GL2_wd_a <- extract(GL2_ezg_rf_wd_a, coord_GL2) 

regr_rf_data_GL2_v_k <- extract(GL2_ezg_rf_v_k, coord_GL2) 
regr_rf_data_GL2_v_s <- extract(GL2_ezg_rf_v_s, coord_GL2) 
regr_rf_data_GL2_v_a <- extract(GL2_ezg_rf_v_a, coord_GL2)

# L2
regr_rf_data_L2_wd_k <- extract(L2_ezg_rf_wd_k, coord_L2) 
regr_rf_data_L2_wd_s <- extract(L2_ezg_rf_wd_s, coord_L2) 
regr_rf_data_L2_wd_a <- extract(L2_ezg_rf_wd_a, coord_L2) 

regr_rf_data_L2_v_k <- extract(L2_ezg_rf_v_k, coord_L2) 
regr_rf_data_L2_v_s <- extract(L2_ezg_rf_v_s, coord_L2) 
regr_rf_data_L2_v_a <- extract(L2_ezg_rf_v_a, coord_L2)


# M1
regr_rf_data_M1_wd_k <- extract(M1_ezg_rf_wd_k, coord_M1) 
regr_rf_data_M1_wd_s <- extract(M1_ezg_rf_wd_s, coord_M1) 
regr_rf_data_M1_wd_a <- extract(M1_ezg_rf_wd_a, coord_M1) 

regr_rf_data_M1_v_k <- extract(M1_ezg_rf_v_k, coord_M1) 
regr_rf_data_M1_v_s <- extract(M1_ezg_rf_v_s, coord_M1) 
regr_rf_data_M1_v_a <- extract(M1_ezg_rf_v_a, coord_M1)


# S1
regr_rf_data_S1_wd_k <- extract(S1_ezg_rf_wd_k, coord_S1) 
regr_rf_data_S1_wd_s <- extract(S1_ezg_rf_wd_s, coord_S1) 
regr_rf_data_S1_wd_a <- extract(S1_ezg_rf_wd_a, coord_S1) 

regr_rf_data_S1_v_k <- extract(S1_ezg_rf_v_k, coord_S1) 
regr_rf_data_S1_v_s <- extract(S1_ezg_rf_v_s, coord_S1) 
regr_rf_data_S1_v_a <- extract(S1_ezg_rf_v_a, coord_S1)

# S2
regr_rf_data_S2_wd_k <- extract(S2_ezg_rf_wd_k, coord_S2) 
regr_rf_data_S2_wd_s <- extract(S2_ezg_rf_wd_s, coord_S2) 
regr_rf_data_S2_wd_a <- extract(S2_ezg_rf_wd_a, coord_S2) 

regr_rf_data_S2_v_k <- extract(S2_ezg_rf_v_k, coord_S2) 
regr_rf_data_S2_v_s <- extract(S2_ezg_rf_v_s, coord_S2) 
regr_rf_data_S2_v_a <- extract(S2_ezg_rf_v_a, coord_S2)

# TH4
regr_rf_data_TH4_wd_k <- extract(TH4_ezg_rf_wd_k, coord_TH4) 
regr_rf_data_TH4_wd_s <- extract(TH4_ezg_rf_wd_s, coord_TH4) 
regr_rf_data_TH4_wd_a <- extract(TH4_ezg_rf_wd_a, coord_TH4) 

regr_rf_data_TH4_v_k <- extract(TH4_ezg_rf_v_k, coord_TH4) 
regr_rf_data_TH4_v_s <- extract(TH4_ezg_rf_v_s, coord_TH4) 
regr_rf_data_TH4_v_a <- extract(TH4_ezg_rf_v_a, coord_TH4)

# VR3
regr_rf_data_VR3_wd_k <- extract(VR3_ezg_rf_wd_k, coord_VR3) 
regr_rf_data_VR3_wd_s <- extract(VR3_ezg_rf_wd_s, coord_VR3) 
regr_rf_data_VR3_wd_a <- extract(VR3_ezg_rf_wd_a, coord_VR3) 

regr_rf_data_VR3_v_k <- extract(VR3_ezg_rf_v_k, coord_VR3) 
regr_rf_data_VR3_v_s <- extract(VR3_ezg_rf_v_s, coord_VR3) 
regr_rf_data_VR3_v_a <- extract(VR3_ezg_rf_v_a, coord_VR3)
```
