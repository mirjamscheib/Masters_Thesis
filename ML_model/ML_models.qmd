...
Additional: Assess Variable Importance 
-- Fit the random forest model
rf_model_v_k <- ranger(formula = k_index ~ ., data = training_v_k, mtry = 1, sample.fraction = 0.2059293, min.node.size = 10)

-- Method 1: Using the importance() function
var_importance <- importance(rf_model_v_k)
print(var_importance)

-- Method 2: Accessing the importance attribute
var_importance <- rf_model_v_k$variable.importance
print(var_importance)
