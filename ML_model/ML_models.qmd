...
training_samp_k <- training_sampling |>
  dplyr::select(-shannon, -abundance, -rel_abundance, -Reach_Untersuchungsstelle, -clog_3_class, -clog_6_class, -sub_type)

# With shannon index as response variable & sampling location 
training_samp_s <- training_sampling |>
  dplyr::select(-k_index, -abundance, -rel_abundance, -Reach_Untersuchungsstelle, -clog_3_class, -clog_6_class, -sub_type)

# With abundance index as response variable & sampling location 
training_samp_a <- training_sampling |>
  dplyr::select(-shannon, -k_index, -rel_abundance, -Reach_Untersuchungsstelle, -clog_3_class, -clog_6_class, -sub_type)

# With relative abundance index as response variable & sampling location 
training_samp_ra <- training_sampling |>
  dplyr::select(-shannon, -abundance, -k_index, -Reach_Untersuchungsstelle, -clog_3_class, -clog_6_class, -sub_type)

### PREDICTOR: ALL POSSIBLE PREDICTORS ###
# With k_index as response variable & all predictors
training_sec_k <- training_section |>
  dplyr::select(-shannon, -abundance, -rel_abundance, -ox_sat, -date_time, -Reach_Untersuchungsstelle, -clog_3_class, -clog_6_class, -sub_type)

# With shannon index as response variable & all predictors 
training_sec_s <- training_section |>
  dplyr::select(-k_index, -abundance, -rel_abundance, -ox_sat, -date_time, -Reach_Untersuchungsstelle, -clog_3_class, -clog_6_class, -sub_type)

# With abundance index as response variable & all predictors 
training_sec_a <- training_section |>
  dplyr::select(-shannon, -k_index, -rel_abundance, -ox_sat, -date_time, -Reach_Untersuchungsstelle, -clog_3_class, -clog_6_class, -sub_type)

# With relative abundance index as response variable & all predictors 
training_sec_ra <- training_section |>
  dplyr::select(-shannon, -abundance, -k_index, -ox_sat, -date_time, -Reach_Untersuchungsstelle, -clog_3_class, -clog_6_class, -sub_type)
```
...
autotuner_rf_v_k$importance()
autotuner_rf_v_s$importance()
autotuner_rf_v_a$importance()
autotuner_rf_v_ra$importance()

### PREDICTORS: VELOCITY AND WD ###
autotuner_rf_wd_k$importance()
autotuner_rf_wd_s$importance()
autotuner_rf_wd_a$importance()
autotuner_rf_wd_ra$importance()

### PREDICTORS: SAMPLING LOCATIONS ###
var_importance_rf_samp_k <- autotuner_rf_samp_k$importance()
var_importance_rf_samp_s <- autotuner_rf_samp_s$importance()
var_importance_rf_samp_a <- autotuner_rf_samp_a$importance()
var_importance_rf_samp_ra <- autotuner_rf_samp_ra$importance()

# bind results together
var_imp_rf_samp <- rbind(var_importance_rf_samp_k, var_importance_rf_samp_s, var_importance_rf_samp_a, var_importance_rf_samp_ra)

### PREDICTORS: ALL PREDICTORS ###
autotuner_rf_sec_k$importance()
autotuner_rf_sec_s$importance()
autotuner_rf_sec_a$importance()
autotuner_rf_sec_ra$importance()
```
