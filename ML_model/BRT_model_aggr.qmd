...
data_v <- read_delim("Pre_Processing/abiotic_mi_sampling/data_aggr_all.csv") |>
  dplyr::select(-river.x, -flow_regime, -date_mzb_sampling, -field_screen_id, -lab_id, -river.y, -river_type, -hyd_peak_resid_natural, -KW, -geology, -biogeo) |>
  mutate(catchment_KW_outlet_km2 = as.numeric(catchment_KW_outlet_km2),
         ecomorph_class = as.numeric(ecomorph_class),
         unaffected_mean_flow_KW_outlet_m3s = as.numeric(unaffected_mean_flow_KW_outlet_m3s),
         unaffected_mean_flow_study_site_m3s = as.numeric(unaffected_mean_flow_study_site_m3s),
         altitude_KW_mabsl = as.numeric(altitude_KW_mabsl),
         dist_study_site_kw_km = as.numeric(dist_study_site_kw_km))

column_types <- sapply(data_v, class)
print(column_types)
```
...
training_v <- data_v |>
  filter(reach != "GL1",
         ...
         reach != "S1",
         reach != "S2",
         reach != "TH4", # noch nicht im lab datensatz, darum wirds noch nicht eingerechnet
         reach != "VR3")
...
test_v <- data_v |>
  filter(reach == "GL1" |
         ...
         reach == "S1" |
         reach == "S2" |
         reach == "TH4" | # fehlt noch im lab datensatz 
         reach == "VR3")
```
...
training_v_k_mean <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

training_v_k_median <- training_v |>
  dplyr::select(-k_index_mean, -k_index_sd, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

training_v_k_sd <- training_v |>
  dplyr::select(-k_index_median, -k_index_mean, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

# With shannon index as response 
training_v_s_mean <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

training_v_s_median <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_mean, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

training_v_s_sd <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_mean, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

# With abundance as response 
training_v_a_mean <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

training_v_a_median <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_mean, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

training_v_a_sd <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_mean, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

# With relative abundance as response  
training_v_ra_mean <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

training_v_ra_median <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_mean, -rel_abundance_sd, -reach)

training_v_ra_sd <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_median, -rel_abundance_mean, -reach)
```
...
### PREDICTOR: VELOCITY ### --------------------------------------
# With k_index as response 
training_v_k_mean_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

training_v_k_median_c <- training_v |>
  dplyr::select(-k_index_mean, -k_index_sd, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

training_v_k_sd_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_mean, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

# With shannon index as response 
training_v_s_mean_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

training_v_s_median_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_mean, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

training_v_s_sd_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_mean, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

# With abundance as response 
training_v_a_mean_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

training_v_a_median_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_mean, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

training_v_a_sd_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_mean, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

# With relative abundance as response  
training_v_ra_mean_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

training_v_ra_median_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_mean, -rel_abundance_sd, -x, -y, -reach)

training_v_ra_sd_c <- training_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_median, -rel_abundance_mean, -x, -y, -reach)
```
...
### PREDICTOR: VELOCITY ### ------------------------------------------
# With k_index as response 
test_v_k_mean <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

test_v_k_median <- test_v |>
  dplyr::select(-k_index_mean, -k_index_sd, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)
...
# With shannon index as response 
test_v_s_mean <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

test_v_s_median <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_mean, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)
...
# With abundance as response 
test_v_a_mean <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

test_v_a_median <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_mean, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)
...
# With relative abundance as response  
test_v_ra_mean <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_median, -rel_abundance_sd, -reach)

test_v_ra_median <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_mean, -rel_abundance_sd, -reach)
...
### PREDICTOR: VELOCITY ### --------------------------------------
# With k_index as response 
test_v_k_mean_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

test_v_k_median_c <- test_v |>
  dplyr::select(-k_index_mean, -k_index_sd, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

test_v_k_sd_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_mean, -shannon_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

# With shannon index as response 
test_v_s_mean_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

test_v_s_median_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_mean, -shannon_sd, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

test_v_s_sd_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_mean, -abundance_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

# With abundance as response 
test_v_a_mean_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

test_v_a_median_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_mean, -abundance_sd, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

test_v_a_sd_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_mean, -rel_abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

# With relative abundance as response  
test_v_ra_mean_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_median, -rel_abundance_sd, -x, -y, -reach)

test_v_ra_median_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_mean, -rel_abundance_sd, -x, -y, -reach)

test_v_ra_sd_c <- test_v |>
  dplyr::select(-k_index_median, -k_index_sd, -k_index_mean, -shannon_median, -shannon_sd, -shannon_mean, -abundance_median, -abundance_sd, -abundance_mean, -rel_abundance_median, -rel_abundance_mean, -x, -y, -reach)
```
...
### PREDICTOR: VELOCITY ### ----------------------------------------------------
# With k_index as response
data_v_k_sp_mean <-  st_as_sf(training_v_k_mean, coords =  c("x", "y"))
st_crs(data_v_k_sp_mean) <- "EPSG: 2056"

data_v_k_sp_median <-  st_as_sf(training_v_k_median, coords =  c("x", "y"))
st_crs(data_v_k_sp_median) <- "EPSG: 2056"

data_v_k_sp_sd <-  st_as_sf(training_v_k_sd, coords =  c("x", "y"))
st_crs(data_v_k_sp_sd) <- "EPSG: 2056"

# With shannon index as response
data_v_s_sp_mean <-  st_as_sf(training_v_s_mean, coords =  c("x", "y"))
st_crs(data_v_s_sp_mean) <- "EPSG: 2056"

data_v_s_sp_median <-  st_as_sf(training_v_s_median, coords =  c("x", "y"))
st_crs(data_v_s_sp_median) <- "EPSG: 2056"

data_v_s_sp_sd <-  st_as_sf(training_v_s_sd, coords =  c("x", "y"))
st_crs(data_v_s_sp_sd) <- "EPSG: 2056"

# With abundance as response
data_v_a_sp_mean <-  st_as_sf(training_v_a_mean, coords =  c("x", "y"))
st_crs(data_v_a_sp_mean) <- "EPSG: 2056"

data_v_a_sp_median <-  st_as_sf(training_v_a_median, coords =  c("x", "y"))
st_crs(data_v_a_sp_median) <- "EPSG: 2056"

data_v_a_sp_sd <-  st_as_sf(training_v_a_sd, coords =  c("x", "y"))
st_crs(data_v_a_sp_sd) <- "EPSG: 2056"

# With rel_abundance as response
data_v_ra_sp_mean <-  st_as_sf(training_v_ra_mean, coords =  c("x", "y"))
st_crs(data_v_ra_sp_mean) <- "EPSG: 2056"

data_v_ra_sp_median <-  st_as_sf(training_v_ra_median, coords =  c("x", "y"))
st_crs(data_v_ra_sp_median) <- "EPSG: 2056"

data_v_ra_sp_sd <-  st_as_sf(training_v_ra_sd, coords =  c("x", "y"))
st_crs(data_v_ra_sp_sd) <- "EPSG: 2056"
...
### PREDICTOR: VELOCITY ### ----------------------------------------------------
# With k_index as response
task_xbrt_v_k_mean <- mlr3spatiotempcv::as_task_regr_st(data_v_k_sp_mean,
  id = "k_index_mean", target = "k_index_mean")

task_xbrt_v_k_median <- mlr3spatiotempcv::as_task_regr_st(data_v_k_sp_median,
  id = "k_index_median", target = "k_index_median")

task_xbrt_v_k_sd <- mlr3spatiotempcv::as_task_regr_st(data_v_k_sp_sd,
  id = "k_index_sd", target = "k_index_sd")

# With shannon index as response
task_xbrt_v_s_mean <- mlr3spatiotempcv::as_task_regr_st(data_v_s_sp_mean,
  id = "shannon_mean", target = "shannon_mean")

task_xbrt_v_s_median <- mlr3spatiotempcv::as_task_regr_st(data_v_s_sp_median,
  id = "shannon_median", target = "shannon_median")

task_xbrt_v_s_sd <- mlr3spatiotempcv::as_task_regr_st(data_v_s_sp_sd,
  id = "shannon_sd", target = "shannon_sd")

# With abundance as response 
task_xbrt_v_a_mean <- mlr3spatiotempcv::as_task_regr_st(data_v_a_sp_mean,
  id = "abundance_mean", target = "abundance_mean")

task_xbrt_v_a_median <- mlr3spatiotempcv::as_task_regr_st(data_v_a_sp_median,
  id = "abundance_median", target = "abundance_median")

task_xbrt_v_a_sd <- mlr3spatiotempcv::as_task_regr_st(data_v_a_sp_sd,
  id = "abundance_sd", target = "abundance_sd")

# With rel_abundance as response 
task_xbrt_v_ra_mean <- mlr3spatiotempcv::as_task_regr_st(data_v_ra_sp_mean,
  id = "rel_abundance_mean", target = "rel_abundance_mean")

task_xbrt_v_ra_median <- mlr3spatiotempcv::as_task_regr_st(data_v_ra_sp_median,
  id = "rel_abundance_median", target = "rel_abundance_median")

task_xbrt_v_ra_sd <- mlr3spatiotempcv::as_task_regr_st(data_v_ra_sp_sd,
  id = "rel_abundance_sd", target = "rel_abundance_sd")
...
### PREDICTOR: VELOCITY ### ---------------------------------------------------
# With k_index as response
autotuner_xbrt_v_k_mean <- mlr3tuning::AutoTuner$new(
...
autotuner_xbrt_v_k_median <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations 
...
autotuner_xbrt_v_k_sd <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations 
...
# With shannon index as response
autotuner_xbrt_v_s_mean <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations 
...
autotuner_xbrt_v_s_median <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations 
...
autotuner_xbrt_v_s_sd <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations 
...
# With abundance as response
autotuner_xbrt_v_a_mean <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations 
...
autotuner_xbrt_v_a_median <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations 
...
autotuner_xbrt_v_a_sd <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations 
...
# With rel_abundance as response
autotuner_xbrt_v_ra_mean <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations
...
autotuner_xbrt_v_ra_median <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations
...
autotuner_xbrt_v_ra_sd <- mlr3tuning::AutoTuner$new(
  learner = lrn_xbrt, # predefined learner
  resampling = mlr3::rsmp("spcv_coords", folds = 5), # spatial partitioning
  measure = mlr3::msr("regr.rmse"), # performance measure
  terminator = mlr3tuning::trm("evals", n_evals = 50), # specify 50 iterations
...
### PREDICTOR: VELOCITY ### --------------------------------------------------
# With k_index as response
autotuner_xbrt_v_k_mean$train(task_xbrt_v_k_mean)
autotuner_xbrt_v_k_median$train(task_xbrt_v_k_median)
autotuner_xbrt_v_k_sd$train(task_xbrt_v_k_sd)

# With shannon index as response
autotuner_xbrt_v_s_mean$train(task_xbrt_v_s_mean)
autotuner_xbrt_v_s_median$train(task_xbrt_v_s_median)
autotuner_xbrt_v_s_sd$train(task_xbrt_v_s_sd)

# With abundance as response
autotuner_xbrt_v_a_mean$train(task_xbrt_v_a_mean)
autotuner_xbrt_v_a_median$train(task_xbrt_v_a_median)
autotuner_xbrt_v_a_sd$train(task_xbrt_v_a_sd)

# With rel_abundance as response
autotuner_xbrt_v_ra_mean$train(task_xbrt_v_ra_mean)
autotuner_xbrt_v_ra_median$train(task_xbrt_v_ra_median)
autotuner_xbrt_v_ra_sd$train(task_xbrt_v_ra_sd)
```
...
write.csv(vi_brt_model_v, "ML_model/var_imp/vi_brt_model_v.csv", row.names = FALSE)
write.csv(vi_brt_model_v_c, "ML_model/var_imp/vi_brt_model_v_c.csv", row.names = FALSE)
write.csv(vi_brt_model_wd, "ML_model/var_imp/vi_brt_model_wd.csv", row.names = FALSE)
write.csv(vi_brt_model_wd_c, "ML_model/var_imp/vi_brt_model_wd_c.csv", row.names = FALSE)
write.csv(vi_brt_model_samp, "ML_model/var_imp/vi_brt_model_samp.csv", row.names = FALSE)
write.csv(vi_brt_model_samp_c, "ML_model/var_imp/vi_brt_model_samp_c.csv", row.names = FALSE)
write.csv(vi_brt_model_sec, "ML_model/var_imp/vi_brt_model_sec.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_k, "ML_Model/pdp_data/pdp_v_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_v_k, "ML_Model/pdp_data/pdp_x_v_k_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_v_k, "ML_Model/pdp_data/pdp_y_v_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_s, "ML_Model/pdp_data/pdp_v_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_v_s, "ML_Model/pdp_data/pdp_x_v_s_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_v_s, "ML_Model/pdp_data/pdp_y_v_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_a, "ML_Model/pdp_data/pdp_v_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_v_a, "ML_Model/pdp_data/pdp_x_v_a_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_v_a, "ML_Model/pdp_data/pdp_y_v_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_ra, "ML_Model/pdp_data/pdp_v_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_v_ra, "ML_Model/pdp_data/pdp_x_v_ra_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_v_ra, "ML_Model/pdp_data/pdp_y_v_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_wd_k, "ML_Model/pdp_data/pdp_v_wd_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_k, "ML_Model/pdp_data/pdp_wd_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_wd_k, "ML_Model/pdp_data/pdp_x_wd_k_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_k, "ML_Model/pdp_data/pdp_y_wd_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_wd_s, "ML_Model/pdp_data/pdp_v_wd_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_s, "ML_Model/pdp_data/pdp_wd_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_wd_s, "ML_Model/pdp_data/pdp_x_wd_s_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_s, "ML_Model/pdp_data/pdp_y_wd_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_wd_a, "ML_Model/pdp_data/pdp_v_wd_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_a, "ML_Model/pdp_data/pdp_wd_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_wd_a, "ML_Model/pdp_data/pdp_x_wd_a_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_a, "ML_Model/pdp_data/pdp_y_wd_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_wd_ra, "ML_Model/pdp_data/pdp_v_wd_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_ra, "ML_Model/pdp_data/pdp_wd_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_wd_ra, "ML_Model/pdp_data/pdp_x_wd_ra_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_wd_ra, "ML_Model/pdp_data/pdp_y_wd_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_samp_k, "ML_Model/pdp_data/pdp_v_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_samp_k, "ML_Model/pdp_data/pdp_wd_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_samp_k, "ML_Model/pdp_data/pdp_x_samp_k_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_k, "ML_Model/pdp_data/pdp_y_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_samp_k, "ML_Model/pdp_data/pdp_z_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_samp_k, "ML_Model/pdp_data/pdp_dist_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_samp_k, "ML_Model/pdp_data/pdp_cv_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_samp_k, "ML_Model/pdp_data/pdp_ac_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_samp_k, "ML_Model/pdp_data/pdp_mc_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_samp_k, "ML_Model/pdp_data/pdp_cc_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_samp_k, "ML_Model/pdp_data/pdp_clog_3_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_samp_k, "ML_Model/pdp_data/pdp_clog_6_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_samp_k, "ML_Model/pdp_data/pdp_sub_samp_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_samp_s, "ML_Model/pdp_data/pdp_v_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_samp_s, "ML_Model/pdp_data/pdp_wd_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_samp_s, "ML_Model/pdp_data/pdp_x_samp_s_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_s, "ML_Model/pdp_data/pdp_y_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_samp_s, "ML_Model/pdp_data/pdp_z_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_samp_s, "ML_Model/pdp_data/pdp_dist_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_samp_s, "ML_Model/pdp_data/pdp_cv_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_samp_s, "ML_Model/pdp_data/pdp_ac_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_samp_s, "ML_Model/pdp_data/pdp_mc_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_samp_s, "ML_Model/pdp_data/pdp_cc_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_samp_s, "ML_Model/pdp_data/pdp_clog_3_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_samp_s, "ML_Model/pdp_data/pdp_clog_6_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_samp_s, "ML_Model/pdp_data/pdp_sub_samp_s_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_samp_a, "ML_Model/pdp_data/pdp_v_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_samp_a, "ML_Model/pdp_data/pdp_wd_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_samp_a, "ML_Model/pdp_data/pdp_x_samp_a_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_a, "ML_Model/pdp_data/pdp_y_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_samp_a, "ML_Model/pdp_data/pdp_z_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_samp_a, "ML_Model/pdp_data/pdp_dist_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_samp_a, "ML_Model/pdp_data/pdp_cv_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_samp_a, "ML_Model/pdp_data/pdp_ac_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_samp_a, "ML_Model/pdp_data/pdp_mc_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_samp_a, "ML_Model/pdp_data/pdp_cc_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_samp_a, "ML_Model/pdp_data/pdp_clog_3_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_samp_a, "ML_Model/pdp_data/pdp_clog_6_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_samp_a, "ML_Model/pdp_data/pdp_sub_samp_a_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_samp_ra, "ML_Model/pdp_data/pdp_v_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_samp_ra, "ML_Model/pdp_data/pdp_wd_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_samp_ra, "ML_Model/pdp_data/pdp_x_samp_ra_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_samp_ra, "ML_Model/pdp_data/pdp_y_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_samp_ra, "ML_Model/pdp_data/pdp_z_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_samp_ra, "ML_Model/pdp_data/pdp_dist_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_samp_ra, "ML_Model/pdp_data/pdp_cv_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_samp_ra, "ML_Model/pdp_data/pdp_ac_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_samp_ra, "ML_Model/pdp_data/pdp_mc_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_samp_ra, "ML_Model/pdp_data/pdp_cc_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_samp_ra, "ML_Model/pdp_data/pdp_clog_3_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_samp_ra, "ML_Model/pdp_data/pdp_clog_6_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_samp_ra, "ML_Model/pdp_data/pdp_sub_samp_ra_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_v_sec_k, "ML_Model/pdp_data/pdp_v_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_wd_sec_k, "ML_Model/pdp_data/pdp_wd_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_x_sec_k, "ML_Model/pdp_data/pdp_x_sec_k_brt.csv", row.names = FALSE)
write.csv(pdp_model_y_sec_k, "ML_Model/pdp_data/pdp_y_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_z_sec_k, "ML_Model/pdp_data/pdp_z_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_dist_sec_k, "ML_Model/pdp_data/pdp_dist_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cv_sec_k, "ML_Model/pdp_data/pdp_cv_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ac_sec_k, "ML_Model/pdp_data/pdp_ac_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_mc_sec_k, "ML_Model/pdp_data/pdp_mc_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cc_sec_k, "ML_Model/pdp_data/pdp_cc_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_3_sec_k, "ML_Model/pdp_data/pdp_clog_3_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_clog_6_sec_k, "ML_Model/pdp_data/pdp_clog_6_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_sub_sec_k, "ML_Model/pdp_data/pdp_sub_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phb_sec_k, "ML_Model/pdp_data/pdp_phb_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_phd_sec_k, "ML_Model/pdp_data/pdp_phd_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_pha_sec_k, "ML_Model/pdp_data/pdp_pha_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cb_sec_k, "ML_Model/pdp_data/pdp_cb_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_cd_sec_k, "ML_Model/pdp_data/pdp_cd_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ca_sec_k, "ML_Model/pdp_data/pdp_ca_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ob_sec_k, "ML_Model/pdp_data/pdp_ob_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_od_sec_k, "ML_Model/pdp_data/pdp_od_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_oa_sec_k, "ML_Model/pdp_data/pdp_oa_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tb_sec_k, "ML_Model/pdp_data/pdp_tb_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_td_sec_k, "ML_Model/pdp_data/pdp_td_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ta_sec_k, "ML_Model/pdp_data/pdp_ta_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_teb_sec_k, "ML_Model/pdp_data/pdp_teb_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ted_sec_k, "ML_Model/pdp_data/pdp_ted_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_tea_sec_k, "ML_Model/pdp_data/pdp_tea_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qb_sec_k, "ML_Model/pdp_data/pdp_qb_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qd_sec_k, "ML_Model/pdp_data/pdp_qd_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_qa_sec_k, "ML_Model/pdp_data/pdp_qa_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gb_sec_k, "ML_Model/pdp_data/pdp_gb_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_gd_sec_k, "ML_Model/pdp_data/pdp_gd_sec_k_brt.csv", row.names = FALSE)
...
# export data 
write.csv(pdp_model_ga_sec_k, "ML_Model/pdp_data/pdp_ga_sec_k_brt.csv", row.names = FALSE)
