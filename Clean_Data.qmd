...
```{r}
# abiotic data
abiotic <- read_delim("Data/Abiotic_MI_Sampling/Abiotic_2022_2023_FINAL.csv")
...
gl6 <- read_delim("Data/GPS_Punkte/GL6.csv", col_names = FALSE)
...
```{r}
# Load MI data field 
field <- read_delim("Data/Abiotic_MI_Sampling/MZB_Feldscreening.csv", col_names = FALSE)
...
```{r}
# MI data lab 
lab <- read_delim("Data/Abiotic_MI_Sampling/MZB_SBI_Labor.csv", col_names = FALSE)
...
write_xlsx(abiotic_field,"Data\\Data_Complete\\Abiotic_MI_Field.xlsx")
```
...
write_xlsx(abiotic_lab,"Data\\Data_Complete\\Abiotic_MI_Lab.xlsx")  
```
...
# write excel with Lab results 
write_xlsx(abiotic_lab_model,"Data\\Data_Complete\\Abiotic_MI_Lab_Model.xlsx")  
```
