...
## bind Qs together
```{r}
GL1 <- cbind(Q_model_GL1, Q_MI_GL1)
GL2 <- cbind(Q_model_GL2, Q_MI_GL2)
```
...
Q_sampling_GL1$Q <- Q_MI_GL1 * Q_model_GL1 / Q_pegel_GL1
Q_sampling_GL1$Q <- 0.7

Q_sampling_GL1 <- Q_model_GL1 |>
  cbind(Q_MI_GL1) |>
  mutate(Q = Q_MI_GL1 * Q_model_GL1,
         reach = "GL1")

Q_sampling_GL2 <- GL2 |>
  mutate(Q = Q_MI_GL2 * Q_model_GL2,
         reach = "GL2") |>
  cbind(Q_MI_GL2)
